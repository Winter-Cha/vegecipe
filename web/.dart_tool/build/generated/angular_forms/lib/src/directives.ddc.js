define(['dart_sdk', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/core/application_tokens'], function(dart_sdk, change_detection, application_tokens) {
  ...
  const src__validators = Object.create(dart.library);
  const src__directives__validators = Object.create(dart.library);
  const src__model = Object.create(dart.library);
  const src__directives__abstract_control_directive = Object.create(dart.library);
  const src__directives__control_value_accessor = Object.create(dart.library);
  const src__directives__checkbox_value_accessor = Object.create(dart.library);
  const src__directives__normalize_validator = Object.create(dart.library);
  const src__directives__number_value_accessor = Object.create(dart.library);
  const src__directives__select_control_value_accessor = Object.create(dart.library);
  const src__directives__default_value_accessor = Object.create(dart.library);
  const src__directives__ng_control_group = Object.create(dart.library);
  const src__directives__ng_control = Object.create(dart.library);
  const src__directives__form_interface = Object.create(dart.library);
  const src__directives__control_container = Object.create(dart.library);
  const src__directives__shared = Object.create(dart.library);
  const src__directives__radio_control_value_accessor = Object.create(dart.library);
  const src__directives__abstract_form = Object.create(dart.library);
  const src__directives__ng_form = Object.create(dart.library);
  const src__directives__memorized_form = Object.create(dart.library);
  const src__directives__ng_control_name = Object.create(dart.library);
  const src__directives__ng_form_control = Object.create(dart.library);
  const src__directives__ng_form_model = Object.create(dart.library);
  const src__directives__ng_model = Object.create(dart.library);
  const src__directives__ng_control_status = Object.create(dart.library);
  const src__directives = Object.create(dart.library);
  const src__form_builder = Object.create(dart.library);
  ...
  dart.setLibraryUri(src__validators.Validators, "package:angular_forms/src/validators.dart");
  ...
  dart.setLibraryUri(src__directives__validators.Validator, "package:angular_forms/src/directives/validators.dart");
  ...
  dart.setLibraryUri(src__directives__validators.RequiredValidator, "package:angular_forms/src/directives/validators.dart");
  ...
  const _minLength = dart.privateName(src__directives__validators, "_minLength");
  ...
  dart.setLibraryUri(src__directives__validators.MinLengthValidator, "package:angular_forms/src/directives/validators.dart");
  ...
  const _maxLength = dart.privateName(src__directives__validators, "_maxLength");
  ...
  dart.setLibraryUri(src__directives__validators.MaxLengthValidator, "package:angular_forms/src/directives/validators.dart");
  ...
  dart.setLibraryUri(src__directives__validators.PatternValidator, "package:angular_forms/src/directives/validators.dart");
  ...
  const _value = dart.privateName(src__model, "_value");
  const _valueChanges = dart.privateName(src__model, "_valueChanges");
  const _statusChanges = dart.privateName(src__model, "_statusChanges");
  const _disabledChanges = dart.privateName(src__model, "_disabledChanges");
  const _status = dart.privateName(src__model, "_status");
  const _errors = dart.privateName(src__model, "_errors");
  const _pristine = dart.privateName(src__model, "_pristine");
  const _touched = dart.privateName(src__model, "_touched");
  const _parent = dart.privateName(src__model, "_parent");
  const _forEachChild = dart.privateName(src__model, "_forEachChild");
  const _updateTouched = dart.privateName(src__model, "_updateTouched");
  const _updatePristine = dart.privateName(src__model, "_updatePristine");
  const _emitEvent = dart.privateName(src__model, "_emitEvent");
  const _updateAncestors = dart.privateName(src__model, "_updateAncestors");
  const _runValidator = dart.privateName(src__model, "_runValidator");
  const _calculateStatus = dart.privateName(src__model, "_calculateStatus");
  const _updateControlsErrors = dart.privateName(src__model, "_updateControlsErrors");
  const _allControlsHaveStatus = dart.privateName(src__model, "_allControlsHaveStatus");
  const _anyControlsHaveStatus = dart.privateName(src__model, "_anyControlsHaveStatus");
  const _anyControlsTouched = dart.privateName(src__model, "_anyControlsTouched");
  const _anyControlsDirty = dart.privateName(src__model, "_anyControlsDirty");
  const _anyControls = dart.privateName(src__model, "_anyControls");
  ...
  const _onChange = dart.privateName(src__model, "_onChange");
  const _rawValue = dart.privateName(src__model, "_rawValue");
  ...
  const _checkAllValuesPresent = dart.privateName(src__model, "_checkAllValuesPresent");
  const _reduceValue = dart.privateName(src__model, "_reduceValue");
  ...
  dart.setLibraryUri(src__model.ControlGroup, "package:angular_forms/src/model.dart");
  ...
  dart.setLibraryUri(src__model.ControlArray, "package:angular_forms/src/model.dart");
  ...
  dart.setLibraryUri(src__directives__control_value_accessor.TouchHandler, "package:angular_forms/src/directives/control_value_accessor.dart");
  ...
  const _element = dart.privateName(src__directives__checkbox_value_accessor, "_element");
  ...
  dart.setLibraryUri(src__directives__checkbox_value_accessor.CheckboxControlValueAccessor, "package:angular_forms/src/directives/checkbox_value_accessor.dart");
  ...
  const _element$ = dart.privateName(src__directives__number_value_accessor, "_element");
  const Object_TouchHandler$$ = class Object_TouchHandler extends core.Object {};
  (Object_TouchHandler$$.new = function() {
    src__directives__control_value_accessor.TouchHandler.new.call(this);
  }).prototype = Object_TouchHandler$$.prototype;
  ...
  dart.setLibraryUri(src__directives__number_value_accessor.NumberValueAccessor, "package:angular_forms/src/directives/number_value_accessor.dart");
  ...
  const _element$0 = dart.privateName(src__directives__select_control_value_accessor, "_element");
  const _optionMap = dart.privateName(src__directives__select_control_value_accessor, "_optionMap");
  const _idCounter = dart.privateName(src__directives__select_control_value_accessor, "_idCounter");
  const _getOptionValue = dart.privateName(src__directives__select_control_value_accessor, "_getOptionValue");
  const _getOptionId = dart.privateName(src__directives__select_control_value_accessor, "_getOptionId");
  const _registerOption = dart.privateName(src__directives__select_control_value_accessor, "_registerOption");
  ...
  dart.setLibraryUri(src__directives__select_control_value_accessor.SelectControlValueAccessor, "package:angular_forms/src/directives/select_control_value_accessor.dart");
  ...
  const _select = dart.privateName(src__directives__select_control_value_accessor, "_select");
  const _setElementValue = dart.privateName(src__directives__select_control_value_accessor, "_setElementValue");
  ...
  dart.setLibraryUri(src__directives__select_control_value_accessor.NgSelectOption, "package:angular_forms/src/directives/select_control_value_accessor.dart");
  ...
  const _element$1 = dart.privateName(src__directives__default_value_accessor, "_element");
  ...
  dart.setLibraryUri(src__directives__default_value_accessor.DefaultValueAccessor, "package:angular_forms/src/directives/default_value_accessor.dart");
  ...
  const _parent$ = dart.privateName(src__directives__ng_control_group, "_parent");
  const _isDisabled = dart.privateName(src__directives__ng_control_group, "_isDisabled");
  const _disabledChanged = dart.privateName(src__directives__ng_control_group, "_disabledChanged");
  ...
  dart.setLibraryUri(src__directives__ng_control_group.NgControlGroup, "package:angular_forms/src/directives/ng_control_group.dart");
  ...
  dart.setLibraryUri(src__directives__ng_control.NgControl, "package:angular_forms/src/directives/ng_control.dart");
  ...
  dart.setLibraryUri(src__directives__form_interface.Form, "package:angular_forms/src/directives/form_interface.dart");
  ...
  const _accessors = dart.privateName(src__directives__radio_control_value_accessor, "_accessors");
  const _control = dart.privateName(src__directives__radio_control_value_accessor, "_control");
  ...
  dart.setLibraryUri(src__directives__radio_control_value_accessor.RadioControlRegistry, "package:angular_forms/src/directives/radio_control_value_accessor.dart");
  ...
  dart.setLibraryUri(src__directives__radio_control_value_accessor.RadioButtonState, "package:angular_forms/src/directives/radio_control_value_accessor.dart");
  ...
  const _element$2 = dart.privateName(src__directives__radio_control_value_accessor, "_element");
  const _registry = dart.privateName(src__directives__radio_control_value_accessor, "_registry");
  const _injector = dart.privateName(src__directives__radio_control_value_accessor, "_injector");
  const _state = dart.privateName(src__directives__radio_control_value_accessor, "_state");
  ...
  dart.setLibraryUri(src__directives__radio_control_value_accessor.RadioControlValueAccessor, "package:angular_forms/src/directives/radio_control_value_accessor.dart");
  ...
  const _ngSubmit = dart.privateName(src__directives__abstract_form, "_ngSubmit");
  const _ngBeforeSubmit = dart.privateName(src__directives__abstract_form, "_ngBeforeSubmit");
  ...
  dart.setLibraryUri(src__directives__ng_form.NgForm, "package:angular_forms/src/directives/ng_form.dart");
  ...
  dart.setLibraryUri(src__directives__memorized_form.MemorizedForm, "package:angular_forms/src/directives/memorized_form.dart");
  const _parent$0 = dart.privateName(src__directives__ng_control_name, "_parent");
  const _update = dart.privateName(src__directives__ng_control_name, "_update");
  const _modelChanged = dart.privateName(src__directives__ng_control_name, "_modelChanged");
  const _model = dart.privateName(src__directives__ng_control_name, "_model");
  const _added = dart.privateName(src__directives__ng_control_name, "_added");
  const _isDisabled$ = dart.privateName(src__directives__ng_control_name, "_isDisabled");
  const _disabledChanged$ = dart.privateName(src__directives__ng_control_name, "_disabledChanged");
  ...
  dart.setLibraryUri(src__directives__ng_control_name.NgControlName, "package:angular_forms/src/directives/ng_control_name.dart");
  ...
  const _formChanged = dart.privateName(src__directives__ng_form_control, "_formChanged");
  const _form = dart.privateName(src__directives__ng_form_control, "_form");
  const _update$ = dart.privateName(src__directives__ng_form_control, "_update");
  const _modelChanged$ = dart.privateName(src__directives__ng_form_control, "_modelChanged");
  const _model$ = dart.privateName(src__directives__ng_form_control, "_model");
  ...
  dart.setLibraryUri(src__directives__ng_form_control.NgFormControl, "package:angular_forms/src/directives/ng_form_control.dart");
  ...
  const _validator = dart.privateName(src__directives__ng_form_model, "_validator");
  const _formChanged$ = dart.privateName(src__directives__ng_form_model, "_formChanged");
  const _form$ = dart.privateName(src__directives__ng_form_model, "_form");
  const _checkFormPresent = dart.privateName(src__directives__ng_form_model, "_checkFormPresent");
  const _updateDomValue = dart.privateName(src__directives__ng_form_model, "_updateDomValue");
  ...
  dart.setLibraryUri(src__directives__ng_form_model.NgFormModel, "package:angular_forms/src/directives/ng_form_model.dart");
  ...
  const _control$ = dart.privateName(src__directives__ng_model, "_control");
  const _update$0 = dart.privateName(src__directives__ng_model, "_update");
  const _model$0 = dart.privateName(src__directives__ng_model, "_model");
  const _modelChanged$0 = dart.privateName(src__directives__ng_model, "_modelChanged");
  const _init = dart.privateName(src__directives__ng_model, "_init");
  ...
  dart.setLibraryUri(src__directives__ng_model.NgModel, "package:angular_forms/src/directives/ng_model.dart");
  ...
  const _cd = dart.privateName(src__directives__ng_control_status, "_cd");
  ...
  dart.setLibraryUri(src__directives__ng_control_status.NgControlStatus, "package:angular_forms/src/directives/ng_control_status.dart");
  ...
  dart.setLibraryUri(src__form_builder.FormBuilder, "package:angular_forms/src/form_builder.dart");
