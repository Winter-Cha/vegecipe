define(['dart_sdk', 'packages/http_parser/http_parser', 'packages/pedantic/pedantic'], function(dart_sdk, http_parser, pedantic) {
  ...
  dart.setLibraryUri(src__byte_stream.ByteStream, "package:http/src/byte_stream.dart");
  ...
  dart.setLibraryUri(src__exception.ClientException, "package:http/src/exception.dart");
  ...
  dart.setLibraryUri(src__base_request.BaseRequest, "package:http/src/base_request.dart");
  ...
  dart.setLibraryUri(src__request.Request, "package:http/src/request.dart");
  ...
  dart.setLibraryUri(src__base_response.BaseResponse, "package:http/src/base_response.dart");
  ...
  dart.setLibraryUri(src__streamed_response.StreamedResponse, "package:http/src/streamed_response.dart");
  ...
  dart.setLibraryUri(src__response.Response, "package:http/src/response.dart");
  ...
  dart.setLibraryUri(src__client.Client, "package:http/src/client.dart");
  ...
  dart.setLibraryUri(src__base_client.BaseClient, "package:http/src/base_client.dart");
  ...
  dart.setLibraryUri(src__browser_client.BrowserClient, "package:http/src/browser_client.dart");
