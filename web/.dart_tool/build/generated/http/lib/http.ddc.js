define(['dart_sdk', 'packages/http/src/base_client', 'packages/http_parser/http_parser'], function(dart_sdk, base_client, http_parser) {
  ...
  dart.setLibraryUri(src__multipart_file.MultipartFile, "package:http/src/multipart_file.dart");
  ...
  dart.setLibraryUri(src__multipart_request.MultipartRequest, "package:http/src/multipart_request.dart");
  ...
  dart.setLibraryUri(src__streamed_request.StreamedRequest, "package:http/src/streamed_request.dart");
