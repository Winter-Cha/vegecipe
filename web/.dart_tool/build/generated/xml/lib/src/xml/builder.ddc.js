define(['dart_sdk', 'packages/petitparser/petitparser', 'packages/petitparser/src/core/actions/action', 'packages/collection/src/canonicalized_map'], function(dart_sdk, petitparser, action, canonicalized_map) {
  ...
  const src__xml__utils__attribute_type = Object.create(dart.library);
  const src__xml__utils__node_type = Object.create(dart.library);
  const src__xml__utils__token = Object.create(dart.library);
  const src__xml__utils__entities = Object.create(dart.library);
  const src__xml__visitors__normalizer = Object.create(dart.library);
  const src__xml__iterators__preceding = Object.create(dart.library);
  const src__xml__visitors__writer = Object.create(dart.library);
  const src__xml__visitors__pretty_writer = Object.create(dart.library);
  const src__xml__utils__writable = Object.create(dart.library);
  const src__xml__utils__simple_name = Object.create(dart.library);
  const src__xml__utils__prefix_name = Object.create(dart.library);
  const src__xml__visitors__transformer = Object.create(dart.library);
  const src__xml__visitors__visitable = Object.create(dart.library);
  const src__xml__nodes__text = Object.create(dart.library);
  const src__xml__nodes__processing = Object.create(dart.library);
  const src__xml__utils__owned = Object.create(dart.library);
  const src__xml__utils__exceptions = Object.create(dart.library);
  const src__xml__utils__node_list = Object.create(dart.library);
  const src__xml__utils__named = Object.create(dart.library);
  const src__xml__utils__name_matcher = Object.create(dart.library);
  const src__xml__nodes__element = Object.create(dart.library);
  const src__xml__nodes__parent = Object.create(dart.library);
  const src__xml__nodes__document_fragment = Object.create(dart.library);
  const src__xml__nodes__comment = Object.create(dart.library);
  const src__xml__visitors__visitor = Object.create(dart.library);
  const src__xml__nodes__cdata = Object.create(dart.library);
  const src__xml__builder = Object.create(dart.library);
  const src__xml__utils__name = Object.create(dart.library);
  const src__xml__nodes__attribute = Object.create(dart.library);
  const src__xml__iterators__following = Object.create(dart.library);
  const src__xml__iterators__descendants = Object.create(dart.library);
  const src__xml__iterators__ancestors = Object.create(dart.library);
  const src__xml__nodes__node = Object.create(dart.library);
  const src__xml__nodes__data = Object.create(dart.library);
  const src__xml__nodes__doctype = Object.create(dart.library);
  const src__xml__nodes__document = Object.create(dart.library);
  const src__xml__production = Object.create(dart.library);
  const src__xml__grammar = Object.create(dart.library);
  const src__xml__parser = Object.create(dart.library);
  ...
  let VoidToNever = () => (VoidToNever = dart.constFn(dart.fnType(dart.bottom, [])))();
  ...
  dart.setLibraryUri(src__xml__utils__attribute_type.XmlAttributeType, "package:xml/src/xml/utils/attribute_type.dart");
  ...
  dart.setLibraryUri(src__xml__utils__node_type.XmlNodeType, "package:xml/src/xml/utils/node_type.dart");
  ...
  dart.setLibraryUri(src__xml__utils__token.XmlToken, "package:xml/src/xml/utils/token.dart");
  ...
  const _stopper = dart.privateName(src__xml__utils__entities, "_stopper");
  const _stopperCode = dart.privateName(src__xml__utils__entities, "_stopperCode");
  const _minLength = dart.privateName(src__xml__utils__entities, "_minLength");
  ...
  dart.setLibraryUri(src__xml__utils__entities.XmlCharacterDataParser, "package:xml/src/xml/utils/entities.dart");
  ...
  const _normalize = dart.privateName(src__xml__visitors__normalizer, "_normalize");
  const _removeEmpty = dart.privateName(src__xml__visitors__normalizer, "_removeEmpty");
  const _mergeAdjacent = dart.privateName(src__xml__visitors__normalizer, "_mergeAdjacent");
  ...
  dart.setLibraryUri(src__xml__visitors__visitor.XmlVisitor, "package:xml/src/xml/visitors/visitor.dart");
  ...
  dart.setLibraryUri(src__xml__visitors__normalizer.XmlNormalizer, "package:xml/src/xml/visitors/normalizer.dart");
  ...
  dart.setLibraryUri(src__xml__visitors__visitable.XmlVisitable, "package:xml/src/xml/visitors/visitable.dart");
  ...
  dart.setLibraryUri(src__xml__utils__writable.XmlWritable, "package:xml/src/xml/utils/writable.dart");
  dart.defineExtensionMethods(src__xml__utils__writable.XmlWritable, ['toString']);
  const _parent = dart.privateName(src__xml__utils__owned, "_parent");
  ...
  dart.setLibraryUri(src__xml__utils__owned.XmlOwned, "package:xml/src/xml/utils/owned.dart");
  ...
  src__xml__nodes__node.XmlNode = class XmlNode extends Object_XmlOwned$ {
    get children() {
      return const$ || (const$ = dart.constList([], src__xml__nodes__node.XmlNode));
    }
    get attributes() {
      return const$0 || (const$0 = dart.constList([], src__xml__nodes__attribute.XmlAttribute));
    }
    get preceding() {
  ...
  dart.setLibraryUri(src__xml__nodes__node.XmlNode, "package:xml/src/xml/nodes/node.dart");
  ...
  dart.setLibraryUri(src__xml__iterators__preceding.XmlPrecedingIterable, "package:xml/src/xml/iterators/preceding.dart");
  ...
  dart.setLibraryUri(src__xml__iterators__preceding.XmlPrecedingIterator, "package:xml/src/xml/iterators/preceding.dart");
  ...
  dart.setLibraryUri(src__xml__visitors__writer.XmlWriter, "package:xml/src/xml/visitors/writer.dart");
  ...
  dart.setLibraryUri(src__xml__visitors__pretty_writer.XmlPrettyWriter, "package:xml/src/xml/visitors/pretty_writer.dart");
  ...
  dart.setLibraryUri(src__xml__utils__name.XmlName, "package:xml/src/xml/utils/name.dart");
  ...
  dart.setLibraryUri(src__xml__utils__simple_name.XmlSimpleName, "package:xml/src/xml/utils/simple_name.dart");
  ...
  dart.setLibraryUri(src__xml__utils__prefix_name.XmlPrefixName, "package:xml/src/xml/utils/prefix_name.dart");
  ...
  dart.setLibraryUri(src__xml__visitors__transformer.XmlTransformer, "package:xml/src/xml/visitors/transformer.dart");
  ...
  const _text = dart.privateName(src__xml__nodes__data, "_text");
  ...
  dart.setLibraryUri(src__xml__nodes__data.XmlData, "package:xml/src/xml/nodes/data.dart");
  ...
  dart.setLibraryUri(src__xml__nodes__text.XmlText, "package:xml/src/xml/nodes/text.dart");
  ...
  dart.setLibraryUri(src__xml__nodes__processing.XmlProcessing, "package:xml/src/xml/nodes/processing.dart");
  ...
  dart.setLibraryUri(src__xml__utils__exceptions.XmlException, "package:xml/src/xml/utils/exceptions.dart");
  ...
  dart.setLibraryUri(src__xml__utils__exceptions.XmlParserException, "package:xml/src/xml/utils/exceptions.dart");
  ...
  dart.setLibraryUri(src__xml__utils__exceptions.XmlNodeTypeException, "package:xml/src/xml/utils/exceptions.dart");
  ...
  dart.setLibraryUri(src__xml__utils__exceptions.XmlParentException, "package:xml/src/xml/utils/exceptions.dart");
  ...
  dart.setLibraryUri(src__xml__utils__exceptions.XmlTagException, "package:xml/src/xml/utils/exceptions.dart");
  const _expandFragment = dart.privateName(src__xml__utils__node_list, "_expandFragment");
  const _expandNodes = dart.privateName(src__xml__utils__node_list, "_expandNodes");
  ...
  dart.setLibraryUri(src__xml__utils__named.XmlNamed, "package:xml/src/xml/utils/named.dart");
  ...
  let const$1;
  let const$2;
  const _filterElements = dart.privateName(src__xml__nodes__parent, "_filterElements");
  ...
  dart.setLibraryUri(src__xml__nodes__parent.XmlParent, "package:xml/src/xml/nodes/parent.dart");
  ...
  (src__xml__nodes__element.XmlElement.new = function(name, attributes, children, isSelfClosing) {
    if (attributes === void 0) attributes = const$1 || (const$1 = dart.constList([], src__xml__nodes__attribute.XmlAttribute));
    if (children === void 0) children = const$2 || (const$2 = dart.constList([], src__xml__nodes__node.XmlNode));
  ...
  dart.setLibraryUri(src__xml__nodes__element.XmlElement, "package:xml/src/xml/nodes/element.dart");
  ...
  dart.setLibraryUri(src__xml__nodes__document_fragment.XmlDocumentFragment, "package:xml/src/xml/nodes/document_fragment.dart");
  ...
  dart.setLibraryUri(src__xml__nodes__comment.XmlComment, "package:xml/src/xml/nodes/comment.dart");
  ...
  dart.setLibraryUri(src__xml__nodes__cdata.XmlCDATA, "package:xml/src/xml/nodes/cdata.dart");
  const _stack = dart.privateName(src__xml__builder, "_stack");
  let const$4;
  let const$5;
  const _insert = dart.privateName(src__xml__builder, "_insert");
  const _buildName = dart.privateName(src__xml__builder, "_buildName");
  const _lookup = dart.privateName(src__xml__builder, "_lookup");
  src__xml__builder.XmlBuilder = class XmlBuilder extends core.Object {
    ...
    element(name, opts) {
      let namespace = opts && 'namespace' in opts ? opts.namespace : null;
      let namespaces = opts && 'namespaces' in opts ? opts.namespaces : const$4 || (const$4 = dart.constMap(core.String, core.String, []));
      let attributes = opts && 'attributes' in opts ? opts.attributes : const$5 || (const$5 = dart.constMap(core.String, core.String, []));
    ...
    [_lookup](uri) {
      let builder = this[_stack][$lastWhere](dart.fn(builder => builder.namespaces[$containsKey](uri), XmlNodeBuilderTobool()), {orElse: dart.fn(() => dart.throw(new core.ArgumentError.new("Undefined namespace: " + dart.str(uri))), VoidToNever())});
  ...
  dart.setLibraryUri(src__xml__builder.XmlBuilder, "package:xml/src/xml/builder.dart");
  ...
  dart.setLibraryUri(src__xml__builder.NamespaceData, "package:xml/src/xml/builder.dart");
  ...
  dart.setLibraryUri(src__xml__builder.XmlNodeBuilder, "package:xml/src/xml/builder.dart");
  ...
  dart.setLibraryUri(src__xml__builder.XmlDocumentBuilder, "package:xml/src/xml/builder.dart");
  ...
  dart.setLibraryUri(src__xml__builder.XmlElementBuilder, "package:xml/src/xml/builder.dart");
  ...
  const _value = dart.privateName(src__xml__nodes__attribute, "_value");
  ...
  dart.setLibraryUri(src__xml__nodes__attribute.XmlAttribute, "package:xml/src/xml/nodes/attribute.dart");
  ...
  dart.setLibraryUri(src__xml__iterators__following.XmlFollowingIterable, "package:xml/src/xml/iterators/following.dart");
  ...
  dart.setLibraryUri(src__xml__iterators__following.XmlFollowingIterator, "package:xml/src/xml/iterators/following.dart");
  ...
  dart.setLibraryUri(src__xml__iterators__descendants.XmlDescendantsIterable, "package:xml/src/xml/iterators/descendants.dart");
  ...
  dart.setLibraryUri(src__xml__iterators__descendants.XmlDescendantsIterator, "package:xml/src/xml/iterators/descendants.dart");
  ...
  dart.setLibraryUri(src__xml__iterators__ancestors.XmlAncestorsIterable, "package:xml/src/xml/iterators/ancestors.dart");
  ...
  dart.setLibraryUri(src__xml__iterators__ancestors.XmlAncestorsIterator, "package:xml/src/xml/iterators/ancestors.dart");
  ...
  dart.setLibraryUri(src__xml__nodes__doctype.XmlDoctype, "package:xml/src/xml/nodes/doctype.dart");
  let const$6;
  src__xml__nodes__document.XmlDocument = class XmlDocument extends src__xml__nodes__parent.XmlParent {
    ...
    get rootElement() {
      return src__xml__nodes__element.XmlElement._check(this.children.firstWhere(dart.fn(node => src__xml__nodes__element.XmlElement.is(node), XmlNodeTobool()), {orElse: dart.fn(() => dart.throw(new core.StateError.new("Empty XML document")), VoidToNever())}));
    }
    get document() {
      return this;
    }
  ...
  (src__xml__nodes__document.XmlDocument.new = function(children) {
    if (children === void 0) children = const$6 || (const$6 = dart.constList([], src__xml__nodes__node.XmlNode));
  ...
  dart.setLibraryUri(src__xml__nodes__document.XmlDocument, "package:xml/src/xml/nodes/document.dart");
  ...
  dart.setLibraryUri(src__xml__production.XmlProductionDefinition, "package:xml/src/xml/production.dart");
  ...
  dart.setLibraryUri(src__xml__parser.XmlParserDefinition, "package:xml/src/xml/parser.dart");
