define(['dart_sdk', 'packages/collection/src/comparators', 'packages/stack_trace/stack_trace', 'packages/logging/logging'], function(dart_sdk, comparators, stack_trace, logging) {
  'use strict';
  ...
  const src__runtime__optimizations = Object.create(dart.library);
  const src__runtime = Object.create(dart.library);
  const src__di__errors = Object.create(dart.library);
  const src__core__di__opaque_token = Object.create(dart.library);
  const src__di__providers = Object.create(dart.library);
  const src__di__module = Object.create(dart.library);
  const src__core__di__decorators = Object.create(dart.library);
  const src__di__reflector = Object.create(dart.library);
  const src__di__injector__runtime = Object.create(dart.library);
  const src__di__injector__map = Object.create(dart.library);
  const src__di__injector__hierarchical = Object.create(dart.library);
  const src__di__injector__empty = Object.create(dart.library);
  const src__di__injector__injector = Object.create(dart.library);
  const src__core__di__provider = Object.create(dart.library);
  const src__core__di = Object.create(dart.library);
  const src__facade__lang = Object.create(dart.library);
  const src__core__change_detection__change_detection_util = Object.create(dart.library);
  const src__core__change_detection__change_detector_ref = Object.create(dart.library);
  const src__core__change_detection__constants = Object.create(dart.library);
  const src__core__change_detection__differs__default_iterable_differ = Object.create(dart.library);
  const src__core__change_detection__differs__default_keyvalue_differ = Object.create(dart.library);
  const src__core__change_detection__pipe_transform = Object.create(dart.library);
  const src__core__change_detection__change_detection = Object.create(dart.library);
  const src__core__metadata__typed = Object.create(dart.library);
  const src__core__metadata__view = Object.create(dart.library);
  const src__core__metadata__lifecycle_hooks = Object.create(dart.library);
  const src__core__metadata__visibility = Object.create(dart.library);
  const src__core__metadata = Object.create(dart.library);
  const src__core__zone__ng_zone = Object.create(dart.library);
  const src__facade__exception_handler = Object.create(dart.library);
  const $add = dartx.add;
  ...
  let TypedOfObject = () => (TypedOfObject = dart.constFn(src__core__metadata__typed.Typed$(core.Object)))();
  let ListOfTypedOfObject = () => (ListOfTypedOfObject = dart.constFn(core.List$(TypedOfObject())))();
  ...
  dart.setLibraryUri(src__di__errors.InjectionError, "package:angular/src/di/errors.dart");
  let const$;
  ...
  dart.setLibraryUri(src__di__errors.NoProviderError, "package:angular/src/di/errors.dart");
  ...
  const _uniqueName = dart.privateName(src__core__di__opaque_token, "_uniqueName");
  ...
  const _listOf = dart.privateName(src__core__di__opaque_token, "_listOf");
  ...
  dart.setLibraryUri(src__di__providers.RuntimeInjectorBuilder, "package:angular/src/di/providers.dart");
  ...
  const _buildAtRuntime = dart.privateName(src__di__providers, "_buildAtRuntime");
  const _listOfMulti = dart.privateName(src__di__providers, "_listOfMulti");
  ...
  src__di__providers.listOfMulti = function(provider) {
    ...
    if (src__core__di__opaque_token.MultiToken.is(token)) {
      return src__core__di__opaque_token.listOfMultiToken(core.Object, token);
    }
  ...
  dart.setLibraryUri(src__di__module.Module, "package:angular/src/di/module.dart");
  ...
  dart.setLibraryUri(src__core__di__decorators.Inject, "package:angular/src/core/di/decorators.dart");
  ...
  dart.setLibraryUri(src__core__di__decorators.Injectable, "package:angular/src/core/di/decorators.dart");
  ...
  dart.setLibraryUri(src__core__di__decorators.Optional, "package:angular/src/core/di/decorators.dart");
  ...
  dart.setLibraryUri(src__core__di__decorators.Self, "package:angular/src/core/di/decorators.dart");
  ...
  dart.setLibraryUri(src__core__di__decorators.SkipSelf, "package:angular/src/core/di/decorators.dart");
  ...
  dart.setLibraryUri(src__core__di__decorators.Host, "package:angular/src/core/di/decorators.dart");
  ...
  dart.setLibraryUri(src__di__injector__runtime.ReflectiveInjector, "package:angular/src/di/injector/runtime.dart");
  ...
  const _providers = dart.privateName(src__di__injector__runtime, "_providers");
  const _multiProviders = dart.privateName(src__di__injector__runtime, "_multiProviders");
  const _staticOnlyResolveAndCreate = dart.privateName(src__di__injector__runtime, "_staticOnlyResolveAndCreate");
  const _instances = dart.privateName(src__di__injector__runtime, "_instances");
  const _resolveMulti = dart.privateName(src__di__injector__runtime, "_resolveMulti");
  const _resolveMeta = dart.privateName(src__di__injector__runtime, "_resolveMeta");
  const _resolveArgs = dart.privateName(src__di__injector__runtime, "_resolveArgs");
  let const$5;
  ...
  dart.setMethodSignature(src__di__injector__injector.Injector, () => ({
    ...
    provideTokenOptional: dart.gFnType(T => [T, [src__core__di__opaque_token.OpaqueToken$(T)]])
  }));
  dart.setLibraryUri(src__di__injector__injector.Injector, "package:angular/src/di/injector/injector.dart");
  ...
  dart.setLibraryUri(src__di__injector__hierarchical.HierarchicalInjector, "package:angular/src/di/injector/hierarchical.dart");
  ...
  dart.setLibraryUri(src__di__injector__runtime._RuntimeInjector, "package:angular/src/di/injector/runtime.dart");
  ...
  dart.setLibraryUri(src__di__injector__runtime._FlatProviders, "package:angular/src/di/injector/runtime.dart");
  ...
  let const$6;
  const _providers$ = dart.privateName(src__di__injector__map, "_providers");
  ...
  dart.setLibraryUri(src__di__injector__map.MapInjector, "package:angular/src/di/injector/map.dart");
  ...
  dart.setLibraryUri(src__di__injector__empty.EmptyInjector, "package:angular/src/di/injector/empty.dart");
  ...
  const _providersOrModules = dart.privateName(src__di__injector__injector, "_providersOrModules");
  ...
  dart.setLibraryUri(src__di__injector__injector.GenerateInjector, "package:angular/src/di/injector/injector.dart");
  ...
  src__core__change_detection__change_detection_util._DevModeEquality = class _DevModeEquality extends src__equality.DefaultEquality$(core.Object) {
    equals(a, b) {
      ...
      } else if (!IterableOfObject().is(a) && !dart.test(src__facade__lang.isPrimitive(a)) && !IterableOfObject().is(b) && !dart.test(src__facade__lang.isPrimitive(b))) {
        return true;
      } else {
  ...
  dart.setLibraryUri(src__core__change_detection__change_detection_util._DevModeEquality, "package:angular/src/core/change_detection/change_detection_util.dart");
  let const$9;
  ...
  dart.setLibraryUri(src__core__change_detection__change_detection_util.SimpleChange, "package:angular/src/core/change_detection/change_detection_util.dart");
  ...
  dart.setLibraryUri(src__core__change_detection__change_detector_ref.ChangeDetectorRef, "package:angular/src/core/change_detection/change_detector_ref.dart");
  ...
  dart.setLibraryUri(src__core__change_detection__constants.ChangeDetectorState, "package:angular/src/core/change_detection/constants.dart");
  ...
  dart.setLibraryUri(src__core__change_detection__constants.ChangeDetectionStrategy, "package:angular/src/core/change_detection/constants.dart");
  dart.defineLazy(src__core__change_detection__constants.ChangeDetectionStrategy, {
    ...
    /*src__core__change_detection__constants.ChangeDetectionStrategy.CheckOnce*/get CheckOnce() {
      return src__core__change_detection__constants.ChangeDetectionCheckedState.checkOnce;
    },
    /*src__core__change_detection__constants.ChangeDetectionStrategy.Checked*/get Checked() {
      return src__core__change_detection__constants.ChangeDetectionCheckedState.waitingForMarkForCheck;
    },
    /*src__core__change_detection__constants.ChangeDetectionStrategy.CheckAlways*/get CheckAlways() {
      return src__core__change_detection__constants.ChangeDetectionCheckedState.checkAlways;
    },
    /*src__core__change_detection__constants.ChangeDetectionStrategy.Detached*/get Detached() {
      return src__core__change_detection__constants.ChangeDetectionCheckedState.waitingToBeAttached;
    },
  ...
  src__core__change_detection__constants.ChangeDetectionCheckedState = class ChangeDetectionCheckedState extends core.Object {};
  (src__core__change_detection__constants.ChangeDetectionCheckedState.new = function() {
  }).prototype = src__core__change_detection__constants.ChangeDetectionCheckedState.prototype;
  dart.addTypeTests(src__core__change_detection__constants.ChangeDetectionCheckedState);
  dart.setLibraryUri(src__core__change_detection__constants.ChangeDetectionCheckedState, "package:angular/src/core/change_detection/constants.dart");
  dart.defineLazy(src__core__change_detection__constants.ChangeDetectionCheckedState, {
    /*src__core__change_detection__constants.ChangeDetectionCheckedState.checkOnce*/get checkOnce() {
      return 1;
    },
    /*src__core__change_detection__constants.ChangeDetectionCheckedState.waitingForMarkForCheck*/get waitingForMarkForCheck() {
      return 2;
    },
    /*src__core__change_detection__constants.ChangeDetectionCheckedState.checkAlways*/get checkAlways() {
      return 3;
    },
    /*src__core__change_detection__constants.ChangeDetectionCheckedState.waitingToBeAttached*/get waitingToBeAttached() {
      return 4;
    }
  });
  ...
  const _trackByFn = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_trackByFn");
  const _length = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_length");
  const _collection = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_collection");
  const _linkedRecords = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_linkedRecords");
  const _unlinkedRecords = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_unlinkedRecords");
  const _previousItHead = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_previousItHead");
  const _itHead = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_itHead");
  const _itTail = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_itTail");
  const _additionsHead = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_additionsHead");
  const _additionsTail = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_additionsTail");
  const _movesHead = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_movesHead");
  const _movesTail = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_movesTail");
  const _removalsHead = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_removalsHead");
  const _removalsTail = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_removalsTail");
  const _identityChangesHead = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_identityChangesHead");
  const _identityChangesTail = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_identityChangesTail");
  const _nextRemoved = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_nextRemoved");
  const _next = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_next");
  const _nextAdded = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_nextAdded");
  const _nextIdentityChange = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_nextIdentityChange");
  let const$10;
  const _reset = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_reset");
  const _mismatch = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_mismatch");
  const _verifyReinsertion = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_verifyReinsertion");
  const _addIdentityChange = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_addIdentityChange");
  const _truncate = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_truncate");
  const _nextPrevious = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_nextPrevious");
  const _nextMoved = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_nextMoved");
  const _prev = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_prev");
  const _remove = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_remove");
  const _moveAfter = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_moveAfter");
  const _reinsertAfter = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_reinsertAfter");
  const _addAfter = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_addAfter");
  const _addToMoves = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_addToMoves");
  const _unlink = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_unlink");
  const _addToRemovals = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_addToRemovals");
  const _prevRemoved = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_prevRemoved");
  const _insertAfter = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_insertAfter");
  src__core__change_detection__differs__default_iterable_differ.DefaultIterableDiffer = class DefaultIterableDiffer extends core.Object {
    ...
    forEachOperation(fn) {
      ...
      while (nextIt != null || nextRemove != null) {
        ...
        let currentIndex = src__runtime__optimizations.unsafeCast(core.int, dart.dload(record, 'currentIndex'));
        if (core.identical(record, nextRemove)) {
          ...
          if (dart.dload(record, 'previousIndex') == null) {
            ...
            if (localMovePreviousIndex !== localCurrentIndex) {
              ...
              let previousIndex = src__runtime__optimizations.unsafeCast(core.int, dart.dload(record, 'previousIndex'));
    ...
    diff(collection) {
      if (collection != null) {
        ...
        collection = const$10 || (const$10 = dart.constList([], core.Object));
      }
  ...
  (src__core__change_detection__differs__default_iterable_differ.DefaultIterableDiffer.new = function(trackByFn) {
    ...
    this[_trackByFn] = trackByFn != null ? trackByFn : dart.fn(src__core__change_detection__differs__default_iterable_differ._trackByIdentity, intAnddynamicToObject());
  ...
  dart.setMethodSignature(src__core__change_detection__differs__default_iterable_differ.DefaultIterableDiffer, () => ({
    ...
    diff: dart.fnType(src__core__change_detection__differs__default_iterable_differ.DefaultIterableDiffer, [core.Iterable$(core.Object)]),
  ...
  dart.setLibraryUri(src__core__change_detection__differs__default_iterable_differ.DefaultIterableDiffer, "package:angular/src/core/change_detection/differs/default_iterable_differ.dart");
  dart.setFieldSignature(src__core__change_detection__differs__default_iterable_differ.DefaultIterableDiffer, () => ({
    ...
    [_collection]: dart.fieldType(IterableOfObject()),
  ...
  const _prevDup = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_prevDup");
  const _nextDup = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_nextDup");
  ...
  dart.setLibraryUri(src__core__change_detection__differs__default_iterable_differ.CollectionChangeRecord, "package:angular/src/core/change_detection/differs/default_iterable_differ.dart");
  ...
  const _head = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_head");
  const _tail = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_tail");
  ...
  dart.setLibraryUri(src__core__change_detection__differs__default_iterable_differ._DuplicateItemRecordList, "package:angular/src/core/change_detection/differs/default_iterable_differ.dart");
  ...
  const _map = dart.privateName(src__core__change_detection__differs__default_iterable_differ, "_map");
  ...
  dart.setLibraryUri(src__core__change_detection__differs__default_iterable_differ._DuplicateMap, "package:angular/src/core/change_detection/differs/default_iterable_differ.dart");
  ...
  const _records = dart.privateName(src__core__change_detection__differs__default_keyvalue_differ, "_records");
  const _mapHead = dart.privateName(src__core__change_detection__differs__default_keyvalue_differ, "_mapHead");
  const _appendAfter = dart.privateName(src__core__change_detection__differs__default_keyvalue_differ, "_appendAfter");
  const _previousMapHead = dart.privateName(src__core__change_detection__differs__default_keyvalue_differ, "_previousMapHead");
  const _changesHead = dart.privateName(src__core__change_detection__differs__default_keyvalue_differ, "_changesHead");
  const _changesTail = dart.privateName(src__core__change_detection__differs__default_keyvalue_differ, "_changesTail");
  const _additionsHead$ = dart.privateName(src__core__change_detection__differs__default_keyvalue_differ, "_additionsHead");
  const _additionsTail$ = dart.privateName(src__core__change_detection__differs__default_keyvalue_differ, "_additionsTail");
  const _removalsHead$ = dart.privateName(src__core__change_detection__differs__default_keyvalue_differ, "_removalsHead");
  const _nextChanged = dart.privateName(src__core__change_detection__differs__default_keyvalue_differ, "_nextChanged");
  const _nextAdded$ = dart.privateName(src__core__change_detection__differs__default_keyvalue_differ, "_nextAdded");
  const _next$ = dart.privateName(src__core__change_detection__differs__default_keyvalue_differ, "_next");
  const _reset$ = dart.privateName(src__core__change_detection__differs__default_keyvalue_differ, "_reset");
  const _addToAdditions = dart.privateName(src__core__change_detection__differs__default_keyvalue_differ, "_addToAdditions");
  const _prev$ = dart.privateName(src__core__change_detection__differs__default_keyvalue_differ, "_prev");
  const _maybeAddToChanges = dart.privateName(src__core__change_detection__differs__default_keyvalue_differ, "_maybeAddToChanges");
  const _getOrCreateRecord = dart.privateName(src__core__change_detection__differs__default_keyvalue_differ, "_getOrCreateRecord");
  const _insertBeforeOrAppend = dart.privateName(src__core__change_detection__differs__default_keyvalue_differ, "_insertBeforeOrAppend");
  const _addToChanges = dart.privateName(src__core__change_detection__differs__default_keyvalue_differ, "_addToChanges");
  const _nextPrevious$ = dart.privateName(src__core__change_detection__differs__default_keyvalue_differ, "_nextPrevious");
  src__core__change_detection__differs__default_keyvalue_differ.DefaultKeyValueDiffer = class DefaultKeyValueDiffer extends core.Object {
    ...
    diff(map) {
      let t = map;
      t == null ? map = new (LinkedMapOfObject$Object()).new() : t;
  ...
  dart.setMethodSignature(src__core__change_detection__differs__default_keyvalue_differ.DefaultKeyValueDiffer, () => ({
    ...
    diff: dart.fnType(src__core__change_detection__differs__default_keyvalue_differ.DefaultKeyValueDiffer, [core.Map$(core.Object, core.Object)]),
  ...
  dart.setLibraryUri(src__core__change_detection__differs__default_keyvalue_differ.DefaultKeyValueDiffer, "package:angular/src/core/change_detection/differs/default_keyvalue_differ.dart");
  ...
  dart.setLibraryUri(src__core__change_detection__differs__default_keyvalue_differ.KeyValueChangeRecord, "package:angular/src/core/change_detection/differs/default_keyvalue_differ.dart");
  ...
  dart.setLibraryUri(src__core__change_detection__pipe_transform.PipeTransform, "package:angular/src/core/change_detection/pipe_transform.dart");
  ...
  dart.setLibraryUri(src__core__metadata__view.ViewEncapsulation, "package:angular/src/core/metadata/view.dart");
  ...
  dart.setLibraryUri(src__core__metadata__lifecycle_hooks.LifecycleHooks, "package:angular/src/core/metadata/lifecycle_hooks.dart");
  ...
  dart.setLibraryUri(src__core__metadata__lifecycle_hooks.OnChanges, "package:angular/src/core/metadata/lifecycle_hooks.dart");
  ...
  dart.setLibraryUri(src__core__metadata__lifecycle_hooks.AfterChanges, "package:angular/src/core/metadata/lifecycle_hooks.dart");
  ...
  dart.setLibraryUri(src__core__metadata__lifecycle_hooks.OnInit, "package:angular/src/core/metadata/lifecycle_hooks.dart");
  ...
  dart.setLibraryUri(src__core__metadata__lifecycle_hooks.OnDestroy, "package:angular/src/core/metadata/lifecycle_hooks.dart");
  ...
  dart.setLibraryUri(src__core__metadata__lifecycle_hooks.DoCheck, "package:angular/src/core/metadata/lifecycle_hooks.dart");
  ...
  dart.setLibraryUri(src__core__metadata__lifecycle_hooks.AfterContentInit, "package:angular/src/core/metadata/lifecycle_hooks.dart");
  ...
  dart.setLibraryUri(src__core__metadata__lifecycle_hooks.AfterContentChecked, "package:angular/src/core/metadata/lifecycle_hooks.dart");
  ...
  dart.setLibraryUri(src__core__metadata__lifecycle_hooks.AfterViewInit, "package:angular/src/core/metadata/lifecycle_hooks.dart");
  ...
  dart.setLibraryUri(src__core__metadata__lifecycle_hooks.AfterViewChecked, "package:angular/src/core/metadata/lifecycle_hooks.dart");
  ...
  dart.setLibraryUri(src__core__metadata__visibility.Visibility, "package:angular/src/core/metadata/visibility.dart");
  ...
  dart.setLibraryUri(src__core__metadata.Directive, "package:angular/src/core/metadata.dart");
  ...
  dart.setLibraryUri(src__core__metadata.Component, "package:angular/src/core/metadata.dart");
  dart.setFieldSignature(src__core__metadata.Component, () => ({
    ...
    directiveTypes: dart.finalFieldType(ListOfTypedOfObject()),
  ...
  dart.setLibraryUri(src__core__metadata.Pipe, "package:angular/src/core/metadata.dart");
  ...
  dart.setLibraryUri(src__core__metadata.Attribute, "package:angular/src/core/metadata.dart");
  ...
  dart.setLibraryUri(src__core__metadata._Query, "package:angular/src/core/metadata.dart");
  ...
  dart.setLibraryUri(src__core__metadata.ContentChildren, "package:angular/src/core/metadata.dart");
  ...
  dart.setLibraryUri(src__core__metadata.ContentChild, "package:angular/src/core/metadata.dart");
  ...
  dart.setLibraryUri(src__core__metadata._ViewQuery, "package:angular/src/core/metadata.dart");
  ...
  dart.setLibraryUri(src__core__metadata.ViewChildren, "package:angular/src/core/metadata.dart");
  ...
  dart.setLibraryUri(src__core__metadata.ViewChild, "package:angular/src/core/metadata.dart");
  ...
  dart.setLibraryUri(src__core__metadata.Input, "package:angular/src/core/metadata.dart");
  ...
  dart.setLibraryUri(src__core__metadata.Output, "package:angular/src/core/metadata.dart");
  ...
  dart.setLibraryUri(src__core__metadata.HostBinding, "package:angular/src/core/metadata.dart");
  ...
  dart.setLibraryUri(src__core__metadata.HostListener, "package:angular/src/core/metadata.dart");
  ...
  const _thisZoneKey = dart.privateName(src__core__zone__ng_zone, "_thisZoneKey");
  const _onTurnStart = dart.privateName(src__core__zone__ng_zone, "_onTurnStart");
  const _onMicrotaskEmpty = dart.privateName(src__core__zone__ng_zone, "_onMicrotaskEmpty");
  const _onTurnDone = dart.privateName(src__core__zone__ng_zone, "_onTurnDone");
  const _onError = dart.privateName(src__core__zone__ng_zone, "_onError");
  const _outerZone = dart.privateName(src__core__zone__ng_zone, "_outerZone");
  const _innerZone = dart.privateName(src__core__zone__ng_zone, "_innerZone");
  const _hasPendingMicrotasks = dart.privateName(src__core__zone__ng_zone, "_hasPendingMicrotasks");
  const _hasPendingMacrotasks = dart.privateName(src__core__zone__ng_zone, "_hasPendingMacrotasks");
  const _isStable = dart.privateName(src__core__zone__ng_zone, "_isStable");
  const _nesting = dart.privateName(src__core__zone__ng_zone, "_nesting");
  const _isRunning = dart.privateName(src__core__zone__ng_zone, "_isRunning");
  const _disposed = dart.privateName(src__core__zone__ng_zone, "_disposed");
  const _pendingMicrotasks = dart.privateName(src__core__zone__ng_zone, "_pendingMicrotasks");
  const _pendingTimers = dart.privateName(src__core__zone__ng_zone, "_pendingTimers");
  const _createInnerZone = dart.privateName(src__core__zone__ng_zone, "_createInnerZone");
  const _onErrorWithLongStackTrace = dart.privateName(src__core__zone__ng_zone, "_onErrorWithLongStackTrace");
  const _onErrorWithoutLongStackTrace = dart.privateName(src__core__zone__ng_zone, "_onErrorWithoutLongStackTrace");
  const _scheduleMicrotask = dart.privateName(src__core__zone__ng_zone, "_scheduleMicrotask");
  const _run = dart.privateName(src__core__zone__ng_zone, "_run");
  const _runUnary = dart.privateName(src__core__zone__ng_zone, "_runUnary");
  const _runBinary = dart.privateName(src__core__zone__ng_zone, "_runBinary");
  const _createTimer = dart.privateName(src__core__zone__ng_zone, "_createTimer");
  const _setMicrotask = dart.privateName(src__core__zone__ng_zone, "_setMicrotask");
  const _onLeave = dart.privateName(src__core__zone__ng_zone, "_onLeave");
  const _onEnter = dart.privateName(src__core__zone__ng_zone, "_onEnter");
  const _checkStable = dart.privateName(src__core__zone__ng_zone, "_checkStable");
  const _setMacrotask = dart.privateName(src__core__zone__ng_zone, "_setMacrotask");
  const _duration = dart.privateName(src__core__zone__ng_zone, "_duration");
  const _longestPendingTimer = dart.privateName(src__core__zone__ng_zone, "_longestPendingTimer");
  src__core__zone__ng_zone.NgZone = class NgZone extends core.Object {
    ...
    [_onErrorWithoutLongStackTrace](self, parent, zone, error, trace) {
      this[_onError].add(new src__core__zone__ng_zone.NgZoneError.new(error, JSArrayOfObject().of([dart.toString(trace)])));
    }
  ...
  dart.setLibraryUri(src__core__zone__ng_zone.NgZone, "package:angular/src/core/zone/ng_zone.dart");
  ...
  const _timer = dart.privateName(src__core__zone__ng_zone, "_timer");
  const _onCancel = dart.privateName(src__core__zone__ng_zone, "_onCancel");
  ...
  dart.setLibraryUri(src__core__zone__ng_zone._WrappedTimer, "package:angular/src/core/zone/ng_zone.dart");
  ...
  dart.setLibraryUri(src__core__zone__ng_zone.NgZoneError, "package:angular/src/core/zone/ng_zone.dart");
  dart.setFieldSignature(src__core__zone__ng_zone.NgZoneError, () => ({
    ...
    stackTrace: dart.finalFieldType(ListOfObject())
  }));
  const _logger = dart.privateName(src__facade__exception_handler, "_logger");
  ...
  dart.setLibraryUri(src__facade__exception_handler.ExceptionHandler, "package:angular/src/facade/exception_handler.dart");
