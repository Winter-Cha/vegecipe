define(['dart_sdk'], function(dart_sdk) {
  ...
  const src__facade__exception_handler$46template = Object.create(dart.library);
  const src__facade__lang$46template = Object.create(dart.library);
  const src__core__change_detection__change_detection_util$46template = Object.create(dart.library);
  const src__core__change_detection__change_detector_ref$46template = Object.create(dart.library);
  const src__core__change_detection__constants$46template = Object.create(dart.library);
  const src__runtime__optimizations$46template = Object.create(dart.library);
  const src__runtime$46template = Object.create(dart.library);
  const src__core__change_detection__differs__default_iterable_differ$46template = Object.create(dart.library);
  const src__core__change_detection__differs__default_keyvalue_differ$46template = Object.create(dart.library);
  const src__core__change_detection__pipe_transform$46template = Object.create(dart.library);
  const src__core__change_detection__change_detection$46template = Object.create(dart.library);
  const src__di__errors$46template = Object.create(dart.library);
  const src__core__di__opaque_token$46template = Object.create(dart.library);
  const src__di__providers$46template = Object.create(dart.library);
  const src__di__module$46template = Object.create(dart.library);
  const src__core__di__decorators$46template = Object.create(dart.library);
  const src__di__reflector$46template = Object.create(dart.library);
  const src__di__injector__runtime$46template = Object.create(dart.library);
  const src__di__injector__map$46template = Object.create(dart.library);
  const src__di__injector__hierarchical$46template = Object.create(dart.library);
  const src__di__injector__empty$46template = Object.create(dart.library);
  const src__di__injector__injector$46template = Object.create(dart.library);
  const src__core__di__provider$46template = Object.create(dart.library);
  const src__core__di$46template = Object.create(dart.library);
  const src__core__metadata__lifecycle_hooks$46template = Object.create(dart.library);
  const src__core__metadata__typed$46template = Object.create(dart.library);
  const src__core__metadata__view$46template = Object.create(dart.library);
  const src__core__metadata__visibility$46template = Object.create(dart.library);
  const src__core__metadata$46template = Object.create(dart.library);
  const src__core__zone__ng_zone$46template = Object.create(dart.library);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["../../facade/exception_handler.template.dart","../../facade/lang.template.dart","change_detection_util.template.dart","change_detector_ref.template.dart","constants.template.dart","../../runtime/optimizations.template.dart","../../runtime.template.dart","differs/default_iterable_differ.template.dart","differs/default_keyvalue_differ.template.dart","pipe_transform.template.dart","change_detection.template.dart","../../di/errors.template.dart","../di/opaque_token.template.dart","../../di/providers.template.dart","../../di/module.template.dart","../di/decorators.template.dart","../../di/reflector.template.dart","../../di/injector/runtime.template.dart","../../di/injector/map.template.dart","../../di/injector/hierarchical.template.dart","../../di/injector/empty.template.dart","../../di/injector/injector.template.dart","../di/provider.template.dart","../di.template.dart","../metadata/lifecycle_hooks.template.dart","../metadata/typed.template.dart","../metadata/view.template.dart","../metadata/visibility.template.dart","../metadata.template.dart","../zone/ng_zone.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;EAQsB;;ECAA;;MCAlB,sEAAQ;YAAG;;;;;AAEb,kBAAI,sEAAQ,GAAE;AACZ;;AAEF,6EAAW;AAEX,IAAM,0CAAa;EACrB;;ECRsB;;ECAA;;ECAA;;MCAlB,gCAAQ;YAAG;;;;;AAEb,kBAAI,gCAAQ,GAAE;AACZ;;AAEF,uCAAW;AAEX,IAAM,oDAAa;EACrB;;MCRI,iFAAQ;YAAG;;;;;AAEb,kBAAI,iFAAQ,GAAE;AACZ;;AAEF,wFAAW;AAEX,IAAM,qCAAa;EACrB;;ECRsB;;ECAA;;MCKlB,iEAAQ;YAAG;;;;;AAEb,kBAAI,iEAAQ,GAAE;AACZ;;AAEF,wEAAW;AAEX,IAAM,2EAAa;AACnB,IAAM,yEAAa;AACnB,IAAM,+DAAa;AACnB,IAAM,sFAAa;AACnB,IAAM,sFAAa;AACnB,IAAM,oEAAa;EACrB;;MClBI,mCAAQ;YAAG;;;;;AAEb,kBAAI,mCAAQ,GAAE;AACZ;;AAEF,0CAAW;AAEX,IAAM,qCAAa;EACrB;;MCRI,+CAAQ;YAAG;;;;;AAEb,kBAAI,+CAAQ,GAAE;AACZ;;AAEF,sDAAW;AAEX,IAAM,qCAAa;EACrB;;MCPI,sCAAQ;YAAG;;;;;AAEb,kBAAI,sCAAQ,GAAE;AACZ;;AAEF,6CAAW;AAEX,IAAM,oDAAa;AACnB,IAAM,qCAAa;EACrB;;MCVI,mCAAQ;YAAG;;;;;AAEb,kBAAI,mCAAQ,GAAE;AACZ;;AAEF,0CAAW;AAEX,IAAM,2CAAa;EACrB;;ECRsB;;MCElB,sCAAQ;YAAG;;;;;AAEb,kBAAI,sCAAQ,GAAE;AACZ;;AAEF,6CAAW;AAEX,IAAM,kDAAa;AACnB,IAAM,oDAAa;AACnB,IAAM,qCAAa;EACrB;;MCHI,8CAAQ;YAAG;;;;;AAEb,kBAAI,8CAAQ,GAAE;AACZ;;AAEF,qDAAW;AAEX,IAAM,kDAAa;AACnB,IAAM,oDAAa;AACnB,IAAM,wCAAa;AACnB,IAAM,wCAAa;AACnB,IAAM,2CAAa;AACnB,IAAM,2CAAa;AACnB,IAAM,iDAAa;AACnB,IAAM,wDAAa;AACnB,IAAM,oDAAa;AACnB,IAAM,qCAAa;EACrB;;MCxBI,0CAAQ;YAAG;;;;;AAEb,kBAAI,0CAAQ,GAAE;AACZ;;AAEF,iDAAW;AAEX,IAAM,iDAAa;AACnB,IAAM,wDAAa;AACnB,IAAM,oDAAa;EACrB;;MCTI,mDAAQ;YAAG;;;;;AAEb,kBAAI,mDAAQ,GAAE;AACZ;;AAEF,0DAAW;AAEX,IAAM,wCAAa;AACnB,IAAM,iDAAa;AACnB,IAAM,oDAAa;AACnB,IAAM,qCAAa;EACrB;;MCbI,4CAAQ;YAAG;;;;;AAEb,kBAAI,4CAAQ,GAAE;AACZ;;AAEF,mDAAW;AAEX,IAAM,wDAAa;AACnB,IAAM,oDAAa;EACrB;;MCFI,+CAAQ;YAAG;;;;;AAEb,kBAAI,+CAAQ,GAAE;AACZ;;AAEF,sDAAW;AAEX,IAAM,oDAAa;AACnB,IAAM,wCAAa;AACnB,IAAM,wCAAa;AACnB,IAAM,iDAAa;AACnB,IAAM,wDAAa;AACnB,IAAM,+CAAa;AACnB,IAAM,oDAAa;AACnB,IAAM,qCAAa;AACnB,IAAM,mDAAa;EACrB;;MCxBI,2CAAQ;YAAG;;;;;AAEb,kBAAI,2CAAQ,GAAE;AACZ;;AAEF,kDAAW;AAEX,IAAM,2CAAa;EACrB;;MCFI,iCAAQ;YAAG;;;;;AAEb,kBAAI,iCAAQ,GAAE;AACZ;;AAEF,wCAAW;AAEX,IAAM,wCAAa;AACnB,IAAM,oDAAa;AACnB,IAAM,mDAAa;AACnB,IAAM,wCAAa;AACnB,IAAM,kDAAa;AACnB,IAAM,oDAAa;AACnB,IAAM,gDAAa;EACrB;;MCpBI,wDAAQ;YAAG;;;;;AAEb,kBAAI,wDAAQ,GAAE;AACZ;;AAEF,+DAAW;AAEX,IAAM,2EAAa;EACrB;;ECRsB;;ECAA;;MCAlB,mDAAQ;YAAG;;;;;AAEb,kBAAI,mDAAQ,GAAE;AACZ;;AAEF,0DAAW;AAEX,IAAM,4CAAa;EACrB;;MCAI,uCAAQ;YAAG;;;;;AAEb,kBAAI,uCAAQ,GAAE;AACZ;;AAEF,8CAAW;AAEX,IAAM,sEAAa;AACnB,IAAM,kDAAa;AACnB,IAAM,6DAAa;AACnB,IAAM,mDAAa;AACnB,IAAM,mDAAa;AACnB,IAAM,kDAAa;AACnB,IAAM,kDAAa;AACnB,IAAM,wDAAa;AACnB,IAAM,wDAAa;EACrB;;ECxBsB","file":"change_detection.template.ddc.js"}');
  // Exports:
  return {
