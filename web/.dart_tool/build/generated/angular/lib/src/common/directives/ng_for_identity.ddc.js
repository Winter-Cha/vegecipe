define(['dart_sdk', 'packages/angular/src/bootstrap/modules'], function(dart_sdk, modules) {
  ...
  const src__common__directives__ng_for_identity = Object.create(dart.library);
  const $isEmpty = dartx.isEmpty;
  const _template = dart.privateName(src__common__directives__ng_for_identity, "_template");
  const _container = dart.privateName(src__common__directives__ng_for_identity, "_container");
