define(['dart_sdk', 'packages/angular/angular.template', 'packages/angular/src/core/change_detection/change_detection.template', 'packages/angular/src/bootstrap/modules', 'packages/angular/src/bootstrap/run.template'], function(dart_sdk, angular, change_detection, modules, run) {
  ...
  const src__runtime__dom_helpers$46template = modules.src__runtime__dom_helpers$46template;
  const src__bootstrap__run$46template = run.src__bootstrap__run$46template;
  const experimental$46template = Object.create(dart.library);
  const src__common__directives__ng_for_identity$46template = Object.create(dart.library);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["experimental.template.dart","src/common/directives/ng_for_identity.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;MAiBI,gCAAQ;YAAG;;;;;AAEb,kBAAI,gCAAQ,GAAE;AACZ;;AAEF,uCAAW;AAEX,IAAM,gCAAa;AACnB,IAAM,qCAAa;AACnB,IAAM,gDAAa;AACnB,IAAM,4CAAa;AACnB,IAAM,iEAAa;AACnB,IAAM,8DAAa;AACnB,IAAM,iDAAa;AACnB,IAAM,oDAAa;AACnB,IAAM,qCAAa;AACnB,IAAM,kDAAa;EACrB;;MC1BI,4DAAQ;YAAG;;;;;AAEb,kBAAI,4DAAQ,GAAE;AACZ;;AAEF,mEAAW;AAEX,IAAM,gCAAa;EACrB","file":"experimental.template.ddc.js"}');
  // Exports:
  return {
