define(['dart_sdk', 'packages/angular_router/src/directives/router_outlet_directive.template', 'packages/angular/src/bootstrap/modules', 'packages/angular/src/core/change_detection/directive_change_detector', 'packages/angular_router/src/constants', 'packages/angular/angular.template', 'packages/angular/src/core/change_detection/change_detection.template'], function(dart_sdk, router_outlet_directive, modules, directive_change_detector, constants, angular, change_detection) {
  ...
  const src__directives__router_link_directive$46template = Object.create(dart.library);
  const src__directives__router_link_active_directive$46template = Object.create(dart.library);
  const src__constants$46template = Object.create(dart.library);
  ...
  const _expr_0 = dart.privateName(src__directives__router_link_directive$46template, "_expr_0");
  src__directives__router_link_directive$46template.RouterLinkNgCd = class RouterLinkNgCd extends src__core__change_detection__directive_change_detector.DirectiveChangeDetector {
    ...
    detectHostChanges(view, el) {
      ...
      if (dart.test(src__core__linker__app_view_utils.checkBinding(this[_expr_0], currVal_0))) {
        src__runtime__dom_helpers.updateAttribute(el, "href", currVal_0);
  ...
  dart.setMethodSignature(src__directives__router_link_directive$46template.RouterLinkNgCd, () => ({
    __proto__: dart.getMethods(src__directives__router_link_directive$46template.RouterLinkNgCd.__proto__),
    detectHostChanges: dart.fnType(dart.void, [src__core__linker__app_view.AppView, html.Element])
  }));
  dart.setLibraryUri(src__directives__router_link_directive$46template.RouterLinkNgCd, "package:angular_router/src/directives/router_link_directive.template.dart");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["angular_router.template.dart","src/directives/router_link_directive.template.dart","src/directives/router_link_active_directive.template.dart","src/constants.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;MAmBI,kCAAQ;YAAG;;;;;AAEb,kBAAI,kCAAQ,GAAE;AACZ;;AAEF,yCAAW;AAEX,IAAM,uCAAa;AACnB,IAAM,sEAAa;AACnB,IAAM,+DAAa;AACnB,IAAM,iEAAa;AACnB,IAAM,uCAAa;AACnB,IAAM,sCAAa;AACnB,IAAM,8CAAa;AACnB,IAAM,wCAAa;AACnB,IAAM,uDAAa;AACnB,IAAM,4CAAa;AACnB,IAAO,kDAAa;AACpB,IAAO,yCAAa;EACtB;;;ICnB2B;;;;;;sBAGF,IAAqB,EAAE,EAAkB;AAC9D,UAAM,YAAY,aAAQ,YAAY;AACtC,oBAAI,AAAQ,8CAAY,CAAC,aAAO,EAAE,SAAS,IAAG;AAC5C,QAAQ,yCAAe,CAAC,EAAE,EAAE,QAAQ,SAAS;AAC7C,qBAAO,GAAG,SAAS;;IAEvB;;mFAPe,QAAa;IADxB,aAAO;IACS,eAAQ,GAAR,QAAQ;;EAAC;;;;;;;;;;;;;;MAU3B,0DAAQ;YAAG;;;;;AAEb,kBAAI,0DAAQ,GAAE;AACZ;;AAEF,iEAAW;AAEX,IAAM,sCAAa;AACnB,IAAM,uDAAa;AACnB,IAAM,4CAAa;AACnB,IAAM,iCAAa;AACnB,IAAM,gCAAa;EACrB;;MC/BI,iEAAQ;YAAG;;;;;AAEb,kBAAI,iEAAQ,GAAE;AACZ;;AAEF,wEAAW;AAEX,IAAM,4CAAa;AACnB,IAAM,kDAAa;AACnB,IAAM,gCAAa;AACnB,IAAM,qCAAa;AACnB,IAAM,+DAAa;EACrB;;MCVI,kCAAQ;YAAG;;;;;AAEb,kBAAI,kCAAQ,GAAE;AACZ;;AAEF,yCAAW;AAEX,IAAM,sEAAa;AACnB,IAAM,+DAAa;AACnB,IAAM,iEAAa;AACnB,IAAM,sCAAa;AACnB,IAAM,gCAAa;AACnB,IAAM,4CAAa;AACnB,IAAM,iDAAa;EACrB","file":"angular_router.template.ddc.js"}');
  // Exports:
  return {
