define(['dart_sdk', 'packages/angular_router/src/directives/router_outlet_directive', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/angular.template', 'packages/angular/src/core/change_detection/change_detection.template'], function(dart_sdk, router_outlet_directive, change_detection, angular, change_detection$) {
  ...
  const src__location__base_href$46template = Object.create(dart.library);
  const src__location__platform_location$46template = Object.create(dart.library);
  const src__location__browser_platform_location$46template = Object.create(dart.library);
  const src__location__location_strategy$46template = Object.create(dart.library);
  const src__location__location$46template = Object.create(dart.library);
  const src__location__hash_location_strategy$46template = Object.create(dart.library);
  const src__location__path_location_strategy$46template = Object.create(dart.library);
  const src__location$46template = Object.create(dart.library);
  const src__url$46template = Object.create(dart.library);
  const src__route_path$46template = Object.create(dart.library);
  const src__route_definition$46template = Object.create(dart.library);
  const src__router__router_state$46template = Object.create(dart.library);
  const src__lifecycle$46template = Object.create(dart.library);
  const src__router__navigation_params$46template = Object.create(dart.library);
  const src__router_hook$46template = Object.create(dart.library);
  const src__router__router_outlet_token$46template = Object.create(dart.library);
  const src__directives__router_outlet_directive$46template = Object.create(dart.library);
  const src__router__router$46template = Object.create(dart.library);
  const src__router__router_impl$46template = Object.create(dart.library);
