define(['dart_sdk', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/bootstrap/modules', 'packages/collection/src/comparators'], function(dart_sdk, change_detection, modules, comparators) {
  ...
  const src__core__metadata = change_detection.src__core__metadata;
  ...
  const src__location__base_href = Object.create(dart.library);
  const src__location__platform_location = Object.create(dart.library);
  const src__location__browser_platform_location = Object.create(dart.library);
  const src__location__location_strategy = Object.create(dart.library);
  const src__location__location = Object.create(dart.library);
  const src__location__hash_location_strategy = Object.create(dart.library);
  const src__location__path_location_strategy = Object.create(dart.library);
  const src__location = Object.create(dart.library);
  const src__url = Object.create(dart.library);
  const src__route_path = Object.create(dart.library);
  const src__route_definition = Object.create(dart.library);
  const src__router__router_state = Object.create(dart.library);
  const src__lifecycle = Object.create(dart.library);
  const src__router__navigation_params = Object.create(dart.library);
  const src__router_hook = Object.create(dart.library);
  const src__router__router_outlet_token = Object.create(dart.library);
  const src__directives__router_outlet_directive = Object.create(dart.library);
  const src__router__router = Object.create(dart.library);
  const src__router__router_impl = Object.create(dart.library);
  ...
  dart.setLibraryUri(src__location__platform_location.PlatformLocation, "package:angular_router/src/location/platform_location.dart");
  ...
  const _location = dart.privateName(src__location__browser_platform_location, "_location");
  const _history = dart.privateName(src__location__browser_platform_location, "_history");
  const _init = dart.privateName(src__location__browser_platform_location, "_init");
  ...
  dart.setLibraryUri(src__location__browser_platform_location.BrowserPlatformLocation, "package:angular_router/src/location/browser_platform_location.dart");
  ...
  dart.setLibraryUri(src__location__location_strategy.LocationStrategy, "package:angular_router/src/location/location_strategy.dart");
  ...
  const _baseHref = dart.privateName(src__location__location, "_baseHref");
  const _subject = dart.privateName(src__location__location, "_subject");
  src__location__location.Location = class Location extends core.Object {
    ...
    normalizePath(path) {
      ...
      let hashStrategy = src__location__hash_location_strategy.HashLocationStrategy.is(this.locationStrategy);
  ...
  dart.setLibraryUri(src__location__location.Location, "package:angular_router/src/location/location.dart");
  ...
  const _platformLocation = dart.privateName(src__location__hash_location_strategy, "_platformLocation");
  const _baseHref$ = dart.privateName(src__location__hash_location_strategy, "_baseHref");
  ...
  dart.setLibraryUri(src__location__hash_location_strategy.HashLocationStrategy, "package:angular_router/src/location/hash_location_strategy.dart");
  ...
  const _platformLocation$ = dart.privateName(src__location__path_location_strategy, "_platformLocation");
  const _baseHref$0 = dart.privateName(src__location__path_location_strategy, "_baseHref");
  ...
  dart.setLibraryUri(src__location__path_location_strategy.PathLocationStrategy, "package:angular_router/src/location/path_location_strategy.dart");
  ...
  dart.setLibraryUri(src__url.Url, "package:angular_router/src/url.dart");
  ...
  dart.setLibraryUri(src__route_path.RoutePath, "package:angular_router/src/route_path.dart");
  ...
  src__route_definition.RouteDefinition = class RouteDefinition extends core.Object {
    ...
    get parameters() {
      return IterableOfString()._check(src__route_definition.RouteDefinition._findParameters.allMatches(this.path)[$map](core.String, dart.fn(m => m._get(1), RegExpMatchToString())));
    }
    toRegExp() {
  ...
  (src__route_definition.RouteDefinition.__ = function(opts) {
    ...
    this[path$1] = src__url.Url.trimSlashes((() => {
      let l = path;
      return l != null ? l : (() => {
        let t = routePath;
    ...
    let l$ = l != null ? l : (() => {
      let t = routePath;
      return t == null ? null : t.useAsDefault;
    })();
    this[useAsDefault$0] = l$ != null ? l$ : false;
    let l$0 = additionalData;
    this[additionalData$0] = l$0 != null ? l$0 : (() => {
      let t = routePath;
      return t == null ? null : t.additionalData;
    })();
  ...
  dart.setLibraryUri(src__route_definition.RouteDefinition, "package:angular_router/src/route_definition.dart");
  ...
  src__route_definition.ComponentRouteDefinition = class ComponentRouteDefinition extends src__route_definition.RouteDefinition {
    ...
    assertValid() {
      ...
      if (!core.Type.is(this.component) && !src__core__linker__component_factory.ComponentFactory.is(this.component)) {
        dart.throw(new core.StateError.new("Must have a valid (non-null) `component` type (got " + dart.str(dart.wrapType(src__core__metadata.Component)) + ")."));
      }
      super.assertValid();
    }
  };
  ...
  dart.setLibraryUri(src__route_definition.ComponentRouteDefinition, "package:angular_router/src/route_definition.dart");
  ...
  dart.setLibraryUri(src__route_definition.DeferredRouteDefinition, "package:angular_router/src/route_definition.dart");
  ...
  const _redirectToParameters = dart.privateName(src__route_definition, "_redirectToParameters");
  let const$0;
  src__route_definition.RedirectRouteDefinition = class RedirectRouteDefinition extends src__route_definition.RouteDefinition {
    ...
    get [_redirectToParameters]() {
      return IterableOfString()._check(src__route_definition.RouteDefinition._findParameters.allMatches(this.redirectTo)[$map](core.String, dart.fn(m => m._get(1), RegExpMatchToString())));
    }
  };
  ...
  dart.setLibraryUri(src__route_definition.RedirectRouteDefinition, "package:angular_router/src/route_definition.dart");
  ...
  const _routePath = dart.privateName(src__router__router_state, "_routePath");
  ...
  dart.setLibraryUri(src__router__router_state.RouterState, "package:angular_router/src/router/router_state.dart");
  ...
  dart.setLibraryUri(src__router__router_state.MutableRouterState, "package:angular_router/src/router/router_state.dart");
  ...
  dart.setLibraryUri(src__lifecycle.CanActivate, "package:angular_router/src/lifecycle.dart");
  ...
  dart.setLibraryUri(src__lifecycle.CanDeactivate, "package:angular_router/src/lifecycle.dart");
  ...
  dart.setLibraryUri(src__lifecycle.CanNavigate, "package:angular_router/src/lifecycle.dart");
  ...
  dart.setLibraryUri(src__lifecycle.CanReuse, "package:angular_router/src/lifecycle.dart");
  ...
  dart.setLibraryUri(src__lifecycle.OnActivate, "package:angular_router/src/lifecycle.dart");
  ...
  dart.setLibraryUri(src__lifecycle.OnDeactivate, "package:angular_router/src/lifecycle.dart");
  let const$1;
  ...
  dart.setLibraryUri(src__router__navigation_params.NavigationParams, "package:angular_router/src/router/navigation_params.dart");
  ...
  dart.setLibraryUri(src__router_hook.RouterHook, "package:angular_router/src/router_hook.dart");
  ...
  dart.setLibraryUri(src__router__router_outlet_token.RouterOutletToken, "package:angular_router/src/router/router_outlet_token.dart");
  ...
  const _viewContainerRef = dart.privateName(src__directives__router_outlet_directive, "_viewContainerRef");
  const _router = dart.privateName(src__directives__router_outlet_directive, "_router");
  const _routerHook = dart.privateName(src__directives__router_outlet_directive, "_routerHook");
  const _loadedComponents = dart.privateName(src__directives__router_outlet_directive, "_loadedComponents");
  const _activeComponentFactory = dart.privateName(src__directives__router_outlet_directive, "_activeComponentFactory");
  const _routes = dart.privateName(src__directives__router_outlet_directive, "_routes");
  let const$2;
  const _activeComponent = dart.privateName(src__directives__router_outlet_directive, "_activeComponent");
  const _shouldReuse = dart.privateName(src__directives__router_outlet_directive, "_shouldReuse");
  ...
  dart.setLibraryUri(src__directives__router_outlet_directive.RouterOutlet, "package:angular_router/src/directives/router_outlet_directive.dart");
  ...
  dart.setLibraryUri(src__router__router.NavigationResult, "package:angular_router/src/router/router.dart");
  ...
  dart.setLibraryUri(src__router__router.Router, "package:angular_router/src/router/router.dart");
  const _location$ = dart.privateName(src__router__router_impl, "_location");
  const _routerHook$ = dart.privateName(src__router__router_impl, "_routerHook");
  const _onRouteActivated = dart.privateName(src__router__router_impl, "_onRouteActivated");
  const _activeState = dart.privateName(src__router__router_impl, "_activeState");
  const _activeComponentRefs = dart.privateName(src__router__router_impl, "_activeComponentRefs");
  const _onNavigationStart = dart.privateName(src__router__router_impl, "_onNavigationStart");
  const _rootOutlet = dart.privateName(src__router__router_impl, "_rootOutlet");
  const _lastNavigation = dart.privateName(src__router__router_impl, "_lastNavigation");
  const _enqueueNavigation = dart.privateName(src__router__router_impl, "_enqueueNavigation");
  const _getAbsolutePath = dart.privateName(src__router__router_impl, "_getAbsolutePath");
  const _navigate = dart.privateName(src__router__router_impl, "_navigate");
  const _canNavigate = dart.privateName(src__router__router_impl, "_canNavigate");
  let const$3;
  const _resolveState = dart.privateName(src__router__router_impl, "_resolveState");
  const _canDeactivate = dart.privateName(src__router__router_impl, "_canDeactivate");
  const _canActivate = dart.privateName(src__router__router_impl, "_canActivate");
  const _activateRouterState = dart.privateName(src__router__router_impl, "_activateRouterState");
  const _attachDefaultChildren = dart.privateName(src__router__router_impl, "_attachDefaultChildren");
  const _resolveStateForOutlet = dart.privateName(src__router__router_impl, "_resolveStateForOutlet");
  const _getTypeFromRoute = dart.privateName(src__router__router_impl, "_getTypeFromRoute");
  src__router__router_impl.RouterImpl = class RouterImpl extends src__router__router.Router {
    ...
    [_getAbsolutePath](path, state) {
      if (path[$startsWith]("./")) {
        ...
        let currentPath = core.String._check(currentRoutes[$fold](core.String, "", dart.fn((soFar, route) => dart.notNull(soFar) + dart.notNull(route.toUrl(state.parameters)), StringAndRouteDefinitionToString())));
        return src__location__location.Location.joinWithSlash(currentPath, path[$substring](2));
      }
      return path;
    }
    [_resolveState](path, navigationParams) {
      return FutureOfMutableRouterState()._check(this[_resolveStateForOutlet](this[_rootOutlet], path).then(src__router__router_state.MutableRouterState, dart.fn(routerState => {
        if (routerState != null) {
  ...
  (src__router__router_impl.RouterImpl.new = function(location, routerHook) {
    ...
    this[_location$].subscribe(dart.fn(_ => {
      ...
      FutureOfNull()._check(this[_enqueueNavigation](url.path, navigationParams).then(core.Null, dart.fn(navigationResult => {
  ...
  dart.setLibraryUri(src__router__router_impl.RouterImpl, "package:angular_router/src/router/router_impl.dart");
