define(['dart_sdk', 'packages/angular_router/src/directives/router_outlet_directive', 'packages/angular/src/core/change_detection/change_detection', 'packages/collection/src/comparators'], function(dart_sdk, router_outlet_directive, change_detection, comparators) {
  ...
  const src__directives__router_link_directive = Object.create(dart.library);
  const src__directives__router_link_active_directive = Object.create(dart.library);
  ...
  const _router = dart.privateName(src__directives__router_link_directive, "_router");
  const _location = dart.privateName(src__directives__router_link_directive, "_location");
  const _target = dart.privateName(src__directives__router_link_directive, "_target");
  const _keyPressSubscription = dart.privateName(src__directives__router_link_directive, "_keyPressSubscription");
  const _routerLink = dart.privateName(src__directives__router_link_directive, "_routerLink");
  const _cachedVisibleHref = dart.privateName(src__directives__router_link_directive, "_cachedVisibleHref");
  const _cachedUrl = dart.privateName(src__directives__router_link_directive, "_cachedUrl");
  const _onKeyPress = dart.privateName(src__directives__router_link_directive, "_onKeyPress");
  const _trigger = dart.privateName(src__directives__router_link_directive, "_trigger");
  ...
  dart.setLibraryUri(src__directives__router_link_directive.RouterLink, "package:angular_router/src/directives/router_link_directive.dart");
  ...
  const _element = dart.privateName(src__directives__router_link_active_directive, "_element");
  const _router$ = dart.privateName(src__directives__router_link_active_directive, "_router");
  const _routeChanged = dart.privateName(src__directives__router_link_active_directive, "_routeChanged");
  const _classes = dart.privateName(src__directives__router_link_active_directive, "_classes");
  const _update = dart.privateName(src__directives__router_link_active_directive, "_update");
  let const$;
  ...
  dart.setLibraryUri(src__directives__router_link_active_directive.RouterLinkActive, "package:angular_router/src/directives/router_link_active_directive.dart");
