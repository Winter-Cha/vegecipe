define(['dart_sdk', 'packages/collection/collection'], function(dart_sdk, collection) {
  ...
  const _source = dart.privateName(src__stream_queue, "_source");
  const _subscription = dart.privateName(src__stream_queue, "_subscription");
  ...
  const _completer = dart.privateName(src__stream_queue, "_completer");
  ...
  const _controller = dart.privateName(src__stream_queue, "_controller");
  ...
  const _completer$ = dart.privateName(src__cancelable_operation, "_completer");
  const _inner = dart.privateName(src__cancelable_operation, "_inner");
  ...
  src__cancelable_operation.CancelableOperation$ = dart.generic(T => {
    ...
    class CancelableOperation extends core.Object {
      ...
      then(R, onValue, opts) {
        ...
        FutureOfNull()._check(this.valueOrCancellation().then(core.Null, dart.fn(result => {
    ...
    dart.setMethodSignature(CancelableOperation, () => ({
      ...
      then: dart.gFnType(R => [src__cancelable_operation.CancelableOperation$(R), [dart.fnType(async.FutureOr$(R), [T])], {onError: dart.fnType(async.FutureOr$(R), [core.Object, core.StackTrace]), onCancel: dart.fnType(async.FutureOr$(R), []), propagateCancel: core.bool}]),
  ...
  const _duration = dart.privateName(src__async_cache, "_duration");
  ...
  const _completer$0 = dart.privateName(src__async_memoizer, "_completer");
  ...
  const _sink = dart.privateName(src__delegate__event_sink, "_sink");
  ...
  const _sink$ = dart.privateName(src__delegate__sink, "_sink");
  ...
  const _sink$0 = dart.privateName(src__delegate__stream_sink, "_sink");
  ...
  const _completer$1 = dart.privateName(src__future_group, "_completer");
  ...
  const _controller$ = dart.privateName(src__stream_completer, "_controller");
  ...
  const _inner$ = dart.privateName(src__stream_sink_transformer__typed, "_inner");
  ...
  const _inner$0 = dart.privateName(src__stream_sink_transformer__stream_transformer_wrapper, "_inner");
  const _controller$0 = dart.privateName(src__stream_sink_transformer__stream_transformer_wrapper, "_controller");
  ...
  const _transformer$ = dart.privateName(src__stream_sink_transformer__handler_transformer, "_transformer");
  const _inner$1 = dart.privateName(src__stream_sink_transformer__handler_transformer, "_inner");
  ...
  const _sink$1 = dart.privateName(src__result__release_sink, "_sink");
  ...
  const _sink$2 = dart.privateName(src__result__capture_sink, "_sink");
  ...
  const _controller$1 = dart.privateName(src__stream_group, "_controller");
  ...
  const _onCancel$ = dart.privateName(src__stream_group, "_onCancel");
  ...
  const _source$0 = dart.privateName(src__subscription_stream, "_source");
  ...
  const _subscription$0 = dart.privateName(src__stream_splitter, "_subscription");
  ...
  const _onCancel$0 = dart.privateName(src__stream_splitter, "_onCancel");
  ...
  const _sink$3 = dart.privateName(src__stream_sink_completer, "_sink");
  ...
  const _controller$2 = dart.privateName(src__stream_sink_completer, "_controller");
  ...
  const _inner$2 = dart.privateName(src__stream_subscription_transformer, "_inner");
  ...
  const _inner$3 = dart.privateName(src__typed_stream_transformer, "_inner");
