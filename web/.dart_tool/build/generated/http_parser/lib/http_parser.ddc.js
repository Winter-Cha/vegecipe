define(['dart_sdk', 'packages/collection/src/canonicalized_map', 'packages/source_span/source_span', 'packages/string_scanner/string_scanner', 'packages/typed_data/typed_buffers'], function(dart_sdk, canonicalized_map, source_span, string_scanner, typed_buffers) {
  ...
  dart.setLibraryUri(src__authentication_challenge.AuthenticationChallenge, "package:http_parser/src/authentication_challenge.dart");
  ...
  dart.setLibraryUri(src__chunked_coding__encoder.ChunkedCodingEncoder, "package:http_parser/src/chunked_coding/encoder.dart");
  ...
  dart.setLibraryUri(src__chunked_coding__encoder._Sink, "package:http_parser/src/chunked_coding/encoder.dart");
  ...
  dart.setLibraryUri(src__chunked_coding__decoder.ChunkedCodingDecoder, "package:http_parser/src/chunked_coding/decoder.dart");
  ...
  dart.setLibraryUri(src__chunked_coding__decoder._Sink, "package:http_parser/src/chunked_coding/decoder.dart");
  ...
  dart.setLibraryUri(src__chunked_coding__decoder._State, "package:http_parser/src/chunked_coding/decoder.dart");
  ...
  dart.setLibraryUri(src__chunked_coding.ChunkedCodingCodec, "package:http_parser/src/chunked_coding.dart");
  ...
  dart.setLibraryUri(src__media_type.MediaType, "package:http_parser/src/media_type.dart");
