define(['dart_sdk', 'packages/web/app_component.css.shim', 'packages/angular/src/bootstrap/modules', 'packages/angular/src/core/change_detection/change_detection', 'packages/web/src/app_bar/app_bar_component', 'packages/core/core', 'packages/redux/redux', 'packages/angular_router/src/directives/router_outlet_directive', 'packages/web/app_component', 'packages/angular/angular.template', 'packages/angular_router/angular_router.template', 'packages/angular/src/runtime/text_binding', 'packages/angular_router/src/constants', 'packages/angular/src/runtime/interpolate', 'packages/firebase_dart_ui/firebase_dart_ui.template', 'packages/firebase_dart_ui/src/auth_ui_js', 'packages/angular_components/laminate/components/modal/modal.template', 'packages/angular_components/laminate/components/modal/modal', 'packages/angular_components/src/laminate/overlay/overlay_ref', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/material_dialog/material_dialog.template', 'packages/angular_components/material_dialog/material_dialog', 'packages/angular_components/material_button/material_button.template', 'packages/angular_components/focus/focus', 'packages/angular_components/src/laminate/popup/popup_hierarchy', 'packages/angular_components/theme/dark_theme', 'packages/angular_components/material_button/material_button', 'packages/angular_components/button_decorator/button_decorator', 'packages/angular_components/interfaces/has_disabled', 'packages/angular_components/content/deferred_content_aware', 'packages/angular_components/utils/browser/window/module', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/utils/browser/dom_service/angular_2', 'packages/angular_components/utils/angular/imperative_view/imperative_view', 'packages/angular_components/laminate/ruler/dom_ruler', 'packages/angular_components/src/utils/angular/managed_zone/managed_zone', 'packages/angular_components/utils/angular/managed_zone/angular_2', 'packages/angular_components/laminate/overlay/module', 'packages/angular_components/model/math/box', 'packages/angular_components/laminate/overlay/zindexer', 'packages/angular_components/focus/focus.template', 'packages/angular_components/laminate/overlay/module.template', 'packages/angular_components/material_icon/material_icon.template'], function(dart_sdk, app_component$46css, modules, change_detection, app_bar_component, core, redux, router_outlet_directive, app_component, angular, angular_router, text_binding, constants, interpolate, firebase_dart_ui, auth_ui_js, modal, modal$, overlay_ref, dom_service, material_dialog, material_dialog$, material_button, focus, popup_hierarchy, dark_theme, material_button$, button_decorator, has_disabled, deferred_content_aware, module, disposer, angular_2, imperative_view, dom_ruler, managed_zone, angular_2$, module$, box, zindexer, focus$, module$0, material_icon) {
  ...
  const _appEl_2$ = dart.privateName(src__common__signin_page__signin_page_component$46template, "_appEl_2");
  const _NgIf_2_9 = dart.privateName(src__common__signin_page__signin_page_component$46template, "_NgIf_2_9");
  ...
  src__common__signin_page__signin_page_component$46template.ViewSignInPageComponent0 = class ViewSignInPageComponent0 extends src__core__linker__app_view.AppView$(src__common__signin_page__signin_page_component.SignInPageComponent) {
    ...
    build() {
      ...
      let doc = html.document;
      let _el_1 = src__runtime__dom_helpers.appendElement(doc, parentRenderNode, "br");
      this.addShimE(_el_1);
      ...
      let _TemplateRef_2_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_2$], dart.fn(src__common__signin_page__signin_page_component$46template.viewFactory_SignInPageComponent1, AppViewAndintToAppViewOfvoid()));
  ...
  const _textBinding_4 = dart.privateName(src__common__signin_page__signin_page_component$46template, "_textBinding_4");
  const _textBinding_6 = dart.privateName(src__common__signin_page__signin_page_component$46template, "_textBinding_6");
  const _textBinding_9 = dart.privateName(src__common__signin_page__signin_page_component$46template, "_textBinding_9");
  const _textBinding_12 = dart.privateName(src__common__signin_page__signin_page_component$46template, "_textBinding_12");
  src__common__signin_page__signin_page_component$46template._ViewSignInPageComponent1 = class _ViewSignInPageComponent1 extends src__core__linker__app_view.AppView$(src__common__signin_page__signin_page_component.SignInPageComponent) {
    build() {
      let doc = html.document;
      let _el_0 = doc[$createElement]("div");
      this.addShimC(html.HtmlElement._check(_el_0));
      let _text_1 = src__runtime__dom_helpers.appendText(_el_0, "Authenticated!");
      let _el_2 = src__runtime__dom_helpers.appendElement(doc, _el_0, "p");
      this.addShimE(_el_2);
      let _text_3 = src__runtime__dom_helpers.appendText(_el_2, "User email: ");
      _el_2[$append](this[_textBinding_4].element);
      let _text_5 = src__runtime__dom_helpers.appendText(_el_2, " Display Name: ");
      _el_2[$append](this[_textBinding_6].element);
      let _el_7 = src__runtime__dom_helpers.appendElement(doc, _el_0, "p");
      this.addShimE(_el_7);
      let _text_8 = src__runtime__dom_helpers.appendText(_el_7, "User Json: ");
      _el_7[$append](this[_textBinding_9].element);
      let _el_10 = src__runtime__dom_helpers.appendElement(doc, _el_0, "p");
      this.addShimE(_el_10);
      let _text_11 = src__runtime__dom_helpers.appendText(_el_10, "Provider Access Token (may not be present unless session is new) : ");
      _el_10[$append](this[_textBinding_12].element);
      this.init1(_el_0);
    }
    detectChangesInternal() {
      let _ctx = this.ctx;
      this[_textBinding_4].updateText(src__runtime__interpolate.interpolateString0(_ctx.userEmail));
      this[_textBinding_6].updateText(src__runtime__interpolate.interpolateString0(_ctx.displayName));
      this[_textBinding_9].updateText(core$.String._check(src__runtime__interpolate.interpolate0(_ctx.userJson)));
      this[_textBinding_12].updateText(src__runtime__interpolate.interpolateString0(_ctx.providerAccessToken));
    }
  };
  (src__common__signin_page__signin_page_component$46template._ViewSignInPageComponent1.new = function(parentView, parentIndex) {
    ...
    this[_textBinding_12] = new src__runtime__text_binding.TextBinding.new();
    src__common__signin_page__signin_page_component$46template._ViewSignInPageComponent1.__proto__.new.call(this, src__core__linker__view_type.ViewType.embedded, parentView, parentIndex, src__core__change_detection__constants.ChangeDetectionStrategy.CheckAlways);
    this.initComponentStyles();
  }).prototype = src__common__signin_page__signin_page_component$46template._ViewSignInPageComponent1.prototype;
  dart.addTypeTests(src__common__signin_page__signin_page_component$46template._ViewSignInPageComponent1);
  dart.setMethodSignature(src__common__signin_page__signin_page_component$46template._ViewSignInPageComponent1, () => ({
    __proto__: dart.getMethods(src__common__signin_page__signin_page_component$46template._ViewSignInPageComponent1.__proto__),
    build: dart.fnType(src__core__linker__component_factory.ComponentRef$(src__common__signin_page__signin_page_component.SignInPageComponent), [])
  }));
  dart.setFieldSignature(src__common__signin_page__signin_page_component$46template._ViewSignInPageComponent1, () => ({
    __proto__: dart.getFields(src__common__signin_page__signin_page_component$46template._ViewSignInPageComponent1.__proto__),
    ...
    [_textBinding_12]: dart.finalFieldType(src__runtime__text_binding.TextBinding)
  }));
  src__common__signin_page__signin_page_component$46template.viewFactory_SignInPageComponent1 = function(parentView, parentIndex) {
    return new src__common__signin_page__signin_page_component$46template._ViewSignInPageComponent1.new(parentView, parentIndex);
  };
  dart.defineLazy(src__common__signin_page__signin_page_component$46template, {
  ...
  const _appEl_2$0 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_appEl_2");
  const _NgIf_2_9$ = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_NgIf_2_9");
  const _compView_3 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_compView_3");
  const _ModalComponent_3_5 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_ModalComponent_3_5");
  const _compView_4 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_compView_4");
  const _MaterialDialogComponent_4_5 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_MaterialDialogComponent_4_5");
  const _compView_7 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_compView_7");
  const _SignInPageComponent_7_5 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_SignInPageComponent_7_5");
  const _compView_9 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_compView_9");
  const _AutoFocusDirective_9_5 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_AutoFocusDirective_9_5");
  const _AcxDarkTheme_9_6 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_AcxDarkTheme_9_6");
  const _MaterialButtonComponent_9_7 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_MaterialButtonComponent_9_7");
  const _expr_2$0 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_expr_2");
  let const$0;
  let const$1;
  const _handle_visibleChange_3_0 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_handle_visibleChange_3_0");
  const _handle_trigger_9_0 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_handle_trigger_9_0");
  let const$2;
  src__app_bar__signin_bar__signin_bar_component$46template.ViewSignInBarComponent0 = class ViewSignInBarComponent0 extends src__core__linker__app_view.AppView$(src__app_bar__signin_bar__signin_bar_component.SignInBarComponent) {
    ...
    build() {
      ...
      _el_8[$append](_el_9);
      src__runtime__dom_helpers.setAttribute(_el_9, "autoFocus", "");
      src__runtime__dom_helpers.setAttribute(_el_9, "clear-size", "");
      this.addShimC(_el_9);
      this[_AutoFocusDirective_9_5] = dart.test(src__runtime__optimizations.isDevMode) ? src__di__errors.debugInjectorWrap(focus__focus.AutoFocusDirective, dart.wrapType(focus__focus.AutoFocusDirective), dart.fn(() => new focus__focus.AutoFocusDirective.new(_el_9, utils__browser__dom_service__dom_service.DomService._check(this.parentView.injectorGet(dart.wrapType(utils__browser__dom_service__dom_service.DomService), this.viewData.parentIndex)), null, this[_ModalComponent_3_5], src__laminate__popup__popup_ref.PopupRef._check(this.parentView.injectorGetOptional(dart.wrapType(src__laminate__popup__popup_ref.PopupRef), this.viewData.parentIndex))), VoidToAutoFocusDirective())) : new focus__focus.AutoFocusDirective.new(_el_9, utils__browser__dom_service__dom_service.DomService._check(this.parentView.injectorGet(dart.wrapType(utils__browser__dom_service__dom_service.DomService), this.viewData.parentIndex)), null, this[_ModalComponent_3_5], src__laminate__popup__popup_ref.PopupRef._check(this.parentView.injectorGetOptional(dart.wrapType(src__laminate__popup__popup_ref.PopupRef), this.viewData.parentIndex)));
      this[_AcxDarkTheme_9_6] = dart.test(src__runtime__optimizations.isDevMode) ? src__di__errors.debugInjectorWrap(theme__dark_theme.AcxDarkTheme, dart.wrapType(theme__dark_theme.AcxDarkTheme), dart.fn(() => new theme__dark_theme.AcxDarkTheme.new(core$.bool._check(this.parentView.injectorGetOptional(const$0 || (const$0 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("acxDarkTheme"))), this.viewData.parentIndex))), VoidToAcxDarkTheme())) : new theme__dark_theme.AcxDarkTheme.new(core$.bool._check(this.parentView.injectorGetOptional(const$1 || (const$1 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("acxDarkTheme"))), this.viewData.parentIndex)));
      this[_MaterialButtonComponent_9_7] = new material_button__material_button.MaterialButtonComponent.new(_el_9, theme__dark_theme.AcxDarkTheme._check(this[_AcxDarkTheme_9_6]), this[_compView_9], null);
      let _text_10 = src__runtime__dom_helpers.createText("Close");
      this[_compView_9].create(this[_MaterialButtonComponent_9_7], JSArrayOfObject().of([JSArrayOfText().of([_text_10])]));
      this[_compView_4].create(this[_MaterialDialogComponent_4_5], JSArrayOfObject().of([JSArrayOfElement().of([_el_5]), JSArrayOfHtmlElement().of([_el_7]), JSArrayOfElement().of([_el_8])]));
      this[_compView_3].create(this[_ModalComponent_3_5], JSArrayOfObject().of([JSArrayOfHtmlElement().of([_el_4])]));
      let subscription_0 = this[_ModalComponent_3_5].onVisibleChanged.listen(this.eventHandler1(core$.bool, core$.bool, dart.bind(this, _handle_visibleChange_3_0)));
      let subscription_1 = this[_MaterialButtonComponent_9_7].trigger.listen(this.eventHandler1(html.UIEvent, html.UIEvent, dart.bind(this, _handle_trigger_9_0)));
    ...
    injectorGetInternal(token, nodeIndex, notFoundResult) {
      if (3 <= dart.notNull(nodeIndex) && dart.notNull(nodeIndex) <= 10) {
        if (9 <= dart.notNull(nodeIndex)) {
        ...
        if (token === dart.wrapType(laminate__components__modal__modal.ModalComponent) || token === dart.wrapType(content__deferred_content_aware.DeferredContentAware) || token === dart.wrapType(laminate__components__modal__modal.Modal)) {
          return this[_ModalComponent_3_5];
        }
      }
    ...
    detectChangesInternal() {
      ...
      if (!dart.test(src__core__linker__app_view_utils.AppViewUtils.throwOnChanges)) {
        this[_MaterialDialogComponent_4_5].ngAfterContentChecked();
      }
      ...
      if (!dart.test(src__core__linker__app_view_utils.AppViewUtils.throwOnChanges)) {
        if (firstCheck) {
          this[_ModalComponent_3_5].ngAfterViewInit();
        }
      }
    }
    destroyInternal() {
      ...
      this[_MaterialDialogComponent_4_5].ngOnDestroy();
      this[_ModalComponent_3_5].ngOnDestroy();
    }
    [_handle_visibleChange_3_0]($event) {
      let _ctx = this.ctx;
      _ctx.showBasicDialog = core$.bool._check($event);
    }
    [_handle_trigger_9_0]($event) {
      let _ctx = this.ctx;
      _ctx.showBasicDialog = false;
    }
    initComponentStyles() {
  ...
  (src__app_bar__signin_bar__signin_bar_component$46template.ViewSignInBarComponent0.new = function(parentView, parentIndex) {
    ...
    this[_ModalComponent_3_5] = null;
    this[_compView_4] = null;
    this[_MaterialDialogComponent_4_5] = null;
    this[_compView_7] = null;
    this[_SignInPageComponent_7_5] = null;
    this[_compView_9] = null;
    this[_AutoFocusDirective_9_5] = null;
    this[_AcxDarkTheme_9_6] = null;
    this[_MaterialButtonComponent_9_7] = null;
    this[_expr_2$0] = null;
  ...
  dart.setFieldSignature(src__app_bar__signin_bar__signin_bar_component$46template.ViewSignInBarComponent0, () => ({
    ...
    [_NgIf_2_9$]: dart.fieldType(src__common__directives__ng_if.NgIf),
    [_compView_3]: dart.fieldType(laminate__components__modal__modal$46template.ViewModalComponent0),
    [_ModalComponent_3_5]: dart.fieldType(laminate__components__modal__modal.ModalComponent),
    [_compView_4]: dart.fieldType(material_dialog__material_dialog$46template.ViewMaterialDialogComponent0),
    [_MaterialDialogComponent_4_5]: dart.fieldType(material_dialog__material_dialog.MaterialDialogComponent),
    [_compView_7]: dart.fieldType(src__common__signin_page__signin_page_component$46template.ViewSignInPageComponent0),
    [_SignInPageComponent_7_5]: dart.fieldType(src__common__signin_page__signin_page_component.SignInPageComponent),
    ...
    [_AcxDarkTheme_9_6]: dart.fieldType(dart.dynamic),
    [_MaterialButtonComponent_9_7]: dart.fieldType(material_button__material_button.MaterialButtonComponent),
  ...
  src__app_bar__signin_bar__signin_bar_component$46template._ViewSignInBarComponent1 = class _ViewSignInBarComponent1 extends src__core__linker__app_view.AppView$(src__app_bar__signin_bar__signin_bar_component.SignInBarComponent) {
    ...
    detectChangesInternal() {
      ...
      let currVal_0 = _ctx.showBasicDialog;
  ...
  src__app_bar__signin_bar__signin_bar_component$46template._ViewSignInBarComponent2 = class _ViewSignInBarComponent2 extends src__core__linker__app_view.AppView$(src__app_bar__signin_bar__signin_bar_component.SignInBarComponent) {
    build() {
      ...
      src__runtime__dom_helpers.setAttribute(_el_0, "raised", "");
      this.addShimC(_el_0);
      this[_AcxDarkTheme_0_5] = dart.test(src__runtime__optimizations.isDevMode) ? src__di__errors.debugInjectorWrap(theme__dark_theme.AcxDarkTheme, dart.wrapType(theme__dark_theme.AcxDarkTheme), dart.fn(() => new theme__dark_theme.AcxDarkTheme.new(core$.bool._check(this.parentView.parentView.injectorGetOptional(const$5 || (const$5 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("acxDarkTheme"))), this.parentView.viewData.parentIndex))), VoidToAcxDarkTheme())) : new theme__dark_theme.AcxDarkTheme.new(core$.bool._check(this.parentView.parentView.injectorGetOptional(const$6 || (const$6 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("acxDarkTheme"))), this.parentView.viewData.parentIndex)));
      this[_MaterialButtonComponent_0_6] = new material_button__material_button.MaterialButtonComponent.new(_el_0, theme__dark_theme.AcxDarkTheme._check(this[_AcxDarkTheme_0_5]), this[_compView_0$2], null);
      let _text_1 = src__runtime__dom_helpers.createText("Logout");
      this[_compView_0$2].create(this[_MaterialButtonComponent_0_6], JSArrayOfObject().of([JSArrayOfText().of([_text_1])]));
  ...
  src__app_bar__signin_bar__signin_bar_component$46template._ViewSignInBarComponentHost0 = class _ViewSignInBarComponentHost0 extends src__core__linker__app_view.AppView$(src__app_bar__signin_bar__signin_bar_component.SignInBarComponent) {
    ...
    get [_overlayViewportBoundaries_0_18]() {
      if (this[__overlayViewportBoundaries_0_18] == null) {
        this[__overlayViewportBoundaries_0_18] = const$16 || (const$16 = dart.const(new model__math__box.Box.new()));
      }
    ...
    injectorGetInternal(token, nodeIndex, notFoundResult) {
      if (0 === nodeIndex) {
        ...
        if (token === (const$17 || (const$17 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlayContainerName"))))) {
          return this[_overlayContainerName_0_13];
        }
        if (token === (const$18 || (const$18 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlayContainerParent"))))) {
          return this[_overlayContainerParent_0_14];
        }
        if (token === (const$19 || (const$19 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlayContainer"))))) {
          return this[_overlayContainer_0_15];
        }
        if (token === (const$20 || (const$20 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlaySyncDom"))))) {
          return this[_overlaySyncDom_0_16];
        }
        if (token === (const$21 || (const$21 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlayRepositionLoop"))))) {
          return this[_overlayRepositionLoop_0_17];
        }
        if (token === (const$22 || (const$22 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlayViewportBoundaries"))))) {
  ...
  const _expr_2$1 = dart.privateName(src__app_bar__app_bar_component$46template, "_expr_2");
  ...
  src__app_bar__app_bar_component$46template.ViewAppBarComponent0 = class ViewAppBarComponent0 extends src__core__linker__app_view.AppView$(src__app_bar__app_bar_component.AppBarComponent) {
    ...
    get [_overlayContainerName_12_13]() {
      if (this[__overlayContainerName_12_13] == null) {
        this[__overlayContainerName_12_13] = dart.test(src__runtime__optimizations.isDevMode) ? src__di__errors.debugInjectorWrap(core$.String, const$23 || (const$23 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlayContainerName"))), dart.fn(() => laminate__overlay__module.getDefaultContainerName(this.parentView.injectorGetOptional(const$24 || (const$24 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlayContainerName"))), this.viewData.parentIndex)), VoidToString())) : laminate__overlay__module.getDefaultContainerName(this.parentView.injectorGetOptional(const$25 || (const$25 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlayContainerName"))), this.viewData.parentIndex));
      }
      return this[__overlayContainerName_12_13];
    }
    get [_overlayContainerParent_12_14]() {
      if (this[__overlayContainerParent_12_14] == null) {
        this[__overlayContainerParent_12_14] = dart.test(src__runtime__optimizations.isDevMode) ? src__di__errors.debugInjectorWrap(html.HtmlElement, const$26 || (const$26 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlayContainerParent"))), dart.fn(() => laminate__overlay__module.getOverlayContainerParent(html.Document._check(this[_Document_12_6]), this.parentView.injectorGetOptional(const$27 || (const$27 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlayContainerParent"))), this.viewData.parentIndex)), VoidToHtmlElement())) : laminate__overlay__module.getOverlayContainerParent(html.Document._check(this[_Document_12_6]), this.parentView.injectorGetOptional(const$28 || (const$28 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlayContainerParent"))), this.viewData.parentIndex));
      }
      return this[__overlayContainerParent_12_14];
    }
    get [_overlayContainer_12_15]() {
      if (this[__overlayContainer_12_15] == null) {
        this[__overlayContainer_12_15] = dart.test(src__runtime__optimizations.isDevMode) ? src__di__errors.debugInjectorWrap(html.HtmlElement, const$29 || (const$29 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlayContainer"))), dart.fn(() => laminate__overlay__module.getDefaultContainer(core$.String._check(this[_overlayContainerName_12_13]), html.HtmlElement._check(this[_overlayContainerParent_12_14]), this.parentView.injectorGetOptional(const$30 || (const$30 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlayContainer"))), this.viewData.parentIndex)), VoidToHtmlElement())) : laminate__overlay__module.getDefaultContainer(core$.String._check(this[_overlayContainerName_12_13]), html.HtmlElement._check(this[_overlayContainerParent_12_14]), this.parentView.injectorGetOptional(const$31 || (const$31 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlayContainer"))), this.viewData.parentIndex));
      }
    ...
    get [_overlayViewportBoundaries_12_18]() {
      if (this[__overlayViewportBoundaries_12_18] == null) {
        this[__overlayViewportBoundaries_12_18] = const$32 || (const$32 = dart.const(new model__math__box.Box.new()));
      }
    ...
    injectorGetInternal(token, nodeIndex, notFoundResult) {
      if (12 === nodeIndex) {
        ...
        if (token === (const$33 || (const$33 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlayContainerName"))))) {
          return this[_overlayContainerName_12_13];
        }
        if (token === (const$34 || (const$34 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlayContainerParent"))))) {
          return this[_overlayContainerParent_12_14];
        }
        if (token === (const$35 || (const$35 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlayContainer"))))) {
          return this[_overlayContainer_12_15];
        }
        if (token === (const$36 || (const$36 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlaySyncDom"))))) {
          return this[_overlaySyncDom_12_16];
        }
        if (token === (const$37 || (const$37 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlayRepositionLoop"))))) {
          return this[_overlayRepositionLoop_12_17];
        }
        if (token === (const$38 || (const$38 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlayViewportBoundaries"))))) {
  ...
  dart.setFieldSignature(src__app_bar__app_bar_component$46template.ViewAppBarComponent0, () => ({
    ...
    [_expr_2$1]: dart.fieldType(core$.String),
