define(['dart_sdk', 'packages/web/app_component.css.shim', 'packages/angular/src/bootstrap/modules', 'packages/angular/src/core/change_detection/change_detection', 'packages/web/src/app_bar/app_bar_component', 'packages/core/core', 'packages/redux/redux', 'packages/angular_router/src/directives/router_outlet_directive', 'packages/web/app_component', 'packages/angular/angular.template', 'packages/angular_router/angular_router.template', 'packages/angular/src/runtime/text_binding', 'packages/angular_router/src/constants', 'packages/angular/src/runtime/interpolate', 'packages/firebase_dart_ui/firebase_dart_ui.template', 'packages/firebase_dart_ui/src/auth_ui_js', 'packages/angular_components/laminate/components/modal/modal.template', 'packages/angular_components/laminate/components/modal/modal', 'packages/angular_components/src/laminate/overlay/overlay_ref', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/material_dialog/material_dialog.template', 'packages/angular_components/material_dialog/material_dialog', 'packages/angular_components/material_button/material_button.template', 'packages/angular_components/focus/focus', 'packages/angular_components/src/laminate/popup/popup_hierarchy', 'packages/angular_components/theme/dark_theme', 'packages/angular_components/material_button/material_button', 'packages/angular_components/button_decorator/button_decorator', 'packages/angular_components/interfaces/has_disabled', 'packages/angular_components/content/deferred_content_aware', 'packages/angular_components/utils/browser/window/module', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/utils/browser/dom_service/angular_2', 'packages/angular_components/utils/angular/imperative_view/imperative_view', 'packages/angular_components/laminate/ruler/dom_ruler', 'packages/angular_components/src/utils/angular/managed_zone/managed_zone', 'packages/angular_components/utils/angular/managed_zone/angular_2', 'packages/angular_components/laminate/overlay/module', 'packages/angular_components/model/math/box', 'packages/angular_components/laminate/overlay/zindexer', 'packages/angular_components/focus/focus.template', 'packages/angular_components/laminate/overlay/module.template', 'packages/angular_components/material_icon/material_icon.template'], function(dart_sdk, app_component$46css, modules, change_detection, app_bar_component, core, redux, router_outlet_directive, app_component, angular, angular_router, text_binding, constants, interpolate, firebase_dart_ui, auth_ui_js, modal, modal$, overlay_ref, dom_service, material_dialog, material_dialog$, material_button, focus, popup_hierarchy, dark_theme, material_button$, button_decorator, has_disabled, deferred_content_aware, module, disposer, angular_2, imperative_view, dom_ruler, managed_zone, angular_2$, module$, box, zindexer, focus$, module$0, material_icon) {
  ...
  const _appEl_3 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_appEl_3");
  const _NgIf_3_9 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_NgIf_3_9");
  const _compView_4 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_compView_4");
  const _ModalComponent_4_5 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_ModalComponent_4_5");
  const _compView_5 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_compView_5");
  const _MaterialDialogComponent_5_5 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_MaterialDialogComponent_5_5");
  const _compView_8 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_compView_8");
  const _SignInPageComponent_8_5 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_SignInPageComponent_8_5");
  const _compView_10 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_compView_10");
  const _AutoFocusDirective_10_5 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_AutoFocusDirective_10_5");
  const _AcxDarkTheme_10_6 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_AcxDarkTheme_10_6");
  const _MaterialButtonComponent_10_7 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_MaterialButtonComponent_10_7");
  const _expr_3$0 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_expr_3");
  let const$0;
  let const$1;
  const _handle_visibleChange_4_0 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_handle_visibleChange_4_0");
  const _handle_trigger_10_0 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_handle_trigger_10_0");
  let const$2;
  src__app_bar__signin_bar__signin_bar_component$46template.ViewSignInBarComponent0 = class ViewSignInBarComponent0 extends src__core__linker__app_view.AppView$(src__app_bar__signin_bar__signin_bar_component.SignInBarComponent) {
    ...
    build() {
      ...
      _el_9[$append](_el_10);
      src__runtime__dom_helpers.setAttribute(_el_10, "autoFocus", "");
      src__runtime__dom_helpers.setAttribute(_el_10, "clear-size", "");
      this.addShimC(_el_10);
      this[_AutoFocusDirective_10_5] = dart.test(src__runtime__optimizations.isDevMode) ? src__di__errors.debugInjectorWrap(focus__focus.AutoFocusDirective, dart.wrapType(focus__focus.AutoFocusDirective), dart.fn(() => new focus__focus.AutoFocusDirective.new(_el_10, utils__browser__dom_service__dom_service.DomService._check(this.parentView.injectorGet(dart.wrapType(utils__browser__dom_service__dom_service.DomService), this.viewData.parentIndex)), null, this[_ModalComponent_4_5], src__laminate__popup__popup_ref.PopupRef._check(this.parentView.injectorGetOptional(dart.wrapType(src__laminate__popup__popup_ref.PopupRef), this.viewData.parentIndex))), VoidToAutoFocusDirective())) : new focus__focus.AutoFocusDirective.new(_el_10, utils__browser__dom_service__dom_service.DomService._check(this.parentView.injectorGet(dart.wrapType(utils__browser__dom_service__dom_service.DomService), this.viewData.parentIndex)), null, this[_ModalComponent_4_5], src__laminate__popup__popup_ref.PopupRef._check(this.parentView.injectorGetOptional(dart.wrapType(src__laminate__popup__popup_ref.PopupRef), this.viewData.parentIndex)));
      this[_AcxDarkTheme_10_6] = dart.test(src__runtime__optimizations.isDevMode) ? src__di__errors.debugInjectorWrap(theme__dark_theme.AcxDarkTheme, dart.wrapType(theme__dark_theme.AcxDarkTheme), dart.fn(() => new theme__dark_theme.AcxDarkTheme.new(core$.bool._check(this.parentView.injectorGetOptional(const$0 || (const$0 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("acxDarkTheme"))), this.viewData.parentIndex))), VoidToAcxDarkTheme())) : new theme__dark_theme.AcxDarkTheme.new(core$.bool._check(this.parentView.injectorGetOptional(const$1 || (const$1 = dart.const(new src__core__di__opaque_token.OpaqueToken.new("acxDarkTheme"))), this.viewData.parentIndex)));
      this[_MaterialButtonComponent_10_7] = new material_button__material_button.MaterialButtonComponent.new(_el_10, theme__dark_theme.AcxDarkTheme._check(this[_AcxDarkTheme_10_6]), this[_compView_10], null);
      let _text_11 = src__runtime__dom_helpers.createText("Close");
      this[_compView_10].create(this[_MaterialButtonComponent_10_7], JSArrayOfObject().of([JSArrayOfText().of([_text_11])]));
      this[_compView_5].create(this[_MaterialDialogComponent_5_5], JSArrayOfObject().of([JSArrayOfElement().of([_el_6]), JSArrayOfHtmlElement().of([_el_8]), JSArrayOfElement().of([_el_9])]));
      this[_compView_4].create(this[_ModalComponent_4_5], JSArrayOfObject().of([JSArrayOfHtmlElement().of([_el_5])]));
      let subscription_0 = this[_ModalComponent_4_5].onVisibleChanged.listen(this.eventHandler1(core$.bool, core$.bool, dart.bind(this, _handle_visibleChange_4_0)));
      let subscription_1 = this[_MaterialButtonComponent_10_7].trigger.listen(this.eventHandler1(html.UIEvent, html.UIEvent, dart.bind(this, _handle_trigger_10_0)));
    ...
    injectorGetInternal(token, nodeIndex, notFoundResult) {
      if (4 <= dart.notNull(nodeIndex) && dart.notNull(nodeIndex) <= 11) {
        if (10 <= dart.notNull(nodeIndex)) {
          if (token === dart.wrapType(theme__dark_theme.AcxDarkTheme)) {
            return this[_AcxDarkTheme_10_6];
          }
          if (token === dart.wrapType(material_button__material_button.MaterialButtonComponent) || token === dart.wrapType(button_decorator__button_decorator.ButtonDirective) || token === dart.wrapType(interfaces__has_disabled.HasDisabled)) {
            return this[_MaterialButtonComponent_10_7];
          }
        }
        if (token === dart.wrapType(laminate__components__modal__modal.ModalComponent) || token === dart.wrapType(content__deferred_content_aware.DeferredContentAware) || token === dart.wrapType(laminate__components__modal__modal.Modal)) {
          return this[_ModalComponent_4_5];
        }
      }
    ...
    detectChangesInternal() {
      ...
      if (firstCheck) {
        this[_AutoFocusDirective_10_5].autoFocus = true;
      }
      if (!dart.test(src__core__linker__app_view_utils.AppViewUtils.throwOnChanges) && firstCheck) {
        this[_AutoFocusDirective_10_5].ngOnInit();
      }
      changed = false;
      if (changed) {
      ...
      if (!dart.test(src__core__linker__app_view_utils.AppViewUtils.throwOnChanges)) {
        this[_MaterialDialogComponent_5_5].ngAfterContentChecked();
      }
      ...
      if (!dart.test(src__core__linker__app_view_utils.AppViewUtils.throwOnChanges)) {
        if (firstCheck) {
          this[_ModalComponent_4_5].ngAfterViewInit();
        }
      }
    }
    destroyInternal() {
      ...
      this[_AutoFocusDirective_10_5].ngOnDestroy();
      this[_MaterialDialogComponent_5_5].ngOnDestroy();
      this[_ModalComponent_4_5].ngOnDestroy();
    }
    [_handle_visibleChange_4_0]($event) {
      let _ctx = this.ctx;
      _ctx.showSignInDialog = core$.bool._check($event);
    }
    [_handle_trigger_10_0]($event) {
      let _ctx = this.ctx;
  ...
  (src__app_bar__signin_bar__signin_bar_component$46template.ViewSignInBarComponent0.new = function(parentView, parentIndex) {
    ...
    this[_ModalComponent_4_5] = null;
    this[_compView_5] = null;
    this[_MaterialDialogComponent_5_5] = null;
    this[_compView_8] = null;
    this[_SignInPageComponent_8_5] = null;
    this[_compView_10] = null;
    this[_AutoFocusDirective_10_5] = null;
    this[_AcxDarkTheme_10_6] = null;
    this[_MaterialButtonComponent_10_7] = null;
    this[_expr_3$0] = null;
  ...
  dart.setMethodSignature(src__app_bar__signin_bar__signin_bar_component$46template.ViewSignInBarComponent0, () => ({
    ...
    [_handle_visibleChange_4_0]: dart.fnType(dart.void, [dart.dynamic]),
    [_handle_trigger_10_0]: dart.fnType(dart.void, [dart.dynamic]),
    initComponentStyles: dart.fnType(dart.void, [])
  }));
  ...
  dart.setFieldSignature(src__app_bar__signin_bar__signin_bar_component$46template.ViewSignInBarComponent0, () => ({
    ...
    [_compView_4]: dart.fieldType(laminate__components__modal__modal$46template.ViewModalComponent0),
    [_ModalComponent_4_5]: dart.fieldType(laminate__components__modal__modal.ModalComponent),
    [_compView_5]: dart.fieldType(material_dialog__material_dialog$46template.ViewMaterialDialogComponent0),
    [_MaterialDialogComponent_5_5]: dart.fieldType(material_dialog__material_dialog.MaterialDialogComponent),
    [_compView_8]: dart.fieldType(src__common__signin_page__signin_page_component$46template.ViewSignInPageComponent0),
    [_SignInPageComponent_8_5]: dart.fieldType(src__common__signin_page__signin_page_component.SignInPageComponent),
    [_compView_10]: dart.fieldType(material_button__material_button$46template.ViewMaterialButtonComponent0),
    [_AutoFocusDirective_10_5]: dart.fieldType(focus__focus.AutoFocusDirective),
    [_AcxDarkTheme_10_6]: dart.fieldType(dart.dynamic),
    [_MaterialButtonComponent_10_7]: dart.fieldType(material_button__material_button.MaterialButtonComponent),
  ...
  const _textBinding_1 = dart.privateName(src__app_bar__signin_bar__signin_bar_component$46template, "_textBinding_1");
  src__app_bar__signin_bar__signin_bar_component$46template._ViewSignInBarComponent2 = class _ViewSignInBarComponent2 extends src__core__linker__app_view.AppView$(src__app_bar__signin_bar__signin_bar_component.SignInBarComponent) {
    build() {
      ...
      this.updateChildClass(html.HtmlElement._check(_el_0), "signin-user-info");
    ...
    detectChangesInternal() {
      let _ctx = this.ctx;
      this[_textBinding_1].updateText(src__runtime__interpolate.interpolateString0(_ctx.displayName));
    }
  };
  ...
  dart.setFieldSignature(src__app_bar__signin_bar__signin_bar_component$46template._ViewSignInBarComponent3, () => ({
    __proto__: dart.getFields(src__app_bar__signin_bar__signin_bar_component$46template._ViewSignInBarComponent3.__proto__),
    [_compView_0$2]: dart.fieldType(material_button__material_button$46template.ViewMaterialButtonComponent0),
    [_AcxDarkTheme_0_5]: dart.fieldType(dart.dynamic),
    [_MaterialButtonComponent_0_6]: dart.fieldType(material_button__material_button.MaterialButtonComponent)
  }));
