...
class ViewSignInBarComponent0 extends AppView<import2.SignInBarComponent> {
  ...
  NgIf _NgIf_2_9;
  import5.ViewModalComponent0 _compView_3;
  import6.ModalComponent _ModalComponent_3_5;
  import7.ViewMaterialDialogComponent0 _compView_4;
  import8.MaterialDialogComponent _MaterialDialogComponent_4_5;
  import9.ViewSignInPageComponent0 _compView_7;
  import10.SignInPageComponent _SignInPageComponent_7_5;
  import11.ViewMaterialButtonComponent0 _compView_9;
  import12.AutoFocusDirective _AutoFocusDirective_9_5;
  dynamic _AcxDarkTheme_9_6;
  import13.MaterialButtonComponent _MaterialButtonComponent_9_7;
  bool _expr_2;
  ...
  ComponentRef<import2.SignInBarComponent> build() {
    ...
    _compView_3 = import5.ViewModalComponent0(this, 3);
    final _el_3 = _compView_3.rootEl;
    parentRenderNode.append(_el_3);
    addShimC(_el_3);
    _ModalComponent_3_5 = (import18.isDevMode
        ? import22.debugInjectorWrap(import6.ModalComponent, () {
            return import6.ModalComponent(parentView.injectorGet(import23.OverlayService, viewData.parentIndex), _el_3, parentView.injectorGet(import24.DomService, viewData.parentIndex), parentView.injectorGetOptional(import6.Modal, viewData.parentIndex), parentView.injectorGetOptional(import6.GlobalModalStack, viewData.parentIndex));
          })
        : import6.ModalComponent(parentView.injectorGet(import23.OverlayService, viewData.parentIndex), _el_3, parentView.injectorGet(import24.DomService, viewData.parentIndex), parentView.injectorGetOptional(import6.Modal, viewData.parentIndex), parentView.injectorGetOptional(import6.GlobalModalStack, viewData.parentIndex)));
    _compView_4 = import7.ViewMaterialDialogComponent0(this, 4);
    final _el_4 = _compView_4.rootEl;
    this.updateChildClassNonHtml(_el_4, 'basic-dialog');
    addShimC(_el_4);
    _MaterialDialogComponent_4_5 = (import18.isDevMode
        ? import22.debugInjectorWrap(import8.MaterialDialogComponent, () {
            return import8.MaterialDialogComponent(_el_4, parentView.injectorGet(import24.DomService, viewData.parentIndex), _compView_4, _ModalComponent_3_5);
          })
        : import8.MaterialDialogComponent(_el_4, parentView.injectorGet(import24.DomService, viewData.parentIndex), _compView_4, _ModalComponent_3_5));
    final _el_5 = doc.createElement('h1');
    import20.setAttribute(_el_5, 'header', '');
    addShimE(_el_5);
    final _text_6 = import20.appendText(_el_5, 'Sign in');
    _compView_7 = import9.ViewSignInPageComponent0(this, 7);
    final _el_7 = _compView_7.rootEl;
    addShimC(_el_7);
    _SignInPageComponent_7_5 = (import18.isDevMode
    ...
    _compView_7.create0(_SignInPageComponent_7_5);
    final _el_8 = doc.createElement('div');
    import20.setAttribute(_el_8, 'footer', '');
    addShimC(_el_8);
    _compView_9 = import11.ViewMaterialButtonComponent0(this, 9);
    final _el_9 = _compView_9.rootEl;
    _el_8.append(_el_9);
    import20.setAttribute(_el_9, 'autoFocus', '');
    import20.setAttribute(_el_9, 'clear-size', '');
    addShimC(_el_9);
    _AutoFocusDirective_9_5 = (import18.isDevMode
        ? import22.debugInjectorWrap(import12.AutoFocusDirective, () {
            return import12.AutoFocusDirective(_el_9, parentView.injectorGet(import24.DomService, viewData.parentIndex), null, _ModalComponent_3_5, parentView.injectorGetOptional(import27.PopupRef, viewData.parentIndex));
          })
        : import12.AutoFocusDirective(_el_9, parentView.injectorGet(import24.DomService, viewData.parentIndex), null, _ModalComponent_3_5, parentView.injectorGetOptional(import27.PopupRef, viewData.parentIndex)));
    _AcxDarkTheme_9_6 = (import18.isDevMode
    ...
    _MaterialButtonComponent_9_7 = import13.MaterialButtonComponent(_el_9, _AcxDarkTheme_9_6, _compView_9, null);
    final _text_10 = import20.createText('Close');
    _compView_9.create(_MaterialButtonComponent_9_7, [
      [_text_10]
    ]);
    _compView_4.create(_MaterialDialogComponent_4_5, [
      [_el_5],
      [_el_7],
      [_el_8]
    ]);
    _compView_3.create(_ModalComponent_3_5, [
      [_el_4]
    ]);
    final subscription_0 = _ModalComponent_3_5.onVisibleChanged.listen(eventHandler1(_handle_visibleChange_3_0));
    final subscription_1 = _MaterialButtonComponent_9_7.trigger.listen(eventHandler1(_handle_trigger_9_0));
    init(const [], [subscription_0, subscription_1]);
  }

  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if (((3 <= nodeIndex) && (nodeIndex <= 10))) {
      if ((9 <= nodeIndex)) {
        if (identical(token, import28.AcxDarkTheme)) {
          return _AcxDarkTheme_9_6;
        }
  ...
  void detectChangesInternal() {
    ...
    changed = false;
    final currVal_2 = _ctx.showBasicDialog;
    if (import33.checkBinding(_expr_2, currVal_2)) {
      _ModalComponent_3_5.visible = currVal_2;
      changed = true;
      _expr_2 = currVal_2;
    }
    if (changed) {
    ...
    if ((!import33.AppViewUtils.throwOnChanges)) {
      _MaterialDialogComponent_4_5.ngAfterContentChecked();
    }
    ...
    if ((!import33.AppViewUtils.throwOnChanges)) {
      if (firstCheck) {
        _ModalComponent_3_5.ngAfterViewInit();
      }
    }
  }
  ...
  void destroyInternal() {
    ...
    _MaterialDialogComponent_4_5.ngOnDestroy();
    _ModalComponent_3_5.ngOnDestroy();
  }

  void _handle_visibleChange_3_0($event) {
    final _ctx = ctx;
    _ctx.showBasicDialog = $event;
  }
...
class _ViewSignInBarComponent1 extends AppView<import2.SignInBarComponent> {
  ...
  void detectChangesInternal() {
    ...
    final currVal_0 = _ctx.showBasicDialog;
