...
class ViewNavBarComponent0 extends AppView<import2.NavBarComponent> {
  ...
  ComponentRef<import2.NavBarComponent> build() {
    ...
    import12.setAttribute(_el_2, 'alt', 'Now in theaters');
    ...
    import12.setAttribute(_el_8, 'alt', 'Showtimes');
    this.updateChildClass(_el_8, 'icon');
    import12.setAttribute(_el_8, 'src', 'images/showtimes.svg');
    addShimE(_el_8);
    ...
    import12.setAttribute(_el_14, 'alt', 'Coming soon');
    this.updateChildClass(_el_14, 'icon');
    import12.setAttribute(_el_14, 'src', 'images/coming-soon.svg');
    addShimE(_el_14);
  ...
  void detectChangesInternal() {
    ...
    final currVal_1 = import17.RoutePaths.nowInTheaters.toUrl();
    ...
    final currVal_3 = import17.RoutePaths.showtimes.toUrl();
    ...
    final currVal_5 = import17.RoutePaths.comingSoon.toUrl();
    ...
    _textBinding_5.updateText(import19.interpolateString0(_ctx.messages.nowInTheaters));
    _RouterLink_7_5.detectHostChanges(this, _el_7);
    _textBinding_11.updateText(import19.interpolateString0(_ctx.messages.showtimes));
    _RouterLink_13_5.detectHostChanges(this, _el_13);
    _textBinding_17.updateText(import19.interpolateString0(_ctx.messages.comingSoon));
