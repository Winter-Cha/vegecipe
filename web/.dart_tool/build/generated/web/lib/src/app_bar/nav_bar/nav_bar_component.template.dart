...
class ViewNavBarComponent0 extends AppView<import2.NavBarComponent> {
  ...
  ComponentRef<import2.NavBarComponent> build() {
    ...
    import12.setAttribute(_el_2, 'alt', 'Vegan News');
    ...
    import12.setAttribute(_el_8, 'alt', 'Now in theaters');
    ...
    import12.setAttribute(_el_14, 'alt', 'Showtimes');
    this.updateChildClass(_el_14, 'icon');
    import12.setAttribute(_el_14, 'src', 'images/showtimes.svg');
    addShimE(_el_14);
    ...
    import12.setAttribute(_el_20, 'alt', 'Coming soon');
    this.updateChildClass(_el_20, 'icon');
    import12.setAttribute(_el_20, 'src', 'images/coming-soon.svg');
    addShimE(_el_20);
  ...
  void detectChangesInternal() {
    ...
    final currVal_1 = import17.RoutePaths.vegeNews.toUrl();
    ...
    final currVal_3 = import17.RoutePaths.nowInTheaters.toUrl();
    ...
    final currVal_5 = import17.RoutePaths.showtimes.toUrl();
    ...
    final currVal_7 = import17.RoutePaths.comingSoon.toUrl();
    ...
    _textBinding_5.updateText(import19.interpolateString0(_ctx.messages.vegeNews));
    _RouterLink_7_5.detectHostChanges(this, _el_7);
    _textBinding_11.updateText(import19.interpolateString0(_ctx.messages.nowInTheaters));
    _RouterLink_13_5.detectHostChanges(this, _el_13);
    _textBinding_17.updateText(import19.interpolateString0(_ctx.messages.showtimes));
    _RouterLink_19_5.detectHostChanges(this, _el_19);
    _textBinding_23.updateText(import19.interpolateString0(_ctx.messages.comingSoon));
