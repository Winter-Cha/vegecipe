define(['dart_sdk', 'packages/core/core', 'packages/kt_dart/collection', 'packages/angular/src/core/change_detection/change_detection', 'packages/intl/intl', 'packages/angular/src/bootstrap/modules', 'packages/angular/angular.template', 'packages/angular/src/runtime/text_binding', 'packages/angular/src/runtime/interpolate', 'packages/angular/src/runtime/proxies', 'packages/redux/redux', 'packages/angular_router/angular_router.template', 'packages/angular_router/src/directives/router_outlet_directive'], function(dart_sdk, core, collection, change_detection, intl, modules, angular, text_binding, interpolate, proxies, redux, angular_router, router_outlet_directive) {
  ...
  let AppViewOfLazyImageComponent$ = () => (AppViewOfLazyImageComponent$ = dart.constFn(src__core__linker__app_view.AppView$(src__common__vegenews_poster__lazy_image_component.LazyImageComponent)))();
  let AppViewAndintToAppViewOfLazyImageComponent$ = () => (AppViewAndintToAppViewOfLazyImageComponent$ = dart.constFn(dart.fnType(AppViewOfLazyImageComponent$(), [src__core__linker__app_view.AppView, core$.int])))();
  let ComponentFactoryOfLazyImageComponent$ = () => (ComponentFactoryOfLazyImageComponent$ = dart.constFn(src__core__linker__component_factory.ComponentFactory$(src__common__vegenews_poster__lazy_image_component.LazyImageComponent)))();
  let ComponentRefOfLazyImageComponent$ = () => (ComponentRefOfLazyImageComponent$ = dart.constFn(src__core__linker__component_factory.ComponentRef$(src__common__vegenews_poster__lazy_image_component.LazyImageComponent)))();
  ...
  const _calculateDimensionsIfNeeded$ = dart.privateName(src__common__vegenews_poster__lazy_image_component, "_calculateDimensionsIfNeeded");
  let const$2;
  ...
  const messages$2 = Symbol("VegeNewsPosterComponent.messages");
  const vegeNews = Symbol("VegeNewsPosterComponent.vegeNews");
  const isComingSoon$ = Symbol("VegeNewsPosterComponent.isComingSoon");
  const hasDetails$ = Symbol("VegeNewsPosterComponent.hasDetails");
  const isTouchable$ = Symbol("VegeNewsPosterComponent.isTouchable");
  ...
  const _expr_0$8 = dart.privateName(src__common__vegenews_poster__lazy_image_component$46template, "_expr_0");
  const _expr_1$3 = dart.privateName(src__common__vegenews_poster__lazy_image_component$46template, "_expr_1");
  const _el_0$2 = dart.privateName(src__common__vegenews_poster__lazy_image_component$46template, "_el_0");
  ...
  dart.defineLazy(src__common__vegenews_poster__lazy_image_component$46template, {
    /*src__common__vegenews_poster__lazy_image_component$46template._LazyImageComponentNgFactory*/get _LazyImageComponentNgFactory() {
      return dart.const(new (ComponentFactoryOfLazyImageComponent$()).new("lazy-img", dart.fn(src__common__vegenews_poster__lazy_image_component$46template.viewFactory_LazyImageComponentHost0, AppViewAndintToAppViewOfLazyImageComponent$())));
    }
  });
  ...
  const _compView_0$9 = dart.privateName(src__common__vegenews_poster__lazy_image_component$46template, "_compView_0");
  const _LazyImageComponent_0_5$0 = dart.privateName(src__common__vegenews_poster__lazy_image_component$46template, "_LazyImageComponent_0_5");
  src__common__vegenews_poster__lazy_image_component$46template._ViewLazyImageComponentHost0 = class _ViewLazyImageComponentHost0 extends src__core__linker__app_view.AppView$(src__common__vegenews_poster__lazy_image_component.LazyImageComponent) {
    build() {
      this[_compView_0$9] = new src__common__vegenews_poster__lazy_image_component$46template.ViewLazyImageComponent0.new(this, 0);
      this.rootEl = this[_compView_0$9].rootEl;
      this[_LazyImageComponent_0_5$0] = new src__common__vegenews_poster__lazy_image_component.LazyImageComponent.new(this.rootEl);
  ...
  dart.setFieldSignature(src__common__vegenews_poster__lazy_image_component$46template._ViewLazyImageComponentHost0, () => ({
    ...
    [_compView_0$9]: dart.fieldType(src__common__vegenews_poster__lazy_image_component$46template.ViewLazyImageComponent0),
    [_LazyImageComponent_0_5$0]: dart.fieldType(src__common__vegenews_poster__lazy_image_component.LazyImageComponent)
  }));
  ...
  const _appEl_2$2 = dart.privateName(src__common__vegenews_poster__vegenews_poster_component$46template, "_appEl_2");
  const _NgIf_2_9$0 = dart.privateName(src__common__vegenews_poster__vegenews_poster_component$46template, "_NgIf_2_9");
  ...
  const _expr_0$9 = dart.privateName(src__common__vegenews_poster__vegenews_poster_component$46template, "_expr_0");
  const _el_1$1 = dart.privateName(src__common__vegenews_poster__vegenews_poster_component$46template, "_el_1");
  src__common__vegenews_poster__vegenews_poster_component$46template.ViewVegeNewsPosterComponent0 = class ViewVegeNewsPosterComponent0 extends src__core__linker__app_view.AppView$(src__common__vegenews_poster__vegenews_poster_component.VegeNewsPosterComponent) {
    ...
    build() {
      ...
      let _TemplateRef_2_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_2$2], dart.fn(src__common__vegenews_poster__vegenews_poster_component$46template.viewFactory_VegeNewsPosterComponent1, AppViewAndintToAppViewOfvoid()));
    ...
    detectChangesInternal() {
      let _ctx = this.ctx;
      this[_NgIf_2_9$0].ngIf = _ctx.vegeNews.hasMediumPortraitImage;
  ...
  const _compView_0$10 = dart.privateName(src__common__vegenews_poster__vegenews_poster_component$46template, "_compView_0");
  const _LazyImageComponent_0_5$1 = dart.privateName(src__common__vegenews_poster__vegenews_poster_component$46template, "_LazyImageComponent_0_5");
  const _expr_1$4 = dart.privateName(src__common__vegenews_poster__vegenews_poster_component$46template, "_expr_1");
  src__common__vegenews_poster__vegenews_poster_component$46template._ViewVegeNewsPosterComponent1 = class _ViewVegeNewsPosterComponent1 extends src__core__linker__app_view.AppView$(src__common__vegenews_poster__vegenews_poster_component.VegeNewsPosterComponent) {
    build() {
      this[_compView_0$10] = new src__common__vegenews_poster__lazy_image_component$46template.ViewLazyImageComponent0.new(this, 0);
      let _el_0 = this[_compView_0$10].rootEl;
      this.addShimC(_el_0);
      this[_LazyImageComponent_0_5$1] = new src__common__vegenews_poster__lazy_image_component.LazyImageComponent.new(_el_0);
  ...
  dart.setFieldSignature(src__common__vegenews_poster__vegenews_poster_component$46template._ViewVegeNewsPosterComponent1, () => ({
    ...
    [_compView_0$10]: dart.fieldType(src__common__vegenews_poster__lazy_image_component$46template.ViewLazyImageComponent0),
    [_LazyImageComponent_0_5$1]: dart.fieldType(src__common__vegenews_poster__lazy_image_component.LazyImageComponent),
  ...
  const _textBinding_3$0 = dart.privateName(src__common__vegenews_poster__vegenews_poster_component$46template, "_textBinding_3");
  const _textBinding_5$ = dart.privateName(src__common__vegenews_poster__vegenews_poster_component$46template, "_textBinding_5");
  src__common__vegenews_poster__vegenews_poster_component$46template._ViewVegeNewsPosterComponent2 = class _ViewVegeNewsPosterComponent2 extends src__core__linker__app_view.AppView$(src__common__vegenews_poster__vegenews_poster_component.VegeNewsPosterComponent) {
    ...
    detectChangesInternal() {
      let _ctx = this.ctx;
      this[_textBinding_3$0].updateText(src__runtime__interpolate.interpolateString0(_ctx.vegeNews.title));
      this[_textBinding_5$].updateText(src__runtime__interpolate.interpolateString0(_ctx.vegeNews.writtenBy));
    }
  };
  ...
  const _textBinding_2$ = dart.privateName(src__common__vegenews_poster__vegenews_poster_component$46template, "_textBinding_2");
  const _textBinding_4$1 = dart.privateName(src__common__vegenews_poster__vegenews_poster_component$46template, "_textBinding_4");
  ...
  src__common__vegenews_poster__vegenews_poster_component$46template._ViewVegeNewsPosterComponentHost0 = class _ViewVegeNewsPosterComponentHost0 extends src__core__linker__app_view.AppView$(src__common__vegenews_poster__vegenews_poster_component.VegeNewsPosterComponent) {
    build() {
      this[_compView_0$10] = new src__common__vegenews_poster__vegenews_poster_component$46template.ViewVegeNewsPosterComponent0.new(this, 0);
      ...
      this[_compView_0$10].create(this[_VegeNewsPosterComponent_0_5], this.projectedNodes);
      this.init1(this.rootEl);
  ...
  dart.setFieldSignature(src__common__vegenews_poster__vegenews_poster_component$46template._ViewVegeNewsPosterComponentHost0, () => ({
    ...
    [_compView_0$10]: dart.fieldType(src__common__vegenews_poster__vegenews_poster_component$46template.ViewVegeNewsPosterComponent0),
  ...
  const _expr_0$10 = dart.privateName(src__vegenews_details__landscape_image__vegenews_landscape_image_component$46template, "_expr_0");
  ...
  const _compView_0$11 = dart.privateName(src__vegenews_details__landscape_image__vegenews_landscape_image_component$46template, "_compView_0");
  ...
  src__vegenews_details__landscape_image__vegenews_landscape_image_component$46template._ViewVegeNewsLandscapeImageComponentHost0 = class _ViewVegeNewsLandscapeImageComponentHost0 extends src__core__linker__app_view.AppView$(src__vegenews_details__landscape_image__vegenews_landscape_image_component.VegeNewsLandscapeImageComponent) {
    build() {
      this[_compView_0$11] = new src__vegenews_details__landscape_image__vegenews_landscape_image_component$46template.ViewVegeNewsLandscapeImageComponent0.new(this, 0);
      ...
      this[_compView_0$11].create(this[_VegeNewsLandscapeImageComponent_0_5], this.projectedNodes);
      this.init1(this.rootEl);
  ...
  dart.setFieldSignature(src__vegenews_details__landscape_image__vegenews_landscape_image_component$46template._ViewVegeNewsLandscapeImageComponentHost0, () => ({
    ...
    [_compView_0$11]: dart.fieldType(src__vegenews_details__landscape_image__vegenews_landscape_image_component$46template.ViewVegeNewsLandscapeImageComponent0),
  ...
  const _expr_0$11 = dart.privateName(src__showtimes__date_selector_component$46template, "_expr_0");
  ...
  const _textBinding_2$0 = dart.privateName(src__showtimes__date_selector_component$46template, "_textBinding_2");
  const _textBinding_4$2 = dart.privateName(src__showtimes__date_selector_component$46template, "_textBinding_4");
  ...
  const _el_0$3 = dart.privateName(src__showtimes__date_selector_component$46template, "_el_0");
  ...
  src__showtimes__date_selector_component$46template._ViewDateSelectorComponent1 = class _ViewDateSelectorComponent1 extends src__core__linker__app_view.AppView$(src__showtimes__date_selector_component.DateSelectorComponent) {
    build() {
      let doc = html.document;
      this[_el_0$3] = html.DivElement._check(doc[$createElement]("div"));
      this.updateChildClass(this[_el_0$3], "date-item");
      this.addShimC(this[_el_0$3]);
      let _el_1 = src__runtime__dom_helpers.appendElement(doc, this[_el_0$3], "p");
      this.updateChildClass(html.HtmlElement._check(_el_1), "dayname");
      this.addShimE(_el_1);
      _el_1[$append](this[_textBinding_2$0].element);
      let _el_3 = src__runtime__dom_helpers.appendElement(doc, this[_el_0$3], "p");
      this.updateChildClass(html.HtmlElement._check(_el_3), "day");
      this.addShimE(_el_3);
      _el_3[$append](this[_textBinding_4$2].element);
      this[_el_0$3][$addEventListener]("click", this.eventHandler1(html.Event, html.Event, dart.bind(this, _handle_click_0_0$)));
    ...
    detectChangesInternal() {
      ...
      if (dart.test(src__core__linker__app_view_utils.checkBinding(this[_expr_0$11], currVal_0))) {
        src__runtime__dom_helpers.updateClassBinding(this[_el_0$3], "selected", currVal_0);
        this[_expr_0$11] = currVal_0;
      }
      this[_textBinding_2$0].updateText(core$.String._check(src__runtime__interpolate.interpolate0(this[_pipe_date_0_0$](local_date, "E"))));
      this[_textBinding_4$2].updateText(core$.String._check(src__runtime__interpolate.interpolate0(this[_pipe_date_0_1$](local_date, "d"))));
    }
    [_handle_click_0_0$]($event) {
      let local_date = src__runtime__optimizations.unsafeCast(core$.DateTime, this.locals[$_get]("$implicit"));
      let _ctx = this.ctx;
  ...
  dart.setFieldSignature(src__showtimes__date_selector_component$46template._ViewDateSelectorComponent1, () => ({
    ...
    [_expr_0$11]: dart.fieldType(core$.bool),
    [_pipe_date_0_0$]: dart.fieldType(dynamicAndStringToString()),
    [_pipe_date_0_1$]: dart.fieldType(dynamicAndStringToString()),
    [_el_0$3]: dart.fieldType(html.DivElement)
  }));
  ...
  const _compView_0$12 = dart.privateName(src__showtimes__date_selector_component$46template, "_compView_0");
  ...
  src__showtimes__date_selector_component$46template._ViewDateSelectorComponentHost0 = class _ViewDateSelectorComponentHost0 extends src__core__linker__app_view.AppView$(src__showtimes__date_selector_component.DateSelectorComponent) {
    build() {
      this[_compView_0$12] = new src__showtimes__date_selector_component$46template.ViewDateSelectorComponent0.new(this, 0);
      ...
      this[_compView_0$12].create(this[_DateSelectorComponent_0_5], this.projectedNodes);
      this.init1(this.rootEl);
  ...
  dart.setFieldSignature(src__showtimes__date_selector_component$46template._ViewDateSelectorComponentHost0, () => ({
    ...
    [_compView_0$12]: dart.fieldType(src__showtimes__date_selector_component$46template.ViewDateSelectorComponent0),
  ...
  const _store$0 = dart.privateName(src__showtimes__showtimes_page_component, "_store");
  const _router = dart.privateName(src__showtimes__showtimes_page_component, "_router");
  src__showtimes__showtimes_page_component.ShowtimesPageComponent = class ShowtimesPageComponent extends core$.Object {
    ...
    get viewModel() {
      return src__viewmodels__showtime_page_view_model.ShowtimesPageViewModel.fromStore(this[_store$0]);
    }
    get shows() {
    ...
    openShowDetails(show) {
      ...
      let event = src__redux__event__event_selectors.eventForShowSelector(this[_store$0].state, show);
    ...
    onActivate(previous, _) {
      ...
      this[_store$0].dispatch(new src__redux__show__show_actions.FetchShowsIfNotLoadedAction.new());
    }
  };
  ...
  const messages$3 = Symbol("ShowtimesPageComponent.messages");
  ...
  const _textBinding_3$1 = dart.privateName(src__showtimes__showtimes_page_component$46template, "_textBinding_3");
  const _compView_4 = dart.privateName(src__showtimes__showtimes_page_component$46template, "_compView_4");
  ...
  const _expr_0$12 = dart.privateName(src__showtimes__showtimes_page_component$46template, "_expr_0");
  const _expr_1$5 = dart.privateName(src__showtimes__showtimes_page_component$46template, "_expr_1");
  const _expr_2$0 = dart.privateName(src__showtimes__showtimes_page_component$46template, "_expr_2");
  ...
  src__showtimes__showtimes_page_component$46template.ViewShowtimesPageComponent0 = class ViewShowtimesPageComponent0 extends src__core__linker__app_view.AppView$(src__showtimes__showtimes_page_component.ShowtimesPageComponent) {
    ...
    build() {
      ...
      this[_compView_4] = new src__common__theater_selector__theater_selector_component$46template.ViewTheaterSelectorComponent0.new(this, 4);
      ...
      this[_compView_4].create0(this[_TheaterSelectorComponent_4_8]);
      ...
      this.init(const$3 || (const$3 = dart.constList([], core$.Object)), JSArrayOfStreamSubscriptionOfvoid().of([subscription_0]));
    }
    detectChangesInternal() {
      let _ctx = this.ctx;
      ...
      this[_textBinding_3$1].updateText(src__runtime__interpolate.interpolateString0(_ctx.messages.showtimes));
  ...
  dart.setFieldSignature(src__showtimes__showtimes_page_component$46template.ViewShowtimesPageComponent0, () => ({
    ...
    [_compView_4]: dart.fieldType(src__common__theater_selector__theater_selector_component$46template.ViewTheaterSelectorComponent0),
  ...
  const _compView_0$13 = dart.privateName(src__showtimes__showtimes_page_component$46template, "_compView_0");
  ...
  src__showtimes__showtimes_page_component$46template._ViewShowtimesPageComponent1 = class _ViewShowtimesPageComponent1 extends src__core__linker__app_view.AppView$(src__showtimes__showtimes_page_component.ShowtimesPageComponent) {
    build() {
      this[_compView_0$13] = new src__common__showtime_item__showtime_item_component$46template.ViewShowtimeItemComponent0.new(this, 0);
      ...
      this[_compView_0$13].create0(this[_ShowtimeItemComponent_0_5$]);
  ...
  dart.setFieldSignature(src__showtimes__showtimes_page_component$46template._ViewShowtimesPageComponent1, () => ({
    ...
    [_compView_0$13]: dart.fieldType(src__common__showtime_item__showtime_item_component$46template.ViewShowtimeItemComponent0),
    [_ShowtimeItemComponent_0_5$]: dart.fieldType(src__common__showtime_item__showtime_item_component.ShowtimeItemComponent),
    [_expr_0$12]: dart.fieldType(dart.dynamic)
  }));
  ...
  src__showtimes__showtimes_page_component$46template._ViewShowtimesPageComponentHost0 = class _ViewShowtimesPageComponentHost0 extends src__core__linker__app_view.AppView$(src__showtimes__showtimes_page_component.ShowtimesPageComponent) {
    build() {
      this[_compView_0$13] = new src__showtimes__showtimes_page_component$46template.ViewShowtimesPageComponent0.new(this, 0);
      ...
      this[_compView_0$13].create(this[_ShowtimesPageComponent_0_5], this.projectedNodes);
      this.init1(this.rootEl);
  ...
  dart.setFieldSignature(src__showtimes__showtimes_page_component$46template._ViewShowtimesPageComponentHost0, () => ({
    ...
    [_compView_0$13]: dart.fieldType(src__showtimes__showtimes_page_component$46template.ViewShowtimesPageComponent0),
  ...
  const messages$4 = Symbol("VegeNewsDetailsComponent.messages");
  ...
  const _appEl_0$1 = dart.privateName(src__vegenews_details__vegenews_details_component$46template, "_appEl_0");
  ...
  src__vegenews_details__vegenews_details_component$46template.ViewVegeNewsDetailsComponent0 = class ViewVegeNewsDetailsComponent0 extends src__core__linker__app_view.AppView$(src__vegenews_details__vegenews_details_component.VegeNewsDetailsComponent) {
    ...
    build() {
      ...
      let _TemplateRef_0_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_0$1], dart.fn(src__vegenews_details__vegenews_details_component$46template.viewFactory_VegeNewsDetailsComponent1, AppViewAndintToAppViewOfvoid()));
  ...
  const _compView_1$0 = dart.privateName(src__vegenews_details__vegenews_details_component$46template, "_compView_1");
  ...
  const _appEl_9$ = dart.privateName(src__vegenews_details__vegenews_details_component$46template, "_appEl_9");
  const _NgIf_9_9$ = dart.privateName(src__vegenews_details__vegenews_details_component$46template, "_NgIf_9_9");
  const _appEl_10$ = dart.privateName(src__vegenews_details__vegenews_details_component$46template, "_appEl_10");
  const _NgIf_10_9$ = dart.privateName(src__vegenews_details__vegenews_details_component$46template, "_NgIf_10_9");
  ...
  const _expr_0$13 = dart.privateName(src__vegenews_details__vegenews_details_component$46template, "_expr_0");
  const _expr_1$6 = dart.privateName(src__vegenews_details__vegenews_details_component$46template, "_expr_1");
  const _expr_2$1 = dart.privateName(src__vegenews_details__vegenews_details_component$46template, "_expr_2");
  const _el_0$4 = dart.privateName(src__vegenews_details__vegenews_details_component$46template, "_el_0");
  src__vegenews_details__vegenews_details_component$46template._ViewVegeNewsDetailsComponent1 = class _ViewVegeNewsDetailsComponent1 extends src__core__linker__app_view.AppView$(src__vegenews_details__vegenews_details_component.VegeNewsDetailsComponent) {
    build() {
      ...
      this.updateChildClass(this[_el_0$4], "container");
      this.addShimC(this[_el_0$4]);
      this[_compView_1$0] = new src__vegenews_details__landscape_image__vegenews_landscape_image_component$46template.ViewVegeNewsLandscapeImageComponent0.new(this, 1);
      let _el_1 = this[_compView_1$0].rootEl;
      this[_el_0$4][$append](_el_1);
      this.addShimC(_el_1);
      ...
      this[_compView_1$0].create0(this[_VegeNewsLandscapeImageComponent_1_5]);
      let _el_2 = src__runtime__dom_helpers.appendElement(doc, this[_el_0$4], "img");
      this.updateChildClass(html.HtmlElement._check(_el_2), "back");
      src__runtime__dom_helpers.setAttribute(_el_2, "src", "images/back.svg");
      this.addShimE(_el_2);
      let _el_3 = src__runtime__dom_helpers.appendDiv(doc, this[_el_0$4]);
      ...
      let _TemplateRef_9_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_9$], dart.fn(src__vegenews_details__vegenews_details_component$46template.viewFactory_VegeNewsDetailsComponent2, AppViewAndintToAppViewOfvoid()));
      this[_NgIf_9_9$] = new src__common__directives__ng_if.NgIf.new(this[_appEl_9$], _TemplateRef_9_8);
      let _anchor_10 = src__runtime__dom_helpers.appendAnchor(this[_el_0$4]);
      this[_appEl_10$] = new src__core__linker__view_container.ViewContainer.new(10, 0, this, _anchor_10);
      let _TemplateRef_10_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_10$], dart.fn(src__vegenews_details__vegenews_details_component$46template.viewFactory_VegeNewsDetailsComponent3, AppViewAndintToAppViewOfvoid()));
      this[_NgIf_10_9$] = new src__common__directives__ng_if.NgIf.new(this[_appEl_10$], _TemplateRef_10_8);
      let _anchor_11 = src__runtime__dom_helpers.appendAnchor(this[_el_0$4]);
    ...
    detectChangesInternal() {
      ...
      this[_NgIf_9_9$].ngIf = _ctx.vegeNews.writtenBy != null;
      this[_NgIf_10_9$].ngIf = _ctx.vegeNews.hasContent;
      ...
      if (dart.test(src__core__linker__app_view_utils.checkBinding(this[_expr_0$13], currVal_0))) {
        src__runtime__dom_helpers.updateClassBinding(this[_el_0$4], "visible", currVal_0);
  ...
  dart.setFieldSignature(src__vegenews_details__vegenews_details_component$46template._ViewVegeNewsDetailsComponent1, () => ({
    ...
    [_compView_1$0]: dart.fieldType(src__vegenews_details__landscape_image__vegenews_landscape_image_component$46template.ViewVegeNewsLandscapeImageComponent0),
  ...
  const _textBinding_2$1 = dart.privateName(src__vegenews_details__vegenews_details_component$46template, "_textBinding_2");
  const _textBinding_4$3 = dart.privateName(src__vegenews_details__vegenews_details_component$46template, "_textBinding_4");
  src__vegenews_details__vegenews_details_component$46template._ViewVegeNewsDetailsComponent2 = class _ViewVegeNewsDetailsComponent2 extends src__core__linker__app_view.AppView$(src__vegenews_details__vegenews_details_component.VegeNewsDetailsComponent) {
    build() {
      ...
      _el_0[$append](this[_textBinding_4$3].element);
      this.init1(_el_0);
    }
    detectChangesInternal() {
      let _ctx = this.ctx;
      this[_textBinding_2$1].updateText(src__runtime__interpolate.interpolateString0(_ctx.messages.writtenBy));
      this[_textBinding_4$3].updateText(src__runtime__interpolate.interpolateString0(_ctx.vegeNews.writtenBy));
    }
  };
  ...
  const _textBinding_3$2 = dart.privateName(src__vegenews_details__vegenews_details_component$46template, "_textBinding_3");
  src__vegenews_details__vegenews_details_component$46template._ViewVegeNewsDetailsComponent3 = class _ViewVegeNewsDetailsComponent3 extends src__core__linker__app_view.AppView$(src__vegenews_details__vegenews_details_component.VegeNewsDetailsComponent) {
    ...
    detectChangesInternal() {
      let _ctx = this.ctx;
      this[_textBinding_3$2].updateText(src__runtime__interpolate.interpolateString0(_ctx.vegeNews.content));
    }
  };
  ...
  src__vegenews_details__vegenews_details_component$46template._ViewVegeNewsDetailsComponent5 = class _ViewVegeNewsDetailsComponent5 extends src__core__linker__app_view.AppView$(src__vegenews_details__vegenews_details_component.VegeNewsDetailsComponent) {
    build() {
      let doc = html.document;
      this[_el_0$4] = doc[$createElement]("img");
      this.addShimE(this[_el_0$4]);
      this.init1(this[_el_0$4]);
    }
    detectChangesInternal() {
      let _ctx = this.ctx;
      ...
      if (dart.test(src__core__linker__app_view_utils.checkBinding(this[_expr_0$13], currVal_0))) {
        src__runtime__dom_helpers.setProperty(this[_el_0$4], "src", src__core__linker__app_view_utils.appViewUtils.sanitizer.sanitizeUrl(currVal_0));
        this[_expr_0$13] = currVal_0;
      }
      let currVal_1 = "A still frame from the movie " + dart.notNull(_ctx.vegeNews.title);
      if (dart.test(src__core__linker__app_view_utils.checkBinding(this[_expr_1$6], currVal_1))) {
        src__runtime__dom_helpers.setProperty(this[_el_0$4], "alt", currVal_1);
        this[_expr_1$6] = currVal_1;
      }
    }
  };
  ...
  dart.setFieldSignature(src__vegenews_details__vegenews_details_component$46template._ViewVegeNewsDetailsComponent5, () => ({
    ...
    [_expr_0$13]: dart.fieldType(dart.dynamic),
    [_expr_1$6]: dart.fieldType(dart.dynamic),
    [_el_0$4]: dart.fieldType(html.Element)
  }));
  ...
  const _compView_0$14 = dart.privateName(src__vegenews_details__vegenews_details_component$46template, "_compView_0");
  ...
  src__vegenews_details__vegenews_details_component$46template._ViewVegeNewsDetailsComponentHost0 = class _ViewVegeNewsDetailsComponentHost0 extends src__core__linker__app_view.AppView$(src__vegenews_details__vegenews_details_component.VegeNewsDetailsComponent) {
    build() {
      this[_compView_0$14] = new src__vegenews_details__vegenews_details_component$46template.ViewVegeNewsDetailsComponent0.new(this, 0);
      ...
      this[_compView_0$14].create(this[_VegeNewsDetailsComponent_0_5], this.projectedNodes);
      this.init1(this.rootEl);
  ...
  dart.setFieldSignature(src__vegenews_details__vegenews_details_component$46template._ViewVegeNewsDetailsComponentHost0, () => ({
    ...
    [_compView_0$14]: dart.fieldType(src__vegenews_details__vegenews_details_component$46template.ViewVegeNewsDetailsComponent0),
  ...
  const _store$2 = dart.privateName(src__vegenews__vegenews_page_component, "_store");
  const _router$0 = dart.privateName(src__vegenews__vegenews_page_component, "_router");
  src__vegenews__vegenews_page_component.VegeNewsPageComponent = class VegeNewsPageComponent extends core$.Object {
    ...
    get viewModel() {
      return src__viewmodels__vegenews_page_view_model.VegeNewsPageViewModel.fromStore(this[_store$2]);
    }
    onActivate(previous, current) {
  ...
  const messages$5 = Symbol("VegeNewsPageComponent.messages");
  ...
  const _textBinding_3$3 = dart.privateName(src__vegenews__vegenews_page_component$46template, "_textBinding_3");
  const _compView_4$0 = dart.privateName(src__vegenews__vegenews_page_component$46template, "_compView_4");
  ...
  const _expr_0$14 = dart.privateName(src__vegenews__vegenews_page_component$46template, "_expr_0");
  const _expr_1$7 = dart.privateName(src__vegenews__vegenews_page_component$46template, "_expr_1");
  const _expr_2$2 = dart.privateName(src__vegenews__vegenews_page_component$46template, "_expr_2");
  ...
  src__vegenews__vegenews_page_component$46template.ViewVegeNewsPageComponent0 = class ViewVegeNewsPageComponent0 extends src__core__linker__app_view.AppView$(src__vegenews__vegenews_page_component.VegeNewsPageComponent) {
    ...
    build() {
      ...
      this[_compView_4$0] = new src__common__loading_view__loading_view_component$46template.ViewLoadingViewComponent0.new(this, 4);
      ...
      this[_compView_4$0].create(this[_LoadingViewComponent_4_5], JSArrayOfObject().of([JSArrayOfElement().of([_el_5])]));
    ...
    detectChangesInternal() {
      ...
      this[_textBinding_3$3].updateText(src__runtime__interpolate.interpolateString0(_ctx.VegeNewsTitle));
  ...
  dart.setFieldSignature(src__vegenews__vegenews_page_component$46template.ViewVegeNewsPageComponent0, () => ({
    ...
    [_compView_4$0]: dart.fieldType(src__common__loading_view__loading_view_component$46template.ViewLoadingViewComponent0),
    ...
    [_expr_0$14]: dart.fieldType(core$.bool),
    [_expr_1$7]: dart.fieldType(core$.String),
  ...
  const _compView_0$15 = dart.privateName(src__vegenews__vegenews_page_component$46template, "_compView_0");
  ...
  src__vegenews__vegenews_page_component$46template._ViewVegeNewsPageComponent1 = class _ViewVegeNewsPageComponent1 extends src__core__linker__app_view.AppView$(src__vegenews__vegenews_page_component.VegeNewsPageComponent) {
    build() {
      this[_compView_0$15] = new src__common__vegenews_poster__vegenews_poster_component$46template.ViewVegeNewsPosterComponent0.new(this, 0);
      let _el_0 = this[_compView_0$15].rootEl;
      this.addShimC(_el_0);
      ...
      this[_compView_0$15].create0(this[_VegeNewsPosterComponent_0_5$]);
  ...
  dart.setFieldSignature(src__vegenews__vegenews_page_component$46template._ViewVegeNewsPageComponent1, () => ({
    ...
    [_compView_0$15]: dart.fieldType(src__common__vegenews_poster__vegenews_poster_component$46template.ViewVegeNewsPosterComponent0),
    [_VegeNewsPosterComponent_0_5$]: dart.fieldType(src__common__vegenews_poster__vegenews_poster_component.VegeNewsPosterComponent),
  ...
  src__vegenews__vegenews_page_component$46template._ViewVegeNewsPageComponentHost0 = class _ViewVegeNewsPageComponentHost0 extends src__core__linker__app_view.AppView$(src__vegenews__vegenews_page_component.VegeNewsPageComponent) {
    build() {
      this[_compView_0$15] = new src__vegenews__vegenews_page_component$46template.ViewVegeNewsPageComponent0.new(this, 0);
      ...
      this[_compView_0$15].create(this[_VegeNewsPageComponent_0_5], this.projectedNodes);
      this.init1(this.rootEl);
  ...
  dart.setFieldSignature(src__vegenews__vegenews_page_component$46template._ViewVegeNewsPageComponentHost0, () => ({
    ...
    [_compView_0$15]: dart.fieldType(src__vegenews__vegenews_page_component$46template.ViewVegeNewsPageComponent0),
  ...
  const _store$3 = dart.privateName(src__events__events_page_component, "_store");
  const _router$1 = dart.privateName(src__events__events_page_component, "_router");
  ...
  src__events__events_page_component.EventsPageComponent = class EventsPageComponent extends core$.Object {
    ...
    get viewModel() {
      return src__viewmodels__events_page_view_model.EventsPageViewModel.fromStore(this[_store$3], this[_listType]);
    }
    get eventTypeTitle() {
    ...
    onActivate(previous, current) {
      ...
      if (this[_listType] === src__models__event.EventListType.comingSoon) {
        this[_store$3].dispatch(new src__redux___common__common_actions.FetchComingSoonEventsIfNotLoadedAction.new());
      }
    }
  ...
  const messages$6 = Symbol("EventsPageComponent.messages");
  ...
  const _textBinding_3$4 = dart.privateName(src__events__events_page_component$46template, "_textBinding_3");
  const _compView_4$1 = dart.privateName(src__events__events_page_component$46template, "_compView_4");
  const _appEl_4$1 = dart.privateName(src__events__events_page_component$46template, "_appEl_4");
  ...
  const _expr_0$15 = dart.privateName(src__events__events_page_component$46template, "_expr_0");
  const _expr_1$8 = dart.privateName(src__events__events_page_component$46template, "_expr_1");
  const _expr_2$3 = dart.privateName(src__events__events_page_component$46template, "_expr_2");
  const _expr_3$1 = dart.privateName(src__events__events_page_component$46template, "_expr_3");
  ...
  src__events__events_page_component$46template.ViewEventsPageComponent0 = class ViewEventsPageComponent0 extends src__core__linker__app_view.AppView$(src__events__events_page_component.EventsPageComponent) {
    ...
    build() {
      ...
      this[_compView_4$1] = new src__common__theater_selector__theater_selector_component$46template.ViewTheaterSelectorComponent0.new(this, 4);
      ...
      this[_compView_4$1].create0(this[_TheaterSelectorComponent_4_8$]);
    ...
    detectChangesInternal() {
      ...
      this[_appEl_7$].detectChangesInNestedViews();
      this[_textBinding_3$4].updateText(src__runtime__interpolate.interpolateString0(_ctx.eventTypeTitle));
  ...
  dart.setFieldSignature(src__events__events_page_component$46template.ViewEventsPageComponent0, () => ({
    ...
    [_compView_4$1]: dart.fieldType(src__common__theater_selector__theater_selector_component$46template.ViewTheaterSelectorComponent0),
  ...
  const _compView_0$16 = dart.privateName(src__events__events_page_component$46template, "_compView_0");
  const _EventPosterComponent_0_5$ = dart.privateName(src__events__events_page_component$46template, "_EventPosterComponent_0_5");
  const _handle_click_0_0$2 = dart.privateName(src__events__events_page_component$46template, "_handle_click_0_0");
  src__events__events_page_component$46template._ViewEventsPageComponent1 = class _ViewEventsPageComponent1 extends src__core__linker__app_view.AppView$(src__events__events_page_component.EventsPageComponent) {
    build() {
      this[_compView_0$16] = new src__common__event_poster__event_poster_component$46template.ViewEventPosterComponent0.new(this, 0);
      let _el_0 = this[_compView_0$16].rootEl;
      this.addShimC(_el_0);
      ...
      this[_compView_0$16].create0(this[_EventPosterComponent_0_5$]);
  ...
  dart.setFieldSignature(src__events__events_page_component$46template._ViewEventsPageComponent1, () => ({
    ...
    [_compView_0$16]: dart.fieldType(src__common__event_poster__event_poster_component$46template.ViewEventPosterComponent0),
    [_EventPosterComponent_0_5$]: dart.fieldType(src__common__event_poster__event_poster_component.EventPosterComponent),
  ...
  src__events__events_page_component$46template._ViewEventsPageComponentHost0 = class _ViewEventsPageComponentHost0 extends src__core__linker__app_view.AppView$(src__events__events_page_component.EventsPageComponent) {
    build() {
      this[_compView_0$16] = new src__events__events_page_component$46template.ViewEventsPageComponent0.new(this, 0);
      ...
      this[_compView_0$16].create(this[_EventsPageComponent_0_5], this.projectedNodes);
      this.init1(this.rootEl);
  ...
  dart.setFieldSignature(src__events__events_page_component$46template._ViewEventsPageComponentHost0, () => ({
    ...
    [_compView_0$16]: dart.fieldType(src__events__events_page_component$46template.ViewEventsPageComponent0),
  ...
  const _store$4 = dart.privateName(src__event_details__event_details_component, "_store");
  const _router$2 = dart.privateName(src__event_details__event_details_component, "_router");
  const _navigatedFromApp$ = dart.privateName(src__event_details__event_details_component, "_navigatedFromApp");
  ...
  const _animateContentIntoView$ = dart.privateName(src__event_details__event_details_component, "_animateContentIntoView");
  const _waitForEventDetails$ = dart.privateName(src__event_details__event_details_component, "_waitForEventDetails");
  src__event_details__event_details_component.EventDetailsComponent = class EventDetailsComponent extends core$.Object {
    ...
    [_populateEventDetails](eventId, showId) {
      this.event = src__redux__event__event_selectors.eventByIdSelector(this[_store$4].state, eventId);
      this.show = src__redux__show__show_selectors.showByIdSelector(this[_store$4].state, showId);
      if (this.show != null) {
        let t = this.event;
        t == null ? this.event = src__redux__event__event_selectors.eventForShowSelector(this[_store$4].state, this.show) : t;
      }
      if (this.event != null) {
        this[_store$4].dispatch(new src__redux__actor__actor_actions.FetchActorAvatarsAction.new(this.event));
        this[_animateContentIntoView$]();
      } else {
        this[_store$4].dispatch(new src__redux__event__event_actions.RefreshEventsAction.new(src__models__event.EventListType.nowInTheaters));
        this[_store$4].dispatch(new src__redux__event__event_actions.RefreshEventsAction.new(src__models__event.EventListType.comingSoon));
        this[_waitForEventDetails$](eventId, showId);
      }
    }
    [_waitForEventDetails$](eventId, showId) {
      let state = this[_store$4].state.eventState;
      ...
      this[_eventDetailsSubscription] = this[_store$4].onChange.listen(dart.fn(state => {
        {
          let state = this[_store$4].state.eventState;
    ...
    goBack() {
      ...
      this[_router$2].navigateByUrl(src__routes.RoutePaths.nowInTheaters.toUrl(), {replace: true});
    }
  };
  ...
  const messages$7 = Symbol("EventDetailsComponent.messages");
  const event$1 = Symbol("EventDetailsComponent.event");
  const show$0 = Symbol("EventDetailsComponent.show");
  const contentVisible$ = Symbol("EventDetailsComponent.contentVisible");
  ...
  dart.setMethodSignature(src__event_details__event_details_component.EventDetailsComponent, () => ({
    ...
    [_waitForEventDetails$]: dart.fnType(dart.void, [core$.String, core$.String]),
    [_animateContentIntoView$]: dart.fnType(dart.void, []),
  ...
  const _appEl_0$2 = dart.privateName(src__event_details__event_details_component$46template, "_appEl_0");
  const _NgIf_0_9$ = dart.privateName(src__event_details__event_details_component$46template, "_NgIf_0_9");
  src__event_details__event_details_component$46template.ViewEventDetailsComponent0 = class ViewEventDetailsComponent0 extends src__core__linker__app_view.AppView$(src__event_details__event_details_component.EventDetailsComponent) {
    ...
    build() {
      ...
      let _TemplateRef_0_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_0$2], dart.fn(src__event_details__event_details_component$46template.viewFactory_EventDetailsComponent1, AppViewAndintToAppViewOfvoid()));
      this[_NgIf_0_9$] = new src__common__directives__ng_if.NgIf.new(this[_appEl_0$2], _TemplateRef_0_8);
      this.init0();
    }
    detectChangesInternal() {
      let _ctx = this.ctx;
      this[_NgIf_0_9$].ngIf = _ctx.event != null;
  ...
  const _textBinding_7$ = dart.privateName(src__event_details__event_details_component$46template, "_textBinding_7");
  const _textBinding_10 = dart.privateName(src__event_details__event_details_component$46template, "_textBinding_10");
  const _compView_1$1 = dart.privateName(src__event_details__event_details_component$46template, "_compView_1");
  ...
  const _compView_4$2 = dart.privateName(src__event_details__event_details_component$46template, "_compView_4");
  ...
  const _expr_0$16 = dart.privateName(src__event_details__event_details_component$46template, "_expr_0");
  const _expr_1$9 = dart.privateName(src__event_details__event_details_component$46template, "_expr_1");
  const _expr_2$4 = dart.privateName(src__event_details__event_details_component$46template, "_expr_2");
  const _expr_6 = dart.privateName(src__event_details__event_details_component$46template, "_expr_6");
  const _el_0$5 = dart.privateName(src__event_details__event_details_component$46template, "_el_0");
  src__event_details__event_details_component$46template._ViewEventDetailsComponent1 = class _ViewEventDetailsComponent1 extends src__core__linker__app_view.AppView$(src__event_details__event_details_component.EventDetailsComponent) {
    build() {
      ...
      this[_compView_1$1] = new src__event_details__landscape_image__event_landscape_image_component$46template.ViewEventLandscapeImageComponent0.new(this, 1);
      ...
      this[_compView_1$1].create0(this[_EventLandscapeImageComponent_1_5]);
      ...
      this.addShimC(_el_3);
      this[_compView_4$2] = new src__common__event_poster__event_poster_component$46template.ViewEventPosterComponent0.new(this, 4);
      ...
      this[_compView_4$2].create0(this[_EventPosterComponent_4_5]);
      let _el_5 = src__runtime__dom_helpers.appendDiv(doc, _el_3);
      ...
      let _anchor_14 = src__runtime__dom_helpers.appendAnchor(this[_el_0$5]);
      ...
      let _anchor_15 = src__runtime__dom_helpers.appendAnchor(this[_el_0$5]);
      ...
      let _anchor_16 = src__runtime__dom_helpers.appendAnchor(this[_el_0$5]);
      ...
      let _anchor_17 = src__runtime__dom_helpers.appendAnchor(this[_el_0$5]);
    ...
    detectChangesInternal() {
      ...
      this[_textBinding_7$].updateText(src__runtime__interpolate.interpolateString0(_ctx.event.title));
  ...
  dart.setFieldSignature(src__event_details__event_details_component$46template._ViewEventDetailsComponent1, () => ({
    ...
    [_compView_1$1]: dart.fieldType(src__event_details__landscape_image__event_landscape_image_component$46template.ViewEventLandscapeImageComponent0),
    ...
    [_compView_4$2]: dart.fieldType(src__common__event_poster__event_poster_component$46template.ViewEventPosterComponent0),
  ...
  const _textBinding_2$2 = dart.privateName(src__event_details__event_details_component$46template, "_textBinding_2");
  const _textBinding_4$4 = dart.privateName(src__event_details__event_details_component$46template, "_textBinding_4");
  src__event_details__event_details_component$46template._ViewEventDetailsComponent2 = class _ViewEventDetailsComponent2 extends src__core__linker__app_view.AppView$(src__event_details__event_details_component.EventDetailsComponent) {
    ...
    detectChangesInternal() {
      let _ctx = this.ctx;
      this[_textBinding_2$2].updateText(src__runtime__interpolate.interpolateString0(_ctx.messages.director));
      this[_textBinding_4$4].updateText(src__runtime__interpolate.interpolateString0(_ctx.event.director));
    }
  };
  ...
  src__event_details__event_details_component$46template._ViewEventDetailsComponent3 = class _ViewEventDetailsComponent3 extends src__core__linker__app_view.AppView$(src__event_details__event_details_component.EventDetailsComponent) {
    build() {
      ...
      this.addShimC(html.HtmlElement._check(_el_0));
      this[_compView_1$1] = new src__common__showtime_item__showtime_item_component$46template.ViewShowtimeItemComponent0.new(this, 1);
      let _el_1 = this[_compView_1$1].rootEl;
      _el_0[$append](_el_1);
      ...
      this[_compView_1$1].create0(this[_ShowtimeItemComponent_1_5]);
      this.init1(_el_0);
    }
    detectChangesInternal() {
      let _ctx = this.ctx;
  ...
  dart.setFieldSignature(src__event_details__event_details_component$46template._ViewEventDetailsComponent3, () => ({
    ...
    [_compView_1$1]: dart.fieldType(src__common__showtime_item__showtime_item_component$46template.ViewShowtimeItemComponent0),
  ...
  const _textBinding_3$5 = dart.privateName(src__event_details__event_details_component$46template, "_textBinding_3");
  const _textBinding_5$0 = dart.privateName(src__event_details__event_details_component$46template, "_textBinding_5");
  src__event_details__event_details_component$46template._ViewEventDetailsComponent4 = class _ViewEventDetailsComponent4 extends src__core__linker__app_view.AppView$(src__event_details__event_details_component.EventDetailsComponent) {
    ...
    detectChangesInternal() {
      let _ctx = this.ctx;
      this[_textBinding_3$5].updateText(src__runtime__interpolate.interpolateString0(_ctx.messages.storyline));
      this[_textBinding_5$0].updateText(src__runtime__interpolate.interpolateString0(_ctx.event.synopsis));
    }
  };
  ...
  src__event_details__event_details_component$46template._ViewEventDetailsComponent5 = class _ViewEventDetailsComponent5 extends src__core__linker__app_view.AppView$(src__event_details__event_details_component.EventDetailsComponent) {
    build() {
      ...
      this.addShimE(_el_2);
      _el_2[$append](this[_textBinding_3$5].element);
      this[_compView_4$2] = new src__event_details__actor_scroller__actor_scroller_component$46template.ViewActorScrollerComponent0.new(this, 4);
      let _el_4 = this[_compView_4$2].rootEl;
      _el_1[$append](_el_4);
      this.addShimC(_el_4);
      ...
      this[_compView_4$2].create0(this[_ActorScrollerComponent_4_5]);
      this.init1(_el_0);
    }
    detectChangesInternal() {
      let _ctx = this.ctx;
      ...
      this[_textBinding_3$5].updateText(src__runtime__interpolate.interpolateString0(_ctx.messages.cast));
      this[_compView_4$2].detectChanges();
    }
    destroyInternal() {
      this[_compView_4$2].destroyInternalState();
  ...
  dart.setFieldSignature(src__event_details__event_details_component$46template._ViewEventDetailsComponent5, () => ({
    ...
    [_textBinding_3$5]: dart.finalFieldType(src__runtime__text_binding.TextBinding),
    [_compView_4$2]: dart.fieldType(src__event_details__actor_scroller__actor_scroller_component$46template.ViewActorScrollerComponent0),
  ...
  const _appEl_5$ = dart.privateName(src__event_details__event_details_component$46template, "_appEl_5");
  const _NgFor_5_9$ = dart.privateName(src__event_details__event_details_component$46template, "_NgFor_5_9");
  src__event_details__event_details_component$46template._ViewEventDetailsComponent6 = class _ViewEventDetailsComponent6 extends src__core__linker__app_view.AppView$(src__event_details__event_details_component.EventDetailsComponent) {
    build() {
      ...
      let _anchor_5 = src__runtime__dom_helpers.appendAnchor(_el_4);
      this[_appEl_5$] = new src__core__linker__view_container.ViewContainer.new(5, 4, this, _anchor_5);
      let _TemplateRef_5_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_5$], dart.fn(src__event_details__event_details_component$46template.viewFactory_EventDetailsComponent7, AppViewAndintToAppViewOfvoid()));
      this[_NgFor_5_9$] = new src__common__directives__ng_for.NgFor.new(this[_appEl_5$], _TemplateRef_5_8);
      this.init1(_el_0);
    }
    detectChangesInternal() {
      ...
      this[_appEl_5$].detectChangesInNestedViews();
      this[_textBinding_3$5].updateText(src__runtime__interpolate.interpolateString0(_ctx.messages.gallery));
    }
    destroyInternal() {
      this[_appEl_5$].destroyNestedViews();
    }
  ...
  const _compView_0$17 = dart.privateName(src__event_details__event_details_component$46template, "_compView_0");
  ...
  src__event_details__event_details_component$46template._ViewEventDetailsComponentHost0 = class _ViewEventDetailsComponentHost0 extends src__core__linker__app_view.AppView$(src__event_details__event_details_component.EventDetailsComponent) {
    build() {
      this[_compView_0$17] = new src__event_details__event_details_component$46template.ViewEventDetailsComponent0.new(this, 0);
      ...
      this[_compView_0$17].create(this[_EventDetailsComponent_0_5], this.projectedNodes);
      this.init1(this.rootEl);
  ...
  dart.setFieldSignature(src__event_details__event_details_component$46template._ViewEventDetailsComponentHost0, () => ({
    ...
    [_compView_0$17]: dart.fieldType(src__event_details__event_details_component$46template.ViewEventDetailsComponent0),
  ...
  dart.defineLazy(src__routes.RoutePaths, {
    /*src__routes.RoutePaths.vegeNews*/get vegeNews() {
      return new src__route_path.RoutePath.new({path: "/vegenews", useAsDefault: true});
    },
  ...
  const messages$8 = Symbol("NavBarComponent.messages");
  ...
  src__app_bar__scroll_utils.listenForScrollDirectionChanges = function(callback) {
    let previousTop = 0;
    return async.Timer.periodic(const$6 || (const$6 = dart.const(new core$.Duration.new({milliseconds: 250}))), dart.fn(_ => {
  ...
  src__app_bar__search_bar__search_bar_component.SearchBarComponent = class SearchBarComponent extends core$.Object {
    ...
    toggleSearch() {
      ...
      if (dart.test(this.searchOpen)) {
        async.Timer.new(const$7 || (const$7 = dart.const(new core$.Duration.new({milliseconds: 250}))), dart.fn(() => this.searchField.focus(), VoidTovoid()));
      } else {
        this.searchField.value = "";
  ...
  const messages$9 = Symbol("SearchBarComponent.messages");
  ...
  const _store$5 = dart.privateName(src__app_bar__app_bar_component, "_store");
  const _router$3 = dart.privateName(src__app_bar__app_bar_component, "_router");
  ...
  src__app_bar__app_bar_component.AppBarComponent = class AppBarComponent extends core$.Object {
    ...
    get theaterName() {
      return this[_store$5].state.theaterState.currentTheater.name;
    }
    get theaterDropdownVisible() {
    ...
    [_listenForRoutes]() {
      this[_routeListener] = this[_router$3].onRouteActivated.listen(dart.fn(route => {
        let path = route.routePath.path;
        this.isEventDetailsPage = path == src__routes.RoutePaths.eventDetails.path || path == src__routes.RoutePaths.showDetails.path || path == src__routes.RoutePaths.vegeNewsDetails.path;
  ...
  const messages$10 = Symbol("AppBarComponent.messages");
