define(['dart_sdk', 'packages/core/core', 'packages/kt_dart/collection', 'packages/angular/src/core/change_detection/change_detection', 'packages/intl/intl', 'packages/angular/src/bootstrap/modules', 'packages/angular/angular.template', 'packages/angular/src/runtime/text_binding', 'packages/angular/src/runtime/interpolate', 'packages/angular/src/runtime/proxies', 'packages/redux/redux', 'packages/angular_router/angular_router.template', 'packages/angular_components/material_button/material_button.template', 'packages/angular_components/theme/dark_theme', 'packages/angular_components/material_button/material_button', 'packages/angular_components/button_decorator/button_decorator', 'packages/angular_components/interfaces/has_disabled', 'packages/angular_components/angular_components.template', 'packages/angular_router/src/directives/router_outlet_directive', 'packages/angular_components/material_button/material_button_base.template', 'packages/firebase/firebase', 'packages/firebase/src/app'], function(dart_sdk, core, collection, change_detection, intl, modules, angular, text_binding, interpolate, proxies, redux, angular_router, material_button, dark_theme, material_button$, button_decorator, has_disabled, angular_components, router_outlet_directive, material_button_base, firebase, app) {
  ...
  src__common__vegebook_poster__vegebook_poster_component$46template.ViewVegeBookPosterComponent0 = class ViewVegeBookPosterComponent0 extends src__core__linker__app_view.AppView$(src__common__vegebook_poster__vegebook_poster_component.VegeBookPosterComponent) {
    ...
    build() {
      ...
      let _text_4 = src__runtime__dom_helpers.createText("Add post image");
  ...
  (src__vegebook_details__write_vegebook__write_vegebook_component.WriteVegeBookComponent.new = function(store, router, messages) {
    this[vegeBook$1] = new src__models__vegebook.VegeBook.new({id: "", title: "", content: "", images: new src__models__vegebook.VegeBookImageData.new({landscapeBig: null, landscapeSmall: null, portraitSmall: null, portraitMedium: null, portraitLarge: null}), writtenBy: "", writerPhotoUrl: ""});
  ...
  const _compView_5$ = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_compView_5");
  const _AcxDarkTheme_5_5 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_AcxDarkTheme_5_5");
  const _MaterialButtonComponent_5_6 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_MaterialButtonComponent_5_6");
  ...
  const _VegeBookPosterComponent_8_5 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_VegeBookPosterComponent_8_5");
  ...
  src__vegebook_details__write_vegebook__write_vegebook_component$46template._ViewWriteVegeBookComponent1 = class _ViewWriteVegeBookComponent1 extends src__core__linker__app_view.AppView$(src__vegebook_details__write_vegebook__write_vegebook_component.WriteVegeBookComponent) {
    build() {
      ...
      let _el_5 = this[_compView_5$].rootEl;
      this[_el_0$7][$append](_el_5);
      this.updateChildClassNonHtml(_el_5, "blue add-landscape-image");
      src__runtime__dom_helpers.setAttribute(_el_5, "raised", "");
      this.addShimC(_el_5);
      ...
      this[_MaterialButtonComponent_5_6] = new material_button__material_button.MaterialButtonComponent.new(_el_5, theme__dark_theme.AcxDarkTheme._check(this[_AcxDarkTheme_5_5]), this[_compView_5$], null);
      let _text_6 = src__runtime__dom_helpers.createText("Add Landscape image");
      this[_compView_5$].create(this[_MaterialButtonComponent_5_6], JSArrayOfObject().of([JSArrayOfText().of([_text_6])]));
      let _el_7 = src__runtime__dom_helpers.appendDiv(doc, this[_el_0$7]);
      this.updateChildClass(_el_7, "vegebook-header");
      this.addShimC(_el_7);
      this[_compView_8] = new src__common__vegebook_poster__vegebook_poster_component$46template.ViewVegeBookPosterComponent0.new(this, 8);
      let _el_8 = this[_compView_8].rootEl;
      _el_7[$append](_el_8);
      this.addShimC(_el_8);
      this[_VegeBookPosterComponent_8_5] = dart.test(src__runtime__optimizations.isDevMode) ? src__di__errors.debugInjectorWrap(src__common__vegebook_poster__vegebook_poster_component.VegeBookPosterComponent, dart.wrapType(src__common__vegebook_poster__vegebook_poster_component.VegeBookPosterComponent), dart.fn(() => new src__common__vegebook_poster__vegebook_poster_component.VegeBookPosterComponent.new(src__i18n__messages.Messages._check(this.parentView.injectorGet(dart.wrapType(src__i18n__messages.Messages), this.viewData.parentIndex))), VoidToVegeBookPosterComponent())) : new src__common__vegebook_poster__vegebook_poster_component.VegeBookPosterComponent.new(src__i18n__messages.Messages._check(this.parentView.injectorGet(dart.wrapType(src__i18n__messages.Messages), this.viewData.parentIndex)));
      this[_compView_8].create0(this[_VegeBookPosterComponent_8_5]);
      let _el_9 = src__runtime__dom_helpers.appendDiv(doc, _el_7);
      this.updateChildClass(_el_9, "vegebook-information");
      this.addShimC(_el_9);
      let _el_10 = src__runtime__dom_helpers.appendElement(doc, _el_9, "h2");
      this.updateChildClass(html.HtmlElement._check(_el_10), "title");
      this.addShimE(_el_10);
      _el_10[$append](this[_textBinding_11$].element);
      let _el_12 = src__runtime__dom_helpers.appendDiv(doc, _el_9);
      ...
      let _TemplateRef_13_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_13], dart.fn(src__vegebook_details__write_vegebook__write_vegebook_component$46template.viewFactory_WriteVegeBookComponent2, AppViewAndintToAppViewOfvoid()));
      ...
      let _TemplateRef_14_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_14], dart.fn(src__vegebook_details__write_vegebook__write_vegebook_component$46template.viewFactory_WriteVegeBookComponent3, AppViewAndintToAppViewOfvoid()));
    ...
    injectorGetInternal(token, nodeIndex, notFoundResult) {
      ...
      if (5 <= dart.notNull(nodeIndex) && dart.notNull(nodeIndex) <= 6) {
        if (token === dart.wrapType(theme__dark_theme.AcxDarkTheme)) {
    ...
    detectChangesInternal() {
      ...
      changed = false;
      if (firstCheck) {
        this[_MaterialButtonComponent_5_6].raised = true;
        changed = true;
      }
      if (changed) {
      ...
      if (firstCheck) {
        this[_VegeBookPosterComponent_8_5].hasDetails = false;
        this[_VegeBookPosterComponent_8_5].isTouchable = false;
      }
      let currVal_4 = _ctx.vegeBook;
      if (dart.test(src__core__linker__app_view_utils.checkBinding(this[_expr_4$], currVal_4))) {
        this[_VegeBookPosterComponent_8_5].vegeBook = currVal_4;
        this[_expr_4$] = currVal_4;
      }
      ...
      this[_textBinding_11$].updateText(src__runtime__interpolate.interpolateString0(_ctx.vegeBook.title));
  ...
  (src__vegebook_details__write_vegebook__write_vegebook_component$46template._ViewWriteVegeBookComponent1.new = function(parentView, parentIndex) {
    ...
    this[_VegeBookPosterComponent_8_5] = null;
    this[_appEl_13] = null;
  ...
  dart.setFieldSignature(src__vegebook_details__write_vegebook__write_vegebook_component$46template._ViewWriteVegeBookComponent1, () => ({
    ...
    [_compView_8]: dart.fieldType(src__common__vegebook_poster__vegebook_poster_component$46template.ViewVegeBookPosterComponent0),
    [_VegeBookPosterComponent_8_5]: dart.fieldType(src__common__vegebook_poster__vegebook_poster_component.VegeBookPosterComponent),
  ...
  const _textBinding_3$6 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_textBinding_3");
  src__vegebook_details__write_vegebook__write_vegebook_component$46template._ViewWriteVegeBookComponent3 = class _ViewWriteVegeBookComponent3 extends src__core__linker__app_view.AppView$(src__vegebook_details__write_vegebook__write_vegebook_component.WriteVegeBookComponent) {
    ...
    detectChangesInternal() {
      let _ctx = this.ctx;
      this[_textBinding_3$6].updateText(src__runtime__interpolate.interpolateString0(_ctx.vegeBook.content));
    }
  };
  ...
  const _textBinding_3$7 = dart.privateName(src__vegebook__vegebook_page_component$46template, "_textBinding_3");
  ...
  const _compView_5$0 = dart.privateName(src__vegebook__vegebook_page_component$46template, "_compView_5");
  ...
  src__vegebook__vegebook_page_component$46template.ViewVegeBookPageComponent0 = class ViewVegeBookPageComponent0 extends src__core__linker__app_view.AppView$(src__vegebook__vegebook_page_component.VegeBookPageComponent) {
    ...
    build() {
      ...
      this.init(const$12 || (const$12 = dart.constList([], core$.Object)), JSArrayOfStreamSubscriptionOfvoid().of([subscription_0]));
    }
    detectChangesInternal() {
      let _ctx = this.ctx;
      this[_NgIf_4_9$0].ngIf = !dart.test(_ctx.isAuthenticated());
      ...
      this[_appEl_7$].detectChangesInNestedViews();
      this[_textBinding_3$7].updateText(src__runtime__interpolate.interpolateString0(_ctx.VegeBookTitle));
  ...
  const _textBinding_3$8 = dart.privateName(src__events__events_page_component$46template, "_textBinding_3");
  ...
  const _compView_5$1 = dart.privateName(src__events__events_page_component$46template, "_compView_5");
  ...
  src__events__events_page_component$46template.ViewEventsPageComponent0 = class ViewEventsPageComponent0 extends src__core__linker__app_view.AppView$(src__events__events_page_component.EventsPageComponent) {
    ...
    build() {
      ...
      this[_compView_5$1] = new src__common__loading_view__loading_view_component$46template.ViewLoadingViewComponent0.new(this, 5);
      let _el_5 = this[_compView_5$1].rootEl;
      _el_0[$append](_el_5);
      this.addShimC(_el_5);
      this[_LoadingViewComponent_5_5$] = dart.test(src__runtime__optimizations.isDevMode) ? src__di__errors.debugInjectorWrap(src__common__loading_view__loading_view_component.LoadingViewComponent, dart.wrapType(src__common__loading_view__loading_view_component.LoadingViewComponent), dart.fn(() => new src__common__loading_view__loading_view_component.LoadingViewComponent.new(src__i18n__messages.Messages._check(this.parentView.injectorGet(dart.wrapType(src__i18n__messages.Messages), this.viewData.parentIndex))), VoidToLoadingViewComponent())) : new src__common__loading_view__loading_view_component.LoadingViewComponent.new(src__i18n__messages.Messages._check(this.parentView.injectorGet(dart.wrapType(src__i18n__messages.Messages), this.viewData.parentIndex)));
      let _el_6 = doc[$createElement]("div");
      ...
      this[_compView_5$1].create(this[_LoadingViewComponent_5_5$], JSArrayOfObject().of([JSArrayOfElement().of([_el_6])]));
      let subscription_0 = this[_LoadingViewComponent_5_5$].actionButtonClicked.listen(this.eventHandler1(dart.dynamic, dart.dynamic, dart.bind(this, _handle_actionButtonClicked_5_0$)));
      this.init(const$15 || (const$15 = dart.constList([], core$.Object)), JSArrayOfStreamSubscriptionOfvoid().of([subscription_0]));
    }
    detectChangesInternal() {
      let _ctx = this.ctx;
      ...
      this[_textBinding_3$8].updateText(src__runtime__interpolate.interpolateString0(_ctx.eventTypeTitle));
      this[_compView_4$2].detectChanges();
      this[_compView_5$1].detectChanges();
    }
    destroyInternal() {
      this[_appEl_4$2].destroyNestedViews();
      this[_appEl_7$0].destroyNestedViews();
      this[_compView_4$2].destroyInternalState();
      this[_compView_5$1].destroyInternalState();
      this[_LoadingViewComponent_5_5$].ngOnDestroy();
    }
    [_handle_actionButtonClicked_5_0$]($event) {
      let _ctx = this.ctx;
  ...
  dart.setFieldSignature(src__events__events_page_component$46template.ViewEventsPageComponent0, () => ({
    ...
    [_TheaterSelectorComponent_4_8$]: dart.fieldType(src__common__theater_selector__theater_selector_component.TheaterSelectorComponent),
    [_compView_5$1]: dart.fieldType(src__common__loading_view__loading_view_component$46template.ViewLoadingViewComponent0),
    [_LoadingViewComponent_5_5$]: dart.fieldType(src__common__loading_view__loading_view_component.LoadingViewComponent),
  ...
  const _textBinding_3$9 = dart.privateName(src__event_details__event_details_component$46template, "_textBinding_3");
  ...
  src__event_details__event_details_component$46template._ViewEventDetailsComponent4 = class _ViewEventDetailsComponent4 extends src__core__linker__app_view.AppView$(src__event_details__event_details_component.EventDetailsComponent) {
    build() {
      ...
      let _el_2 = src__runtime__dom_helpers.appendElement(doc, _el_1, "h3");
      this.addShimE(_el_2);
      _el_2[$append](this[_textBinding_3$9].element);
      let _el_4 = src__runtime__dom_helpers.appendElement(doc, _el_1, "p");
    ...
    detectChangesInternal() {
      let _ctx = this.ctx;
      this[_textBinding_3$9].updateText(src__runtime__interpolate.interpolateString0(_ctx.messages.storyline));
  ...
  (src__event_details__event_details_component$46template._ViewEventDetailsComponent4.new = function(parentView, parentIndex) {
    this[_textBinding_3$9] = new src__runtime__text_binding.TextBinding.new();
  ...
  dart.setFieldSignature(src__event_details__event_details_component$46template._ViewEventDetailsComponent4, () => ({
    ...
    [_textBinding_3$9]: dart.finalFieldType(src__runtime__text_binding.TextBinding),
  ...
  src__event_details__event_details_component$46template._ViewEventDetailsComponent5 = class _ViewEventDetailsComponent5 extends src__core__linker__app_view.AppView$(src__event_details__event_details_component.EventDetailsComponent) {
    ...
    detectChangesInternal() {
      ...
      this[_textBinding_3$9].updateText(src__runtime__interpolate.interpolateString0(_ctx.messages.cast));
      this[_compView_4$3].detectChanges();
    }
    destroyInternal() {
      this[_compView_4$3].destroyInternalState();
  ...
  src__event_details__event_details_component$46template._ViewEventDetailsComponent6 = class _ViewEventDetailsComponent6 extends src__core__linker__app_view.AppView$(src__event_details__event_details_component.EventDetailsComponent) {
    ...
    detectChangesInternal() {
      ...
      this[_textBinding_3$9].updateText(src__runtime__interpolate.interpolateString0(_ctx.messages.gallery));
    }
    destroyInternal() {
  ...
  src__app_bar__scroll_utils.listenForScrollDirectionChanges = function(callback) {
    let previousTop = 0;
    return async.Timer.periodic(const$16 || (const$16 = dart.const(new core$.Duration.new({milliseconds: 250}))), dart.fn(_ => {
  ...
  src__app_bar__search_bar__search_bar_component.SearchBarComponent = class SearchBarComponent extends core$.Object {
    ...
    toggleSearch() {
      ...
      if (dart.test(this.searchOpen)) {
        async.Timer.new(const$17 || (const$17 = dart.const(new core$.Duration.new({milliseconds: 250}))), dart.fn(() => this.searchField.focus(), VoidTovoid()));
      } else {
        this.searchField.value = "";
