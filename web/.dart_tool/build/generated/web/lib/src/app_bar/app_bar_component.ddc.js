define(['dart_sdk', 'packages/core/core', 'packages/kt_dart/collection', 'packages/angular/src/core/change_detection/change_detection', 'packages/intl/intl', 'packages/angular/src/bootstrap/modules', 'packages/angular/angular.template', 'packages/angular/src/runtime/text_binding', 'packages/angular/src/runtime/interpolate', 'packages/angular/src/runtime/proxies', 'packages/redux/redux', 'packages/angular_router/angular_router.template', 'packages/angular_router/src/directives/router_outlet_directive'], function(dart_sdk, core, collection, change_detection, intl, modules, angular, text_binding, interpolate, proxies, redux, angular_router, router_outlet_directive) {
  ...
  const _expr_0$8 = dart.privateName(src__showtimes__date_selector_component$46template, "_expr_0");
  ...
  const _textBinding_2$ = dart.privateName(src__showtimes__date_selector_component$46template, "_textBinding_2");
  const _textBinding_4$1 = dart.privateName(src__showtimes__date_selector_component$46template, "_textBinding_4");
  ...
  const _el_0$2 = dart.privateName(src__showtimes__date_selector_component$46template, "_el_0");
  ...
  src__showtimes__date_selector_component$46template._ViewDateSelectorComponent1 = class _ViewDateSelectorComponent1 extends src__core__linker__app_view.AppView$(src__showtimes__date_selector_component.DateSelectorComponent) {
    build() {
      let doc = html.document;
      this[_el_0$2] = html.DivElement._check(doc[$createElement]("div"));
      this.updateChildClass(this[_el_0$2], "date-item");
      this.addShimC(this[_el_0$2]);
      let _el_1 = src__runtime__dom_helpers.appendElement(doc, this[_el_0$2], "p");
      this.updateChildClass(html.HtmlElement._check(_el_1), "dayname");
      this.addShimE(_el_1);
      _el_1[$append](this[_textBinding_2$].element);
      let _el_3 = src__runtime__dom_helpers.appendElement(doc, this[_el_0$2], "p");
      this.updateChildClass(html.HtmlElement._check(_el_3), "day");
      this.addShimE(_el_3);
      _el_3[$append](this[_textBinding_4$1].element);
      this[_el_0$2][$addEventListener]("click", this.eventHandler1(html.Event, html.Event, dart.bind(this, _handle_click_0_0$)));
    ...
    detectChangesInternal() {
      ...
      if (dart.test(src__core__linker__app_view_utils.checkBinding(this[_expr_0$8], currVal_0))) {
        src__runtime__dom_helpers.updateClassBinding(this[_el_0$2], "selected", currVal_0);
        this[_expr_0$8] = currVal_0;
      }
      this[_textBinding_2$].updateText(core$.String._check(src__runtime__interpolate.interpolate0(this[_pipe_date_0_0$](local_date, "E"))));
      this[_textBinding_4$1].updateText(core$.String._check(src__runtime__interpolate.interpolate0(this[_pipe_date_0_1$](local_date, "d"))));
    }
    [_handle_click_0_0$]($event) {
      let local_date = src__runtime__optimizations.unsafeCast(core$.DateTime, this.locals[$_get]("$implicit"));
      let _ctx = this.ctx;
  ...
  dart.setFieldSignature(src__showtimes__date_selector_component$46template._ViewDateSelectorComponent1, () => ({
    ...
    [_expr_0$8]: dart.fieldType(core$.bool),
    [_pipe_date_0_0$]: dart.fieldType(dynamicAndStringToString()),
    [_pipe_date_0_1$]: dart.fieldType(dynamicAndStringToString()),
  ...
  const _compView_0$9 = dart.privateName(src__showtimes__date_selector_component$46template, "_compView_0");
  ...
  src__showtimes__date_selector_component$46template._ViewDateSelectorComponentHost0 = class _ViewDateSelectorComponentHost0 extends src__core__linker__app_view.AppView$(src__showtimes__date_selector_component.DateSelectorComponent) {
    build() {
      this[_compView_0$9] = new src__showtimes__date_selector_component$46template.ViewDateSelectorComponent0.new(this, 0);
      ...
      this[_compView_0$9].create(this[_DateSelectorComponent_0_5], this.projectedNodes);
      this.init1(this.rootEl);
  ...
  dart.setFieldSignature(src__showtimes__date_selector_component$46template._ViewDateSelectorComponentHost0, () => ({
    ...
    [_compView_0$9]: dart.fieldType(src__showtimes__date_selector_component$46template.ViewDateSelectorComponent0),
  ...
  const messages$2 = Symbol("ShowtimesPageComponent.messages");
  ...
  const _textBinding_3$0 = dart.privateName(src__showtimes__showtimes_page_component$46template, "_textBinding_3");
  const _compView_4 = dart.privateName(src__showtimes__showtimes_page_component$46template, "_compView_4");
  const _appEl_4$ = dart.privateName(src__showtimes__showtimes_page_component$46template, "_appEl_4");
  ...
  const _expr_0$9 = dart.privateName(src__showtimes__showtimes_page_component$46template, "_expr_0");
  const _expr_1$3 = dart.privateName(src__showtimes__showtimes_page_component$46template, "_expr_1");
  ...
  src__showtimes__showtimes_page_component$46template.ViewShowtimesPageComponent0 = class ViewShowtimesPageComponent0 extends src__core__linker__app_view.AppView$(src__showtimes__showtimes_page_component.ShowtimesPageComponent) {
    ...
    build() {
      ...
      _el_1[$append](_el_4);
      this.addShimC(_el_4);
      this[_appEl_4$] = new src__core__linker__view_container.ViewContainer.new(4, 1, this, _el_4);
      this[_TheaterSelectorComponent_4_8] = dart.test(src__runtime__optimizations.isDevMode) ? src__di__errors.debugInjectorWrap(src__common__theater_selector__theater_selector_component.TheaterSelectorComponent, dart.wrapType(src__common__theater_selector__theater_selector_component.TheaterSelectorComponent), dart.fn(() => new src__common__theater_selector__theater_selector_component.TheaterSelectorComponent.new(StoreOfAppState()._check(this.parentView.injectorGet(dart.wrapType(src__store.Store), this.viewData.parentIndex)), this[_appEl_4$]), VoidToTheaterSelectorComponent())) : new src__common__theater_selector__theater_selector_component.TheaterSelectorComponent.new(StoreOfAppState()._check(this.parentView.injectorGet(dart.wrapType(src__store.Store), this.viewData.parentIndex)), this[_appEl_4$]);
      ...
      this.init(const$2 || (const$2 = dart.constList([], core$.Object)), JSArrayOfStreamSubscriptionOfvoid().of([subscription_0]));
    }
    detectChangesInternal() {
      let _ctx = this.ctx;
      ...
      this[_textBinding_3$0].updateText(src__runtime__interpolate.interpolateString0(_ctx.messages.showtimes));
  ...
  const _compView_0$10 = dart.privateName(src__showtimes__showtimes_page_component$46template, "_compView_0");
  ...
  src__showtimes__showtimes_page_component$46template._ViewShowtimesPageComponent1 = class _ViewShowtimesPageComponent1 extends src__core__linker__app_view.AppView$(src__showtimes__showtimes_page_component.ShowtimesPageComponent) {
    build() {
      this[_compView_0$10] = new src__common__showtime_item__showtime_item_component$46template.ViewShowtimeItemComponent0.new(this, 0);
      ...
      this[_compView_0$10].create0(this[_ShowtimeItemComponent_0_5$]);
  ...
  dart.setFieldSignature(src__showtimes__showtimes_page_component$46template._ViewShowtimesPageComponent1, () => ({
    ...
    [_compView_0$10]: dart.fieldType(src__common__showtime_item__showtime_item_component$46template.ViewShowtimeItemComponent0),
    [_ShowtimeItemComponent_0_5$]: dart.fieldType(src__common__showtime_item__showtime_item_component.ShowtimeItemComponent),
    [_expr_0$9]: dart.fieldType(dart.dynamic)
  }));
  ...
  src__showtimes__showtimes_page_component$46template._ViewShowtimesPageComponentHost0 = class _ViewShowtimesPageComponentHost0 extends src__core__linker__app_view.AppView$(src__showtimes__showtimes_page_component.ShowtimesPageComponent) {
    build() {
      this[_compView_0$10] = new src__showtimes__showtimes_page_component$46template.ViewShowtimesPageComponent0.new(this, 0);
      ...
      this[_compView_0$10].create(this[_ShowtimesPageComponent_0_5], this.projectedNodes);
      this.init1(this.rootEl);
  ...
  dart.setFieldSignature(src__showtimes__showtimes_page_component$46template._ViewShowtimesPageComponentHost0, () => ({
    ...
    [_compView_0$10]: dart.fieldType(src__showtimes__showtimes_page_component$46template.ViewShowtimesPageComponent0),
  ...
  const _store$1 = dart.privateName(src__events__events_page_component, "_store");
  const _router$ = dart.privateName(src__events__events_page_component, "_router");
  ...
  src__events__events_page_component.EventsPageComponent = class EventsPageComponent extends core$.Object {
    ...
    get viewModel() {
      return src__viewmodels__events_page_view_model.EventsPageViewModel.fromStore(this[_store$1], this[_listType]);
    }
    get eventTypeTitle() {
    ...
    onActivate(previous, current) {
      ...
      if (this[_listType] === src__models__event.EventListType.comingSoon) {
        this[_store$1].dispatch(new src__redux___common__common_actions.FetchComingSoonEventsIfNotLoadedAction.new());
      }
    }
  ...
  const messages$3 = Symbol("EventsPageComponent.messages");
  ...
  const _textBinding_3$1 = dart.privateName(src__events__events_page_component$46template, "_textBinding_3");
  const _compView_4$ = dart.privateName(src__events__events_page_component$46template, "_compView_4");
  const _appEl_4$0 = dart.privateName(src__events__events_page_component$46template, "_appEl_4");
  ...
  const _expr_0$10 = dart.privateName(src__events__events_page_component$46template, "_expr_0");
  const _expr_1$4 = dart.privateName(src__events__events_page_component$46template, "_expr_1");
  const _expr_2$1 = dart.privateName(src__events__events_page_component$46template, "_expr_2");
  const _expr_3$0 = dart.privateName(src__events__events_page_component$46template, "_expr_3");
  ...
  src__events__events_page_component$46template.ViewEventsPageComponent0 = class ViewEventsPageComponent0 extends src__core__linker__app_view.AppView$(src__events__events_page_component.EventsPageComponent) {
    ...
    detectChangesInternal() {
      ...
      this[_appEl_7$].detectChangesInNestedViews();
      this[_textBinding_3$1].updateText(src__runtime__interpolate.interpolateString0(_ctx.eventTypeTitle));
      this[_compView_4$].detectChanges();
      this[_compView_5$].detectChanges();
    }
    destroyInternal() {
  ...
  const _compView_0$11 = dart.privateName(src__events__events_page_component$46template, "_compView_0");
  const _EventPosterComponent_0_5$ = dart.privateName(src__events__events_page_component$46template, "_EventPosterComponent_0_5");
  const _handle_click_0_0$1 = dart.privateName(src__events__events_page_component$46template, "_handle_click_0_0");
  src__events__events_page_component$46template._ViewEventsPageComponent1 = class _ViewEventsPageComponent1 extends src__core__linker__app_view.AppView$(src__events__events_page_component.EventsPageComponent) {
    build() {
      this[_compView_0$11] = new src__common__event_poster__event_poster_component$46template.ViewEventPosterComponent0.new(this, 0);
      let _el_0 = this[_compView_0$11].rootEl;
      this.addShimC(_el_0);
      ...
      this[_compView_0$11].create0(this[_EventPosterComponent_0_5$]);
  ...
  dart.setFieldSignature(src__events__events_page_component$46template._ViewEventsPageComponent1, () => ({
    ...
    [_compView_0$11]: dart.fieldType(src__common__event_poster__event_poster_component$46template.ViewEventPosterComponent0),
    [_EventPosterComponent_0_5$]: dart.fieldType(src__common__event_poster__event_poster_component.EventPosterComponent),
    [_expr_0$10]: dart.fieldType(dart.dynamic),
    [_expr_1$4]: dart.fieldType(core$.bool)
  }));
  ...
  src__events__events_page_component$46template._ViewEventsPageComponentHost0 = class _ViewEventsPageComponentHost0 extends src__core__linker__app_view.AppView$(src__events__events_page_component.EventsPageComponent) {
    build() {
      this[_compView_0$11] = new src__events__events_page_component$46template.ViewEventsPageComponent0.new(this, 0);
      ...
      this[_compView_0$11].create(this[_EventsPageComponent_0_5], this.projectedNodes);
      this.init1(this.rootEl);
  ...
  dart.setFieldSignature(src__events__events_page_component$46template._ViewEventsPageComponentHost0, () => ({
    ...
    [_compView_0$11]: dart.fieldType(src__events__events_page_component$46template.ViewEventsPageComponent0),
  ...
  const _store$2 = dart.privateName(src__event_details__event_details_component, "_store");
  const _router$0 = dart.privateName(src__event_details__event_details_component, "_router");
  ...
  src__event_details__event_details_component.EventDetailsComponent = class EventDetailsComponent extends core$.Object {
    ...
    [_populateEventDetails](eventId, showId) {
      this.event = src__redux__event__event_selectors.eventByIdSelector(this[_store$2].state, eventId);
      this.show = src__redux__show__show_selectors.showByIdSelector(this[_store$2].state, showId);
      if (this.show != null) {
        let t = this.event;
        t == null ? this.event = src__redux__event__event_selectors.eventForShowSelector(this[_store$2].state, this.show) : t;
      }
      if (this.event != null) {
        this[_store$2].dispatch(new src__redux__actor__actor_actions.FetchActorAvatarsAction.new(this.event));
        this[_animateContentIntoView]();
      } else {
        this[_store$2].dispatch(new src__redux__event__event_actions.RefreshEventsAction.new(src__models__event.EventListType.nowInTheaters));
        this[_store$2].dispatch(new src__redux__event__event_actions.RefreshEventsAction.new(src__models__event.EventListType.comingSoon));
        this[_waitForEventDetails](eventId, showId);
      }
    }
    [_waitForEventDetails](eventId, showId) {
      let state = this[_store$2].state.eventState;
      ...
      this[_eventDetailsSubscription] = this[_store$2].onChange.listen(dart.fn(state => {
        {
          let state = this[_store$2].state.eventState;
    ...
    goBack() {
      ...
      this[_router$0].navigateByUrl(src__routes.RoutePaths.nowInTheaters.toUrl(), {replace: true});
    }
  };
  ...
  const messages$4 = Symbol("EventDetailsComponent.messages");
  ...
  const _compView_4$0 = dart.privateName(src__event_details__event_details_component$46template, "_compView_4");
  ...
  const _expr_0$11 = dart.privateName(src__event_details__event_details_component$46template, "_expr_0");
  const _expr_1$5 = dart.privateName(src__event_details__event_details_component$46template, "_expr_1");
  const _expr_2$2 = dart.privateName(src__event_details__event_details_component$46template, "_expr_2");
  const _expr_6 = dart.privateName(src__event_details__event_details_component$46template, "_expr_6");
  const _el_0$3 = dart.privateName(src__event_details__event_details_component$46template, "_el_0");
  src__event_details__event_details_component$46template._ViewEventDetailsComponent1 = class _ViewEventDetailsComponent1 extends src__core__linker__app_view.AppView$(src__event_details__event_details_component.EventDetailsComponent) {
    build() {
      ...
      this.updateChildClass(this[_el_0$3], "container");
      ...
      let _el_2 = src__runtime__dom_helpers.appendElement(doc, this[_el_0$3], "img");
      this.updateChildClass(html.HtmlElement._check(_el_2), "back");
      src__runtime__dom_helpers.setAttribute(_el_2, "src", "images/back.svg");
      this.addShimE(_el_2);
      let _el_3 = src__runtime__dom_helpers.appendDiv(doc, this[_el_0$3]);
      this.updateChildClass(_el_3, "event-header");
      this.addShimC(_el_3);
      this[_compView_4$0] = new src__common__event_poster__event_poster_component$46template.ViewEventPosterComponent0.new(this, 4);
      ...
      this[_compView_4$0].create0(this[_EventPosterComponent_4_5]);
      ...
      let _anchor_14 = src__runtime__dom_helpers.appendAnchor(this[_el_0$3]);
      ...
      let _anchor_15 = src__runtime__dom_helpers.appendAnchor(this[_el_0$3]);
      ...
      let _anchor_16 = src__runtime__dom_helpers.appendAnchor(this[_el_0$3]);
      ...
      let _anchor_17 = src__runtime__dom_helpers.appendAnchor(this[_el_0$3]);
    ...
    detectChangesInternal() {
      ...
      if (dart.test(src__core__linker__app_view_utils.checkBinding(this[_expr_0$11], currVal_0))) {
        src__runtime__dom_helpers.updateClassBinding(this[_el_0$3], "visible", currVal_0);
  ...
  dart.setFieldSignature(src__event_details__event_details_component$46template._ViewEventDetailsComponent1, () => ({
    ...
    [_compView_4$0]: dart.fieldType(src__common__event_poster__event_poster_component$46template.ViewEventPosterComponent0),
  ...
  const _textBinding_2$0 = dart.privateName(src__event_details__event_details_component$46template, "_textBinding_2");
  const _textBinding_4$2 = dart.privateName(src__event_details__event_details_component$46template, "_textBinding_4");
  src__event_details__event_details_component$46template._ViewEventDetailsComponent2 = class _ViewEventDetailsComponent2 extends src__core__linker__app_view.AppView$(src__event_details__event_details_component.EventDetailsComponent) {
    build() {
      ...
      _el_0[$append](this[_textBinding_4$2].element);
      this.init1(_el_0);
    }
    detectChangesInternal() {
      let _ctx = this.ctx;
      this[_textBinding_2$0].updateText(src__runtime__interpolate.interpolateString0(_ctx.messages.director));
      this[_textBinding_4$2].updateText(src__runtime__interpolate.interpolateString0(_ctx.event.director));
    }
  };
  ...
  const _textBinding_3$2 = dart.privateName(src__event_details__event_details_component$46template, "_textBinding_3");
  const _textBinding_5$ = dart.privateName(src__event_details__event_details_component$46template, "_textBinding_5");
  src__event_details__event_details_component$46template._ViewEventDetailsComponent4 = class _ViewEventDetailsComponent4 extends src__core__linker__app_view.AppView$(src__event_details__event_details_component.EventDetailsComponent) {
    ...
    detectChangesInternal() {
      let _ctx = this.ctx;
      this[_textBinding_3$2].updateText(src__runtime__interpolate.interpolateString0(_ctx.messages.storyline));
      this[_textBinding_5$].updateText(src__runtime__interpolate.interpolateString0(_ctx.event.synopsis));
    }
  };
  ...
  src__event_details__event_details_component$46template._ViewEventDetailsComponent5 = class _ViewEventDetailsComponent5 extends src__core__linker__app_view.AppView$(src__event_details__event_details_component.EventDetailsComponent) {
    build() {
      ...
      this.addShimE(_el_2);
      _el_2[$append](this[_textBinding_3$2].element);
      this[_compView_4$0] = new src__event_details__actor_scroller__actor_scroller_component$46template.ViewActorScrollerComponent0.new(this, 4);
      let _el_4 = this[_compView_4$0].rootEl;
      _el_1[$append](_el_4);
      this.addShimC(_el_4);
      ...
      this[_compView_4$0].create0(this[_ActorScrollerComponent_4_5]);
      this.init1(_el_0);
    }
    detectChangesInternal() {
      let _ctx = this.ctx;
      ...
      this[_textBinding_3$2].updateText(src__runtime__interpolate.interpolateString0(_ctx.messages.cast));
      this[_compView_4$0].detectChanges();
    }
    destroyInternal() {
      this[_compView_4$0].destroyInternalState();
  ...
  dart.setFieldSignature(src__event_details__event_details_component$46template._ViewEventDetailsComponent5, () => ({
    ...
    [_textBinding_3$2]: dart.finalFieldType(src__runtime__text_binding.TextBinding),
    [_compView_4$0]: dart.fieldType(src__event_details__actor_scroller__actor_scroller_component$46template.ViewActorScrollerComponent0),
  ...
  src__event_details__event_details_component$46template._ViewEventDetailsComponent7 = class _ViewEventDetailsComponent7 extends src__core__linker__app_view.AppView$(src__event_details__event_details_component.EventDetailsComponent) {
    ...
    detectChangesInternal() {
      ...
      if (dart.test(src__core__linker__app_view_utils.checkBinding(this[_expr_0$11], currVal_0))) {
        src__runtime__dom_helpers.setProperty(this[_el_0$3], "src", src__core__linker__app_view_utils.appViewUtils.sanitizer.sanitizeUrl(currVal_0));
        this[_expr_0$11] = currVal_0;
      }
  ...
  const _compView_0$12 = dart.privateName(src__event_details__event_details_component$46template, "_compView_0");
  ...
  src__event_details__event_details_component$46template._ViewEventDetailsComponentHost0 = class _ViewEventDetailsComponentHost0 extends src__core__linker__app_view.AppView$(src__event_details__event_details_component.EventDetailsComponent) {
    build() {
      this[_compView_0$12] = new src__event_details__event_details_component$46template.ViewEventDetailsComponent0.new(this, 0);
      ...
      this[_compView_0$12].create(this[_EventDetailsComponent_0_5], this.projectedNodes);
      this.init1(this.rootEl);
  ...
  dart.setFieldSignature(src__event_details__event_details_component$46template._ViewEventDetailsComponentHost0, () => ({
    ...
    [_compView_0$12]: dart.fieldType(src__event_details__event_details_component$46template.ViewEventDetailsComponent0),
  ...
  dart.defineLazy(src__routes.RoutePaths, {
    /*src__routes.RoutePaths.nowInTheaters*/get nowInTheaters() {
      return new src__route_path.RoutePath.new({path: "/", additionalData: src__models__event.EventListType.nowInTheaters, useAsDefault: true});
    },
  ...
  const messages$5 = Symbol("NavBarComponent.messages");
  ...
  src__app_bar__scroll_utils.listenForScrollDirectionChanges = function(callback) {
    let previousTop = 0;
    return async.Timer.periodic(const$4 || (const$4 = dart.const(new core$.Duration.new({milliseconds: 250}))), dart.fn(_ => {
  ...
  src__app_bar__search_bar__search_bar_component.SearchBarComponent = class SearchBarComponent extends core$.Object {
    ...
    toggleSearch() {
      ...
      if (dart.test(this.searchOpen)) {
        async.Timer.new(const$5 || (const$5 = dart.const(new core$.Duration.new({milliseconds: 250}))), dart.fn(() => this.searchField.focus(), VoidTovoid()));
      } else {
        this.searchField.value = "";
  ...
  const messages$6 = Symbol("SearchBarComponent.messages");
  ...
  const _store$3 = dart.privateName(src__app_bar__app_bar_component, "_store");
  const _router$1 = dart.privateName(src__app_bar__app_bar_component, "_router");
  ...
  src__app_bar__app_bar_component.AppBarComponent = class AppBarComponent extends core$.Object {
    ...
    get theaterName() {
      return this[_store$3].state.theaterState.currentTheater.name;
    }
    get theaterDropdownVisible() {
    ...
    [_listenForRoutes]() {
      this[_routeListener] = this[_router$1].onRouteActivated.listen(dart.fn(route => {
  ...
  const messages$7 = Symbol("AppBarComponent.messages");
