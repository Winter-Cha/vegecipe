define(['dart_sdk', 'packages/core/core', 'packages/kt_dart/collection', 'packages/angular/src/core/change_detection/change_detection', 'packages/intl/intl', 'packages/angular/src/bootstrap/modules', 'packages/angular/angular.template', 'packages/angular/src/runtime/text_binding', 'packages/angular/src/runtime/interpolate', 'packages/angular/src/runtime/proxies', 'packages/redux/redux', 'packages/angular_router/angular_router.template', 'packages/angular_components/angular_components.template', 'packages/angular_router/src/directives/router_outlet_directive', 'packages/firebase/firebase', 'packages/firebase/src/app', 'packages/angular_components/material_button/material_button.template', 'packages/angular_components/theme/dark_theme', 'packages/angular_components/material_button/material_button', 'packages/angular_components/material_input/material_input.template', 'packages/angular_components/material_input/material_input', 'packages/angular_components/material_input/deferred_validator', 'packages/angular_forms/src/directives', 'packages/angular_components/material_input/material_input_default_value_accessor', 'packages/angular_quill/angular_quill.template', 'packages/angular_quill/src/quill/quill', 'packages/angular_components/button_decorator/button_decorator', 'packages/angular_components/interfaces/has_disabled', 'packages/angular_components/material_input/base_material_input', 'packages/angular_components/utils/angular/reference/reference', 'packages/angular_components/focus/focus_interface', 'packages/angular_components/material_datepicker/proto/date.pb.template', 'packages/angular_forms/angular_forms.template'], function(dart_sdk, core, collection, change_detection, intl, modules, angular, text_binding, interpolate, proxies, redux, angular_router, angular_components, router_outlet_directive, firebase, app, material_button, dark_theme, material_button$, material_input, material_input$, deferred_validator, directives, material_input_default_value_accessor, angular_quill, quill, button_decorator, has_disabled, base_material_input, reference, focus_interface, date$46pb, angular_forms) {
  ...
  const _el_2 = dart.privateName(src__vegebook_details__vegebook_details_component$46template, "_el_2");
  ...
  src__vegebook_details__write_vegebook__write_vegebook_component.WriteVegeBookComponent = class WriteVegeBookComponent extends core$.Object {
    ...
    onActivate(previous, current) {
      ...
      this.writer = t == null ? null : t.displayName;
    ...
    submit() {
      return async.async(dart.dynamic, (function* submit() {
        ...
        try {
          ...
          landscapeBig = dart.toString(dowurl);
        ...
        try {
          ...
          task.onStateChanged.listen(dart.fn(_ => this.loading = true, UploadTaskSnapshotTobool()), {onDone: dart.fn(() => this.loading = false, VoidTobool())});
          let dowurl = (yield (yield task.future).ref.getDownloadURL());
          portraitMedium = dart.toString(dowurl);
          core$.print(" url p " + dart.str(dart.toString(dowurl)));
        } catch (e$0) {
          let e = dart.getThrown(e$0);
          core$.print("Error in uploading to storage: " + dart.str(e));
        }
        let vegeBook = new src__models__vegebook.VegeBook.new({id: "", title: "", content: "", images: new src__models__vegebook.VegeBookImageData.new({landscapeBig: landscapeBig, landscapeSmall: null, portraitSmall: null, portraitMedium: portraitMedium, portraitLarge: null}), writtenBy: (() => {
            let t = src__top_level.auth().currentUser;
        ...
        let vegeBookMap = new (IdentityMapOfString$Object()).from(["id", doc.id, "images", new (IdentityMapOfString$String()).from(["landscapeBig", vegeBook.images.landscapeBig, "portraitMedium", vegeBook.images.portraitMedium]), "content", this.htmlStr, "title", this.title, "writtenBy", vegeBook.writtenBy, "writerPhotoUrl", vegeBook.writerPhotoUrl, "reportingDate", new core$.DateTime.now()]);
  ...
  const writer = Symbol("WriteVegeBookComponent.writer");
  ...
  dart.setFieldSignature(src__vegebook_details__write_vegebook__write_vegebook_component.WriteVegeBookComponent, () => ({
    ...
    writer: dart.fieldType(core$.String),
  ...
  const _textBinding_24 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_textBinding_24");
  const _textBinding_26 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_textBinding_26");
  ...
  const _compView_29 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_compView_29");
  const _QuillComponent_29_5 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_QuillComponent_29_5");
  const _QuillValueAccessor_29_6 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_QuillValueAccessor_29_6");
  const _NgValueAccessor_29_7 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_NgValueAccessor_29_7");
  const _NgModel_29_8 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_NgModel_29_8");
  ...
  const _handle_ngModelChange_29_2 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_handle_ngModelChange_29_2");
  let const$14;
  let const$15;
  let const$16;
  src__vegebook_details__write_vegebook__write_vegebook_component$46template.ViewWriteVegeBookComponent0 = class ViewWriteVegeBookComponent0 extends src__core__linker__app_view.AppView$(src__vegebook_details__write_vegebook__write_vegebook_component.WriteVegeBookComponent) {
    ...
    build() {
      ...
      let parentRenderNode = this.initViewRoot(_rootEl);
      let doc = html.document;
      this[_el_0$7] = src__runtime__dom_helpers.appendDiv(doc, parentRenderNode);
      ...
      let _el_22 = src__runtime__dom_helpers.appendElement(doc, _el_21, "p");
      this.updateChildClass(html.HtmlElement._check(_el_22), "writtenBy");
      this.addShimE(_el_22);
      let _el_23 = src__runtime__dom_helpers.appendElement(doc, _el_22, "strong");
      this.addShimE(_el_23);
      _el_23[$append](this[_textBinding_24].element);
      let _text_25 = src__runtime__dom_helpers.appendText(_el_22, ": ");
      _el_22[$append](this[_textBinding_26].element);
      let _el_27 = src__runtime__dom_helpers.appendDiv(doc, this[_el_0$7]);
      this.updateChildClass(_el_27, "section");
      this.addShimC(_el_27);
      let _el_28 = src__runtime__dom_helpers.appendDiv(doc, _el_27);
      this.updateChildClass(_el_28, "centered-content");
      this.addShimC(_el_28);
      this[_compView_29] = new src__quill__quill_component$46template.ViewQuillComponent0.new(this, 29);
      let _el_29 = this[_compView_29].rootEl;
      _el_28[$append](_el_29);
      this.updateChildClassNonHtml(_el_29, "quill_pad");
      src__runtime__dom_helpers.setAttribute(_el_29, "placeholder", "Write something...");
      this.addShimC(_el_29);
      this[_QuillComponent_29_5] = new src__quill__quill_component.QuillComponent.new();
      this[_QuillValueAccessor_29_6] = new src__quill__quill_component.QuillValueAccessor.new(this[_QuillComponent_29_5]);
      this[_NgValueAccessor_29_7] = JSArrayOfControlValueAccessor().of([this[_QuillValueAccessor_29_6]]);
      this[_NgModel_29_8] = new src__directives__ng_model.NgModel.new(null, this[_NgValueAccessor_29_7]);
      this[_compView_29].create0(this[_QuillComponent_29_5]);
      ...
      let subscription_1 = this[_QuillComponent_29_5].blur.listen(this.eventHandler0(dart.dynamic, dart.bind(_ctx, 'blur')));
      let subscription_2 = this[_QuillComponent_29_5].input.listen(this.eventHandler0(dart.dynamic, dart.bind(_ctx, 'input')));
      let subscription_3 = this[_NgModel_29_8].update.listen(this.eventHandler1(dart.dynamic, dart.dynamic, dart.bind(this, _handle_ngModelChange_29_2)));
      _ctx.landscapeImageElement = html.ImageElement._check(this[_el_4]);
      _ctx.posterImageElement = html.ImageElement._check(this[_el_15]);
      this.init(const$14 || (const$14 = dart.constList([], core$.Object)), JSArrayOfStreamSubscriptionOfvoid().of([subscription_0, subscription_1, subscription_2, subscription_3]));
    }
    injectorGetInternal(token, nodeIndex, notFoundResult) {
      ...
      if (29 === nodeIndex) {
        if (token === (const$16 || (const$16 = dart.const(new (MultiTokenOfControlValueAccessor()).new("NgValueAccessor"))))) {
          return this[_NgValueAccessor_29_7];
        }
        if (token === dart.wrapType(src__directives__ng_model.NgModel) || token === dart.wrapType(src__directives__ng_control.NgControl)) {
          return this[_NgModel_29_8];
        }
      }
    ...
    detectChangesInternal() {
      ...
      if (firstCheck) {
        this[_QuillComponent_29_5].placeholder = "Write something...";
      }
      changed = false;
      this[_NgModel_29_8].model = _ctx.htmlStr;
      this[_NgModel_29_8].ngAfterChanges();
      if (!dart.test(src__core__linker__app_view_utils.AppViewUtils.throwOnChanges) && firstCheck) {
        this[_NgModel_29_8].ngOnInit();
      }
      if (!dart.test(src__core__linker__app_view_utils.AppViewUtils.throwOnChanges)) {
        if (firstCheck) {
          this[_QuillComponent_29_5].ngAfterContentInit();
        }
      }
      let currVal_0 = _ctx.contentVisible;
      ...
      this[_textBinding_24].updateText(src__runtime__interpolate.interpolateString0(_ctx.messages.writtenBy));
      this[_textBinding_26].updateText(src__runtime__interpolate.interpolateString0(_ctx.writer));
      this[_compView_6$].detectChanges();
    ...
    destroyInternal() {
      ...
      this[_compView_29].destroyInternalState();
      this[_MaterialInputComponent_20_10].ngOnDestroy();
      this[_MaterialInputDefaultValueAccessor_20_12].ngOnDestroy();
      this[_QuillComponent_29_5].ngOnDestroy();
      this[_QuillValueAccessor_29_6].ngOnDestroy();
    }
    ...
    [_handle_ngModelChange_29_2]($event) {
      let _ctx = this.ctx;
  ...
  (src__vegebook_details__write_vegebook__write_vegebook_component$46template.ViewWriteVegeBookComponent0.new = function(parentView, parentIndex) {
    this[_textBinding_24] = new src__runtime__text_binding.TextBinding.new();
    this[_textBinding_26] = new src__runtime__text_binding.TextBinding.new();
    this[_compView_6$] = null;
    ...
    this[_QuillComponent_29_5] = null;
    this[_QuillValueAccessor_29_6] = null;
    this[_NgValueAccessor_29_7] = null;
    this[_NgModel_29_8] = null;
  ...
  dart.setMethodSignature(src__vegebook_details__write_vegebook__write_vegebook_component$46template.ViewWriteVegeBookComponent0, () => ({
    ...
    [_handle_ngModelChange_29_2]: dart.fnType(dart.void, [dart.dynamic]),
    initComponentStyles: dart.fnType(dart.void, [])
  }));
  dart.setFieldSignature(src__vegebook_details__write_vegebook__write_vegebook_component$46template.ViewWriteVegeBookComponent0, () => ({
    ...
    [_textBinding_24]: dart.finalFieldType(src__runtime__text_binding.TextBinding),
    [_textBinding_26]: dart.finalFieldType(src__runtime__text_binding.TextBinding),
    ...
    [_compView_29]: dart.fieldType(src__quill__quill_component$46template.ViewQuillComponent0),
    [_QuillComponent_29_5]: dart.fieldType(src__quill__quill_component.QuillComponent),
    [_QuillValueAccessor_29_6]: dart.fieldType(src__quill__quill_component.QuillValueAccessor),
    [_NgValueAccessor_29_7]: dart.fieldType(ListOfControlValueAccessor()),
    [_NgModel_29_8]: dart.fieldType(src__directives__ng_model.NgModel),
  ...
  src__vegebook__vegebook_page_component$46template.ViewVegeBookPageComponent0 = class ViewVegeBookPageComponent0 extends src__core__linker__app_view.AppView$(src__vegebook__vegebook_page_component.VegeBookPageComponent) {
    ...
    build() {
      ...
      this.init(const$17 || (const$17 = dart.constList([], core$.Object)), JSArrayOfStreamSubscriptionOfvoid().of([subscription_0]));
    }
    detectChangesInternal() {
      let _ctx = this.ctx;
  ...
  src__app_bar__scroll_utils.listenForScrollDirectionChanges = function(callback) {
    let previousTop = 0;
    return async.Timer.periodic(const$21 || (const$21 = dart.const(new core$.Duration.new({milliseconds: 250}))), dart.fn(_ => {
  ...
  src__app_bar__search_bar__search_bar_component.SearchBarComponent = class SearchBarComponent extends core$.Object {
    ...
    toggleSearch() {
      ...
      if (dart.test(this.searchOpen)) {
        async.Timer.new(const$22 || (const$22 = dart.const(new core$.Duration.new({milliseconds: 250}))), dart.fn(() => this.searchField.focus(), VoidTovoid()));
      } else {
        this.searchField.value = "";
