define(['dart_sdk', 'packages/core/core', 'packages/kt_dart/collection', 'packages/angular/src/core/change_detection/change_detection', 'packages/intl/intl', 'packages/angular/src/bootstrap/modules', 'packages/angular/angular.template', 'packages/angular/src/runtime/text_binding', 'packages/angular/src/runtime/interpolate', 'packages/angular/src/runtime/proxies', 'packages/redux/redux', 'packages/angular_router/angular_router.template', 'packages/angular_components/material_button/material_button.template', 'packages/angular_components/theme/dark_theme', 'packages/angular_components/material_button/material_button', 'packages/angular_components/button_decorator/button_decorator', 'packages/angular_components/interfaces/has_disabled', 'packages/angular_components/angular_components.template', 'packages/angular_router/src/directives/router_outlet_directive', 'packages/firebase/firebase', 'packages/angular_quill/angular_quill.template', 'packages/angular_quill/src/quill/quill', 'packages/angular_forms/src/directives', 'packages/angular_components/material_input/material_input.template', 'packages/angular_forms/angular_forms.template', 'packages/firebase/src/app'], function(dart_sdk, core, collection, change_detection, intl, modules, angular, text_binding, interpolate, proxies, redux, angular_router, material_button, dark_theme, material_button$, button_decorator, has_disabled, angular_components, router_outlet_directive, firebase, angular_quill, quill, directives, material_input, angular_forms, app) {
  ...
  const _compView_3 = dart.privateName(src__common__vegebook_poster__vegebook_poster_component$46template, "_compView_3");
  const _AcxDarkTheme_3_5 = dart.privateName(src__common__vegebook_poster__vegebook_poster_component$46template, "_AcxDarkTheme_3_5");
  const _MaterialButtonComponent_3_6 = dart.privateName(src__common__vegebook_poster__vegebook_poster_component$46template, "_MaterialButtonComponent_3_6");
  const _appEl_5 = dart.privateName(src__common__vegebook_poster__vegebook_poster_component$46template, "_appEl_5");
  const _NgIf_5_9 = dart.privateName(src__common__vegebook_poster__vegebook_poster_component$46template, "_NgIf_5_9");
  const _appEl_6 = dart.privateName(src__common__vegebook_poster__vegebook_poster_component$46template, "_appEl_6");
  const _NgIf_6_9 = dart.privateName(src__common__vegebook_poster__vegebook_poster_component$46template, "_NgIf_6_9");
  ...
  src__common__vegebook_poster__vegebook_poster_component$46template.ViewVegeBookPosterComponent0 = class ViewVegeBookPosterComponent0 extends src__core__linker__app_view.AppView$(src__common__vegebook_poster__vegebook_poster_component.VegeBookPosterComponent) {
    ...
    build() {
      ...
      let _TemplateRef_5_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_5], dart.fn(src__common__vegebook_poster__vegebook_poster_component$46template.viewFactory_VegeBookPosterComponent2, AppViewAndintToAppViewOfvoid()));
      ...
      let _TemplateRef_6_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_6], dart.fn(src__common__vegebook_poster__vegebook_poster_component$46template.viewFactory_VegeBookPosterComponent3, AppViewAndintToAppViewOfvoid()));
      this[_NgIf_6_9] = new src__common__directives__ng_if.NgIf.new(this[_appEl_6], _TemplateRef_6_8);
      this.init0();
    }
    injectorGetInternal(token, nodeIndex, notFoundResult) {
      if (3 <= dart.notNull(nodeIndex) && dart.notNull(nodeIndex) <= 4) {
    ...
    detectChangesInternal() {
      ...
      this[_NgIf_5_9].ngIf = _ctx.hasDetails;
      this[_NgIf_6_9].ngIf = _ctx.isComingSoon;
  ...
  const _appEl_3$0 = dart.privateName(src__common__vegenews_poster__vegenews_poster_component$46template, "_appEl_3");
  const _NgIf_3_9$0 = dart.privateName(src__common__vegenews_poster__vegenews_poster_component$46template, "_NgIf_3_9");
  const _appEl_4$ = dart.privateName(src__common__vegenews_poster__vegenews_poster_component$46template, "_appEl_4");
  const _NgIf_4_9$ = dart.privateName(src__common__vegenews_poster__vegenews_poster_component$46template, "_NgIf_4_9");
  ...
  src__common__vegenews_poster__vegenews_poster_component$46template.ViewVegeNewsPosterComponent0 = class ViewVegeNewsPosterComponent0 extends src__core__linker__app_view.AppView$(src__common__vegenews_poster__vegenews_poster_component.VegeNewsPosterComponent) {
    ...
    build() {
      ...
      let _TemplateRef_3_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_3$0], dart.fn(src__common__vegenews_poster__vegenews_poster_component$46template.viewFactory_VegeNewsPosterComponent2, AppViewAndintToAppViewOfvoid()));
      this[_NgIf_3_9$0] = new src__common__directives__ng_if.NgIf.new(this[_appEl_3$0], _TemplateRef_3_8);
      let _anchor_4 = src__runtime__dom_helpers.appendAnchor(parentRenderNode);
      this[_appEl_4$] = new src__core__linker__view_container.ViewContainer.new(4, null, this, _anchor_4);
      let _TemplateRef_4_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_4$], dart.fn(src__common__vegenews_poster__vegenews_poster_component$46template.viewFactory_VegeNewsPosterComponent3, AppViewAndintToAppViewOfvoid()));
      this[_NgIf_4_9$] = new src__common__directives__ng_if.NgIf.new(this[_appEl_4$], _TemplateRef_4_8);
      this.init0();
    }
    detectChangesInternal() {
  ...
  const _appEl_5$0 = dart.privateName(src__vegenews_details__vegenews_details_component$46template, "_appEl_5");
  ...
  src__vegenews_details__vegenews_details_component$46template._ViewVegeNewsDetailsComponent4 = class _ViewVegeNewsDetailsComponent4 extends src__core__linker__app_view.AppView$(src__vegenews_details__vegenews_details_component.VegeNewsDetailsComponent) {
    build() {
      ...
      let _TemplateRef_5_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_5$0], dart.fn(src__vegenews_details__vegenews_details_component$46template.viewFactory_VegeNewsDetailsComponent5, AppViewAndintToAppViewOfvoid()));
      this[_NgFor_5_9$] = new src__common__directives__ng_for.NgFor.new(this[_appEl_5$0], _TemplateRef_5_8);
      this.init1(_el_0);
    }
    detectChangesInternal() {
      let _ctx = this.ctx;
  ...
  const _appEl_4$0 = dart.privateName(src__showtimes__showtimes_page_component$46template, "_appEl_4");
  ...
  src__showtimes__showtimes_page_component$46template.ViewShowtimesPageComponent0 = class ViewShowtimesPageComponent0 extends src__core__linker__app_view.AppView$(src__showtimes__showtimes_page_component.ShowtimesPageComponent) {
    ...
    build() {
      ...
      _el_1[$append](_el_4);
      this.addShimC(_el_4);
      this[_appEl_4$0] = new src__core__linker__view_container.ViewContainer.new(4, 1, this, _el_4);
      this[_TheaterSelectorComponent_4_8] = dart.test(src__runtime__optimizations.isDevMode) ? src__di__errors.debugInjectorWrap(src__common__theater_selector__theater_selector_component.TheaterSelectorComponent, dart.wrapType(src__common__theater_selector__theater_selector_component.TheaterSelectorComponent), dart.fn(() => new src__common__theater_selector__theater_selector_component.TheaterSelectorComponent.new(StoreOfAppState()._check(this.parentView.injectorGet(dart.wrapType(src__store.Store), this.viewData.parentIndex)), this[_appEl_4$0]), VoidToTheaterSelectorComponent())) : new src__common__theater_selector__theater_selector_component.TheaterSelectorComponent.new(StoreOfAppState()._check(this.parentView.injectorGet(dart.wrapType(src__store.Store), this.viewData.parentIndex)), this[_appEl_4$0]);
  ...
  src__vegebook_details__write_vegebook__write_vegebook_component.WriteVegeBookComponent = class WriteVegeBookComponent extends core$.Object {
    ...
    [_populateVegeBookDetails$](vegeBookId) {
      this.vegeBook = src__redux__vegebook__vegebook_selectors.vegeBookByIdSelector(this[_store$4].state, vegeBookId);
      if (this.vegeBook != null) {
        this[_animateContentIntoView$0]();
      } else {
        this[_store$4].dispatch(new src__redux__vegebook__vegebook_actions.RefreshVegeBookAction.new());
        this[_waitForEventDetails$0](vegeBookId);
      }
    }
  ...
  const _textBinding_9 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_textBinding_9");
  const _compView_1$2 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_compView_1");
  const _VegeBookLandscapeImageComponent_1_5$ = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_VegeBookLandscapeImageComponent_1_5");
  const _compView_3$ = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_compView_3");
  const _AcxDarkTheme_3_5$ = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_AcxDarkTheme_3_5");
  const _MaterialButtonComponent_3_6$ = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_MaterialButtonComponent_3_6");
  ...
  const _VegeBookPosterComponent_6_5 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_VegeBookPosterComponent_6_5");
  const _appEl_11$0 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_appEl_11");
  const _NgIf_11_9$0 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_NgIf_11_9");
  const _compView_14 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_compView_14");
  const _QuillComponent_14_5 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_QuillComponent_14_5");
  const _QuillValueAccessor_14_6 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_QuillValueAccessor_14_6");
  const _NgValueAccessor_14_7 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_NgValueAccessor_14_7");
  const _NgModel_14_8 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_NgModel_14_8");
  ...
  const _expr_3$1 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_expr_3");
  const _el_0$7 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_el_0");
  let const$8;
  let const$9;
  const _handle_ngModelChange_14_2 = dart.privateName(src__vegebook_details__write_vegebook__write_vegebook_component$46template, "_handle_ngModelChange_14_2");
  let const$10;
  src__vegebook_details__write_vegebook__write_vegebook_component$46template._ViewWriteVegeBookComponent1 = class _ViewWriteVegeBookComponent1 extends src__core__linker__app_view.AppView$(src__vegebook_details__write_vegebook__write_vegebook_component.WriteVegeBookComponent) {
    build() {
      ...
      this[_MaterialButtonComponent_3_6$] = new material_button__material_button.MaterialButtonComponent.new(_el_3, theme__dark_theme.AcxDarkTheme._check(this[_AcxDarkTheme_3_5$]), this[_compView_3$], null);
      let _text_4 = src__runtime__dom_helpers.createText("Add Landscape image");
      this[_compView_3$].create(this[_MaterialButtonComponent_3_6$], JSArrayOfObject().of([JSArrayOfText().of([_text_4])]));
      let _el_5 = src__runtime__dom_helpers.appendDiv(doc, this[_el_0$7]);
      this.updateChildClass(_el_5, "vegebook-header");
      this.addShimC(_el_5);
      this[_compView_6$] = new src__common__vegebook_poster__vegebook_poster_component$46template.ViewVegeBookPosterComponent0.new(this, 6);
      let _el_6 = this[_compView_6$].rootEl;
      _el_5[$append](_el_6);
      this.addShimC(_el_6);
      this[_VegeBookPosterComponent_6_5] = dart.test(src__runtime__optimizations.isDevMode) ? src__di__errors.debugInjectorWrap(src__common__vegebook_poster__vegebook_poster_component.VegeBookPosterComponent, dart.wrapType(src__common__vegebook_poster__vegebook_poster_component.VegeBookPosterComponent), dart.fn(() => new src__common__vegebook_poster__vegebook_poster_component.VegeBookPosterComponent.new(src__i18n__messages.Messages._check(this.parentView.injectorGet(dart.wrapType(src__i18n__messages.Messages), this.viewData.parentIndex))), VoidToVegeBookPosterComponent())) : new src__common__vegebook_poster__vegebook_poster_component.VegeBookPosterComponent.new(src__i18n__messages.Messages._check(this.parentView.injectorGet(dart.wrapType(src__i18n__messages.Messages), this.viewData.parentIndex)));
      this[_compView_6$].create0(this[_VegeBookPosterComponent_6_5]);
      let _el_7 = src__runtime__dom_helpers.appendDiv(doc, _el_5);
      this.updateChildClass(_el_7, "vegebook-information");
      this.addShimC(_el_7);
      let _el_8 = src__runtime__dom_helpers.appendElement(doc, _el_7, "h2");
      this.updateChildClass(html.HtmlElement._check(_el_8), "title");
      this.addShimE(_el_8);
      _el_8[$append](this[_textBinding_9].element);
      let _el_10 = src__runtime__dom_helpers.appendDiv(doc, _el_7);
      this.updateChildClass(_el_10, "body");
      this.addShimC(_el_10);
      let _anchor_11 = src__runtime__dom_helpers.appendAnchor(_el_10);
      this[_appEl_11$0] = new src__core__linker__view_container.ViewContainer.new(11, 10, this, _anchor_11);
      let _TemplateRef_11_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_11$0], dart.fn(src__vegebook_details__write_vegebook__write_vegebook_component$46template.viewFactory_WriteVegeBookComponent2, AppViewAndintToAppViewOfvoid()));
      this[_NgIf_11_9$0] = new src__common__directives__ng_if.NgIf.new(this[_appEl_11$0], _TemplateRef_11_8);
      let _el_12 = src__runtime__dom_helpers.appendDiv(doc, this[_el_0$7]);
      ...
      this[_compView_14] = new src__quill__quill_component$46template.ViewQuillComponent0.new(this, 14);
      let _el_14 = this[_compView_14].rootEl;
      _el_13[$append](_el_14);
      src__runtime__dom_helpers.setAttribute(_el_14, "placeholder", "Write something...");
      this.addShimC(_el_14);
      this[_QuillComponent_14_5] = new src__quill__quill_component.QuillComponent.new();
      this[_QuillValueAccessor_14_6] = new src__quill__quill_component.QuillValueAccessor.new(this[_QuillComponent_14_5]);
      this[_NgValueAccessor_14_7] = JSArrayOfControlValueAccessor().of([this[_QuillValueAccessor_14_6]]);
      this[_NgModel_14_8] = new src__directives__ng_model.NgModel.new(null, this[_NgValueAccessor_14_7]);
      this[_compView_14].create0(this[_QuillComponent_14_5]);
      _el_2[$addEventListener]("click", this.eventHandler0(html.Event, dart.bind(_ctx, 'goBack')));
      let subscription_0 = this[_QuillComponent_14_5].blur.listen(this.eventHandler0(dart.dynamic, dart.bind(_ctx, 'blur')));
      let subscription_1 = this[_QuillComponent_14_5].input.listen(this.eventHandler0(dart.dynamic, dart.bind(_ctx, 'input')));
      let subscription_2 = this[_NgModel_14_8].update.listen(this.eventHandler1(dart.dynamic, dart.dynamic, dart.bind(this, _handle_ngModelChange_14_2)));
      this.init(JSArrayOfObject().of([this[_el_0$7]]), JSArrayOfStreamSubscriptionOfvoid().of([subscription_0, subscription_1, subscription_2]));
    }
    injectorGetInternal(token, nodeIndex, notFoundResult) {
      if (3 <= dart.notNull(nodeIndex) && dart.notNull(nodeIndex) <= 4) {
        if (token === dart.wrapType(theme__dark_theme.AcxDarkTheme)) {
    ...
    detectChangesInternal() {
      ...
      if (firstCheck) {
        this[_VegeBookPosterComponent_6_5].hasDetails = false;
        this[_VegeBookPosterComponent_6_5].isTouchable = false;
      }
      let currVal_3 = _ctx.vegeBook;
      if (dart.test(src__core__linker__app_view_utils.checkBinding(this[_expr_3$1], currVal_3))) {
        this[_VegeBookPosterComponent_6_5].vegeBook = currVal_3;
        this[_expr_3$1] = currVal_3;
      }
      this[_NgIf_11_9$0].ngIf = _ctx.vegeBook.writtenBy != null;
      if (firstCheck) {
        this[_QuillComponent_14_5].placeholder = "Write something...";
      }
      changed = false;
      this[_NgModel_14_8].model = _ctx.htmlStr;
      this[_NgModel_14_8].ngAfterChanges();
      if (!dart.test(src__core__linker__app_view_utils.AppViewUtils.throwOnChanges) && firstCheck) {
        this[_NgModel_14_8].ngOnInit();
      }
      this[_appEl_11$0].detectChangesInNestedViews();
      if (!dart.test(src__core__linker__app_view_utils.AppViewUtils.throwOnChanges)) {
        if (firstCheck) {
          this[_QuillComponent_14_5].ngAfterContentInit();
        }
      }
      let currVal_0 = _ctx.contentVisible;
      ...
      this[_compView_3$].detectHostChanges(firstCheck);
      this[_textBinding_9].updateText(src__runtime__interpolate.interpolateString0(_ctx.vegeBook.title));
    ...
    destroyInternal() {
      this[_appEl_11$0].destroyNestedViews();
      this[_compView_1$2].destroyInternalState();
      this[_compView_3$].destroyInternalState();
      this[_compView_6$].destroyInternalState();
      this[_compView_14].destroyInternalState();
      this[_VegeBookLandscapeImageComponent_1_5$].ngOnDestroy();
      this[_QuillComponent_14_5].ngOnDestroy();
      this[_QuillValueAccessor_14_6].ngOnDestroy();
    }
    [_handle_ngModelChange_14_2]($event) {
      let _ctx = this.ctx;
  ...
  (src__vegebook_details__write_vegebook__write_vegebook_component$46template._ViewWriteVegeBookComponent1.new = function(parentView, parentIndex) {
    ...
    this[_MaterialButtonComponent_3_6$] = null;
    this[_compView_6$] = null;
    this[_VegeBookPosterComponent_6_5] = null;
    this[_appEl_11$0] = null;
    this[_NgIf_11_9$0] = null;
    this[_compView_14] = null;
    this[_QuillComponent_14_5] = null;
    this[_QuillValueAccessor_14_6] = null;
    this[_NgValueAccessor_14_7] = null;
    this[_NgModel_14_8] = null;
  ...
  dart.setMethodSignature(src__vegebook_details__write_vegebook__write_vegebook_component$46template._ViewWriteVegeBookComponent1, () => ({
    ...
    build: dart.fnType(src__core__linker__component_factory.ComponentRef$(src__vegebook_details__write_vegebook__write_vegebook_component.WriteVegeBookComponent), []),
    injectorGetInternal: dart.fnType(dart.dynamic, [dart.dynamic, core$.int, dart.dynamic]),
    [_handle_ngModelChange_14_2]: dart.fnType(dart.void, [dart.dynamic])
  }));
  dart.setFieldSignature(src__vegebook_details__write_vegebook__write_vegebook_component$46template._ViewWriteVegeBookComponent1, () => ({
    ...
    [_AcxDarkTheme_3_5$]: dart.fieldType(dart.dynamic),
    [_MaterialButtonComponent_3_6$]: dart.fieldType(material_button__material_button.MaterialButtonComponent),
    [_compView_6$]: dart.fieldType(src__common__vegebook_poster__vegebook_poster_component$46template.ViewVegeBookPosterComponent0),
    [_VegeBookPosterComponent_6_5]: dart.fieldType(src__common__vegebook_poster__vegebook_poster_component.VegeBookPosterComponent),
    [_appEl_11$0]: dart.fieldType(src__core__linker__view_container.ViewContainer),
    [_NgIf_11_9$0]: dart.fieldType(src__common__directives__ng_if.NgIf),
    [_compView_14]: dart.fieldType(src__quill__quill_component$46template.ViewQuillComponent0),
    [_QuillComponent_14_5]: dart.fieldType(src__quill__quill_component.QuillComponent),
    [_QuillValueAccessor_14_6]: dart.fieldType(src__quill__quill_component.QuillValueAccessor),
    [_NgValueAccessor_14_7]: dart.fieldType(ListOfControlValueAccessor()),
    [_NgModel_14_8]: dart.fieldType(src__directives__ng_model.NgModel),
  ...
  const _appEl_4$1 = dart.privateName(src__vegebook__vegebook_page_component$46template, "_appEl_4");
  const _NgIf_4_9$0 = dart.privateName(src__vegebook__vegebook_page_component$46template, "_NgIf_4_9");
  ...
  src__vegebook__vegebook_page_component$46template.ViewVegeBookPageComponent0 = class ViewVegeBookPageComponent0 extends src__core__linker__app_view.AppView$(src__vegebook__vegebook_page_component.VegeBookPageComponent) {
    ...
    build() {
      ...
      this[_appEl_4$1] = new src__core__linker__view_container.ViewContainer.new(4, 0, this, _anchor_4);
      let _TemplateRef_4_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_4$1], dart.fn(src__vegebook__vegebook_page_component$46template.viewFactory_VegeBookPageComponent1, AppViewAndintToAppViewOfvoid()));
      this[_NgIf_4_9$0] = new src__common__directives__ng_if.NgIf.new(this[_appEl_4$1], _TemplateRef_4_8);
      ...
      this.init(const$11 || (const$11 = dart.constList([], core$.Object)), JSArrayOfStreamSubscriptionOfvoid().of([subscription_0]));
    }
    detectChangesInternal() {
      let _ctx = this.ctx;
      this[_NgIf_4_9$0].ngIf = _ctx.isAuthenticated();
  ...
  src__events__events_page_component$46template.ViewEventsPageComponent0 = class ViewEventsPageComponent0 extends src__core__linker__app_view.AppView$(src__events__events_page_component.EventsPageComponent) {
    ...
    build() {
      ...
      let subscription_0 = this[_LoadingViewComponent_5_5$].actionButtonClicked.listen(this.eventHandler1(dart.dynamic, dart.dynamic, dart.bind(this, _handle_actionButtonClicked_5_0$)));
      this.init(const$14 || (const$14 = dart.constList([], core$.Object)), JSArrayOfStreamSubscriptionOfvoid().of([subscription_0]));
    }
    detectChangesInternal() {
      let _ctx = this.ctx;
      ...
      if (dart.test(src__core__linker__app_view_utils.checkBinding(this[_expr_3$3], currVal_3))) {
        this[_NgFor_7_9$0].ngForOf = currVal_3;
        this[_expr_3$3] = currVal_3;
      }
      if (!dart.test(src__core__linker__app_view_utils.AppViewUtils.throwOnChanges)) {
  ...
  const _compView_1$3 = dart.privateName(src__event_details__event_details_component$46template, "_compView_1");
  ...
  src__event_details__event_details_component$46template._ViewEventDetailsComponent1 = class _ViewEventDetailsComponent1 extends src__core__linker__app_view.AppView$(src__event_details__event_details_component.EventDetailsComponent) {
    build() {
      ...
      this[_compView_1$3] = new src__event_details__landscape_image__event_landscape_image_component$46template.ViewEventLandscapeImageComponent0.new(this, 1);
      ...
      this[_compView_1$3].create0(this[_EventLandscapeImageComponent_1_5]);
  ...
  dart.setFieldSignature(src__event_details__event_details_component$46template._ViewEventDetailsComponent1, () => ({
    ...
    [_compView_1$3]: dart.fieldType(src__event_details__landscape_image__event_landscape_image_component$46template.ViewEventLandscapeImageComponent0),
  ...
  src__event_details__event_details_component$46template._ViewEventDetailsComponent3 = class _ViewEventDetailsComponent3 extends src__core__linker__app_view.AppView$(src__event_details__event_details_component.EventDetailsComponent) {
    build() {
      ...
      this.addShimC(html.HtmlElement._check(_el_0));
      this[_compView_1$3] = new src__common__showtime_item__showtime_item_component$46template.ViewShowtimeItemComponent0.new(this, 1);
      let _el_1 = this[_compView_1$3].rootEl;
      _el_0[$append](_el_1);
      ...
      this[_compView_1$3].create0(this[_ShowtimeItemComponent_1_5]);
      this.init1(_el_0);
    }
    detectChangesInternal() {
      let _ctx = this.ctx;
  ...
  dart.setFieldSignature(src__event_details__event_details_component$46template._ViewEventDetailsComponent3, () => ({
    ...
    [_compView_1$3]: dart.fieldType(src__common__showtime_item__showtime_item_component$46template.ViewShowtimeItemComponent0),
  ...
  const _appEl_5$1 = dart.privateName(src__event_details__event_details_component$46template, "_appEl_5");
  ...
  src__event_details__event_details_component$46template._ViewEventDetailsComponent6 = class _ViewEventDetailsComponent6 extends src__core__linker__app_view.AppView$(src__event_details__event_details_component.EventDetailsComponent) {
    build() {
      ...
      this.addShimC(_el_4);
      let _anchor_5 = src__runtime__dom_helpers.appendAnchor(_el_4);
      this[_appEl_5$1] = new src__core__linker__view_container.ViewContainer.new(5, 4, this, _anchor_5);
      let _TemplateRef_5_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_5$1], dart.fn(src__event_details__event_details_component$46template.viewFactory_EventDetailsComponent7, AppViewAndintToAppViewOfvoid()));
      this[_NgFor_5_9$0] = new src__common__directives__ng_for.NgFor.new(this[_appEl_5$1], _TemplateRef_5_8);
      this.init1(_el_0);
    }
    detectChangesInternal() {
      let _ctx = this.ctx;
  ...
  dart.setFieldSignature(src__event_details__event_details_component$46template._ViewEventDetailsComponent6, () => ({
    ...
    [_textBinding_3$8]: dart.finalFieldType(src__runtime__text_binding.TextBinding),
    [_appEl_5$1]: dart.fieldType(src__core__linker__view_container.ViewContainer),
  ...
  src__app_bar__scroll_utils.listenForScrollDirectionChanges = function(callback) {
    let previousTop = 0;
    return async.Timer.periodic(const$15 || (const$15 = dart.const(new core$.Duration.new({milliseconds: 250}))), dart.fn(_ => {
  ...
  src__app_bar__search_bar__search_bar_component.SearchBarComponent = class SearchBarComponent extends core$.Object {
    ...
    toggleSearch() {
      ...
      if (dart.test(this.searchOpen)) {
        async.Timer.new(const$16 || (const$16 = dart.const(new core$.Duration.new({milliseconds: 250}))), dart.fn(() => this.searchField.focus(), VoidTovoid()));
      } else {
        this.searchField.value = "";
