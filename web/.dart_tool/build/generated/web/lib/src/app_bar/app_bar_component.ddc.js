  ...
  src__common__signin_page__signin_page_component.SignInPageComponent = class SignInPageComponent extends core$.Object {
    ...
    getUIConfig() {
      if (this[_uiConfig] == null) {
        ...
        let gitHub = {provider: src__auth.GithubAuthProvider.PROVIDER_ID, scopes: []};
        ...
        this[_uiConfig] = {signInSuccessUrl: "/", signInOptions: [googleOptions, src__auth.EmailAuthProvider.PROVIDER_ID, gitHub], signInFlow: "redirect", credentialHelper: "accountchooser.com", tosUrl: "/tos.html", callbacks: callbacks};
      }
