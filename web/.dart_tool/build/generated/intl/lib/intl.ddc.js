define(['dart_sdk', 'packages/intl/date_symbols', 'packages/intl/src/plural_rules', 'packages/intl/number_symbols', 'packages/intl/number_symbols_data'], function(dart_sdk, date_symbols, plural_rules, number_symbols, number_symbols_data) {
  ...
  intl.Intl = class Intl extends core.Object {
    ...
    static _select(choice, cases, opts) {
      ...
      let modifiedArgs = args == null ? null : (() => {
        let _ = JSArrayOfObject().of([stringChoice]);
        _[$addAll](args[$skip](1));
        return _;
      })();
  ...
  intl._CompactNumberFormat = class _CompactNumberFormat extends intl.NumberFormat {
    ...
    get [_stylesForSearching]() {
      return IterableOf_CompactStyle()._check(this[_styles][$reversed][$expand](intl._CompactStyle, dart.fn(x => x.allStyles, _CompactStyleBaseToIterableOf_CompactStyle())));
    }
    parse(text) {
  ...
  intl.DateFormat = class DateFormat extends core.Object {
    ...
    [_initDigitMatcher]() {
      ...
      let localeDigits = IterableOfint()._check(IterableOfint().generate(10, dart.fn(i => i, intToint()))[$map](core.int, dart.fn(i => dart.notNull(this.localeZeroCodeUnit) + dart.notNull(i), intToint())))[$toList]();
