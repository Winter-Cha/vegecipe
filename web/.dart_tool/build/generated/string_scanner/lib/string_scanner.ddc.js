define(['dart_sdk', 'packages/source_span/source_span'], function(dart_sdk, source_span) {
  ...
  dart.setLibraryUri(src__exception.StringScannerException, "package:string_scanner/src/exception.dart");
  ...
  dart.setLibraryUri(src__string_scanner.StringScanner, "package:string_scanner/src/string_scanner.dart");
  ...
  dart.setLibraryUri(src__line_scanner.LineScanner, "package:string_scanner/src/line_scanner.dart");
  ...
  dart.setLibraryUri(src__line_scanner.LineScannerState, "package:string_scanner/src/line_scanner.dart");
  ...
  dart.setLibraryUri(src__relative_span_scanner.RelativeSpanScanner, "package:string_scanner/src/relative_span_scanner.dart");
  ...
  dart.setLibraryUri(src__relative_span_scanner._SpanScannerState, "package:string_scanner/src/relative_span_scanner.dart");
  ...
  const _scanner$0 = dart.privateName(src__eager_span_scanner, "_scanner");
  ...
  const _scanner$1 = dart.privateName(src__span_scanner, "_scanner");
  ...
  dart.setLibraryUri(src__span_scanner.SpanScanner, "package:string_scanner/src/span_scanner.dart");
  ...
  dart.setLibraryUri(src__eager_span_scanner.EagerSpanScanner, "package:string_scanner/src/eager_span_scanner.dart");
  ...
  dart.setLibraryUri(src__eager_span_scanner._EagerSpanScannerState, "package:string_scanner/src/eager_span_scanner.dart");
  ...
  dart.setLibraryUri(src__span_scanner._SpanScannerState, "package:string_scanner/src/span_scanner.dart");
