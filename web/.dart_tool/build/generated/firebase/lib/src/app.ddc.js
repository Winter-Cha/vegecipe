define(['dart_sdk'], function(dart_sdk) {
  ...
  let FutureOfFullMetadata = () => (FutureOfFullMetadata = dart.constFn(async.Future$(src__storage.FullMetadata)))();
  ...
  let FutureOfDocumentSnapshot = () => (FutureOfDocumentSnapshot = dart.constFn(async.Future$(src__firestore.DocumentSnapshot)))();
  ...
  let FutureOfQuerySnapshot = () => (FutureOfQuerySnapshot = dart.constFn(async.Future$(src__firestore.QuerySnapshot)))();
  ...
  let FutureOfDocumentReference = () => (FutureOfDocumentReference = dart.constFn(async.Future$(src__firestore.DocumentReference)))();
  ...
  let IterableOfDocumentChange = () => (IterableOfDocumentChange = dart.constFn(core.Iterable$(src__firestore.DocumentChange)))();
  ...
  let IterableOfDocumentSnapshot = () => (IterableOfDocumentSnapshot = dart.constFn(core.Iterable$(src__firestore.DocumentSnapshot)))();
  ...
  let IterableOfUserInfoOfUserInfoJsImpl = () => (IterableOfUserInfoOfUserInfoJsImpl = dart.constFn(core.Iterable$(UserInfoOfUserInfoJsImpl())))();
  ...
  let FutureOfUserCredential = () => (FutureOfUserCredential = dart.constFn(async.Future$(src__auth.UserCredential)))();
  let UserJsImplToUser = () => (UserJsImplToUser = dart.constFn(dart.fnType(src__auth.User, [dart.anonymousJSType("UserJsImpl")])))();
  let FutureOfUser = () => (FutureOfUser = dart.constFn(async.Future$(src__auth.User)))();
  ...
  let FutureOfConfirmationResult = () => (FutureOfConfirmationResult = dart.constFn(async.Future$(src__auth.ConfirmationResult)))();
  ...
  src__storage.StorageReference = class StorageReference extends src__js.JsObjectWrapper$(dart.lazyJSType(() => dart.global.firebase.storage.Reference, "firebase.storage.Reference")) {
    ...
    getMetadata() {
      return FutureOfFullMetadata()._check(src__utils.handleThenable(dart.anonymousJSType("FullMetadataJsImpl"), this.jsObject.getMetadata()).then(src__storage.FullMetadata, dart.fn(src__storage.FullMetadata.getInstance, dynamicToFullMetadata())));
    }
    put(blob, metadata) {
    ...
    updateMetadata(metadata) {
      return FutureOfFullMetadata()._check(src__utils.handleThenable(dart.anonymousJSType("FullMetadataJsImpl"), this.jsObject.updateMetadata(metadata.jsObject)).then(src__storage.FullMetadata, dart.fn(src__storage.FullMetadata.getInstance, dynamicToFullMetadata())));
    }
  };
  ...
  src__storage._SettableMetadataBase$ = dart.generic(T => {
    class _SettableMetadataBase extends src__js.JsObjectWrapper$(T) {
      ...
      get customMetadata() {
        return MapOfString$String()._check((() => {
  ...
  src__storage.UploadTask = class UploadTask extends src__js.JsObjectWrapper$(dart.lazyJSType(() => dart.global.firebase.storage.UploadTask, "firebase.storage.UploadTask")) {
    get future() {
      let t = this[_future];
      return t == null ? this[_future] = FutureOfUploadTaskSnapshot()._check(src__utils.handleThenable(dart.anonymousJSType("UploadTaskSnapshotJsImpl"), this.jsObject).then(src__storage.UploadTaskSnapshot, dart.fn(src__storage.UploadTaskSnapshot.getInstance, UploadTaskSnapshotJsImplToUploadTaskSnapshot()))) : t;
    }
    get snapshot() {
  ...
  src__database.ThenableReference = class ThenableReference extends src__database.DatabaseReference$(dart.lazyJSType(() => dart.global.firebase.database.ThenableReference, "firebase.database.ThenableReference")) {
    get future() {
      let t = this[_future$];
      return t == null ? this[_future$] = FutureOfDatabaseReferenceOfReferenceJsImpl()._check(src__utils.handleThenable(dart.lazyJSType(() => dart.global.firebase.database.Reference, "firebase.database.Reference"), this.jsObject).then(DatabaseReferenceOfReferenceJsImpl(), dart.fn(src__database.DatabaseReference.getInstance, ReferenceJsImplToDatabaseReferenceOfReferenceJsImpl()))) : t;
    }
  };
  ...
  src__firestore.DocumentReference = class DocumentReference extends JsObjectWrapper__Updatable$$ {
    ...
    get() {
      return FutureOfDocumentSnapshot()._check(src__utils.handleThenable(dart.lazyJSType(() => dart.global.firebase.firestore.DocumentSnapshot, "firebase.firestore.DocumentSnapshot"), this.jsObject.get()).then(src__firestore.DocumentSnapshot, dart.fn(src__firestore.DocumentSnapshot.getInstance, DocumentSnapshotJsImplToDocumentSnapshot())));
    }
    get onSnapshot() {
  ...
  src__firestore.Query$ = dart.generic(T => {
    class Query extends src__js.JsObjectWrapper$(T) {
      ...
      get() {
        return FutureOfQuerySnapshot()._check(src__utils.handleThenable(dart.lazyJSType(() => dart.global.firebase.firestore.QuerySnapshot, "firebase.firestore.QuerySnapshot"), this.jsObject.get()).then(src__firestore.QuerySnapshot, dart.fn(src__firestore.QuerySnapshot.getInstance, QuerySnapshotJsImplToQuerySnapshot())));
      }
      limit(limit) {
  ...
  src__firestore.QuerySnapshot = class QuerySnapshot extends src__js.JsObjectWrapper$(dart.lazyJSType(() => dart.global.firebase.firestore.QuerySnapshot, "firebase.firestore.QuerySnapshot")) {
    docChanges() {
      return IterableOfDocumentChange()._check(this.jsObject.docChanges()[$map](src__firestore.DocumentChange, dart.fn(e => src__firestore.DocumentChange.getInstance(dart.anonymousJSType("DocumentChangeJsImpl")._check(e)), dynamicToDocumentChange())))[$toList]();
    }
    get docs() {
      return IterableOfDocumentSnapshot()._check(this.jsObject.docs[$map](src__firestore.DocumentSnapshot, dart.fn(e => src__firestore.DocumentSnapshot.getInstance(dart.lazyJSType(() => dart.global.firebase.firestore.DocumentSnapshot, "firebase.firestore.DocumentSnapshot")._check(e)), dynamicToDocumentSnapshot())))[$toList]();
    }
    get empty() {
  ...
  src__auth.User = class User extends src__auth.UserInfo$(dart.anonymousJSType("UserJsImpl")) {
    ...
    get providerData() {
      return IterableOfUserInfoOfUserInfoJsImpl()._check(this.jsObject.providerData[$map](UserInfoOfUserInfoJsImpl(), dart.fn(data => new (UserInfoOfUserInfoJsImpl()).fromJsObject(dart.anonymousJSType("UserInfoJsImpl")._check(data)), dynamicToUserInfoOfUserInfoJsImpl())))[$toList]();
    }
    get refreshToken() {
    ...
    linkAndRetrieveDataWithCredential(credential) {
      return FutureOfUserCredential()._check(src__utils.handleThenable(dart.anonymousJSType("UserCredentialJsImpl"), this.jsObject.linkAndRetrieveDataWithCredential(credential)).then(src__auth.UserCredential, dart.fn(u => new src__auth.UserCredential.fromJsObject(u), UserCredentialJsImplToUserCredential())));
    }
    linkWithCredential(credential) {
      return FutureOfUser()._check(src__utils.handleThenable(dart.anonymousJSType("UserJsImpl"), this.jsObject.linkWithCredential(credential)).then(src__auth.User, dart.fn(src__auth.User.getInstance, UserJsImplToUser())));
    }
    linkWithPhoneNumber(phoneNumber, applicationVerifier) {
      return FutureOfConfirmationResult()._check(src__utils.handleThenable(dart.lazyJSType(() => dart.global.firebase.auth.ConfirmationResult, "firebase.auth.ConfirmationResult"), this.jsObject.linkWithPhoneNumber(phoneNumber, applicationVerifier.jsObject)).then(src__auth.ConfirmationResult, dart.fn(c => new src__auth.ConfirmationResult.fromJsObject(c), ConfirmationResultJsImplToConfirmationResult())));
    }
    linkWithPopup(provider) {
      return FutureOfUserCredential()._check(src__utils.handleThenable(dart.anonymousJSType("UserCredentialJsImpl"), this.jsObject.linkWithPopup(provider.jsObject)).then(src__auth.UserCredential, dart.fn(u => new src__auth.UserCredential.fromJsObject(u), UserCredentialJsImplToUserCredential())));
    }
    linkWithRedirect(provider) {
      return src__utils.handleThenable(dart.dynamic, this.jsObject.linkWithRedirect(provider.jsObject));
    }
    reauthenticateAndRetrieveDataWithCredential(credential) {
      return FutureOfUserCredential()._check(src__utils.handleThenable(dart.dynamic, this.jsObject.reauthenticateAndRetrieveDataWithCredential(credential)).then(src__auth.UserCredential, dart.fn(o => new src__auth.UserCredential.fromJsObject(dart.anonymousJSType("UserCredentialJsImpl")._check(o)), dynamicToUserCredential())));
    }
    ...
    reauthenticateWithPopup(provider) {
      return FutureOfUserCredential()._check(src__utils.handleThenable(dart.anonymousJSType("UserCredentialJsImpl"), this.jsObject.reauthenticateWithPopup(provider.jsObject)).then(src__auth.UserCredential, dart.fn(u => new src__auth.UserCredential.fromJsObject(u), UserCredentialJsImplToUserCredential())));
    }
    ...
    unlink(providerId) {
      return FutureOfUser()._check(src__utils.handleThenable(dart.anonymousJSType("UserJsImpl"), this.jsObject.unlink(providerId)).then(src__auth.User, dart.fn(src__auth.User.getInstance, UserJsImplToUser())));
    }
  ...
  src__auth.Auth = class Auth extends src__js.JsObjectWrapper$(dart.lazyJSType(() => dart.global.firebase.auth.Auth, "firebase.auth.Auth")) {
    ...
    createUserWithEmailAndPassword(email, password) {
      return FutureOfUserCredential()._check(src__utils.handleThenable(dart.anonymousJSType("UserCredentialJsImpl"), this.jsObject.createUserWithEmailAndPassword(email, password)).then(src__auth.UserCredential, dart.fn(u => new src__auth.UserCredential.fromJsObject(u), UserCredentialJsImplToUserCredential())));
    }
    createUserAndRetrieveDataWithEmailAndPassword(email, password) {
      return FutureOfUserCredential()._check(src__utils.handleThenable(dart.anonymousJSType("UserCredentialJsImpl"), this.jsObject.createUserAndRetrieveDataWithEmailAndPassword(email, password)).then(src__auth.UserCredential, dart.fn(u => new src__auth.UserCredential.fromJsObject(u), UserCredentialJsImplToUserCredential())));
    }
    fetchProvidersForEmail(email) {
      return src__utils.handleThenable(ListOfString(), this.jsObject.fetchProvidersForEmail(email));
    }
    getRedirectResult() {
      return FutureOfUserCredential()._check(src__utils.handleThenable(dart.anonymousJSType("UserCredentialJsImpl"), this.jsObject.getRedirectResult()).then(src__auth.UserCredential, dart.fn(u => new src__auth.UserCredential.fromJsObject(u), UserCredentialJsImplToUserCredential())));
    }
    ...
    signInAndRetrieveDataWithCredential(credential) {
      return FutureOfUserCredential()._check(src__utils.handleThenable(dart.anonymousJSType("UserCredentialJsImpl"), this.jsObject.signInAndRetrieveDataWithCredential(credential)).then(src__auth.UserCredential, dart.fn(u => new src__auth.UserCredential.fromJsObject(u), UserCredentialJsImplToUserCredential())));
    }
    signInAnonymously() {
      return FutureOfUserCredential()._check(src__utils.handleThenable(dart.anonymousJSType("UserCredentialJsImpl"), this.jsObject.signInAnonymously()).then(src__auth.UserCredential, dart.fn(u => new src__auth.UserCredential.fromJsObject(u), UserCredentialJsImplToUserCredential())));
    }
    signInAnonymouslyAndRetrieveData() {
      return FutureOfUserCredential()._check(src__utils.handleThenable(dart.anonymousJSType("UserCredentialJsImpl"), this.jsObject.signInAnonymouslyAndRetrieveData()).then(src__auth.UserCredential, dart.fn(u => new src__auth.UserCredential.fromJsObject(u), UserCredentialJsImplToUserCredential())));
    }
    signInWithCredential(credential) {
      return FutureOfUser()._check(src__utils.handleThenable(dart.anonymousJSType("UserJsImpl"), this.jsObject.signInWithCredential(credential)).then(src__auth.User, dart.fn(src__auth.User.getInstance, UserJsImplToUser())));
    }
    signInWithCustomToken(token) {
      return FutureOfUserCredential()._check(src__utils.handleThenable(dart.anonymousJSType("UserCredentialJsImpl"), this.jsObject.signInWithCustomToken(token)).then(src__auth.UserCredential, dart.fn(u => new src__auth.UserCredential.fromJsObject(u), UserCredentialJsImplToUserCredential())));
    }
    signInAndRetrieveDataWithCustomToken(token) {
      return FutureOfUserCredential()._check(src__utils.handleThenable(dart.anonymousJSType("UserCredentialJsImpl"), this.jsObject.signInAndRetrieveDataWithCustomToken(token)).then(src__auth.UserCredential, dart.fn(u => new src__auth.UserCredential.fromJsObject(u), UserCredentialJsImplToUserCredential())));
    }
    signInWithEmailAndPassword(email, password) {
      return FutureOfUserCredential()._check(src__utils.handleThenable(dart.anonymousJSType("UserCredentialJsImpl"), this.jsObject.signInWithEmailAndPassword(email, password)).then(src__auth.UserCredential, dart.fn(u => new src__auth.UserCredential.fromJsObject(u), UserCredentialJsImplToUserCredential())));
    }
    signInAndRetrieveDataWithEmailAndPassword(email, password) {
      return FutureOfUserCredential()._check(src__utils.handleThenable(dart.anonymousJSType("UserCredentialJsImpl"), this.jsObject.signInAndRetrieveDataWithEmailAndPassword(email, password)).then(src__auth.UserCredential, dart.fn(u => new src__auth.UserCredential.fromJsObject(u), UserCredentialJsImplToUserCredential())));
    }
    signInWithPhoneNumber(phoneNumber, applicationVerifier) {
      return FutureOfConfirmationResult()._check(src__utils.handleThenable(dart.lazyJSType(() => dart.global.firebase.auth.ConfirmationResult, "firebase.auth.ConfirmationResult"), this.jsObject.signInWithPhoneNumber(phoneNumber, applicationVerifier.jsObject)).then(src__auth.ConfirmationResult, dart.fn(c => new src__auth.ConfirmationResult.fromJsObject(c), ConfirmationResultJsImplToConfirmationResult())));
    }
    signInWithPopup(provider) {
      return FutureOfUserCredential()._check(src__utils.handleThenable(dart.anonymousJSType("UserCredentialJsImpl"), this.jsObject.signInWithPopup(provider.jsObject)).then(src__auth.UserCredential, dart.fn(u => new src__auth.UserCredential.fromJsObject(u), UserCredentialJsImplToUserCredential())));
    }
  ...
  src__auth.ConfirmationResult = class ConfirmationResult extends src__js.JsObjectWrapper$(dart.lazyJSType(() => dart.global.firebase.auth.ConfirmationResult, "firebase.auth.ConfirmationResult")) {
    ...
    confirm(verificationCode) {
      return FutureOfUserCredential()._check(src__utils.handleThenable(dart.anonymousJSType("UserCredentialJsImpl"), this.jsObject.confirm(verificationCode)).then(src__auth.UserCredential, dart.fn(u => new src__auth.UserCredential.fromJsObject(u), UserCredentialJsImplToUserCredential())));
    }
  };
