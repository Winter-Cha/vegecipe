define(['dart_sdk', 'packages/firebase/src/app'], function(dart_sdk, app) {
  ...
  let IterableOfApp = () => (IterableOfApp = dart.constFn(core.Iterable$(src__app.App)))();
  ...
  dart.copyProperties(src__top_level, {
    get apps() {
      return IterableOfApp()._check(dart.global.firebase.apps[$map](src__app.App, dart.fn(e => src__app.App.getInstance(dart.lazyJSType(() => dart.global.firebase.app.App, "firebase.app.App")._check(e)), dynamicToApp())))[$toList]();
    }
  });
