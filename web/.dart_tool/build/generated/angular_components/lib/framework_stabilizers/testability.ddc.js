define(['dart_sdk', 'packages/angular_components/framework_stabilizers/framework_stabilizers'], function(dart_sdk, framework_stabilizers) {
  ...
  const framework_stabilizers__testability = Object.create(dart.library);
  ...
  dart.setMethodSignature(framework_stabilizers__testability.AbstractTestability, () => ({
    ...
    whenStable: dart.fnType(dart.void, [dart.fnType(dart.void, [core.bool, core.String])]),
    checkStable: dart.fnType(dart.void, []),
    [_runCallbacksIfStable]: dart.fnType(dart.void, [], {newCallback: dart.fnType(dart.void, [core.bool, core.String])})
  }));
