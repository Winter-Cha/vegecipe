define(['dart_sdk', 'packages/angular_components/src/model/action/async_action', 'packages/angular_components/utils/angular/properties/properties', 'packages/angular_components/laminate/portal/portal'], function(dart_sdk, async_action, properties, portal) {
  ...
  const material_stepper__material_step = Object.create(dart.library);
  ...
  const _continueController = dart.privateName(material_stepper__material_step, "_continueController");
  const _cancelController = dart.privateName(material_stepper__material_step, "_cancelController");
  const _jumpController = dart.privateName(material_stepper__material_step, "_jumpController");
  const _optional = dart.privateName(material_stepper__material_step, "_optional");
  const _hideButtons = dart.privateName(material_stepper__material_step, "_hideButtons");
  const _cancelHidden = dart.privateName(material_stepper__material_step, "_cancelHidden");
  const _complete = dart.privateName(material_stepper__material_step, "_complete");
  const _canContinue = dart.privateName(material_stepper__material_step, "_canContinue");
  const _active = dart.privateName(material_stepper__material_step, "_active");
  const _requestStepAction = dart.privateName(material_stepper__material_step, "_requestStepAction");
