define(['dart_sdk', 'packages/angular_forms/src/directives'], function(dart_sdk, directives) {
  ...
  const src__validators = directives.src__validators;
  const material_input__deferred_validator = Object.create(dart.library);
  ...
  const _delegates = dart.privateName(material_input__deferred_validator, "_delegates");
  ...
  (material_input__deferred_validator.DeferredValidator.new = function() {
  ...
  dart.setMethodSignature(material_input__deferred_validator.DeferredValidator, () => ({
    ...
    add: dart.fnType(dart.void, [dart.fnType(core.Map$(core.String, dart.dynamic), [src__model.AbstractControl])]),
