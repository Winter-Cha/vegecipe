define(['dart_sdk', 'packages/angular_components/material_input/deferred_validator.template', 'packages/angular/angular.template', 'packages/angular_components/focus/focus.template', 'packages/angular_components/forms/error_renderer.template', 'packages/angular_components/interfaces/has_disabled.template', 'packages/angular_components/mixins/focusable_mixin.template', 'packages/angular_components/utils/disposer/disposer.template', 'packages/angular_components/utils/id_generator/id_generator.template', 'packages/angular_forms/angular_forms.template'], function(dart_sdk, deferred_validator, angular, focus, error_renderer, has_disabled, focusable_mixin, disposer, id_generator, angular_forms) {
  ...
  const material_input__base_material_input$46template = Object.create(dart.library);
