define(['dart_sdk', 'packages/angular_components/material_input/material_number_validators', 'packages/angular_components/material_input/material_input', 'packages/angular_components/material_input/material_input_default_value_accessor', 'packages/intl/intl', 'packages/angular_components/utils/angular/properties/properties', 'packages/fixnum/fixnum', 'packages/angular_forms/src/directives', 'packages/quiver/strings'], function(dart_sdk, material_number_validators, material_input, material_input_default_value_accessor, intl, properties, fixnum, directives, strings) {
  ...
  material_input__material_number_accessor.BaseMaterialNumberValueAccessor$ = dart.generic(T => {
    ...
    dart.setLibraryUri(BaseMaterialNumberValueAccessor, "package:angular_components/material_input/material_number_accessor.dart");
  ...
  dart.setLibraryUri(material_input__material_number_accessor.MaterialInt64ValueAccessor, "package:angular_components/material_input/material_number_accessor.dart");
  ...
  dart.setLibraryUri(material_input__material_number_accessor.MaterialNumberValueAccessor, "package:angular_components/material_input/material_number_accessor.dart");
  ...
  dart.setLibraryUri(material_input__material_number_accessor.CheckIntegerValidator, "package:angular_components/material_input/material_number_accessor.dart");
  ...
  dart.setLibraryUri(material_input__material_number_accessor.DecimalNumberFormatDirective, "package:angular_components/material_input/material_number_accessor.dart");
