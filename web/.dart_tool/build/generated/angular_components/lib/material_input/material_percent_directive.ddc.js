define(['dart_sdk', 'packages/intl/intl'], function(dart_sdk, intl) {
  ...
  const material_input__material_percent_directive = Object.create(dart.library);
  ...
  const _replaceErrorMessage = dart.privateName(material_input__material_percent_directive, "_replaceErrorMessage");
  ...
  dart.setLibraryUri(material_input__material_percent_directive.MaterialPercentInputDirective, "package:angular_components/material_input/material_percent_directive.dart");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_percent_directive.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;2BA0C4C,MAA2B;AACnE,UAAI;AACJ,eAAS,MAAO,yFAAe,OAAK,EAAE;AACpC,sBAAI,wFAAe,cAAY,CAAC,GAAG,IAAG;AACpC,2BAAS;sBAAT,SAAS,GAAK,0BAAyB,CAAC,MAAM;AAC9C,kCAAS,EAAC,GAAG,EAAI,wFAAe,QAAC,GAAG;;;AAGxC,UAAM,SAAS,SAAS,WAAT,SAAS,GAAI,MAAM;AAClC,0CAAO,AAAC,yBAAoB,IAAI,kBAC1B,yBAAoB,GAAC,MAAM,KAC3B,MAAM;IACd;IAQS;;;;;;;2FAxCL,KAA4B,EAAE,OAAmB;IAwC5C,0BAAoB;AArC3B,SAAK,KAAK,GAAG;AACb,SAAK,WAAW,GAAG;AACnB,WAAO,IAAI,GAAG;AACd,QAAM,qBAAiB,iCAA2B;AAClD,QAAM,kBAAkB,cAAc,QAAQ,gBAAgB,UAClD,CAAC,cAAc,QAAQ,QAAQ;AAG3C,QAAI,AAAgB,eAAD,GAAG,AAA8C,cAAhC,QAAQ,gBAAgB,OAAO,GAAG,GAAG;AACvE,WAAK,aAAa,GAAG,cAAc,QAAQ,QAAQ;WAC9C;AACL,WAAK,YAAY,GAAG,cAAc,QAAQ,QAAQ;;AAEpD,SAAK,cAAc,GAAG,qCAAoB;EAC5C;;;;;;;;;;;;;MAyB2B,wFAAe;YAAG,0CAC3C,cAAkC,EAAE,kGAAyB,EAC7D,oBAA6B,EAAE,+FAAsB,EACrD,oBAA6B,EAAE,+FAAsB;;;MAG1C,kGAAyB;YAAG,WAAI,QAAQ,CACjD,2CACM,oEACF,uCACA;;MAEK,+FAAsB;YAAG,WAAI,QAAQ,CAAC,gCACzC,mEACF,kBACK,+DACL;;MAEK,+FAAsB;YAAG,WAAI,QAAQ,CAAC,iCACzC,mEACF,kBACK,+DACL","file":"material_percent_directive.ddc.js"}');
  // Exports:
  return {
