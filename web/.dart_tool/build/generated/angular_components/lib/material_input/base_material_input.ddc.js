define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/utils/id_generator/id_generator', 'packages/quiver/strings', 'packages/intl/intl', 'packages/angular_components/mixins/focusable_mixin', 'packages/angular_components/interfaces/has_disabled', 'packages/angular_components/focus/focus_interface', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_forms/src/directives', 'packages/angular/src/bootstrap/modules'], function(dart_sdk, disposer, id_generator, strings, intl, focusable_mixin, has_disabled, focus_interface, change_detection, directives, modules) {
  'use strict';
  ...
  const material_input__base_material_input = Object.create(dart.library);
  ...
  dart.setLibraryUri(material_input__base_material_input.BottomPanelState, "package:angular_components/material_input/base_material_input.dart");
  ...
  const _cd = dart.privateName(material_input__base_material_input, "_cd");
  const _changeDetector = dart.privateName(material_input__base_material_input, "_changeDetector");
  const _disposer = dart.privateName(material_input__base_material_input, "_disposer");
  const _invalid = dart.privateName(material_input__base_material_input, "_invalid");
  const _validationMessage = dart.privateName(material_input__base_material_input, "_validationMessage");
  const _localValidationMessage = dart.privateName(material_input__base_material_input, "_localValidationMessage");
  const _required = dart.privateName(material_input__base_material_input, "_required");
  const _showHintOnlyOnFocus = dart.privateName(material_input__base_material_input, "_showHintOnlyOnFocus");
  const _disabled = dart.privateName(material_input__base_material_input, "_disabled");
  const _pristine = dart.privateName(material_input__base_material_input, "_pristine");
  const _errorMsg = dart.privateName(material_input__base_material_input, "_errorMsg");
  const _error = dart.privateName(material_input__base_material_input, "_error");
  const _inputAriaDescribedBy = dart.privateName(material_input__base_material_input, "_inputAriaDescribedBy");
  const _hintText = dart.privateName(material_input__base_material_input, "_hintText");
  const _requiredErrorMsg = dart.privateName(material_input__base_material_input, "_requiredErrorMsg");
  const _checkValid = dart.privateName(material_input__base_material_input, "_checkValid");
  const _inputTextLength = dart.privateName(material_input__base_material_input, "_inputTextLength");
  const _inputText = dart.privateName(material_input__base_material_input, "_inputText");
  const _characterCounter = dart.privateName(material_input__base_material_input, "_characterCounter");
  const _keypressController = dart.privateName(material_input__base_material_input, "_keypressController");
  const _changeController = dart.privateName(material_input__base_material_input, "_changeController");
  const _blurController = dart.privateName(material_input__base_material_input, "_blurController");
  const _isLocallyValid = dart.privateName(material_input__base_material_input, "_isLocallyValid");
  const _validate = dart.privateName(material_input__base_material_input, "_validate");
  let const$;
  material_input__base_material_input.BaseMaterialInput = class BaseMaterialInput extends mixins__focusable_mixin.FocusableMixin {
    ...
    static _msgCharacterCounter(currentCount, maxCount) {
      return intl$.Intl.message(dart.str(currentCount) + " / " + dart.str(maxCount), {name: "BaseMaterialInput__msgCharacterCounter", args: JSArrayOfObject().of([currentCount, maxCount]), desc: "Character counter shown below a text box in the format \"12 / 25\"", examples: const$ || (const$ = dart.constMap(core.String, core.Object, ["currentCount", 12, "maxCount", 25]))});
    }
  };
  (material_input__base_material_input.BaseMaterialInput.new = function(cd, changeDetector, validator) {
    ...
    this[errorTextId] = new utils__id_generator__id_generator.SequentialIdGenerator.fromUUID().nextId();
    this[_invalid] = false;
  ...
  const errorTextId = Symbol("BaseMaterialInput.errorTextId");
  ...
  const ariaDescribedBy = Symbol("BaseMaterialInput.ariaDescribedBy");
  ...
  dart.setSetterSignature(material_input__base_material_input.BaseMaterialInput, () => ({
    ...
    errorMsg: core.String,
    error: core.String,
    inputAriaDescribedBy: core.String,
  ...
  dart.setLibraryUri(material_input__base_material_input.BaseMaterialInput, "package:angular_components/material_input/base_material_input.dart");
  dart.setFieldSignature(material_input__base_material_input.BaseMaterialInput, () => ({
    ...
    errorTextId: dart.finalFieldType(core.String),
    ...
    [_inputAriaDescribedBy]: dart.fieldType(core.String),
