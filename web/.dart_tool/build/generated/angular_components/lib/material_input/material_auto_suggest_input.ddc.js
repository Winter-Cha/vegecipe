define(['dart_sdk', 'packages/angular_components/model/a11y/active_item', 'packages/angular_components/model/ui/template_support', 'packages/angular_components/model/selection/selection_model', 'packages/angular_components/utils/id_generator/id_generator', 'packages/angular_components/model/selection/selection_options', 'packages/angular_components/utils/angular/properties/properties', 'packages/angular_components/src/model/selection/interfaces/selectable', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/model/selection/select', 'packages/angular_components/material_select/material_select_base', 'packages/angular_components/mixins/selection_input_adapter', 'packages/angular_components/material_input/input_wrapper', 'packages/angular_components/model/a11y/keyboard_handler_mixin', 'packages/angular_components/mixins/highlight_assistant_mixin', 'packages/angular_forms/src/directives', 'packages/angular_components/focus/focus_interface', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/model/ui/has_renderer', 'packages/angular_components/model/ui/has_factory', 'packages/angular_components/mixins/material_dropdown_base', 'packages/angular_components/src/laminate/popup/popup_hierarchy', 'packages/angular_components/laminate/enums/alignment', 'packages/angular_components/material_input/material_input', 'packages/angular_components/src/utils/async/async_update_scheduler'], function(dart_sdk, active_item, template_support, selection_model, id_generator, selection_options, properties, selectable, modules, select, material_select_base, selection_input_adapter, input_wrapper, keyboard_handler_mixin, highlight_assistant_mixin, directives, focus_interface, change_detection, has_renderer, has_factory, material_dropdown_base, popup_hierarchy, alignment, material_input, async_update_scheduler) {
  ...
  const material_input__material_auto_suggest_input = Object.create(dart.library);
  ...
  let ControlValueAccessorOfObject = () => (ControlValueAccessorOfObject = dart.constFn(src__directives__control_value_accessor.ControlValueAccessor$(core.Object)))();
  ...
  const _cd = dart.privateName(material_input__material_auto_suggest_input, "_cd");
  const _popupSizeDelegate = dart.privateName(material_input__material_auto_suggest_input, "_popupSizeDelegate");
  const _isInitialized = dart.privateName(material_input__material_auto_suggest_input, "_isInitialized");
  const _showPopup = dart.privateName(material_input__material_auto_suggest_input, "_showPopup");
  const _focusPending = dart.privateName(material_input__material_auto_suggest_input, "_focusPending");
  const _input = dart.privateName(material_input__material_auto_suggest_input, "_input");
  const _callback = dart.privateName(material_input__material_auto_suggest_input, "_callback");
  const _inputText = dart.privateName(material_input__material_auto_suggest_input, "_inputText");
  const _inputChange = dart.privateName(material_input__material_auto_suggest_input, "_inputChange");
  const _lastSelectedItem = dart.privateName(material_input__material_auto_suggest_input, "_lastSelectedItem");
  const _lastFilterFuture = dart.privateName(material_input__material_auto_suggest_input, "_lastFilterFuture");
  const _filterScheduled = dart.privateName(material_input__material_auto_suggest_input, "_filterScheduled");
  const _isDisposed = dart.privateName(material_input__material_auto_suggest_input, "_isDisposed");
  const _accessibleItemActivation = dart.privateName(material_input__material_auto_suggest_input, "_accessibleItemActivation");
  const _limit = dart.privateName(material_input__material_auto_suggest_input, "_limit");
  const _popupPositions = dart.privateName(material_input__material_auto_suggest_input, "_popupPositions");
  const _selectionListener = dart.privateName(material_input__material_auto_suggest_input, "_selectionListener");
  const _optionsListener = dart.privateName(material_input__material_auto_suggest_input, "_optionsListener");
  const _showPopupController = dart.privateName(material_input__material_auto_suggest_input, "_showPopupController");
  const _onClear = dart.privateName(material_input__material_auto_suggest_input, "_onClear");
  const _isFocused = dart.privateName(material_input__material_auto_suggest_input, "_isFocused");
  const _onFocus = dart.privateName(material_input__material_auto_suggest_input, "_onFocus");
  const _onBlur = dart.privateName(material_input__material_auto_suggest_input, "_onBlur");
  const _filterSuggestions = dart.privateName(material_input__material_auto_suggest_input, "_filterSuggestions");
  const _updateItemActivation = dart.privateName(material_input__material_auto_suggest_input, "_updateItemActivation");
  const _setInputText = dart.privateName(material_input__material_auto_suggest_input, "_setInputText");
  ...
  material_input__material_auto_suggest_input.MaterialAutoSuggestInputComponent$ = dart.generic(T => {
    ...
    class MaterialAutoSuggestInputComponent extends MaterialSelectBase_HighlightAssistantMixin$ {
      ...
      get factoryRenderer() {
        return dynamicToComponentFactory()._check(dart.test(this.highlightOptions) && super.factoryRenderer == null && super.componentRenderer == null ? this.highlightFactoryRenderer : super.factoryRenderer);
      }
      get showPopupChange() {
      ...
      [_updateItemActivation](opts) {
        ...
        if (this.selection == null) {
          ...
          if (dart.test(popupOpening)) {
            let firstSelection = dart.test(this.selection.selectedValues[$isEmpty]) ? null : this.options.optionsList[$firstWhere](dart.fn(opt => this.selection.isSelected(opt), TTobool()), {orElse: dart.fn(() => null, VoidToNull())});
    ...
    MaterialAutoSuggestInputComponent[dart.implements] = () => [ControlValueAccessorOfObject(), focus__focus_interface.Focusable, src__core__metadata__lifecycle_hooks.OnInit, src__core__metadata__lifecycle_hooks.OnDestroy, HasRendererOfT(), HasComponentRendererOfRendersValue$Object(), HasFactoryRendererOfRendersValue$T(), mixins__material_dropdown_base.DropdownHandle, src__laminate__popup__popup_size_provider.PopupSizeProvider];
    dart.setMethodSignature(MaterialAutoSuggestInputComponent, () => ({
      ...
      [_updateItemActivation]: dart.fnType(dart.void, [], {textChanging: core.bool, popupOpening: core.bool}),
      ...
      registerOnChange: dart.fnType(dart.void, [dart.fnType(dart.dynamic, [core.Object], {rawValue: core.String})]),
    ...
    dart.setGetterSignature(MaterialAutoSuggestInputComponent, () => ({
      ...
      accessibleItemActivation: core.bool,
    ...
    dart.setLibraryUri(MaterialAutoSuggestInputComponent, "package:angular_components/material_input/material_auto_suggest_input.dart");
    dart.setFieldSignature(MaterialAutoSuggestInputComponent, () => ({
      ...
      [_accessibleItemActivation]: dart.fieldType(core.bool),
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_auto_suggest_input.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MA0He;;;;;;MACA;;;;;;MAIY;;;;;;MAQpB;;;;;;MAOA;;;;;;MAMA;;;;;;MAMA;;;;;;MAOA;;;;;;MAMA;;;;;;mCAiEwB,KAAU;AACrC,YAAI,KAAK,IAAI,MAAM;AACnB,uCAAyB,GAAG,KAAK;AACjC,wBAAW,2BAA2B,GACR,UAAzB,mBAAc,eAAI,KAAK,eAAM,kBAAa,gBAAK,KAAK;MAC3D;;cAEqC,gCAAyB;;MAUzD;;;;;;MAMA;;;;;;MAIE;;;;;;MAOF;;;;;;MAeE;;;;;;MAOF;;;;;;MAIE;;;;;;;gBAEyB,qBAAgB;;+BAAgB;MAAK;MAI9D;;;;;;uBASU,KAAqB;cAAK,mBAAkB,GAAG,KAAK;;;;;4BAO/C,KAAuB;cACzC,wBAAuB,GAAG,KAAK;;0BAKf,KAAsC;cACtD,sBAAqB,GAAG,KAAK;;MAIlB;;;;;;iBAYP,EAAgC,EAChC,WAAmC,EACnC,iBAA2D;AAAE,mBACjE,kDAA2C,CAAC,EAAE,EAC1C,WAAW,WAAX,WAAW,OAAI,gEAA8B,IAAI,iBAAiB;MAAC;;cAezC,mBAAY,OAAO;;;AAMnD,YAAI,UAAK,IAAI,MAAM,