define(['dart_sdk', 'packages/angular_components/interfaces/has_disabled'], function(dart_sdk, has_disabled) {
  ...
  const material_input__input_wrapper = Object.create(dart.library);
  const _label = dart.privateName(material_input__input_wrapper, "_label");
  const _ariaLabel = dart.privateName(material_input__input_wrapper, "_ariaLabel");
  const _inputText = dart.privateName(material_input__input_wrapper, "_inputText");
  ...
  dart.setLibraryUri(material_input__input_wrapper.MaterialInputWrapper, "package:angular_components/material_input/input_wrapper.dart");
