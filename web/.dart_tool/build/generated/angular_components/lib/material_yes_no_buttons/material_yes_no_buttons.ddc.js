define(['dart_sdk', 'packages/angular_components/interfaces/has_disabled', 'packages/angular_components/material_button/material_button', 'packages/intl/intl', 'packages/angular/src/core/change_detection/change_detection'], function(dart_sdk, has_disabled, material_button, intl, change_detection) {
  ...
  const material_yes_no_buttons__material_yes_no_buttons = Object.create(dart.library);
  ...
  const _yes = dart.privateName(material_yes_no_buttons__material_yes_no_buttons, "_yes");
  const _no = dart.privateName(material_yes_no_buttons__material_yes_no_buttons, "_no");
  ...
  const yesAriaLabel = Symbol("MaterialYesNoButtonsComponent.yesAriaLabel");
  const noAriaLabel = Symbol("MaterialYesNoButtonsComponent.noAriaLabel");
  const yesAutoFocus = Symbol("MaterialYesNoButtonsComponent.yesAutoFocus");
  const noAutoFocus = Symbol("MaterialYesNoButtonsComponent.noAutoFocus");
  ...
  dart.setFieldSignature(material_yes_no_buttons__material_yes_no_buttons.MaterialYesNoButtonsComponent, () => ({
    ...
    yesAriaLabel: dart.fieldType(core.String),
    noAriaLabel: dart.fieldType(core.String),
    yesAutoFocus: dart.fieldType(core.bool),
    noAutoFocus: dart.fieldType(core.bool),
  ...
  const _subscription = dart.privateName(material_yes_no_buttons__material_yes_no_buttons, "_subscription");
  const _onMatchingKeyUp = dart.privateName(material_yes_no_buttons__material_yes_no_buttons, "_onMatchingKeyUp");
  const _isKeyUpMatching = dart.privateName(material_yes_no_buttons__material_yes_no_buttons, "_isKeyUpMatching");
  ...
  const _yesNo = dart.privateName(material_yes_no_buttons__material_yes_no_buttons, "_yesNo");
