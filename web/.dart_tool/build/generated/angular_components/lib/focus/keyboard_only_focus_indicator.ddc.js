define(['dart_sdk', 'packages/angular_components/utils/browser/dom_service/dom_service'], function(dart_sdk, dom_service) {
  ...
  const focus__keyboard_only_focus_indicator = Object.create(dart.library);
  const $outline = dartx.outline;
  let VoidToNull = () => (VoidToNull = dart.constFn(dart.fnType(core.Null, [])))();
  const _element = dart.privateName(focus__keyboard_only_focus_indicator, "_element");
  const _domService = dart.privateName(focus__keyboard_only_focus_indicator, "_domService");
  const _lastInteraction = dart.privateName(focus__keyboard_only_focus_indicator, "_lastInteraction");
