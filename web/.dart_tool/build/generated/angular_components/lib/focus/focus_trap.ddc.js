define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/utils/browser/dom_iterator/dom_iterator', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/focus/focus'], function(dart_sdk, disposer, dom_iterator, change_detection, focus) {
  ...
  const focus__focus_trap = Object.create(dart.library);
  const $offsetWidth = dartx.offsetWidth;
  const $offsetHeight = dartx.offsetHeight;
  const _disposer = dart.privateName(focus__focus_trap, "_disposer");
  const _autoFocusDirective = dart.privateName(focus__focus_trap, "_autoFocusDirective");
  const _content = dart.privateName(focus__focus_trap, "_content");
  const _element = dart.privateName(focus__focus_trap, "_element");
  const _focusFirstInOrder = dart.privateName(focus__focus_trap, "_focusFirstInOrder");
  const _visible = dart.privateName(focus__focus_trap, "_visible");
  const _focusDefault = dart.privateName(focus__focus_trap, "_focusDefault");
  ...
  dart.setLibraryUri(focus__focus_trap.FocusTrapComponent, "package:angular_components/focus/focus_trap.dart");
  ...
  dart.setLibraryUri(focus__focus_trap.FocusContentWrapper, "package:angular_components/focus/focus_trap.dart");
