define(['dart_sdk', 'packages/angular_components/focus/focus', 'packages/angular_components/focus/focus_interface'], function(dart_sdk, focus, focus_interface) {
  'use strict';
  ...
  const focus__focus_activable_item = Object.create(dart.library);
