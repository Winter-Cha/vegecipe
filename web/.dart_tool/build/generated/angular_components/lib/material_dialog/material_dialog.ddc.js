define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/utils/id_generator/id_generator', 'packages/angular_components/src/model/action/async_action', 'packages/angular_components/model/a11y/keyboard_handler_mixin', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/laminate/components/modal/modal'], function(dart_sdk, disposer, id_generator, async_action, keyboard_handler_mixin, change_detection, dom_service, modal) {
  'use strict';
  ...
  const material_dialog__material_dialog = Object.create(dart.library);
  ...
  const _rootElement = dart.privateName(material_dialog__material_dialog, "_rootElement");
  const _domService = dart.privateName(material_dialog__material_dialog, "_domService");
  const _changeDetector = dart.privateName(material_dialog__material_dialog, "_changeDetector");
  const _modal = dart.privateName(material_dialog__material_dialog, "_modal");
  const _disposer = dart.privateName(material_dialog__material_dialog, "_disposer");
  const _uid = dart.privateName(material_dialog__material_dialog, "_uid");
  const _mainElement = dart.privateName(material_dialog__material_dialog, "_mainElement");
  const _shouldShowHeader = dart.privateName(material_dialog__material_dialog, "_shouldShowHeader");
  const _shouldShowFooter = dart.privateName(material_dialog__material_dialog, "_shouldShowFooter");
  const _isInFullscreenModeStreamController = dart.privateName(material_dialog__material_dialog, "_isInFullscreenModeStreamController");
  const _isInFullscreenMode = dart.privateName(material_dialog__material_dialog, "_isInFullscreenMode");
  const _shouldListenForFullscreenChanges = dart.privateName(material_dialog__material_dialog, "_shouldListenForFullscreenChanges");
  const _defaultEscapeHandler = dart.privateName(material_dialog__material_dialog, "_defaultEscapeHandler");
  const _setHeaderFooterScrollBorder = dart.privateName(material_dialog__material_dialog, "_setHeaderFooterScrollBorder");
  const _listenForFullscreenChanges = dart.privateName(material_dialog__material_dialog, "_listenForFullscreenChanges");
  const _updateForFullscreenChangesInsideDomReadLoop = dart.privateName(material_dialog__material_dialog, "_updateForFullscreenChangesInsideDomReadLoop");
  ...
  material_dialog__material_dialog.MaterialDialogComponent = class MaterialDialogComponent extends Object_KeyboardHandlerMixin$ {
    get headerId() {
  ...
  (material_dialog__material_dialog.MaterialDialogComponent.new = function(rootElement, domService, changeDetector, modal) {
    ...
    this[_uid] = new utils__id_generator__id_generator.SequentialIdGenerator.fromUUID().nextId();
    ...
    this[_modal] = modal;
    material_dialog__material_dialog.MaterialDialogComponent.__proto__.new.call(this);
  ...
  const escapeHandler = Symbol("MaterialDialogComponent.escapeHandler");
  ...
  dart.setMethodSignature(material_dialog__material_dialog.MaterialDialogComponent, () => ({
    ...
    [_defaultEscapeHandler]: dart.fnType(dart.void, [html.KeyboardEvent]),
  ...
  dart.setLibraryUri(material_dialog__material_dialog.MaterialDialogComponent, "package:angular_components/material_dialog/material_dialog.dart");
  dart.setFieldSignature(material_dialog__material_dialog.MaterialDialogComponent, () => ({
    ...
    [_uid]: dart.finalFieldType(core.String),
    ...
    escapeHandler: dart.fieldType(KeyboardEventTovoid()),
    error: dart.fieldType(core.String),
    shouldShowScrollStrokes: dart.fieldType(core.bool)
  }));
  dart.defineLazy(material_dialog__material_dialog.MaterialDialogComponent, {
    /*material_dialog__material_dialog.MaterialDialogComponent.hostRole*/get hostRole() {
      return "dialog";
    },
    /*material_dialog__material_dialog.MaterialDialogComponent.ariaModel*/get ariaModel() {
      return "true";
    }
  });
