define(['dart_sdk', 'packages/angular_components/model/ui/icon'], function(dart_sdk, icon) {
  ...
  const glyph__glyph = Object.create(dart.library);
  ...
  const _element = dart.privateName(glyph__glyph, "_element");
  const _icon = dart.privateName(glyph__glyph, "_icon");
  const _iconSet = dart.privateName(glyph__glyph, "_iconSet");
  const _useMaterialIconsExtended = dart.privateName(glyph__glyph, "_useMaterialIconsExtended");
  const _isIconModel = dart.privateName(glyph__glyph, "_isIconModel");
  ...
  dart.setGetterSignature(glyph__glyph.GlyphComponent, () => ({
    ...
    icon: dart.dynamic,
    [_isIconModel]: core.bool,
    iconName: core.String,
    iconSet: core.String,
    useMaterialIconsExtended: core.bool
  }));
