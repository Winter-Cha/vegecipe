define(['dart_sdk', 'packages/angular_components/material_datepicker/preset', 'packages/angular_components/model/date/date', 'packages/angular_components/material_datepicker/calendar', 'packages/angular_components/material_datepicker/range', 'packages/angular_components/model/date/date_formatter', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/focus/focus_interface', 'packages/angular_components/src/material_datepicker/comparison_range_editor', 'packages/angular_components/src/laminate/popup/popup_hierarchy', 'packages/intl/intl', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/src/utils/angular/managed_zone/managed_zone', 'packages/angular_components/material_datepicker/material_calendar_picker', 'packages/angular_components/material_datepicker/material_month_picker', 'packages/quiver/time', 'packages/angular_components/model/observable/observable', 'packages/angular_components/src/material_datepicker/sequential'], function(dart_sdk, preset, date, calendar, range, date_formatter, change_detection, focus_interface, comparison_range_editor, popup_hierarchy, intl, dom_service, managed_zone, material_calendar_picker, material_month_picker, time, observable, sequential) {
  ...
  const material_datepicker__date_range_editor = Object.create(dart.library);
  ...
  const _elementRef = dart.privateName(material_datepicker__date_range_editor, "_elementRef");
  const _domService = dart.privateName(material_datepicker__date_range_editor, "_domService");
  const _managedZone = dart.privateName(material_datepicker__date_range_editor, "_managedZone");
  const _allowHighlightUpdates = dart.privateName(material_datepicker__date_range_editor, "_allowHighlightUpdates");
  const _supportsComparison = dart.privateName(material_datepicker__date_range_editor, "_supportsComparison");
  const _compact = dart.privateName(material_datepicker__date_range_editor, "_compact");
  const _supportsDaysInputs = dart.privateName(material_datepicker__date_range_editor, "_supportsDaysInputs");
  const _presets = dart.privateName(material_datepicker__date_range_editor, "_presets");
  const _validPresets = dart.privateName(material_datepicker__date_range_editor, "_validPresets");
  const _minDate = dart.privateName(material_datepicker__date_range_editor, "_minDate");
  const _maxDate = dart.privateName(material_datepicker__date_range_editor, "_maxDate");
  const _isCalendarCreated = dart.privateName(material_datepicker__date_range_editor, "_isCalendarCreated");
  const _daysToToday = dart.privateName(material_datepicker__date_range_editor, "_daysToToday");
  const _daysToYesterday = dart.privateName(material_datepicker__date_range_editor, "_daysToYesterday");
  const _clock = dart.privateName(material_datepicker__date_range_editor, "_clock");
  const _today = dart.privateName(material_datepicker__date_range_editor, "_today");
  const _controller = dart.privateName(material_datepicker__date_range_editor, "_controller");
  const _monthSelectorState = dart.privateName(material_datepicker__date_range_editor, "_monthSelectorState");
  const _visibleMonth = dart.privateName(material_datepicker__date_range_editor, "_visibleMonth");
  const _visibleMonthName = dart.privateName(material_datepicker__date_range_editor, "_visibleMonthName");
  const _updateValidPresets = dart.privateName(material_datepicker__date_range_editor, "_updateValidPresets");
  const _parseDaysInput = dart.privateName(material_datepicker__date_range_editor, "_parseDaysInput");
  const _createDaysToTodayRange = dart.privateName(material_datepicker__date_range_editor, "_createDaysToTodayRange");
  const _createDaysToYesterdayRange = dart.privateName(material_datepicker__date_range_editor, "_createDaysToYesterdayRange");
  ...
  const dateFormat = Symbol("DateRangeEditorComponent.dateFormat");
  const activeDateFormat = Symbol("DateRangeEditorComponent.activeDateFormat");
  ...
  dart.setLibraryUri(material_datepicker__date_range_editor.DateRangeEditorComponent, "package:angular_components/material_datepicker/date_range_editor.dart");
  ...
  dart.setLibraryUri(material_datepicker__date_range_editor.DateRangeEditorNextPrevModel, "package:angular_components/material_datepicker/date_range_editor.dart");
