define(['dart_sdk', 'packages/angular_components/model/date/date', 'packages/angular_components/material_datepicker/calendar', 'packages/angular_components/model/observable/observable', 'packages/intl/intl', 'packages/angular/src/core/change_detection/change_detection'], function(dart_sdk, date, calendar, observable, intl, change_detection) {
  ...
  const material_datepicker__date_range_input = Object.create(dart.library);
  ...
  const _changeDetector = dart.privateName(material_datepicker__date_range_input, "_changeDetector");
  const _calendarStream = dart.privateName(material_datepicker__date_range_input, "_calendarStream");
  const _disabled = dart.privateName(material_datepicker__date_range_input, "_disabled");
  const _controller = dart.privateName(material_datepicker__date_range_input, "_controller");
  const _isClearRangeSelected = dart.privateName(material_datepicker__date_range_input, "_isClearRangeSelected");
  const _range = dart.privateName(material_datepicker__date_range_input, "_range");
  const _model = dart.privateName(material_datepicker__date_range_input, "_model");
  const _onCalendarChange = dart.privateName(material_datepicker__date_range_input, "_onCalendarChange");
  ...
  dart.setLibraryUri(material_datepicker__date_range_input.DateRangeInputComponent, "package:angular_components/material_datepicker/date_range_input.dart");
