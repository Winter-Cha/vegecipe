define(['dart_sdk', 'packages/angular_components/model/date/date', 'packages/angular_components/material_datepicker/proto/date_range.pb', 'packages/angular_components/material_datepicker/proto/date.pb', 'packages/quiver/time', 'packages/intl/intl'], function(dart_sdk, date, date_range, date$, time, intl) {
  ...
  const material_datepicker__range = Object.create(dart.library);
  ...
  dart.setLibraryUri(material_datepicker__range.DatepickerDateRange, "package:angular_components/material_datepicker/range.dart");
  ...
  const _delegate = dart.privateName(material_datepicker__range, "_delegate");
  const _min = dart.privateName(material_datepicker__range, "_min");
  const _max = dart.privateName(material_datepicker__range, "_max");
  ...
  dart.setLibraryUri(material_datepicker__range._ClampedDateRange, "package:angular_components/material_datepicker/range.dart");
  ...
  const _next = dart.privateName(material_datepicker__range, "_next");
  const _prev = dart.privateName(material_datepicker__range, "_prev");
  ...
  dart.setLibraryUri(material_datepicker__range._BasicDateRange, "package:angular_components/material_datepicker/range.dart");
  ...
  const _date = dart.privateName(material_datepicker__range, "_date");
  const _ago = dart.privateName(material_datepicker__range, "_ago");
  const _titleFunction = dart.privateName(material_datepicker__range, "_titleFunction");
  let const$;
  let const$0;
  ...
  dart.setLibraryUri(material_datepicker__range.SingleDayRange, "package:angular_components/material_datepicker/range.dart");
  ...
  const _start = dart.privateName(material_datepicker__range, "_start");
  const _lengthInDays = dart.privateName(material_datepicker__range, "_lengthInDays");
  ...
  dart.setLibraryUri(material_datepicker__range.MultipleDaysRange, "package:angular_components/material_datepicker/range.dart");
  ...
  dart.setLibraryUri(material_datepicker__range.LastNDaysRange, "package:angular_components/material_datepicker/range.dart");
  let const$2;
  ...
  dart.setLibraryUri(material_datepicker__range.LastNDaysToTodayRange, "package:angular_components/material_datepicker/range.dart");
  let const$3;
  ...
  dart.setLibraryUri(material_datepicker__range.NextNDaysFromTodayRange, "package:angular_components/material_datepicker/range.dart");
  const _startWeekday = dart.privateName(material_datepicker__range, "_startWeekday");
  let const$4;
  let const$5;
  ...
  dart.setLibraryUri(material_datepicker__range.WeekRange, "package:angular_components/material_datepicker/range.dart");
  ...
  dart.setLibraryUri(material_datepicker__range.MonthRange, "package:angular_components/material_datepicker/range.dart");
  ...
  const _theFirst = dart.privateName(material_datepicker__range, "_theFirst");
  let const$8;
  let const$9;
  ...
  dart.setLibraryUri(material_datepicker__range.BroadcastMonthRange, "package:angular_components/material_datepicker/range.dart");
  ...
  dart.setLibraryUri(material_datepicker__range.YearRange, "package:angular_components/material_datepicker/range.dart");
  ...
  dart.setLibraryUri(material_datepicker__range.QuarterRange, "package:angular_components/material_datepicker/range.dart");
