define(['dart_sdk', 'packages/angular_components/model/date/date', 'packages/collection/src/comparators', 'packages/intl/intl'], function(dart_sdk, date, comparators, intl) {
  ...
  const material_datepicker__calendar = Object.create(dart.library);
  ...
  const _classes = dart.privateName(material_datepicker__calendar, "_classes");
  const _boundaryClasses = dart.privateName(material_datepicker__calendar, "_boundaryClasses");
  ...
  dart.setLibraryUri(material_datepicker__calendar.CalendarDay, "package:angular_components/material_datepicker/calendar.dart");
  ...
  const _initClasses = dart.privateName(material_datepicker__calendar, "_initClasses");
  const _positionClasses = dart.privateName(material_datepicker__calendar, "_positionClasses");
  const _colorClasses = dart.privateName(material_datepicker__calendar, "_colorClasses");
  ...
  dart.setLibraryUri(material_datepicker__calendar.Highlight, "package:angular_components/material_datepicker/calendar.dart");
  ...
  const _state = dart.privateName(material_datepicker__calendar, "_state");
  const _highlights = dart.privateName(material_datepicker__calendar, "_highlights");
  const _mergedHighlights = dart.privateName(material_datepicker__calendar, "_mergedHighlights");
  const _updateHighlights = dart.privateName(material_datepicker__calendar, "_updateHighlights");
  const _matching = dart.privateName(material_datepicker__calendar, "_matching");
  const _generateHighlights = dart.privateName(material_datepicker__calendar, "_generateHighlights");
  ...
  dart.setLibraryUri(material_datepicker__calendar._HasHighlights, "package:angular_components/material_datepicker/calendar.dart");
  ...
  dart.setLibraryUri(material_datepicker__calendar.CalendarResolution, "package:angular_components/material_datepicker/calendar.dart");
  ...
  dart.setLibraryUri(material_datepicker__calendar.CalendarSelectionMode, "package:angular_components/material_datepicker/calendar.dart");
  ...
  dart.setLibraryUri(material_datepicker__calendar.CalendarSelection, "package:angular_components/material_datepicker/calendar.dart");
  ...
  dart.setLibraryUri(material_datepicker__calendar.CausedBy, "package:angular_components/material_datepicker/calendar.dart");
  ...
  const _resolutionAtLeast = dart.privateName(material_datepicker__calendar, "_resolutionAtLeast");
  ...
  dart.setLibraryUri(material_datepicker__calendar.CalendarState, "package:angular_components/material_datepicker/calendar.dart");
  ...
  const _start = dart.privateName(material_datepicker__calendar, "_start");
  const _title = dart.privateName(material_datepicker__calendar, "_title");
  const _weeks = dart.privateName(material_datepicker__calendar, "_weeks");
  const _generateWeeks = dart.privateName(material_datepicker__calendar, "_generateWeeks");
  ...
  dart.setLibraryUri(material_datepicker__calendar.CalendarMonth, "package:angular_components/material_datepicker/calendar.dart");
  ...
  dart.setLibraryUri(material_datepicker__calendar.MonthRange, "package:angular_components/material_datepicker/calendar.dart");
  ...
  const _startingWeekday = dart.privateName(material_datepicker__calendar, "_startingWeekday");
  const _days = dart.privateName(material_datepicker__calendar, "_days");
  const _spacers = dart.privateName(material_datepicker__calendar, "_spacers");
  const _end = dart.privateName(material_datepicker__calendar, "_end");
  const _endOfMonth = dart.privateName(material_datepicker__calendar, "_endOfMonth");
  const _generateDays = dart.privateName(material_datepicker__calendar, "_generateDays");
  const _iterateDays = dart.privateName(material_datepicker__calendar, "_iterateDays");
  ...
  dart.setLibraryUri(material_datepicker__calendar.CalendarWeek, "package:angular_components/material_datepicker/calendar.dart");
  ...
  const _months = dart.privateName(material_datepicker__calendar, "_months");
  const _generateMonths = dart.privateName(material_datepicker__calendar, "_generateMonths");
  const _monthDates = dart.privateName(material_datepicker__calendar, "_monthDates");
  ...
  dart.setLibraryUri(material_datepicker__calendar.CalendarYear, "package:angular_components/material_datepicker/calendar.dart");
  ...
  dart.setLibraryUri(material_datepicker__calendar.YearRange, "package:angular_components/material_datepicker/calendar.dart");
