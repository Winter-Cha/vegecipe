define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/src/material_datepicker/sequential', 'packages/intl/intl'], function(dart_sdk, disposer, change_detection, sequential, intl) {
  ...
  const material_datepicker__next_prev_buttons = Object.create(dart.library);
  let boolToNull = () => (boolToNull = dart.constFn(dart.fnType(core.Null, [core.bool])))();
  const _changeDetector = dart.privateName(material_datepicker__next_prev_buttons, "_changeDetector");
  const _modelListeners = dart.privateName(material_datepicker__next_prev_buttons, "_modelListeners");
  const _model = dart.privateName(material_datepicker__next_prev_buttons, "_model");
  const _hasNext = dart.privateName(material_datepicker__next_prev_buttons, "_hasNext");
  const _hasPrev = dart.privateName(material_datepicker__next_prev_buttons, "_hasPrev");
  ...
  dart.setLibraryUri(material_datepicker__next_prev_buttons.NextPrevComponent, "package:angular_components/material_datepicker/next_prev_buttons.dart");
