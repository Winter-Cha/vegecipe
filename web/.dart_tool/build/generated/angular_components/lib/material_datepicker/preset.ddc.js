define(['dart_sdk', 'packages/angular_components/material_datepicker/range', 'packages/intl/intl'], function(dart_sdk, range, intl) {
  ...
  const material_datepicker__preset = Object.create(dart.library);
  const $add = dartx.add;
  ...
  dart.setLibraryUri(material_datepicker__preset.DatepickerPreset, "package:angular_components/material_datepicker/preset.dart");
