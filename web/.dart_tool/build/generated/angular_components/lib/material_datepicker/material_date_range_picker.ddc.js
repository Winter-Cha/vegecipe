define(['dart_sdk', 'packages/angular_components/material_datepicker/config', 'packages/angular_components/utils/angular/css/css', 'packages/angular_components/laminate/enums/alignment', 'packages/angular_components/material_datepicker/preset', 'packages/angular_components/material_datepicker/model', 'packages/angular_components/material_datepicker/comparison', 'packages/angular_components/model/observable/observable', 'packages/angular_components/model/date/date_formatter', 'packages/angular_components/model/date/date', 'packages/angular_components/src/material_datepicker/comparison_range_editor', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/material_datepicker/range', 'packages/angular_components/material_datepicker/comparison_option', 'packages/intl/intl', 'packages/angular_components/interfaces/has_disabled', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/material_datepicker/date_range_editor_host', 'packages/angular_components/src/laminate/popup/popup_hierarchy', 'packages/angular_components/focus/focus_interface', 'packages/angular_components/focus/keyboard_only_focus_indicator', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/material_popup/material_popup'], function(dart_sdk, config, css, alignment, preset, model, comparison, observable, date_formatter, date, comparison_range_editor, disposer, range, comparison_option, intl, has_disabled, change_detection, date_range_editor_host, popup_hierarchy, focus_interface, keyboard_only_focus_indicator, dom_service, material_popup) {
  ...
  const material_datepicker__material_date_range_picker = Object.create(dart.library);
  ...
  const _popupSizeProvider = dart.privateName(material_datepicker__material_date_range_picker, "_popupSizeProvider");
  const _domService = dart.privateName(material_datepicker__material_date_range_picker, "_domService");
  const _ngZone = dart.privateName(material_datepicker__material_date_range_picker, "_ngZone");
  const _config = dart.privateName(material_datepicker__material_date_range_picker, "_config");
  const _dateRangeEditor = dart.privateName(material_datepicker__material_date_range_picker, "_dateRangeEditor");
  const _focusOnDateRangeEditorInit = dart.privateName(material_datepicker__material_date_range_picker, "_focusOnDateRangeEditorInit");
  const _supportsComparison = dart.privateName(material_datepicker__material_date_range_picker, "_supportsComparison");
  const _showNextPrevButtons = dart.privateName(material_datepicker__material_date_range_picker, "_showNextPrevButtons");
  const _supportsDaysInputs = dart.privateName(material_datepicker__material_date_range_picker, "_supportsDaysInputs");
  const _compact = dart.privateName(material_datepicker__material_date_range_picker, "_compact");
  const _movingStartMaintainsLength = dart.privateName(material_datepicker__material_date_range_picker, "_movingStartMaintainsLength");
  const _disabled = dart.privateName(material_datepicker__material_date_range_picker, "_disabled");
  const _minDate = dart.privateName(material_datepicker__material_date_range_picker, "_minDate");
  const _maxDate = dart.privateName(material_datepicker__material_date_range_picker, "_maxDate");
  const _customPlaceHolderMsg = dart.privateName(material_datepicker__material_date_range_picker, "_customPlaceHolderMsg");
  const _comparisonOptions = dart.privateName(material_datepicker__material_date_range_picker, "_comparisonOptions");
  const _lastState = dart.privateName(material_datepicker__material_date_range_picker, "_lastState");
  const _popupVisible = dart.privateName(material_datepicker__material_date_range_picker, "_popupVisible");
  const _isEditorCreated = dart.privateName(material_datepicker__material_date_range_picker, "_isEditorCreated");
  const _isCalendarCreated = dart.privateName(material_datepicker__material_date_range_picker, "_isCalendarCreated");
  const _isApplying = dart.privateName(material_datepicker__material_date_range_picker, "_isApplying");
  const _disposer = dart.privateName(material_datepicker__material_date_range_picker, "_disposer");
  const _onPopupVisible = dart.privateName(material_datepicker__material_date_range_picker, "_onPopupVisible");
  const _formattedRange = dart.privateName(material_datepicker__material_date_range_picker, "_formattedRange");
  const _formattedComparison = dart.privateName(material_datepicker__material_date_range_picker, "_formattedComparison");
  const _maybeStripComparison = dart.privateName(material_datepicker__material_date_range_picker, "_maybeStripComparison");
  const _isPreset = dart.privateName(material_datepicker__material_date_range_picker, "_isPreset");
  const _updateFormattedRanges = dart.privateName(material_datepicker__material_date_range_picker, "_updateFormattedRanges");
  const _showApplyBar = dart.privateName(material_datepicker__material_date_range_picker, "_showApplyBar");
  const _isComparisonOptionsSupported = dart.privateName(material_datepicker__material_date_range_picker, "_isComparisonOptionsSupported");
  const _initCalendar = dart.privateName(material_datepicker__material_date_range_picker, "_initCalendar");
  const _getFormattedRange = dart.privateName(material_datepicker__material_date_range_picker, "_getFormattedRange");
  const _compareMsg = dart.privateName(material_datepicker__material_date_range_picker, "_compareMsg");
  const _getFormattedComparison = dart.privateName(material_datepicker__material_date_range_picker, "_getFormattedComparison");
  let const$;
  ...
  const preferredPositions = Symbol("MaterialDateRangePickerComponent.preferredPositions");
  ...
  const dropdownButtonAriaLabel = Symbol("MaterialDateRangePickerComponent.dropdownButtonAriaLabel");
  const dateFormat = Symbol("MaterialDateRangePickerComponent.dateFormat");
  const activeDateFormat = Symbol("MaterialDateRangePickerComponent.activeDateFormat");
  ...
  dart.setLibraryUri(material_datepicker__material_date_range_picker.MaterialDateRangePickerComponent, "package:angular_components/material_datepicker/material_date_range_picker.dart");
  dart.setFieldSignature(material_datepicker__material_date_range_picker.MaterialDateRangePickerComponent, () => ({
    ...
    dropdownButtonAriaLabel: dart.fieldType(core.String),
