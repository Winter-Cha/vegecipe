define(['dart_sdk', 'packages/angular_components/utils/angular/css/css', 'packages/intl/intl', 'packages/angular_components/laminate/enums/alignment', 'packages/angular_components/model/date/date', 'packages/angular_components/material_datepicker/calendar', 'packages/angular_components/material_datepicker/range', 'packages/quiver/time', 'packages/angular_components/focus/focus_interface', 'packages/angular_components/mixins/focusable_mixin', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/interfaces/has_disabled', 'packages/angular_components/material_select/dropdown_button', 'packages/angular_components/material_input/material_input'], function(dart_sdk, css, intl, alignment, date, calendar, range, time, focus_interface, focusable_mixin, change_detection, has_disabled, dropdown_button, material_input) {
  ...
  const material_datepicker__material_datepicker = Object.create(dart.library);
  ...
  const _compact = dart.privateName(material_datepicker__material_datepicker, "_compact");
  const _controller = dart.privateName(material_datepicker__material_datepicker, "_controller");
  const _date = dart.privateName(material_datepicker__material_datepicker, "_date");
  const _calendar = dart.privateName(material_datepicker__material_datepicker, "_calendar");
  const _disabled = dart.privateName(material_datepicker__material_datepicker, "_disabled");
  const _popupVisible = dart.privateName(material_datepicker__material_datepicker, "_popupVisible");
  const _popupVisibleController = dart.privateName(material_datepicker__material_datepicker, "_popupVisibleController");
  const _presetDates = dart.privateName(material_datepicker__material_datepicker, "_presetDates");
  const _numCalendarWeekRows = dart.privateName(material_datepicker__material_datepicker, "_numCalendarWeekRows");
  const _updateLabel = dart.privateName(material_datepicker__material_datepicker, "_updateLabel");
  const _setDateInternal = dart.privateName(material_datepicker__material_datepicker, "_setDateInternal");
  const _focusTarget = dart.privateName(material_datepicker__material_datepicker, "_focusTarget");
  ...
  const ariaLabelForDropdownButton = Symbol("MaterialDatepickerComponent.ariaLabelForDropdownButton");
  ...
  const selectDatePlaceHolderMsg = Symbol("MaterialDatepickerComponent.selectDatePlaceHolderMsg");
  const placeholderMsg = Symbol("MaterialDatepickerComponent.placeholderMsg");
  ...
  dart.setLibraryUri(material_datepicker__material_datepicker.MaterialDatepickerComponent, "package:angular_components/material_datepicker/material_datepicker.dart");
  dart.setFieldSignature(material_datepicker__material_datepicker.MaterialDatepickerComponent, () => ({
    ...
    ariaLabelForDropdownButton: dart.fieldType(core.String),
    ...
    selectDatePlaceHolderMsg: dart.fieldType(core.String),
    placeholderMsg: dart.fieldType(core.String),
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_datepicker.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IA0Ee;;;;;;IAIN;;;;;;IAMI;;;;;;IAQN;;;;;;IAQA;;;;;;gBAIO,KAAU;AACpB,oBAAQ,GAAG,KAAK;IAClB;;YAGoB,eAAQ;;IASvB;;;;;;IAGkB;;;;;;;YAOQ,kBAAW,OAAO;;uBAE3B,IAAS;UACjB,+CAAQ,sCAAQ,SAAS;UAAO,8DAAa;AACzD,sBAAI,IAAI,EAAI,WAAK,GAAE;AACnB,uBAAW,IAAI,CAAC,IAAI;AACpB,iBAAK,GAAG,IAAI;AACZ,qBAAS,GAAG,IAAI,IAAI,OACd,eAAS,oBAAoB,CAAC,IAAI,EAAE,IAAI,UAAS,KAAK,KACtD,eAAS,sBAAsB;AACrC,wBAAY;AACZ,oBAAI,UAAU,GAAE;AACd,yBAAY,GAAG;;IAEnB;aAIS,IAAS;AAChB,4BAAgB,CAAC,IAAI,eAAc;IACrC;;YAGiB,YAAK;;;YAGQ,gBAAS;;iBAC1B,KAAmB;AAC9B,qBAAS,GAAG,KAAK;AACjB,qBAAK,KAAK,IAAI,CAAC,KAAK,iBAAiB,IAAG;AACxC,4BAAgB,CAAC,KAAK,UAAU,CAAC,KAAK,iBAAiB,OAAO,UACnD,sCAAQ,aAAa;I