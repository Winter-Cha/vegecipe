define(['dart_sdk', 'packages/angular_components/material_datepicker/calendar', 'packages/angular_components/model/observable/observable', 'packages/angular_components/src/material_datepicker/calendar_listener', 'packages/quiver/time', 'packages/angular_components/model/date/date', 'packages/angular/src/core/change_detection/change_detection', 'packages/intl/intl'], function(dart_sdk, calendar, observable, calendar_listener, time, date, change_detection, intl) {
  ...
  const material_datepicker__material_month_picker = Object.create(dart.library);
  ...
  const _model = dart.privateName(material_datepicker__material_month_picker, "_model");
  const _minDate = dart.privateName(material_datepicker__material_month_picker, "_minDate");
  const _maxDate = dart.privateName(material_datepicker__material_month_picker, "_maxDate");
  const _mode = dart.privateName(material_datepicker__material_month_picker, "_mode");
  const _today = dart.privateName(material_datepicker__material_month_picker, "_today");
  const _scroller = dart.privateName(material_datepicker__material_month_picker, "_scroller");
  const _container = dart.privateName(material_datepicker__material_month_picker, "_container");
  const _isResetNeeded = dart.privateName(material_datepicker__material_month_picker, "_isResetNeeded");
  const _inputListener = dart.privateName(material_datepicker__material_month_picker, "_inputListener");
  const _calendarStream = dart.privateName(material_datepicker__material_month_picker, "_calendarStream");
  const _clickListener = dart.privateName(material_datepicker__material_month_picker, "_clickListener");
  const _mouseDownListener = dart.privateName(material_datepicker__material_month_picker, "_mouseDownListener");
  const _mouseMoveListener = dart.privateName(material_datepicker__material_month_picker, "_mouseMoveListener");
  const _mouseLeaveListener = dart.privateName(material_datepicker__material_month_picker, "_mouseLeaveListener");
  const _onCalendarChange = dart.privateName(material_datepicker__material_month_picker, "_onCalendarChange");
  const _scrollToSelection = dart.privateName(material_datepicker__material_month_picker, "_scrollToSelection");
  const _resetHighlights = dart.privateName(material_datepicker__material_month_picker, "_resetHighlights");
  const _renderHighlights = dart.privateName(material_datepicker__material_month_picker, "_renderHighlights");
  const _renderHover = dart.privateName(material_datepicker__material_month_picker, "_renderHover");
  const _monthSelector = dart.privateName(material_datepicker__material_month_picker, "_monthSelector");
  let const$;
  let const$0;
  const _highlightElements = dart.privateName(material_datepicker__material_month_picker, "_highlightElements");
  const _renderRange = dart.privateName(material_datepicker__material_month_picker, "_renderRange");
  const _canSelectDate = dart.privateName(material_datepicker__material_month_picker, "_canSelectDate");
  const _resetView = dart.privateName(material_datepicker__material_month_picker, "_resetView");
  const _addEventListeners = dart.privateName(material_datepicker__material_month_picker, "_addEventListeners");
  const _removeEventListeners = dart.privateName(material_datepicker__material_month_picker, "_removeEventListeners");
  const _renderAllYears = dart.privateName(material_datepicker__material_month_picker, "_renderAllYears");
  const _onClick = dart.privateName(material_datepicker__material_month_picker, "_onClick");
  const _onMouseDown = dart.privateName(material_datepicker__material_month_picker, "_onMouseDown");
  const _onMouseMove = dart.privateName(material_datepicker__material_month_picker, "_onMouseMove");
  const _onMouseLeave = dart.privateName(material_datepicker__material_month_picker, "_onMouseLeave");
  const _extractDate = dart.privateName(material_datepicker__material_month_picker, "_extractDate");
  material_datepicker__material_month_picker.MaterialMonthPickerComponent = class MaterialMonthPickerComponent extends core.Object {
    ...
    ngOnInit() {
      ...
      if (this[_mode] === material_datepicker__calendar.CalendarSelectionMode.SINGLE_DATE) {
        ...
        this[_inputListener] = src__material_datepicker__calendar_listener.CalendarListener.dateRange(this[_model], {movingStartMaintainsLength: true});
      }
    }
    ngAfterChanges() {
  ...
  material_datepicker__material_month_picker.MaterialMonthPickerComponent[dart.implements] = () => [src__core__metadata__lifecycle_hooks.OnInit, src__core__metadata__lifecycle_hooks.AfterChanges, src__core__metadata__lifecycle_hooks.AfterViewInit, src__core__metadata__lifecycle_hooks.OnDestroy];
  ...
  dart.setLibraryUri(material_datepicker__material_month_picker.MaterialMonthPickerComponent, "package:angular_components/material_datepicker/material_month_picker.dart");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_month_picker.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;cAoCY,KAAmB;AAC3B,kBAAM,MAAM,GAAG,KAAK;AACpB,UAAI,qBAAe,IAAI,MAAM,uBAAiB,CAAC,KAAK;IACtD;;YAE2B,aAAM,MAAM;;;YAOE,aAAM,OAAO;;gBAY1C,OAAY;AACtB,sBAAI,OAAO,EAAI,cAAQ,GAAE;AACzB,oBAAQ,GAAG,OAAO;AAClB,0BAAc,GAAG;IACnB;;YAEoB,eAAQ;;gBAahB,OAAY;AACtB,sBAAI,OAAO,EAAI,cAAQ,GAAE;AACzB,oBAAQ,GAAG,OAAO;AAClB,0BAAc,GAAG;IACnB;;YAEoB,eAAQ;;;YAIM,YAAK;;;AAgBrC,UAAM,WAAW,yBAAgB;AAGjC,oGAAsB,UAAU,GAAG;AACnC,cAAQ,SAAO,CAAC,8FAAsB;AAGtC,gGAAkB,UAAU,GAAG;AAC/B,oGAAsB,SAAO,CAAC,0FAAkB;AAGhD,UAAM,gBAAgB,mBAAU;MAA1B,0BAA0C;AAChD,eAAS,IAAI,GAAG,AAAE,CAAD,GAAG,IAAI,CAAC,IAAI;AAC3B,YAAY,gCAAQ,aAAa,QAAM,CAAC;AACxC,QACE,AAAE,oBAAY,CAAC,YAAe,EAAE,SAAG,AAAE,CAAD,GAAG;QADzC,AAEE,AAAE,KAFC,OAEG,GAAG,mFAAW,QAAC,CAAC;AACxB,sGAAsB,SAAO,CAAC,KAAK;;AAGrC,YAAO,SAAQ;IACjB;uBAEoC,IAAQ;AAC1C,oGAAsB,eAAa,CAAC,WAAc,gBAAE,IAAI;AACxD,gGAAkB,OAAK,iBAAG,IAAI;AAC9B,0CAAO,qFAAa,QAAM,CAAC;IAC7B;;AAGE,oBAAI,UAAK,WAAW,UAAQ,GAAE;AAE9B,UAAM,mBAAmB,UAAK,WAAW,aAC1B,CAAC,QAAC,CAAC,IAAK,CAAC,GAAG,IAAI,UAAK,iBAAiB,uCAAU,cAAM;AACrE,UAAI,gBAAgB,IAAI,MAAM;AAE9B,uBAAY,WAAC,UAAK,uBAAuB,IACnC,gBAAgB,IAAI,KAAK,GACzB,gBAAgB,MAAM