define(['dart_sdk', 'packages/intl/intl', 'packages/angular_components/model/date/date', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/material_datepicker/calendar', 'packages/angular/src/core/change_detection/change_detection', 'packages/quiver/time', 'packages/angular_components/material_input/material_input'], function(dart_sdk, intl, date, disposer, calendar, change_detection, time, material_input) {
  ...
  const material_datepicker__date_input = Object.create(dart.library);
  ...
  const _input = dart.privateName(material_datepicker__date_input, "_input");
  const _clock = dart.privateName(material_datepicker__date_input, "_clock");
  const _inputFormats = dart.privateName(material_datepicker__date_input, "_inputFormats");
  const _dayInputFormatsWithoutYear = dart.privateName(material_datepicker__date_input, "_dayInputFormatsWithoutYear");
  const _monthInputFormatsWithoutDay = dart.privateName(material_datepicker__date_input, "_monthInputFormatsWithoutDay");
  const _monthInputFormatsMonthOnly = dart.privateName(material_datepicker__date_input, "_monthInputFormatsMonthOnly");
  const _defaultMonthFormat = dart.privateName(material_datepicker__date_input, "_defaultMonthFormat");
  const _defaultDayFormat = dart.privateName(material_datepicker__date_input, "_defaultDayFormat");
  const _dateFormat = dart.privateName(material_datepicker__date_input, "_dateFormat");
  const _maxDate = dart.privateName(material_datepicker__date_input, "_maxDate");
  const _minDate = dart.privateName(material_datepicker__date_input, "_minDate");
  const _date = dart.privateName(material_datepicker__date_input, "_date");
  const _isRangeEnd = dart.privateName(material_datepicker__date_input, "_isRangeEnd");
  const _disposer = dart.privateName(material_datepicker__date_input, "_disposer");
  const _controller = dart.privateName(material_datepicker__date_input, "_controller");
  const _cachedResult = dart.privateName(material_datepicker__date_input, "_cachedResult");
  const _cachedInput = dart.privateName(material_datepicker__date_input, "_cachedInput");
  const _cachedMinDate = dart.privateName(material_datepicker__date_input, "_cachedMinDate");
  const _cachedMaxDate = dart.privateName(material_datepicker__date_input, "_cachedMaxDate");
  const _lastParse = dart.privateName(material_datepicker__date_input, "_lastParse");
  const _parseDate = dart.privateName(material_datepicker__date_input, "_parseDate");
  const _parseDateCached = dart.privateName(material_datepicker__date_input, "_parseDateCached");
  const _trySetDate = dart.privateName(material_datepicker__date_input, "_trySetDate");
  const _clampDate = dart.privateName(material_datepicker__date_input, "_clampDate");
  const _parseDateUsingFormatList = dart.privateName(material_datepicker__date_input, "_parseDateUsingFormatList");
  const _guessYear = dart.privateName(material_datepicker__date_input, "_guessYear");
  const _guessCentury = dart.privateName(material_datepicker__date_input, "_guessCentury");
  let const$;
  let const$0;
  ...
  dart.setLibraryUri(material_datepicker__date_input.DateInputDirective, "package:angular_components/material_datepicker/date_input.dart");
