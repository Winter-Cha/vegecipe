define(['dart_sdk', 'packages/intl/intl', 'packages/angular_components/model/date/date', 'packages/angular_components/interfaces/has_disabled', 'packages/quiver/time'], function(dart_sdk, intl, date, has_disabled, time) {
  ...
  const material_datepicker__material_date_time_picker = Object.create(dart.library);
  let StreamControllerOfDateTime = () => (StreamControllerOfDateTime = dart.constFn(async.StreamController$(core.DateTime)))();
  const _clock = dart.privateName(material_datepicker__material_date_time_picker, "_clock");
  const _disabled = dart.privateName(material_datepicker__material_date_time_picker, "_disabled");
  const _required = dart.privateName(material_datepicker__material_date_time_picker, "_required");
  const _utc = dart.privateName(material_datepicker__material_date_time_picker, "_utc");
  const _dateTimeController = dart.privateName(material_datepicker__material_date_time_picker, "_dateTimeController");
  const _dateTime = dart.privateName(material_datepicker__material_date_time_picker, "_dateTime");
  const _date = dart.privateName(material_datepicker__material_date_time_picker, "_date");
  const _time = dart.privateName(material_datepicker__material_date_time_picker, "_time");
  const _updateDateTimeAndNotify = dart.privateName(material_datepicker__material_date_time_picker, "_updateDateTimeAndNotify");
  ...
  dart.setLibraryUri(material_datepicker__material_date_time_picker.MaterialDateTimePickerComponent, "package:angular_components/material_datepicker/material_date_time_picker.dart");
