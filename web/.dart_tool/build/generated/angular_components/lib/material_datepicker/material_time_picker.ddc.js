define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/intl/intl', 'packages/angular_components/model/selection/selection_model', 'packages/angular_components/model/a11y/keyboard_handler_mixin', 'packages/angular_components/interfaces/has_disabled', 'packages/angular/src/core/change_detection/change_detection', 'packages/quiver/time', 'packages/angular_components/src/model/selection/interfaces/selectable', 'packages/angular_components/model/selection/string_selection_options'], function(dart_sdk, disposer, intl, selection_model, keyboard_handler_mixin, has_disabled, change_detection, time, selectable, string_selection_options) {
  ...
  const material_datepicker__material_time_picker = Object.create(dart.library);
  ...
  const _clock = dart.privateName(material_datepicker__material_time_picker, "_clock");
  const _disposer = dart.privateName(material_datepicker__material_time_picker, "_disposer");
  const _timeChangeController = dart.privateName(material_datepicker__material_time_picker, "_timeChangeController");
  const _time = dart.privateName(material_datepicker__material_time_picker, "_time");
  const _disabled = dart.privateName(material_datepicker__material_time_picker, "_disabled");
  const _required = dart.privateName(material_datepicker__material_time_picker, "_required");
  const _utc = dart.privateName(material_datepicker__material_time_picker, "_utc");
  const _popupVisibleController = dart.privateName(material_datepicker__material_time_picker, "_popupVisibleController");
  const _popupVisible = dart.privateName(material_datepicker__material_time_picker, "_popupVisible");
  const _maxTime = dart.privateName(material_datepicker__material_time_picker, "_maxTime");
  const _minTime = dart.privateName(material_datepicker__material_time_picker, "_minTime");
  const _validateTime = dart.privateName(material_datepicker__material_time_picker, "_validateTime");
  const _parseAndTrySetTime = dart.privateName(material_datepicker__material_time_picker, "_parseAndTrySetTime");
  const _parseTime = dart.privateName(material_datepicker__material_time_picker, "_parseTime");
  const _parseTimeOfFormats = dart.privateName(material_datepicker__material_time_picker, "_parseTimeOfFormats");
  let const$;
  let const$0;
  ...
  dart.setLibraryUri(material_datepicker__material_time_picker.MaterialTimePickerComponent, "package:angular_components/material_datepicker/material_time_picker.dart");
  ...
  dart.setLibraryUri(material_datepicker__material_time_picker.TimeSelectionOptions, "package:angular_components/material_datepicker/material_time_picker.dart");
