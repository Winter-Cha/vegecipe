define(['dart_sdk', 'packages/angular_components/material_datepicker/range', 'packages/intl/intl'], function(dart_sdk, range, intl) {
  ...
  const material_datepicker__comparison_option = Object.create(dart.library);
  ...
  dart.setLibraryUri(material_datepicker__comparison_option.ComparisonOption, "package:angular_components/material_datepicker/comparison_option.dart");
