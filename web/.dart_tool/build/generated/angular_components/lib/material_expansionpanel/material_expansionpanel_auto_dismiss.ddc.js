define(['dart_sdk', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/material_expansionpanel/material_expansionpanel'], function(dart_sdk, change_detection, material_expansionpanel) {
  'use strict';
  ...
  const material_expansionpanel__material_expansionpanel_auto_dismiss = Object.create(dart.library);
  ...
  const _expansionPanel = dart.privateName(material_expansionpanel__material_expansionpanel_auto_dismiss, "_expansionPanel");
  const _overlayContainerToken = dart.privateName(material_expansionpanel__material_expansionpanel_auto_dismiss, "_overlayContainerToken");
  const _element = dart.privateName(material_expansionpanel__material_expansionpanel_auto_dismiss, "_element");
  const _clicksOutsideController = dart.privateName(material_expansionpanel__material_expansionpanel_auto_dismiss, "_clicksOutsideController");
  const _clicksOutsideSubscription = dart.privateName(material_expansionpanel__material_expansionpanel_auto_dismiss, "_clicksOutsideSubscription");
  const _mouseUpListener = dart.privateName(material_expansionpanel__material_expansionpanel_auto_dismiss, "_mouseUpListener");
  const _onMouseUp = dart.privateName(material_expansionpanel__material_expansionpanel_auto_dismiss, "_onMouseUp");
