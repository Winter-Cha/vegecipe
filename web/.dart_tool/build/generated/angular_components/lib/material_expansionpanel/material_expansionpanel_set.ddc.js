define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/src/model/action/async_action', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/material_expansionpanel/material_expansionpanel'], function(dart_sdk, disposer, async_action, change_detection, material_expansionpanel) {
  ...
  const material_expansionpanel__material_expansionpanel_set = Object.create(dart.library);
  ...
  const _panelDisposer = dart.privateName(material_expansionpanel__material_expansionpanel_set, "_panelDisposer");
  const _openPanel = dart.privateName(material_expansionpanel__material_expansionpanel_set, "_openPanel");
  const _panels = dart.privateName(material_expansionpanel__material_expansionpanel_set, "_panels");
  const _onPanelsChange = dart.privateName(material_expansionpanel__material_expansionpanel_set, "_onPanelsChange");
  const _setOpenPanel = dart.privateName(material_expansionpanel__material_expansionpanel_set, "_setOpenPanel");
  const _onPanelOpen = dart.privateName(material_expansionpanel__material_expansionpanel_set, "_onPanelOpen");
  const _onPanelClose = dart.privateName(material_expansionpanel__material_expansionpanel_set, "_onPanelClose");
  ...
  dart.setLibraryUri(material_expansionpanel__material_expansionpanel_set.MaterialExpansionPanelSet, "package:angular_components/material_expansionpanel/material_expansionpanel_set.dart");
