define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/reorder_list/reorder_events', 'packages/angular_components/utils/keyboard/keyboard', 'packages/quiver/iterables', 'packages/angular/src/core/change_detection/change_detection'], function(dart_sdk, disposer, reorder_events, keyboard, iterables, change_detection) {
  'use strict';
  ...
  const reorder_list__reorder_list = Object.create(dart.library);
  ...
  const _ngZone = dart.privateName(reorder_list__reorder_list, "_ngZone");
  const _disposer = dart.privateName(reorder_list__reorder_list, "_disposer");
  const _reorder = dart.privateName(reorder_list__reorder_list, "_reorder");
  const _reorderAttempt = dart.privateName(reorder_list__reorder_list, "_reorderAttempt");
  const _delete = dart.privateName(reorder_list__reorder_list, "_delete");
  const _itemSelectionChanged = dart.privateName(reorder_list__reorder_list, "_itemSelectionChanged");
  const _reorderProgress = dart.privateName(reorder_list__reorder_list, "_reorderProgress");
  const _items = dart.privateName(reorder_list__reorder_list, "_items");
  const _subscriptions = dart.privateName(reorder_list__reorder_list, "_subscriptions");
  const _dragSubscriptions = dart.privateName(reorder_list__reorder_list, "_dragSubscriptions");
  const _curTransformY = dart.privateName(reorder_list__reorder_list, "_curTransformY");
  const _itemSizes = dart.privateName(reorder_list__reorder_list, "_itemSizes");
  const _reorderActive = dart.privateName(reorder_list__reorder_list, "_reorderActive");
  const _moveSourceIndex = dart.privateName(reorder_list__reorder_list, "_moveSourceIndex");
  const _currentMoveIndex = dart.privateName(reorder_list__reorder_list, "_currentMoveIndex");
  const _dragSourceElement = dart.privateName(reorder_list__reorder_list, "_dragSourceElement");
  const _selectedElementIndexes = dart.privateName(reorder_list__reorder_list, "_selectedElementIndexes");
  const _pivotItemIndex = dart.privateName(reorder_list__reorder_list, "_pivotItemIndex");
  const _refreshItems = dart.privateName(reorder_list__reorder_list, "_refreshItems");
  const _handleElements = dart.privateName(reorder_list__reorder_list, "_handleElements");
  const _unTrackAll = dart.privateName(reorder_list__reorder_list, "_unTrackAll");
  const _reorderElements = dart.privateName(reorder_list__reorder_list, "_reorderElements");
  const _horizontalTransformHandler = dart.privateName(reorder_list__reorder_list, "_horizontalTransformHandler");
  const _createReorderEvent = dart.privateName(reorder_list__reorder_list, "_createReorderEvent");
  const _moveItem = dart.privateName(reorder_list__reorder_list, "_moveItem");
  const _subscriptionsForElement = dart.privateName(reorder_list__reorder_list, "_subscriptionsForElement");
  const _onDragStart = dart.privateName(reorder_list__reorder_list, "_onDragStart");
  const _onDragEnd = dart.privateName(reorder_list__reorder_list, "_onDragEnd");
  const _onKeyDown = dart.privateName(reorder_list__reorder_list, "_onKeyDown");
  const _onDragOver = dart.privateName(reorder_list__reorder_list, "_onDragOver");
  const _onClick = dart.privateName(reorder_list__reorder_list, "_onClick");
  const _getIndex = dart.privateName(reorder_list__reorder_list, "_getIndex");
  const _clearSelection = dart.privateName(reorder_list__reorder_list, "_clearSelection");
  const _notifySelectionChange = dart.privateName(reorder_list__reorder_list, "_notifySelectionChange");
  const _computeItemSize = dart.privateName(reorder_list__reorder_list, "_computeItemSize");
  const _parsePx = dart.privateName(reorder_list__reorder_list, "_parsePx");
  const _resetChildren = dart.privateName(reorder_list__reorder_list, "_resetChildren");
  const _getNewIndex = dart.privateName(reorder_list__reorder_list, "_getNewIndex");
  const _handleShift = dart.privateName(reorder_list__reorder_list, "_handleShift");
  const _handleCtrl = dart.privateName(reorder_list__reorder_list, "_handleCtrl");
  ...
  (reorder_list__reorder_list.ReorderListComponent.new = function(ngZone) {
    ...
    this[_reorderProgress] = StreamControllerOfReorderEvent().broadcast({sync: true});
  ...
  dart.setGetterSignature(reorder_list__reorder_list.ReorderListComponent, () => ({
    ...
    reorderProgress: async.Stream$(reorder_list__reorder_events.ReorderEvent),
  ...
  dart.setLibraryUri(reorder_list__reorder_list.ReorderListComponent, "package:angular_components/reorder_list/reorder_list.dart");
  dart.setFieldSignature(reorder_list__reorder_list.ReorderListComponent, () => ({
    ...
    [_reorderProgress]: dart.finalFieldType(StreamControllerOfReorderEvent()),
  ...
  const _handleProvider = dart.privateName(reorder_list__reorder_list, "_handleProvider");
  const _handleElement = dart.privateName(reorder_list__reorder_list, "_handleElement");
  const _reorderHandle = dart.privateName(reorder_list__reorder_list, "_reorderHandle");
  ...
  dart.setSetterSignature(reorder_list__reorder_list.ReorderItemDirective, () => ({
    ...
    useHandle: html.HtmlElement
  }));
  dart.setLibraryUri(reorder_list__reorder_list.ReorderItemDirective, "package:angular_components/reorder_list/reorder_list.dart");
  ...
  dart.setLibraryUri(reorder_list__reorder_list.ReorderHandleProvider, "package:angular_components/reorder_list/reorder_list.dart");
  ...
  dart.setLibraryUri(reorder_list__reorder_list.ReorderHandleDirective, "package:angular_components/reorder_list/reorder_list.dart");
