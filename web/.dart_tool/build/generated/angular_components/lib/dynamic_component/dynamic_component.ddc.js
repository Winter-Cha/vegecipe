define(['dart_sdk', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/model/ui/has_renderer', 'packages/angular/src/core/change_detection/change_detection'], function(dart_sdk, modules, has_renderer, change_detection) {
  'use strict';
  ...
  const dynamic_component__dynamic_component = Object.create(dart.library);
  ...
  const _slowComponentLoader = dart.privateName(dynamic_component__dynamic_component, "_slowComponentLoader");
  const _changeDetectorRef = dart.privateName(dynamic_component__dynamic_component, "_changeDetectorRef");
  const _componentLoader = dart.privateName(dynamic_component__dynamic_component, "_componentLoader");
  const _onLoadController = dart.privateName(dynamic_component__dynamic_component, "_onLoadController");
  const _viewContainerRef = dart.privateName(dynamic_component__dynamic_component, "_viewContainerRef");
  const _loadDeferred = dart.privateName(dynamic_component__dynamic_component, "_loadDeferred");
  const _childComponent = dart.privateName(dynamic_component__dynamic_component, "_childComponent");
  const _componentType = dart.privateName(dynamic_component__dynamic_component, "_componentType");
  const _typeChanged = dart.privateName(dynamic_component__dynamic_component, "_typeChanged");
  const _componentFactory = dart.privateName(dynamic_component__dynamic_component, "_componentFactory");
  const _factoryChanged = dart.privateName(dynamic_component__dynamic_component, "_factoryChanged");
  const _value = dart.privateName(dynamic_component__dynamic_component, "_value");
  const _valueChanged = dart.privateName(dynamic_component__dynamic_component, "_valueChanged");
  const _initialize = dart.privateName(dynamic_component__dynamic_component, "_initialize");
  const _disposeChildComponent = dart.privateName(dynamic_component__dynamic_component, "_disposeChildComponent");
  const _updateChildComponent = dart.privateName(dynamic_component__dynamic_component, "_updateChildComponent");
  dynamic_component__dynamic_component.DynamicComponent = class DynamicComponent extends core.Object {
    ...
    [_initialize]() {
      if (this[_componentFactory] != null) {
        ...
        FutureOfNull()._check(this[_slowComponentLoader].loadNextToLocation(dart.dynamic, loadType, this[_viewContainerRef]).then(core.Null, dart.fn(componentRef => {
  ...
  dart.setGetterSignature(dynamic_component__dynamic_component.DynamicComponent, () => ({
    ...
    onLoad: async.Stream$(src__core__linker__component_factory.ComponentRef),
    childComponent: src__core__linker__component_factory.ComponentRef
  }));
  dart.setSetterSignature(dynamic_component__dynamic_component.DynamicComponent, () => ({
    ...
    viewContainerRef: src__core__linker__view_container_ref.ViewContainerRef,
