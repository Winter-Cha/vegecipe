define(['dart_sdk', 'packages/angular_components/laminate/enums/alignment', 'packages/angular_components/content/deferred_content_aware', 'packages/angular_components/src/laminate/popup/popup_hierarchy'], function(dart_sdk, alignment, deferred_content_aware, popup_hierarchy) {
  ...
  const mixins__material_dropdown_base = Object.create(dart.library);
  ...
  const _visibleStream = dart.privateName(mixins__material_dropdown_base, "_visibleStream");
  const _contentVisible = dart.privateName(mixins__material_dropdown_base, "_contentVisible");
  const _visible = dart.privateName(mixins__material_dropdown_base, "_visible");
