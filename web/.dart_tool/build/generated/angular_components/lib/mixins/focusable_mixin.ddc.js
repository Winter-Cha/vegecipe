define(['dart_sdk', 'packages/angular_components/focus/focus_interface'], function(dart_sdk, focus_interface) {
  'use strict';
  ...
  const mixins__focusable_mixin = Object.create(dart.library);
  let StreamControllerOfFocusEvent = () => (StreamControllerOfFocusEvent = dart.constFn(async.StreamController$(html.FocusEvent)))();
  const _onFocus = dart.privateName(mixins__focusable_mixin, "_onFocus");
  const _focusable = dart.privateName(mixins__focusable_mixin, "_focusable");
  const _focusPending = dart.privateName(mixins__focusable_mixin, "_focusPending");
  ...
  mixins__focusable_mixin.FocusableMixin[dart.implements] = () => [focus__focus_interface.Focusable];
