define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/bootstrap/modules'], function(dart_sdk, disposer, change_detection, modules) {
  ...
  const content__deferred_content = Object.create(dart.library);
  ...
  const _viewContainer = dart.privateName(content__deferred_content, "_viewContainer");
  const _template = dart.privateName(content__deferred_content, "_template");
  const _disposer = dart.privateName(content__deferred_content, "_disposer");
  const _placeholder = dart.privateName(content__deferred_content, "_placeholder");
  const _viewRef = dart.privateName(content__deferred_content, "_viewRef");
  const _shown = dart.privateName(content__deferred_content, "_shown");
  const _visible = dart.privateName(content__deferred_content, "_visible");
  const _forceContent = dart.privateName(content__deferred_content, "_forceContent");
  const _setVisible = dart.privateName(content__deferred_content, "_setVisible");
  ...
  (content__deferred_content.DeferredContentDirective.new = function(viewContainer, template, parent) {
    ...
    this[_disposer].addStreamSubscription(core.bool, parent.contentVisible.listen(dart.fn(value => {
      this[_visible] = value;
      this[_setVisible]();
    }, boolToNull())));
  ...
  dart.setSetterSignature(content__deferred_content.DeferredContentDirective, () => ({
  ...
  dart.setFieldSignature(content__deferred_content.DeferredContentDirective, () => ({
    ...
    [_shown]: dart.fieldType(core.bool),
    [_visible]: dart.fieldType(core.bool),
    [_forceContent]: dart.fieldType(core.bool)
  }));
  const _view = dart.privateName(content__deferred_content, "_view");
