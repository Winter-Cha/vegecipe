define(['dart_sdk'], function(dart_sdk) {
  ...
  const utils__disposer__disposer = Object.create(dart.library);
  const $add = dartx.add;
  ...
  const _oneShot = dart.privateName(utils__disposer__disposer, "_oneShot");
  const _disposeFunctions = dart.privateName(utils__disposer__disposer, "_disposeFunctions");
  const _disposeSubs = dart.privateName(utils__disposer__disposer, "_disposeSubs");
  const _disposeSinks = dart.privateName(utils__disposer__disposer, "_disposeSinks");
  const _disposeDisposables = dart.privateName(utils__disposer__disposer, "_disposeDisposables");
  const _disposeCalled = dart.privateName(utils__disposer__disposer, "_disposeCalled");
  const _checkIfAlreadyDisposed = dart.privateName(utils__disposer__disposer, "_checkIfAlreadyDisposed");
  ...
  dart.setMethodSignature(utils__disposer__disposer.Disposer, () => ({
    ...
    addFunction: dart.fnType(dart.fnType(dart.void, []), [dart.fnType(dart.void, [])]),
