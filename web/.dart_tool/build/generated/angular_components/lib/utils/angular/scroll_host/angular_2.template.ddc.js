define(['dart_sdk', 'packages/angular_components/utils/angular/scroll_host/angular_2', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/utils/angular/scroll_host/interface', 'packages/angular/angular.template', 'packages/angular_components/utils/angular/scroll_host/interface.template', 'packages/angular_components/src/utils/angular/scroll_host/pan_controller_impl.template', 'packages/angular_components/src/utils/angular/scroll_host/scroll_host_interface.template', 'packages/angular_components/utils/angular/properties/properties.template', 'packages/angular_components/utils/browser/dom_service/angular_2.template'], function(dart_sdk, angular_2, dom_service, change_detection, $interface, angular, $interface$, pan_controller_impl, scroll_host_interface, properties, angular_2$) {
  ...
  const utils__angular__scroll_host__angular_2$46template = Object.create(dart.library);
