define(['dart_sdk', 'packages/angular_components/src/utils/angular/scroll_host/scroll_host_interface', 'packages/angular_components/utils/disposer/disposer', 'packages/quiver/time'], function(dart_sdk, scroll_host_interface, disposer, time) {
  ...
  const src__utils__angular__scroll_host__scroll_observer = Object.create(dart.library);
  const src__utils__angular__scroll_host__scroll_host_event_impl = Object.create(dart.library);
  const src__utils__angular__scroll_host__gestures = Object.create(dart.library);
  const utils__angular__scroll_host__interface = Object.create(dart.library);
  const $abs = dartx.abs;
  ...
  const _scrollHost = dart.privateName(src__utils__angular__scroll_host__scroll_observer, "_scrollHost");
  const _idleCheckDurationMs = dart.privateName(src__utils__angular__scroll_host__scroll_observer, "_idleCheckDurationMs");
  const _idleCheckDuration = dart.privateName(src__utils__angular__scroll_host__scroll_observer, "_idleCheckDuration");
  const _scrollSub = dart.privateName(src__utils__angular__scroll_host__scroll_observer, "_scrollSub");
  const _scrollTimestamp = dart.privateName(src__utils__angular__scroll_host__scroll_observer, "_scrollTimestamp");
  const _isScrolling = dart.privateName(src__utils__angular__scroll_host__scroll_observer, "_isScrolling");
  const _timer = dart.privateName(src__utils__angular__scroll_host__scroll_observer, "_timer");
  const _subscribe = dart.privateName(src__utils__angular__scroll_host__scroll_observer, "_subscribe");
  const _now = dart.privateName(src__utils__angular__scroll_host__scroll_observer, "_now");
  const _raiseIdleEvent = dart.privateName(src__utils__angular__scroll_host__scroll_observer, "_raiseIdleEvent");
  const _checkIdle = dart.privateName(src__utils__angular__scroll_host__scroll_observer, "_checkIdle");
  ...
  dart.setLibraryUri(src__utils__angular__scroll_host__scroll_observer.ScrollObserver, "package:angular_components/src/utils/angular/scroll_host/scroll_observer.dart");
  ...
  dart.setLibraryUri(src__utils__angular__scroll_host__scroll_host_event_impl.ScrollHostEventImpl, "package:angular_components/src/utils/angular/scroll_host/scroll_host_event_impl.dart");
  ...
  dart.setLibraryUri(src__utils__angular__scroll_host__gestures.GestureDirection, "package:angular_components/src/utils/angular/scroll_host/gestures.dart");
  ...
  const _clock = dart.privateName(src__utils__angular__scroll_host__gestures, "_clock");
  ...
  dart.setLibraryUri(src__utils__angular__scroll_host__gestures.GestureListenerFactory, "package:angular_components/src/utils/angular/scroll_host/gestures.dart");
  ...
  dart.setLibraryUri(src__utils__angular__scroll_host__gestures.GestureEvent, "package:angular_components/src/utils/angular/scroll_host/gestures.dart");
  ...
  const _element = dart.privateName(src__utils__angular__scroll_host__gestures, "_element");
  const _isDirectionScrollable = dart.privateName(src__utils__angular__scroll_host__gestures, "_isDirectionScrollable");
  const _scrollInterval = dart.privateName(src__utils__angular__scroll_host__gestures, "_scrollInterval");
  const _scrollController = dart.privateName(src__utils__angular__scroll_host__gestures, "_scrollController");
  const _disposer = dart.privateName(src__utils__angular__scroll_host__gestures, "_disposer");
  const _gesture = dart.privateName(src__utils__angular__scroll_host__gestures, "_gesture");
  const _directions = dart.privateName(src__utils__angular__scroll_host__gestures, "_directions");
  const _startPoint = dart.privateName(src__utils__angular__scroll_host__gestures, "_startPoint");
  const _capturing = dart.privateName(src__utils__angular__scroll_host__gestures, "_capturing");
  const _startListeners = dart.privateName(src__utils__angular__scroll_host__gestures, "_startListeners");
  const _onCancel = dart.privateName(src__utils__angular__scroll_host__gestures, "_onCancel");
  const _onTouchStart = dart.privateName(src__utils__angular__scroll_host__gestures, "_onTouchStart");
  const _onTouchMove = dart.privateName(src__utils__angular__scroll_host__gestures, "_onTouchMove");
  const _onTouchEnd = dart.privateName(src__utils__angular__scroll_host__gestures, "_onTouchEnd");
  const _scrollTimer = dart.privateName(src__utils__angular__scroll_host__gestures, "_scrollTimer");
  ...
  dart.setLibraryUri(src__utils__angular__scroll_host__gestures.GestureListener, "package:angular_components/src/utils/angular/scroll_host/gestures.dart");
  ...
  const _startTime = dart.privateName(src__utils__angular__scroll_host__gestures, "_startTime");
  const _lastTime = dart.privateName(src__utils__angular__scroll_host__gestures, "_lastTime");
  const _lastTouchPoint = dart.privateName(src__utils__angular__scroll_host__gestures, "_lastTouchPoint");
  const _lastSyncPoint = dart.privateName(src__utils__angular__scroll_host__gestures, "_lastSyncPoint");
  const _finished = dart.privateName(src__utils__angular__scroll_host__gestures, "_finished");
  const _startingTarget = dart.privateName(src__utils__angular__scroll_host__gestures, "_startingTarget");
  const _velocityX = dart.privateName(src__utils__angular__scroll_host__gestures, "_velocityX");
  const _velocityY = dart.privateName(src__utils__angular__scroll_host__gestures, "_velocityY");
  const _velocity = dart.privateName(src__utils__angular__scroll_host__gestures, "_velocity");
  const _addDragEvent = dart.privateName(src__utils__angular__scroll_host__gestures, "_addDragEvent");
  const _addFlingEvent = dart.privateName(src__utils__angular__scroll_host__gestures, "_addFlingEvent");
  const _syncToLastTouchPoint = dart.privateName(src__utils__angular__scroll_host__gestures, "_syncToLastTouchPoint");
  ...
  dart.setLibraryUri(src__utils__angular__scroll_host__gestures._Gesture, "package:angular_components/src/utils/angular/scroll_host/gestures.dart");
