define(['dart_sdk', 'packages/quiver/time', 'packages/angular_components/src/utils/angular/scroll_host/scroll_host_interface', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/utils/angular/scroll_host/interface', 'packages/angular_components/src/utils/angular/scroll_host/pan_controller_impl', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/utils/angular/properties/properties'], function(dart_sdk, time, scroll_host_interface, change_detection, $interface, pan_controller_impl, dom_service, properties) {
  ...
  const utils__angular__scroll_host__angular_2 = Object.create(dart.library);
  ...
  const _domService = dart.privateName(utils__angular__scroll_host__angular_2, "_domService");
  const _ngZone = dart.privateName(utils__angular__scroll_host__angular_2, "_ngZone");
  const _gestureListenerFactory = dart.privateName(utils__angular__scroll_host__angular_2, "_gestureListenerFactory");
  const _onUpdate = dart.privateName(utils__angular__scroll_host__angular_2, "_onUpdate");
  const _scrollHost = dart.privateName(utils__angular__scroll_host__angular_2, "_scrollHost");
  const _disableAutoScroll = dart.privateName(utils__angular__scroll_host__angular_2, "_disableAutoScroll");
  const _usePositionSticky = dart.privateName(utils__angular__scroll_host__angular_2, "_usePositionSticky");
  const _enableSmoothPushing = dart.privateName(utils__angular__scroll_host__angular_2, "_enableSmoothPushing");
  const _init = dart.privateName(utils__angular__scroll_host__angular_2, "_init");
  ...
  dart.setLibraryUri(utils__angular__scroll_host__angular_2.ElementScrollHost, "package:angular_components/utils/angular/scroll_host/angular_2.dart");
  ...
  dart.setLibraryUri(utils__angular__scroll_host__angular_2.WindowScrollHost, "package:angular_components/utils/angular/scroll_host/angular_2.dart");
  const _element = dart.privateName(utils__angular__scroll_host__angular_2, "_element");
  ...
  dart.setLibraryUri(utils__angular__scroll_host__angular_2.StickyFloatingTracker, "package:angular_components/utils/angular/scroll_host/angular_2.dart");
  ...
  dart.setLibraryUri(utils__angular__scroll_host__angular_2.AcxPanClassDirective, "package:angular_components/utils/angular/scroll_host/angular_2.dart");
  const _stickyElement = dart.privateName(utils__angular__scroll_host__angular_2, "_stickyElement");
  const _endElement = dart.privateName(utils__angular__scroll_host__angular_2, "_endElement");
  const _stickyClass = dart.privateName(utils__angular__scroll_host__angular_2, "_stickyClass");
  const _stickyKey = dart.privateName(utils__angular__scroll_host__angular_2, "_stickyKey");
  const _sticky = dart.privateName(utils__angular__scroll_host__angular_2, "_sticky");
  const _position = dart.privateName(utils__angular__scroll_host__angular_2, "_position");
  const _stick = dart.privateName(utils__angular__scroll_host__angular_2, "_stick");
  const _unstick = dart.privateName(utils__angular__scroll_host__angular_2, "_unstick");
  const _stickyController = dart.privateName(utils__angular__scroll_host__angular_2, "_stickyController");
  ...
  dart.setLibraryUri(utils__angular__scroll_host__angular_2.StickyElementDirective, "package:angular_components/utils/angular/scroll_host/angular_2.dart");
