define(['dart_sdk', 'packages/angular/src/bootstrap/modules', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/utils/disposer/disposer'], function(dart_sdk, modules, change_detection, dom_service, disposer) {
  'use strict';
  ...
  const utils__angular__imperative_view__imperative_view = Object.create(dart.library);
  ...
  let FutureOfImperativeViewRef = () => (FutureOfImperativeViewRef = dart.constFn(async.Future$(utils__angular__imperative_view__imperative_view.ImperativeViewRef)))();
  let VoidTovoid = () => (VoidTovoid = dart.constFn(dart.fnType(dart.void, [])))();
  const _componentLoader = dart.privateName(utils__angular__imperative_view__imperative_view, "_componentLoader");
  const _domService = dart.privateName(utils__angular__imperative_view__imperative_view, "_domService");
  utils__angular__imperative_view__imperative_view.AcxImperativeViewUtils = class AcxImperativeViewUtils extends core.Object {
    ...
    insertAngularView(intoDomElement, templateRef, viewContainer) {
      return FutureOfImperativeViewRef()._check(this[_domService].onWrite().then(utils__angular__imperative_view__imperative_view.ImperativeViewRef, dart.fn(_ => {
  ...
  const _disposeFn = dart.privateName(utils__angular__imperative_view__imperative_view, "_disposeFn");
