define(['dart_sdk', 'packages/angular_components/src/utils/angular/managed_zone/managed_zone', 'packages/angular/src/core/change_detection/change_detection'], function(dart_sdk, managed_zone, change_detection) {
  'use strict';
  ...
  const utils__angular__managed_zone__angular_2 = Object.create(dart.library);
  let VoidToNull = () => (VoidToNull = dart.constFn(dart.fnType(core.Null, [])))();
  const _ngZone = dart.privateName(utils__angular__managed_zone__angular_2, "_ngZone");
  const _isDisposed = dart.privateName(utils__angular__managed_zone__angular_2, "_isDisposed");
  utils__angular__managed_zone__angular_2.Angular2ManagedZone = class Angular2ManagedZone extends src__utils__angular__managed_zone__managed_zone.ManagedZoneBase {
    ...
    runOutside(T, fn) {
      return this[_ngZone].runOutsideAngular(T, fn);
    }
  };
