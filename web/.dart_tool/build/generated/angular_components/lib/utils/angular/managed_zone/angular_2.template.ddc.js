define(['dart_sdk', 'packages/angular_components/utils/angular/managed_zone/angular_2', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/di.template', 'packages/angular_components/src/utils/angular/managed_zone/managed_zone.template'], function(dart_sdk, angular_2, change_detection, di, managed_zone) {
  'use strict';
  ...
  const utils__angular__managed_zone__angular_2$46template = Object.create(dart.library);
