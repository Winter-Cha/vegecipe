define(['dart_sdk', 'packages/async/async', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/utils/browser/dom_service/dom_service'], function(dart_sdk, async, change_detection, dom_service) {
  ...
  const utils__showhide__showhide = Object.create(dart.library);
  ...
  const _element = dart.privateName(utils__showhide__showhide, "_element");
  const _domService = dart.privateName(utils__showhide__showhide, "_domService");
  const _transitionEndQueue = dart.privateName(utils__showhide__showhide, "_transitionEndQueue");
  const _initialized = dart.privateName(utils__showhide__showhide, "_initialized");
  const _initialWritePending = dart.privateName(utils__showhide__showhide, "_initialWritePending");
  const _hiding = dart.privateName(utils__showhide__showhide, "_hiding");
  const _onHide = dart.privateName(utils__showhide__showhide, "_onHide");
  const _onShow = dart.privateName(utils__showhide__showhide, "_onShow");
  const _onShowEnd = dart.privateName(utils__showhide__showhide, "_onShowEnd");
  const _onHideEnd = dart.privateName(utils__showhide__showhide, "_onHideEnd");
  const _stopHiding = dart.privateName(utils__showhide__showhide, "_stopHiding");
  const _show = dart.privateName(utils__showhide__showhide, "_show");
  const _hide = dart.privateName(utils__showhide__showhide, "_hide");
  const _removeNgHide = dart.privateName(utils__showhide__showhide, "_removeNgHide");
  const _onTransitionEnd = dart.privateName(utils__showhide__showhide, "_onTransitionEnd");
  const _hideIfHiding = dart.privateName(utils__showhide__showhide, "_hideIfHiding");
  ...
  dart.setLibraryUri(utils__showhide__showhide.ShowHideDirective, "package:angular_components/utils/showhide/showhide.dart");
