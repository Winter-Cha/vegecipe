define(['dart_sdk', 'packages/quiver/core'], function(dart_sdk, core) {
  ...
  const utils__color__color = Object.create(dart.library);
  ...
  const _relativeLuminance = dart.privateName(utils__color__color, "_relativeLuminance");
  const _alphaString = dart.privateName(utils__color__color, "_alphaString");
  utils__color__color.Color = class Color extends core$.Object {
    ...
    get hexString() {
      return "#" + dart.str(utils__color__color.Color._toHex(this.red)) + dart.str(utils__color__color.Color._toHex(this.green)) + dart.str(utils__color__color.Color._toHex(this.blue)) + (this.alpha === 1 ? "" : dart.str(utils__color__color.Color._toHex(255 * dart.notNull(this.alpha))));
    }
    toString() {
    ...
    _equals(o) {
      ...
      return this === o || utils__color__color.Color.is(o) && this.red == o.red && this.green == o.green && this.blue == o.blue && (dart.notNull(this.alpha) - dart.notNull(o.alpha))[$abs]() < 0.01;
    }
    get hashCode() {
      return core$0.hash4(this.red, this.green, this.blue, this.alpha);
    }
    distanceFrom(other) {
      return dart.asInt(math.pow(dart.notNull(other.red) - dart.notNull(this.red), 2) + math.pow(dart.notNull(other.blue) - dart.notNull(this.blue), 2) + math.pow(dart.notNull(other.green) - dart.notNull(this.green), 2));
    }
  };
  ...
  dart.setMethodSignature(utils__color__color.Color, () => ({
    ...
    distanceFrom: dart.fnType(core$.int, [utils__color__color.Color])
  }));
  dart.setGetterSignature(utils__color__color.Color, () => ({
    __proto__: dart.getGetters(utils__color__color.Color.__proto__),
    [_relativeLuminance]: core$.num,
    [_alphaString]: core$.String,
    rgbString: core$.String,
    hexString: core$.String
  }));
  dart.setLibraryUri(utils__color__color.Color, "package:angular_components/utils/color/color.dart");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["color.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;MAWM,uCAAmB;YAAG;;MAKtB,4CAAwB;YAAG;;;;;;yBAYH,GAAU;AAAE,YAAG,gCAAK,CAAC,GAAG;IAAC;mBAI/B,GAAU;AAAE,YAAG,gCAAK,CAAC,GAAG;IAAC;IAcrC;;;;;;IAAK;;;;;;IAAO;;;;;;IAKZ;;;;;;6BAcsB,CAAQ;YACpC,AAAG,cAAF,CAAC,KAAI,UAAa,aAAF,CAAC,IAAG,QAAQ,AAAK,QAAG,CAAa,CAAT,aAAF,CAAC,IAAG,SAAS,OAAO;IAAI;;YAOlC,AAAS,AACE,cADxC,2CAAiB,CAAK,aAAJ,QAAG,IAAG,QAAO,SACA,aAA/B,2CAAiB,CAAO,aAAN,UAAK,IAAG,QAAO,SACH,aAA9B,2CAAiB,CAAM,aAAL,SAAI,IAAG,QAAO;IAAM;kBAQxB,UAAgB;AAChC,UAAI,UAAU,MAAM,KAAI,GAAG;AACzB,uBAAM,yBAAmB,CAAC,UAAU,EAAE,cAClC;;AAEN,UAAM,IAAI,UAAK,KAAI,IAAI,OAAO,mBAAc,CAAC,UAAU;AACvD,UAAM,KAAK,CAAC,oBAAmB;AAC/B,UAAM,KAAK,UAAU,oBAAmB;AACxC,YAAiC,EAAzB,AAAK,AAAY,QAAT,YAAC,EAAE,EAAE,EAAE,IAAI,SAAS,AAAK,AAAY,QAAT,YAAC,EAAE,EAAE,EAAE,IAAI;IACzD;oBAKoB,CAAK,EAAE,CAAK,EAAE,CAAK;AACrC,UAAM,aAAF,CAAC,IAAG,OAAS,aAAF,CAAC,IAAG,KAAK,eAAM,yBAAmB,CAAC,CAAC,EAAE;AACrD,YAAS,AAAY,cAAd,CAAC,KAAI,AAAI,mBAAE,CAAC,KAAM,aAAF,CAAC,iBAAG,CAAC;IAC9B;gBAOkB,CAAO,EAAE,CAA