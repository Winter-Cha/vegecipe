define(['dart_sdk', 'packages/angular_components/framework_stabilizers/testability', 'packages/angular_components/utils/browser/dom_service/dom_service'], function(dart_sdk, testability, dom_service) {
  ...
  const utils__browser__dom_service__dom_service_webdriver_testability = Object.create(dart.library);
  ...
  const _domService = dart.privateName(utils__browser__dom_service__dom_service_webdriver_testability, "_domService");
