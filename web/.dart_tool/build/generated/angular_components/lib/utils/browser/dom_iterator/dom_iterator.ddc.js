define(['dart_sdk'], function(dart_sdk) {
  ...
  const utils__browser__dom_iterator__dom_iterator = Object.create(dart.library);
  ...
  const _element = dart.privateName(utils__browser__dom_iterator__dom_iterator, "_element");
  const _startingElement = dart.privateName(utils__browser__dom_iterator__dom_iterator, "_startingElement");
  const _reverse = dart.privateName(utils__browser__dom_iterator__dom_iterator, "_reverse");
  const _scope = dart.privateName(utils__browser__dom_iterator__dom_iterator, "_scope");
  const _wraps = dart.privateName(utils__browser__dom_iterator__dom_iterator, "_wraps");
  const _navigateBackward = dart.privateName(utils__browser__dom_iterator__dom_iterator, "_navigateBackward");
  const _navigateForward = dart.privateName(utils__browser__dom_iterator__dom_iterator, "_navigateForward");
  ...
  dart.setLibraryUri(utils__browser__dom_iterator__dom_iterator.DomTreeIterator, "package:angular_components/utils/browser/dom_iterator/dom_iterator.dart");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["dom_iterator.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;UAkD4B;AACxB,iBAAO,8DAAe,CAAC,cAAQ,YAClB,WAAC,cAAQ,UAAS,YAAM,0BAAS,KAAK,WAAL,KAAK,GAAI,YAAM;IAC/D;;YAIuB,eAAQ;;;AAK7B,UAAI,cAAQ,IAAI,MAAM;AACpB,cAAO;;AAGT,sBAAI,cAAQ,EAAI,YAAM,eAAI,cAAQ,WAAS,UAAQ,GAAE;AACnD,sBAAQ,GAAG;AACX,cAAO;;AAGT,oBAAI,cAAQ,GAAE;AACZ,+BAAiB;aACZ;AACL,8BAAgB;;AAGlB,sBAAI,cAAQ,EAAI,sBAAgB,GAAE;AAChC,sBAAQ,GAAG;;AAGb,YAAQ,eAAQ,IAAI;IACtB;;AAqBE,sBAAI,cAAQ,EAAI,YAAM,GAAE;AAEtB,sBAAI,YAAM,GAAE;AACV,wBAAQ,GAAG,yDAAc,CAAC,YAAM;eAC3B;AACL,wBAAQ,GAAG;;YAER,KAAI,cAAQ,SAAO,IAAI,MAAM;AAElC,sBAAQ,GAAG;YACN,iBAAI,cAAQ,EAAI,sDAAW,CAAC,cAAQ,SAAO,IAAG;AAEnD,sBAAQ,GAAG,cAAQ,SAAO;aACrB;AAEL,sBAAQ,GAAG,cAAQ,uBAAuB;AAC1C,yBAAO,cAAQ,WAAS,aAAW,GAAE;AACnC,wBAAQ,GAAG,qDAAU,CAAC,cAAQ;;;IAGpC;;AAsBE,oBAAI,cAAQ,WAAS,aAAW,GAAE;AAEhC,sBAAQ,GAAG,sDAAW,CAAC,cAAQ;aAC1B;AAEL,eAAO,cAAQ,SAAO,IAAI,qBACtB,cAAQ,SAAO,EAAI,YAAM,iBACzB,cAAQ,EAAI,qDAAU,CAAC,cAAQ,SAAO,IAAG;AAC3C,wBAAQ,GAAG,cAAQ,SAAO;;AAG5B,YAAI,cAAQ,SAAO,IAAI,oBAClB,cAAQ,SAAO,EAAI,YAAM,iBACtB,cAAQ,EAAI,qDAAU,CAAC,cAAQ,SAAO,IAAI;AAChD,wBAAI,YAAM,GAAE;AACV,0BAAQ,GAAG,YAAM;iBACZ;AACL,0BAAQ,GAAG;;eAER;AACL,wBAAQ,GAAG,cAAQ,mBAAmB;;;IAG5C;;6EA3IgB,OAAO;QACb,qDAAU;QAAe;QAAY,+CAAQ;IACjD,cAAQ,uBAAG,OAAO;IAClB,sBAAgB,uBAAG,OAAO;IAC1B,cAAQ,GAAG,OAAO;IAClB,YAAM,GAAG,KAAK;IACd,YAAM,GAAG,KAAK;AAClB,kBAAI,YAAM,KAAI,YAAM,IAAI,MAAM;AAC5B,iBAAM,kBAAS,CAAC;;AAElB,QAAI,YAAM,IAAI,mBAAS,YAAM,SAAS,CAAC,cAAQ,IAAG;AAChD,iBAAM,kBAAS,CAAC,sBACZ;;EAER;;;;;;;;;;;;;;;;;;;;;;;uEAiIqB,KAAa;AAClC,QAAQ,UAAU,KAAK;AACvB,qBAAO,OAAO,WAAS,aAAW,GAAE;AAClC,aAAO,GAAG,qDAAU,CAAC,OAAO;;AAE9B,UAAO,QAAO;EAChB;oEAEoB,OAAe;UAAK,QAAO,WAAS,QAAC;EAAE;mEAExC,OAAe;AAChC,QAAkB,sCAAW,OAAO,WAAS;AAC7C,UAAO,SAAQ,MAAiB,aAAhB,QAAQ,OAAO,IAAG;EACpC","file":"dom_iterator.ddc.js"}');
  // Exports:
  return {
