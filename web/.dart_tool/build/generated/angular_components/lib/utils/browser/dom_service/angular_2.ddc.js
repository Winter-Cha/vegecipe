define(['dart_sdk', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/utils/disposer/disposer', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/utils/browser/dom_service/dom_service_webdriver_testability', 'packages/angular/experimental'], function(dart_sdk, dom_service, disposer, change_detection, dom_service_webdriver_testability, experimental) {
  ...
  const utils__browser__dom_service__angular_2 = Object.create(dart.library);
  ...
  dart.defineLazy(utils__browser__dom_service__angular_2, {
    ...
    /*utils__browser__dom_service__angular_2.domServiceModule*/get domServiceModule() {
      return dart.const(src__di__module.Module.new({provide: dart.constList([utils__browser__dom_service__angular_2.domServiceBinding], ProviderOfObject())}));
    },
