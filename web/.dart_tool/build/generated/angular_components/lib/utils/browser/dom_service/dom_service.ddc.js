define(['dart_sdk', 'packages/angular_components/src/utils/async/async_update_scheduler', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/utils/disposer/disposable_callback', 'packages/angular/src/core/change_detection/change_detection'], function(dart_sdk, async_update_scheduler, disposer, disposable_callback, change_detection) {
  'use strict';
  ...
  const utils__browser__dom_service__dom_service = Object.create(dart.library);
  ...
  const _ngZone = dart.privateName(utils__browser__dom_service__dom_service, "_ngZone");
  const _window = dart.privateName(utils__browser__dom_service__dom_service, "_window");
  const _domReadQueue = dart.privateName(utils__browser__dom_service__dom_service, "_domReadQueue");
  const _domWriteQueue = dart.privateName(utils__browser__dom_service__dom_service, "_domWriteQueue");
  const _rootZone = dart.privateName(utils__browser__dom_service__dom_service, "_rootZone");
  const _insideDigest = dart.privateName(utils__browser__dom_service__dom_service, "_insideDigest");
  const _layoutObserveRead = dart.privateName(utils__browser__dom_service__dom_service, "_layoutObserveRead");
  const _scheduledProcessQueue = dart.privateName(utils__browser__dom_service__dom_service, "_scheduledProcessQueue");
  const _onLayoutChangedController = dart.privateName(utils__browser__dom_service__dom_service, "_onLayoutChangedController");
  const _onLayoutChangedStream = dart.privateName(utils__browser__dom_service__dom_service, "_onLayoutChangedStream");
  const _onQueuesProcessedController = dart.privateName(utils__browser__dom_service__dom_service, "_onQueuesProcessedController");
  const _onQueuesProcessedStream = dart.privateName(utils__browser__dom_service__dom_service, "_onQueuesProcessedStream");
  const _nextFrameId = dart.privateName(utils__browser__dom_service__dom_service, "_nextFrameId");
  const _nextFrameCompleter = dart.privateName(utils__browser__dom_service__dom_service, "_nextFrameCompleter");
  const _nextFrameFuture = dart.privateName(utils__browser__dom_service__dom_service, "_nextFrameFuture");
  const _state = dart.privateName(utils__browser__dom_service__dom_service, "_state");
  const _crossAppInitialized = dart.privateName(utils__browser__dom_service__dom_service, "_crossAppInitialized");
  const _onIdleController = dart.privateName(utils__browser__dom_service__dom_service, "_onIdleController");
  const _onIdleStream = dart.privateName(utils__browser__dom_service__dom_service, "_onIdleStream");
  const _idleTimerMillis = dart.privateName(utils__browser__dom_service__dom_service, "_idleTimerMillis");
  const _idleTimer = dart.privateName(utils__browser__dom_service__dom_service, "_idleTimer");
  const _inDispatchTurnDoneEvent = dart.privateName(utils__browser__dom_service__dom_service, "_inDispatchTurnDoneEvent");
  const _writeQueueChangedLayout = dart.privateName(utils__browser__dom_service__dom_service, "_writeQueueChangedLayout");
  const _resetIdleTimer = dart.privateName(utils__browser__dom_service__dom_service, "_resetIdleTimer");
  const _scheduleInQueue = dart.privateName(utils__browser__dom_service__dom_service, "_scheduleInQueue");
  const _scheduleProcessQueue = dart.privateName(utils__browser__dom_service__dom_service, "_scheduleProcessQueue");
  const _processQueue = dart.privateName(utils__browser__dom_service__dom_service, "_processQueue");
  const _scheduleOnLayoutChanged = dart.privateName(utils__browser__dom_service__dom_service, "_scheduleOnLayoutChanged");
  const _processQueues = dart.privateName(utils__browser__dom_service__dom_service, "_processQueues");
  const _listenOnLayoutEvents = dart.privateName(utils__browser__dom_service__dom_service, "_listenOnLayoutEvents");
  const _onLayoutObserve = dart.privateName(utils__browser__dom_service__dom_service, "_onLayoutObserve");
  const _cancelIdleTimer = dart.privateName(utils__browser__dom_service__dom_service, "_cancelIdleTimer");
  utils__browser__dom_service__dom_service.DomService = class DomService extends core.Object {
    ...
    get nextFrame() {
      if (this[_nextFrameFuture] == null) {
        ...
        this[_nextFrameFuture] = new (ZonedFutureOfnum()).new(completer.future, dart.gbind(dart.bind(this[_ngZone], 'runOutsideAngular'), dart.dynamic));
      }
    ...
    get onIdle() {
      if (this[_onIdleStream] == null) {
        ...
        this[_onIdleStream] = new src__utils__async__zoned_async.ZonedStream.new(this[_onIdleController].stream, dart.gbind(dart.bind(this[_ngZone], 'runOutsideAngular'), dart.dynamic));
      }
    ...
    [_scheduleInQueue](fn, queue) {
      if (dart.test(utils__browser__dom_service__dom_service.DomService.maintainZoneOnCallbacks)) {
    ...
    get onQueuesProcessed() {
      if (this[_onQueuesProcessedStream] == null) {
        ...
        this[_onQueuesProcessedStream] = new src__utils__async__zoned_async.ZonedStream.new(this[_onQueuesProcessedController].stream, dart.gbind(dart.bind(this[_ngZone], 'runOutsideAngular'), dart.dynamic));
      }
    ...
    get onLayoutChanged() {
      if (this[_onLayoutChangedStream] == null) {
        ...
        this[_onLayoutChangedStream] = new src__utils__async__zoned_async.ZonedStream.new(this[_onLayoutChangedController].stream, dart.gbind(dart.bind(this[_ngZone], 'runOutsideAngular'), dart.dynamic));
        this[_ngZone].runOutsideAngular(core.Null, dart.fn(() => {
  ...
  dart.setMethodSignature(utils__browser__dom_service__dom_service.DomService, () => ({
    ...
    scheduleRead: dart.fnType(utils__disposer__disposer.Disposable, [dart.fnType(dart.void, [])]),
    scheduleWrite: dart.fnType(utils__disposer__disposer.Disposable, [dart.fnType(dart.void, [])]),
    [_scheduleInQueue]: dart.fnType(dart.void, [dart.fnType(dart.void, []), core.List$(dart.fnType(dart.void, []))]),
    onRead: dart.fnType(async.Future, []),
    onWrite: dart.fnType(async.Future, []),
    [_processQueues]: dart.fnType(dart.void, []),
    [_processQueue]: dart.fnType(core.int, [core.List$(dart.fnType(dart.void, []))]),
    ...
    addLayoutObserver: dart.fnType(async.StreamSubscription, [dart.fnType(dart.void, [])]),
  ...
  dart.setGetterSignature(utils__browser__dom_service__dom_service.DomService, () => ({
    ...
    isReadingDom: core.bool,
    isWritingDom: core.bool,
    nextFrame: async.Future$(core.num),
    onIdle: async.Stream,
    onQueuesProcessed: async.Stream,
    onLayoutChanged: async.Stream,
    hasPendingUpdate: core.bool,
    isStable: core.bool,
    state: utils__browser__dom_service__dom_service.DomServiceState
  }));
  ...
  dart.setLibraryUri(utils__browser__dom_service__dom_service.DomService, "package:angular_components/utils/browser/dom_service/dom_service.dart");
  ...
  dart.defineLazy(utils__browser__dom_service__dom_service.DomService, {
    /*utils__browser__dom_service__dom_service.DomService.maintainZoneOnCallbacks*/get maintainZoneOnCallbacks() {
      return true;
    },
  ...
  dart.setLibraryUri(utils__browser__dom_service__dom_service.DomServiceState, "package:angular_components/utils/browser/dom_service/dom_service.dart");
  ...
  const _domService = dart.privateName(utils__browser__dom_service__dom_service, "_domService");
  const _fn = dart.privateName(utils__browser__dom_service__dom_service, "_fn");
  const _callback = dart.privateName(utils__browser__dom_service__dom_service, "_callback");
  const _framesToStabilize = dart.privateName(utils__browser__dom_service__dom_service, "_framesToStabilize");
  const _lastValue = dart.privateName(utils__browser__dom_service__dom_service, "_lastValue");
  const _stableFrameCounter = dart.privateName(utils__browser__dom_service__dom_service, "_stableFrameCounter");
  ...
  dart.setLibraryUri(utils__browser__dom_service__dom_service._ChangeTracker, "package:angular_components/utils/browser/dom_service/dom_service.dart");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["dom_service.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAiFwB;;;;;;IAGb;;;;;;;AAWP,oBAAI,0BAAoB,GAAE;AAC1B,gCAAoB,GAAG;AACvB,mBAAO,kBAAkB,YAAC;AACxB,qBAAO,YAAY,OAAO,CAAC,QAAC,CAAC;AAC3B,cAAI,0BAAqB,IAAI,kBAAQ,0BAAqB,KAAI;AAE5D,0CAAwB,GAAG;AAC3B,yBAAO,cAAc,CAAC,cAAK,CAAC,WAAqB;AACjD,0CAAwB,GAAG;AAI3B,gBAAI,0BAAqB,IAAI,kBAAQ,0BAAqB,KAAI;AAC5D,4CAAwB,GAAG;;AAE7B,gBAAI,sBAAiB,IAAI,MAAM;AAC7B,+CAAiB;;;;;IAK3B;;YAc0B,aAAM,KAAI,wDAAe,QAAQ;IAAC;;YAclC,aAAM,KAAI,wDAAe,QAAQ;IAAC;;UAS7C;UAAc,+CAAQ;AAEnC,mBAAO,IAAI,YAAC;;AACZ,wBAAa,WAAN,KAAK,QAAG,MAAG;AAChB,YAAI,sBAAgB,IAAI,MAAM;AAC9B,YAAI,YAAY,IAAI,MAAM;AACxB,sBAAY,OAAG,iBAAY,yBAAyB;;AAEtD,cAAO,yBAAmB,IAAI;AAC9B,YAAgB,YAAY,yBAAmB;AAC/C,qBAAO,uBAAqB,CAAC,kBAAY;AACzC,8BAAgB,GAAG;AACnB,iCAAmB,GAAG;AACtB,iBAAS,SAAS,CAAC,YAAY;AAC/B,aAAK,cAAL,KAAK,QAvKX;;IAyKE;;AAOE,UAAI,sBAAgB,IAAI,MAAM;AAC5B,cAAO,yBAAmB,IAAI;AAC9B,YAAM,YAAY,qBAAmB;AACrC,iCAAmB,GAAG,SAAS;AAC/B,qBAAO,kBAAkB,YAAC;AAGxB,mBAAI;AACJ,4BAAY,GAAG,aAAO,wBAAsB,CAAC,QAAC,YAAY;AAExD,0BAAI,SAAS,YAAY,GAAE;AAC3B,gBAAI,SAAS,SAAI,yBAAmB,GAAE;AACpC,oCAAgB,GAAG;AACnB,uCAAmB,GAAG;;AAExB,qBAAS,SAAS,CAAC,YAAY;;;AAGnC,8BAAgB,OACZ,wBAAW,CAAC,SAAS,OAAO,uBAAE,aAAO;;AAE3C,YAAO,uBAAgB;IACzB;;AAQE,UAAI,mBAAa,IAAI,MAAM;AACzB,+BAAiB,GAAG,gCAA0B,QACpC,gBAAgB,gCAAe,YAAY,gCAAe;AAEp