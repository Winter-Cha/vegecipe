define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/model/selection/selection_model', 'packages/angular_components/model/ui/has_renderer', 'packages/angular/src/core/change_detection/change_detection'], function(dart_sdk, disposer, selection_model, has_renderer, change_detection) {
  ...
  const material_chips__material_chips = Object.create(dart.library);
  const $toString = dartx.toString;
  let SelectionModelOfNull = () => (SelectionModelOfNull = dart.constFn(model__selection__selection_model.SelectionModel$(core.Null)))();
  let ObjectToString = () => (ObjectToString = dart.constFn(dart.fnType(core.String, [core.Object])))();
  const _changeDetector = dart.privateName(material_chips__material_chips, "_changeDetector");
  const _disposer = dart.privateName(material_chips__material_chips, "_disposer");
  const _selectionModel = dart.privateName(material_chips__material_chips, "_selectionModel");
  let const$;
  const _itemRenderer = dart.privateName(material_chips__material_chips, "_itemRenderer");
  ...
  material_chips__material_chips.MaterialChipsComponent$ = dart.generic(T => {
    ...
    (MaterialChipsComponent.new = function(changeDetector) {
      ...
      this[removable] = true;
      this[_selectionModel] = const$ || (const$ = dart.const(SelectionModelOfNull().empty()));
