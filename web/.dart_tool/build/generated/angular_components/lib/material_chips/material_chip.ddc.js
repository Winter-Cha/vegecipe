define(['dart_sdk', 'packages/angular_components/model/ui/has_renderer', 'packages/angular_components/model/selection/selection_model', 'packages/angular_components/focus/focus', 'packages/intl/intl', 'packages/angular_components/utils/id_generator/id_generator'], function(dart_sdk, has_renderer, selection_model, focus, intl, id_generator) {
  ...
  const material_chips__material_chip = Object.create(dart.library);
  const _itemRenderer = dart.privateName(material_chips__material_chip, "_itemRenderer");
  const _value = dart.privateName(material_chips__material_chip, "_value");
  const _label = dart.privateName(material_chips__material_chip, "_label");
  const _remove = dart.privateName(material_chips__material_chip, "_remove");
  const _uuid = dart.privateName(material_chips__material_chip, "_uuid");
  const _genLabel = dart.privateName(material_chips__material_chip, "_genLabel");
  ...
  material_chips__material_chip.MaterialChipComponent$ = dart.generic(T => {
    ...
    (MaterialChipComponent.new = function(root) {
      this[deleteButtonAriaMessage] = material_chips__material_chip.MaterialChipComponent.chipDeleteButtonMessage;
    ...
    const deleteButtonAriaMessage = Symbol("MaterialChipComponent.deleteButtonAriaMessage");
    ...
    dart.setLibraryUri(MaterialChipComponent, "package:angular_components/material_chips/material_chip.dart");
    dart.setFieldSignature(MaterialChipComponent, () => ({
      __proto__: dart.getFields(MaterialChipComponent.__proto__),
      deleteButtonAriaMessage: dart.fieldType(core.String),
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_chip.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;MA6CS;;;;;;MAUW;;;;;;MAIb;;;;;;MAIA;;;;;;uBAWY,KAAqB;AACpC,2BAAa,GAAG,KAAK;AACrB,uBAAS;MACX;;cAIoC,oBAAa;;gBAOvC,GAAG;AACX,oBAAM,GAAG,GAAG;AACZ,uBAAS;MACX;;cAGqB,aAAM;;;AAIzB,YAAI,YAAM,IAAI,MAAM;AAClB,sBAAM,GAAG;cACJ,OAAK,AAAU,mBAAa,KAAE,oCAAY,GAAG;AAClD,sBAAM,GAAG,iBAAY,UAAC,YAAM;;MAEhC;;cAGoB,aAAM;;;cAIL,cAAO,OAAO;;iBAGc,KAAK;AACpD,mCAAc;+CAAW,UAAK;AAC9B,qBAAO,IAAI,CAAC,UAAK;AACjB,wBAAK;AACL,wBAAK;MACP;;AAIE,YAAI,WAAK,IAAI,MAAM;AACjB,qBAAK,GAAG,0CAAY,OAAO;;AAE7B,cAAO,YAAK;MACd;;0CA1FsB,IAAY;MAS3B,6BAAuB,GAAG,2EAAuB;MAUtC,oBAAc;MAI3B,eAAS,GAAG;MAIZ,iBAAW,GAAG;MAgBH,mBAAa,GAAG,oCAAY;MAcpC,YAAM;MAYP,YAAM;MAMP,aAAO,GAAG,0BAAyB,QAAO;MASzC,WAAK;AApF0B,qDAAM,IAAI;IAAC;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MAFpC,6DAAS;YAAG;;MAIZ,2EAAuB;YAAG,WAAI,QAAQ,CAAC,iBAC1C,iCACA,oEACG;;;;;MAwFT,0CAAY;iBAAG,gEAA8B","file":"material_chip.ddc.js"}');
  // Exports:
  return {
