define(['dart_sdk', 'packages/angular_components/src/laminate/overlay/overlay_ref.template'], function(dart_sdk, overlay_ref) {
  'use strict';
  ...
  const src__laminate__overlay__overlay_state$46template = overlay_ref.src__laminate__overlay__overlay_state$46template;
  ...
  const laminate__overlay__overlay$46template = Object.create(dart.library);
