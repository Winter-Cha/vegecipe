define(['dart_sdk', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/utils/angular/imperative_view/imperative_view'], function(dart_sdk, modules, disposer, imperative_view) {
  ...
  const laminate__portal__portal = Object.create(dart.library);
  ...
  const _attachedHost = dart.privateName(laminate__portal__portal, "_attachedHost");
  ...
  const _locals = dart.privateName(laminate__portal__portal, "_locals");
  let const$;
  let const$0;
  let const$1;
  ...
  const _delegateHost = dart.privateName(laminate__portal__portal, "_delegateHost");
  ...
  const _componentLoader = dart.privateName(laminate__portal__portal, "_componentLoader");
  const _viewContainerRef = dart.privateName(laminate__portal__portal, "_viewContainerRef");
  ...
  const _hostElement = dart.privateName(laminate__portal__portal, "_hostElement");
  const _imperativeViewUtils = dart.privateName(laminate__portal__portal, "_imperativeViewUtils");
  ...
  const _ready = dart.privateName(laminate__portal__portal, "_ready");
