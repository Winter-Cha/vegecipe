define(['dart_sdk', 'packages/angular_components/src/laminate/enums/base'], function(dart_sdk, base) {
  ...
  const laminate__enums__visibility = Object.create(dart.library);
  const _propertyName = dart.privateName(laminate__enums__visibility, "_propertyName");
  const _propertyValue = dart.privateName(laminate__enums__visibility, "_propertyValue");
