define(['dart_sdk', 'packages/angular_components/utils/browser/events/events', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/interfaces/has_disabled', 'packages/angular_forms/src/directives'], function(dart_sdk, events, change_detection, has_disabled, directives) {
  ...
  const material_toggle__material_toggle = Object.create(dart.library);
  ...
  const _changeDetector = dart.privateName(material_toggle__material_toggle, "_changeDetector");
  const _onTouched = dart.privateName(material_toggle__material_toggle, "_onTouched");
  const _checked = dart.privateName(material_toggle__material_toggle, "_checked");
  const _controller = dart.privateName(material_toggle__material_toggle, "_controller");
  const _ariaLabel = dart.privateName(material_toggle__material_toggle, "_ariaLabel");
  const _hasFocus = dart.privateName(material_toggle__material_toggle, "_hasFocus");
  const _isHovered = dart.privateName(material_toggle__material_toggle, "_isHovered");
  const _syncAriaPressed = dart.privateName(material_toggle__material_toggle, "_syncAriaPressed");
  const _updateShadowZ = dart.privateName(material_toggle__material_toggle, "_updateShadowZ");
  ...
  dart.setLibraryUri(material_toggle__material_toggle.MaterialToggleComponent, "package:angular_components/material_toggle/material_toggle.dart");
