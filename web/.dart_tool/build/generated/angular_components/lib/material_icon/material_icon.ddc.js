define(['dart_sdk', 'packages/angular_components/model/ui/icon'], function(dart_sdk, icon) {
  ...
  const material_icon__material_icon = Object.create(dart.library);
  ...
  const _element = dart.privateName(material_icon__material_icon, "_element");
  const _icon = dart.privateName(material_icon__material_icon, "_icon");
