define(['dart_sdk', 'packages/angular_components/material_tab/tab_change_event', 'packages/angular_components/material_tab/material_tab', 'packages/angular/src/core/change_detection/change_detection'], function(dart_sdk, tab_change_event, material_tab, change_detection) {
  'use strict';
  ...
  const material_tab__material_tab_panel = Object.create(dart.library);
  ...
  const _changeDetector = dart.privateName(material_tab__material_tab_panel, "_changeDetector");
  const _initialized = dart.privateName(material_tab__material_tab_panel, "_initialized");
  const _previousActiveTab = dart.privateName(material_tab__material_tab_panel, "_previousActiveTab");
  const _beforeTabChange = dart.privateName(material_tab__material_tab_panel, "_beforeTabChange");
  const _tabChange = dart.privateName(material_tab__material_tab_panel, "_tabChange");
  const _activeTabIndex = dart.privateName(material_tab__material_tab_panel, "_activeTabIndex");
  const _tabs = dart.privateName(material_tab__material_tab_panel, "_tabs");
  const _tabLabels = dart.privateName(material_tab__material_tab_panel, "_tabLabels");
  const _tabIds = dart.privateName(material_tab__material_tab_panel, "_tabIds");
  const _setActiveTab = dart.privateName(material_tab__material_tab_panel, "_setActiveTab");
  const _initTabs = dart.privateName(material_tab__material_tab_panel, "_initTabs");
  const _activeTab = dart.privateName(material_tab__material_tab_panel, "_activeTab");
  material_tab__material_tab_panel.MaterialTabPanelComponent = class MaterialTabPanelComponent extends core.Object {
    ...
    [_initTabs]() {
      this[_tabLabels] = IterableOfString()._check(this[_tabs][$map](core.String, dart.fn(t => t.label, TabToString())))[$toList]();
      this[_tabIds] = IterableOfString()._check(this[_tabs][$map](core.String, dart.fn(t => t.tabId, TabToString())))[$toList]();
  ...
  dart.setGetterSignature(material_tab__material_tab_panel.MaterialTabPanelComponent, () => ({
    ...
    [_activeTab]: material_tab__material_tab.Tab,
    tabLabels: core.List$(core.String),
    tabIds: core.List$(core.String)
  }));
  ...
  dart.defineLazy(material_tab__material_tab_panel.MaterialTabPanelComponent, {
    /*material_tab__material_tab_panel.MaterialTabPanelComponent.hostClass*/get hostClass() {
      return "themeable";
    }
  });
