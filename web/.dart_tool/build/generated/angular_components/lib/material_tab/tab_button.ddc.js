define(['dart_sdk', 'packages/angular_components/material_button/material_button_base', 'packages/angular_components/material_tab/tab_mixin'], function(dart_sdk, material_button_base, tab_mixin) {
  ...
  const material_tab__tab_button = Object.create(dart.library);
  const _nativeElement = dart.privateName(material_tab__tab_button, "_nativeElement");
  ...
  (MaterialButtonBase_TabMixin$.new = function(element, role, opts) {
    material_tab__tab_mixin.TabMixin.new.call(this);
    MaterialButtonBase_TabMixin$.__proto__.new.call(this, element, role, opts);
