define(['dart_sdk', 'packages/angular_components/material_tab/tab_change_event', 'packages/angular/src/core/change_detection/change_detection'], function(dart_sdk, tab_change_event, change_detection) {
  'use strict';
  ...
  const material_tab__fixed_material_tab_strip = Object.create(dart.library);
  ...
  const _changeDetector = dart.privateName(material_tab__fixed_material_tab_strip, "_changeDetector");
  const _transitionAmount = dart.privateName(material_tab__fixed_material_tab_strip, "_transitionAmount");
  const _activeTabIndex = dart.privateName(material_tab__fixed_material_tab_strip, "_activeTabIndex");
  const _tabIndicatorTransform = dart.privateName(material_tab__fixed_material_tab_strip, "_tabIndicatorTransform");
  const _tabLabels = dart.privateName(material_tab__fixed_material_tab_strip, "_tabLabels");
  const _beforeTabChange = dart.privateName(material_tab__fixed_material_tab_strip, "_beforeTabChange");
  const _tabChange = dart.privateName(material_tab__fixed_material_tab_strip, "_tabChange");
  const _activeTabIndexChange = dart.privateName(material_tab__fixed_material_tab_strip, "_activeTabIndexChange");
  const _updateTabIndicatorTransform = dart.privateName(material_tab__fixed_material_tab_strip, "_updateTabIndicatorTransform");
  ...
  dart.setGetterSignature(material_tab__fixed_material_tab_strip.FixedMaterialTabStripComponent, () => ({
    ...
    beforeTabChange: async.Stream$(material_tab__tab_change_event.TabChangeEvent),
    tabChange: async.Stream$(material_tab__tab_change_event.TabChangeEvent),
    activeTabIndex: core.int,
    activeTabIndexChange: async.Stream$(core.int),
    tabLabels: core.List$(core.String),
    tabIndicatorTransform: core.String
  }));
  ...
  dart.setLibraryUri(material_tab__fixed_material_tab_strip.FixedMaterialTabStripComponent, "package:angular_components/material_tab/fixed_material_tab_strip.dart");
  ...
  dart.defineLazy(material_tab__fixed_material_tab_strip.FixedMaterialTabStripComponent, {
    /*material_tab__fixed_material_tab_strip.FixedMaterialTabStripComponent.hostClass*/get hostClass() {
      return "themeable";
    }
  });
  ...
  }, '{"version":3,"sourceRoot":"","sources":["fixed_material_tab_strip.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;YAiDgD,uBAAgB,OAAO;;;YAM7B,iBAAU,OAAO;;uBAOtC,KAAS;AAC1B,UAAI,qBAAe,IAAI,KAAK,EAAE;AAC5B,6BAAe,GAAG,KAAK;AACvB,0CAA4B;AAC5B,6BAAe,aAAa;;IAEhC;;YAE0B,sBAAe;;;YAKD,4BAAqB,OAAO;;kBAKtD,MAAmB;AAC/B,sBAAU,GAAG,MAAM;AACnB,wCAA4B;IAC9B;;YAE8B,iBAAU;;IAI3B;;;;;;sCAQyB,KAAU;AAC9C,uBAAO,KAAK,IAAG,CAAC,MAAM;IACxB;;YAEoC,6BAAsB;;aAE5C,KAAS;AACrB,UAAI,KAAK,IAAI,mBAAc,EAAE;AAC7B,UAAI,YAAQ,iDAAc,CAAC,mBAAc,EAAE,KAAK;AAChD,4BAAgB,IAAI,CAAC,KAAK;AAC1B,oBAAI,KAAK,iBAAiB,GAAE;AAC5B,yBAAc,GAAG,KAAK;AACtB,sBAAU,IAAI,CAAC,KAAK;AACpB,iCAAqB,IAAI,CAAC,mBAAc;IAC1C;cAEiB,KAAS;AACxB,YAAO,UAAG,mBAAc,IAAI,KAAK;IACnC;UAEa,KAAS;cAAK,WAAM;8CAAY,KAAK;IAAC;;AAGjD,UAAI,QAAQ,gBAAU,IAAI,OAAO,AAAE,iBAAE,gBAAU,SAAO,IAAG;AACzD,UAAI,WAA2B,AAAQ,aAAxB,qBAAe,IAAG,KAAK,gBAAG,uBAAiB;AAC1D,kCAAsB,GAAG,yBAAa,QAAQ,4BAAW,KAAK;IAChE;;wGA/B0B,KAAwC;IArD9D,qBAAe,GAAG;IACf,4BAAsB;IAChB,gBAAU;IASjB,sBAAgB,GAClB,4CAA0C,QAAO;IAK/C,gBAAU,GAAG,4CAA0C,QAAO;IAoB9D,2BAAqB,GAAG,iCAA+B;IAahD,YAAM;IAGV,qBAAe;IAClB,uBAAiB,GAAG,gGAA0B,CAAC,KAAK,WAAL,KAAK,GAAI;AAC5D,sCAA4B;EAC9B;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MA5Da,+EAAS;YAAG","file":"fixed_material_tab_strip.ddc.js"}');
  // Exports:
  return {
