define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/model/selection/selection_model', 'packages/angular_components/focus/focus', 'packages/angular_forms/src/directives', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/model/ui/icon', 'packages/angular_components/utils/browser/events/events', 'packages/angular_components/interfaces/has_disabled'], function(dart_sdk, disposer, selection_model, focus, directives, change_detection, icon, events, has_disabled) {
  'use strict';
  ...
  const material_radio__material_radio_group = Object.create(dart.library);
  const material_radio__material_radio = Object.create(dart.library);
  ...
  const _ngZone = dart.privateName(material_radio__material_radio_group, "_ngZone");
  const _disposer = dart.privateName(material_radio__material_radio_group, "_disposer");
  const _radioComponents = dart.privateName(material_radio__material_radio_group, "_radioComponents");
  const _onChange = dart.privateName(material_radio__material_radio_group, "_onChange");
  const _preselectedValue = dart.privateName(material_radio__material_radio_group, "_preselectedValue");
  const _isContentInit = dart.privateName(material_radio__material_radio_group, "_isContentInit");
  const _selected = dart.privateName(material_radio__material_radio_group, "_selected");
  const _resetTabIndex = dart.privateName(material_radio__material_radio_group, "_resetTabIndex");
  const _selectedRadioComponent = dart.privateName(material_radio__material_radio_group, "_selectedRadioComponent");
  const _moveFocus = dart.privateName(material_radio__material_radio_group, "_moveFocus");
  const _moveSelection = dart.privateName(material_radio__material_radio_group, "_moveSelection");
  const _getFocusableChildren = dart.privateName(material_radio__material_radio_group, "_getFocusableChildren");
  const _move = dart.privateName(material_radio__material_radio_group, "_move");
  ...
  dart.setLibraryUri(material_radio__material_radio_group.MaterialRadioGroupComponent, "package:angular_components/material_radio/material_radio_group.dart");
  ...
  const _root = dart.privateName(material_radio__material_radio, "_root");
  const _changeDetector = dart.privateName(material_radio__material_radio, "_changeDetector");
  const _group = dart.privateName(material_radio__material_radio, "_group");
  const _disposer$ = dart.privateName(material_radio__material_radio, "_disposer");
  const _onChecked = dart.privateName(material_radio__material_radio, "_onChecked");
  const _checked = dart.privateName(material_radio__material_radio, "_checked");
  const _enabledTabIndex = dart.privateName(material_radio__material_radio, "_enabledTabIndex");
  const _focusMoveCtrl = dart.privateName(material_radio__material_radio, "_focusMoveCtrl");
  const _selectionMoveCtrl = dart.privateName(material_radio__material_radio, "_selectionMoveCtrl");
  const _isFocused = dart.privateName(material_radio__material_radio, "_isFocused");
  const _isKeyboardEvent = dart.privateName(material_radio__material_radio, "_isKeyboardEvent");
  ...
  dart.setLibraryUri(material_radio__material_radio.MaterialRadioComponent, "package:angular_components/material_radio/material_radio.dart");
