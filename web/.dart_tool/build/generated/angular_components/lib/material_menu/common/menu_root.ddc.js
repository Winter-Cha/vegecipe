define(['dart_sdk', 'packages/angular_components/mixins/material_dropdown_base'], function(dart_sdk, material_dropdown_base) {
  ...
  const material_menu__common__menu_root = Object.create(dart.library);
  const _dropdown = dart.privateName(material_menu__common__menu_root, "_dropdown");
  material_menu__common__menu_root.MenuRoot = class MenuRoot extends core.Object {
    get visible() {
      return this[visible];
    }
    set visible(value) {
  ...
  (material_menu__common__menu_root.MenuRoot.new = function() {
    this[visible] = null;
  ...
  material_menu__common__menu_root.MenuRootDirective = class MenuRootDirective extends material_menu__common__menu_root.MenuRoot {
    closeHierarchy() {
      this.visible = false;
      this[_dropdown].close();
    }
  };
  (material_menu__common__menu_root.MenuRootDirective.new = function(dropdown) {
    this[_dropdown] = dropdown;
    material_menu__common__menu_root.MenuRootDirective.__proto__.new.call(this);
    this.visible = true;
  }).prototype = material_menu__common__menu_root.MenuRootDirective.prototype;
  dart.addTypeTests(material_menu__common__menu_root.MenuRootDirective);
  dart.setMethodSignature(material_menu__common__menu_root.MenuRootDirective, () => ({
