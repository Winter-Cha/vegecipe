define(['dart_sdk', 'packages/angular/angular.template', 'packages/angular_components/mixins/material_dropdown_base.template'], function(dart_sdk, angular, material_dropdown_base) {
  ...
  const material_menu__common__menu_root$46template = Object.create(dart.library);
  dart.defineLazy(material_menu__common__menu_root$46template, {
    /*material_menu__common__menu_root$46template._visited*/get _visited() {
      return false;
    },
    set _visited(_) {}
  });
  material_menu__common__menu_root$46template.initReflector = function() {
    if (dart.test(material_menu__common__menu_root$46template._visited)) {
      return;
    }
    material_menu__common__menu_root$46template._visited = true;
  ...
  // Exports:
  return {
    material_menu__common__menu_root$46template: material_menu__common__menu_root$46template
  };
});
