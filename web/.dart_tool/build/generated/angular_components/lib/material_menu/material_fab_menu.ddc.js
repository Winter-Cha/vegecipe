define(['dart_sdk', 'packages/angular_components/laminate/enums/alignment', 'packages/angular_components/model/observable/observable', 'packages/angular_components/material_popup/material_popup', 'packages/angular_components/model/a11y/keyboard_handler_mixin', 'packages/angular_components/mixins/track_layout_changes', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/model/menu/menu'], function(dart_sdk, alignment, observable, material_popup, keyboard_handler_mixin, track_layout_changes, change_detection, menu) {
  ...
  const material_menu__material_fab_menu = Object.create(dart.library);
  ...
  const _changeDetector = dart.privateName(material_menu__material_fab_menu, "_changeDetector");
  const _activateFirstItemOnInit = dart.privateName(material_menu__material_fab_menu, "_activateFirstItemOnInit");
  const _activateLastItemOnInit = dart.privateName(material_menu__material_fab_menu, "_activateLastItemOnInit");
  const _viewModelStreamSub = dart.privateName(material_menu__material_fab_menu, "_viewModelStreamSub");
  const _viewModel = dart.privateName(material_menu__material_fab_menu, "_viewModel");
  const _onShow = dart.privateName(material_menu__material_fab_menu, "_onShow");
  const _menuVisible = dart.privateName(material_menu__material_fab_menu, "_menuVisible");
  let const$;
  const _trigger = dart.privateName(material_menu__material_fab_menu, "_trigger");
  const _hideMenuContent = dart.privateName(material_menu__material_fab_menu, "_hideMenuContent");
  ...
  material_menu__material_fab_menu.MaterialFabMenuComponent = class MaterialFabMenuComponent extends Object_TrackLayoutChangesMixin$ {
    ...
    trigger(event) {
      this[_trigger]({activateFirstItem: html.KeyboardEvent.is(event)});
    }
    hideMenu() {
      this[_hideMenuContent]();
  ...
  dart.setMethodSignature(material_menu__material_fab_menu.MaterialFabMenuComponent, () => ({
    ...
    trigger: dart.fnType(dart.void, [html.Event]),
    hideMenu: dart.fnType(dart.void, []),
    [_trigger]: dart.fnType(dart.void, [], {activateFirstItem: core.bool, activateLastItem: core.bool}),
  ...
  dart.setGetterSignature(material_menu__material_fab_menu.MaterialFabMenuComponent, () => ({
    ...
    hasIcons: core.bool,
    activateFirstItemOnInit: core.bool,
    activateLastItemOnInit: core.bool
  }));
  ...
  dart.setLibraryUri(material_menu__material_fab_menu.MaterialFabMenuComponent, "package:angular_components/material_menu/material_fab_menu.dart");
  dart.setFieldSignature(material_menu__material_fab_menu.MaterialFabMenuComponent, () => ({
    ...
    [_activateLastItemOnInit]: dart.fieldType(core.bool),
  ...
  const _showPopup = dart.privateName(material_menu__material_fab_menu, "_showPopup");
  ...
  dart.setLibraryUri(material_menu__material_fab_menu.MaterialFabMenuModel, "package:angular_components/material_menu/material_fab_menu.dart");
