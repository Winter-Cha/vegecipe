define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/model/selection/selection_model', 'packages/angular_components/utils/color/palette', 'packages/angular_components/scorecard/scorecard', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/scorecard/scorecard_bar', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/intl/intl'], function(dart_sdk, disposer, selection_model, palette, scorecard, change_detection, scorecard_bar, dom_service, intl) {
  ...
  const scorecard__scoreboard = Object.create(dart.library);
  ...
  const _domService = dart.privateName(scorecard__scoreboard, "_domService");
  const _changeDetector = dart.privateName(scorecard__scoreboard, "_changeDetector");
  const _disposer = dart.privateName(scorecard__scoreboard, "_disposer");
  const _cardSelectionDisposer = dart.privateName(scorecard__scoreboard, "_cardSelectionDisposer");
  const _selectionModel = dart.privateName(scorecard__scoreboard, "_selectionModel");
  const _scorecards = dart.privateName(scorecard__scoreboard, "_scorecards");
  const _scorecardBar = dart.privateName(scorecard__scoreboard, "_scorecardBar");
  const _enableUniformWidths = dart.privateName(scorecard__scoreboard, "_enableUniformWidths");
  const _initialized = dart.privateName(scorecard__scoreboard, "_initialized");
  const _atScorecardBarStart = dart.privateName(scorecard__scoreboard, "_atScorecardBarStart");
  const _atScorecardBarEnd = dart.privateName(scorecard__scoreboard, "_atScorecardBarEnd");
  const _onScorecardsChange = dart.privateName(scorecard__scoreboard, "_onScorecardsChange");
  const _refreshArrows = dart.privateName(scorecard__scoreboard, "_refreshArrows");
  const _resetTabIndex = dart.privateName(scorecard__scoreboard, "_resetTabIndex");
  const _updatedSelected = dart.privateName(scorecard__scoreboard, "_updatedSelected");
  const _scorecardOffset = dart.privateName(scorecard__scoreboard, "_scorecardOffset");
  const _makeScorecardsUniformWidth = dart.privateName(scorecard__scoreboard, "_makeScorecardsUniformWidth");
  ...
  dart.setLibraryUri(scorecard__scoreboard.ScoreboardComponent, "package:angular_components/scorecard/scoreboard.dart");
  ...
  dart.setLibraryUri(scorecard__scoreboard.ScoreboardType, "package:angular_components/scorecard/scoreboard.dart");
