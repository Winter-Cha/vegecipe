define(['dart_sdk', 'packages/angular_components/utils/color/palette', 'packages/angular_components/utils/browser/events/events', 'packages/angular_components/focus/keyboard_only_focus_indicator', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/utils/color/color'], function(dart_sdk, palette, events, keyboard_only_focus_indicator, change_detection, color) {
  ...
  const scorecard__scorecard = Object.create(dart.library);
  const $toUpperCase = dartx.toUpperCase;
  const $_get = dartx._get;
  let StreamControllerOfbool = () => (StreamControllerOfbool = dart.constFn(async.StreamController$(core.bool)))();
  const _changeDetector = dart.privateName(scorecard__scorecard, "_changeDetector");
  const _selectionController = dart.privateName(scorecard__scorecard, "_selectionController");
  const _isChangePositive = dart.privateName(scorecard__scorecard, "_isChangePositive");
  const _isChangeNegative = dart.privateName(scorecard__scorecard, "_isChangeNegative");
  const _isChangeNeutral = dart.privateName(scorecard__scorecard, "_isChangeNeutral");
  const _selectable = dart.privateName(scorecard__scorecard, "_selectable");
  ...
  dart.setGetterSignature(scorecard__scorecard.ScorecardComponent, () => ({
    ...
    isChangePositive: core.bool,
    isChangeNegative: core.bool,
    isChangeNeutral: core.bool,
    changeGlyphIcon: core.String,
    selectable: core.bool,
    hostTabIndex: core.int,
    hostRole: core.String,
    selectedChange: async.Stream$(core.bool),
    backgroundStyle: core.String
  }));
  dart.setSetterSignature(scorecard__scorecard.ScorecardComponent, () => ({
    ...
    changeType: core.String,
    selectable: core.bool
  }));
  dart.setLibraryUri(scorecard__scorecard.ScorecardComponent, "package:angular_components/scorecard/scorecard.dart");
  ...
  dart.defineLazy(scorecard__scorecard.ScorecardComponent, {
    /*scorecard__scorecard.ScorecardComponent.hostClass*/get hostClass() {
      return "themeable";
    },
  ...
  }, '{"version":3,"sourceRoot":"","sources":["scorecard.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;IAmDoB;;;;;;IAMX;;;;;;IAIA;;;;;;IAIA;;;;;;IAKF;;;;;;IAIE;;;;;;IAIA;;;;;;IAIA;;;;;;IAKF;;;;;;mBASU,UAAiB;AAE9B,6BAAiB,GAAG,uBAAiB,GAAG,sBAAgB,GAAG;AAC3D,cAAQ,CAAC,UAAU,WAAV,UAAU,GAAI,SAAiB,eAAa;YAC9C,WAAkB;;AACrB,iCAAiB,GAAG;AACpB;;YACG,WAAkB;;AACrB,iCAAiB,GAAG;AACpB;;YACG,UAAiB;;AACpB,gCAAgB,GAAG;AACnB;;;;AAEA,yBAAM,wBAAmB,CAAC,UAAU,EAAE;;;IAE5C;;YAI6B,wBAAiB;;;YAIjB,wBAAiB;;;YAGlB,uBAAgB;;;AAI1C,WAAO,WAAC,oBAAe;AACvB,uBAAO,qBAAgB,IAAG,iBAAiB;IAC7C;IAKK;;;;;;;YAGkB,kBAAW;;mBAInB,UAAe;AAC5B,uBAAW,GAAG,UAAU;AAMxB,2BAAe,aAAa;IAC9B;;uBAGwB,eAAU,IAAG,IAAI;IAAI;;uBAGtB,eAAU,IAAG,WAAW;IAAI;IAI7C;;;;;;;YAI6B,2BAAoB,OAAO;;;uBAMhC,aAAQ;gBAChC,kBAAa;;+BAAe,qCAAe,QAAC,YAAY;aACxD;IAAS;;AAIb,sBAAW;AACX,oBAAI,eAAU,GAAE;AACd,qBAAQ,GAAG,WAAC,aAAQ;AACpB,kCAAoB,IAAI,CAAC,aAAQ;;IAErC;mBAGoB,KAAmB;AACrC,UAAI,UAAU,KAAK,QAAQ;AAC3B,oBAAI,eAAU,MAAK,OAAO,KAAI,YAAO,MAAM,cAAI,yCAAU,CAAC,KAAK,KAAI;AACjE,aAAK,eAAe;AACpB,wBAAW;;IAEf;;0EAzIyC,OAAY,EAAE,UAAqB;IAV/C,0BAAoB,GAC7C,kCAAgC,QAAO;IAEtC,uBAAiB,GAAG;IACpB,uBAAiB,GAAG;IACpB,sBAAgB,GAAG;IACnB,iBAAW,GAAG;IASZ,WAAK;IAIL,YAAK;IAIL,aAAO;IAKT,iBAAW,GAAG;IAIZ,sBAAgB;IAIhB,iBAAW;IAIX,qBAAe;IAKjB,cAAQ,GAAG;IA+CX,cAAQ,GAAG;IAyBV,mBAAa;IA3GK,qBAAe;IAAO,cAAO,GAAP,OAAO;AAC/C,qEAAM,OAAO,EAAE,UAAU;EAAC;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MAjBnB,iDAAS;YAAG;;MAEZ,0DAAkB;YAAG;;MACrB,0DAAkB;YAAG;;MACrB,yDAAiB;YAAG","file":"scorecard.ddc.js"}');
  // Exports:
  return {
