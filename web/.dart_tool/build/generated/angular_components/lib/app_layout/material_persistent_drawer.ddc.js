define(['dart_sdk', 'packages/angular_components/app_layout/material_drawer_base'], function(dart_sdk, material_drawer_base) {
  ...
  const app_layout__material_persistent_drawer = Object.create(dart.library);
  ...
  dart.setGetterSignature(app_layout__material_persistent_drawer.MaterialPersistentDrawerDirective, () => ({
    __proto__: dart.getGetters(app_layout__material_persistent_drawer.MaterialPersistentDrawerDirective.__proto__),
    hostMatDrawerCollapsed: core.bool,
    hostMatDrawerExpanded: core.bool
  }));
  dart.setLibraryUri(app_layout__material_persistent_drawer.MaterialPersistentDrawerDirective, "package:angular_components/app_layout/material_persistent_drawer.dart");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_persistent_drawer.dart"],"names":[],"mappings":";;;;;;;;;YA2BqC,YAAC,YAAO;;;YAGT,aAAO;;;;AANH;EAAO","file":"material_persistent_drawer.ddc.js"}');
  // Exports:
  return {
