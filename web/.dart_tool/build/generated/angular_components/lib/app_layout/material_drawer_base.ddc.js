define(['dart_sdk', 'packages/angular_components/content/deferred_content_aware', 'packages/angular/src/core/change_detection/change_detection'], function(dart_sdk, deferred_content_aware, change_detection) {
  'use strict';
  ...
  const app_layout__material_drawer_base = Object.create(dart.library);
  ...
  const _visible = dart.privateName(app_layout__material_drawer_base, "_visible");
  const _visibleChange = dart.privateName(app_layout__material_drawer_base, "_visibleChange");
