define(['dart_sdk', 'packages/angular_components/app_layout/material_drawer_base'], function(dart_sdk, material_drawer_base) {
  ...
  const app_layout__material_temporary_drawer = Object.create(dart.library);
  ...
  dart.setGetterSignature(app_layout__material_temporary_drawer.MaterialTemporaryDrawerComponent, () => ({
    __proto__: dart.getGetters(app_layout__material_temporary_drawer.MaterialTemporaryDrawerComponent.__proto__),
