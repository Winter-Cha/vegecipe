define(['dart_sdk', 'packages/angular/src/bootstrap/modules', 'packages/angular/src/core/change_detection/directive_change_detector', 'packages/angular_components/app_layout/material_persistent_drawer', 'packages/angular_components/app_layout/material_drawer_base.template', 'packages/angular/angular.template', 'packages/angular_components/content/deferred_content_aware.template'], function(dart_sdk, modules, directive_change_detector, material_persistent_drawer, material_drawer_base, angular, deferred_content_aware) {
  ...
  const app_layout__material_persistent_drawer$46template = Object.create(dart.library);
  const _expr_0 = dart.privateName(app_layout__material_persistent_drawer$46template, "_expr_0");
  const _expr_1 = dart.privateName(app_layout__material_persistent_drawer$46template, "_expr_1");
  app_layout__material_persistent_drawer$46template.MaterialPersistentDrawerDirectiveNgCd = class MaterialPersistentDrawerDirectiveNgCd extends src__core__change_detection__directive_change_detector.DirectiveChangeDetector {
    ...
    detectHostChanges(view, el) {
      ...
      if (dart.test(src__core__linker__app_view_utils.checkBinding(this[_expr_0], currVal_0))) {
        src__runtime__dom_helpers.updateClassBindingNonHtml(el, "mat-drawer-collapsed", currVal_0);
        this[_expr_0] = currVal_0;
      }
      let currVal_1 = this.instance.hostMatDrawerExpanded;
      if (dart.test(src__core__linker__app_view_utils.checkBinding(this[_expr_1], currVal_1))) {
        src__runtime__dom_helpers.updateClassBindingNonHtml(el, "mat-drawer-expanded", currVal_1);
  ...
  dart.setMethodSignature(app_layout__material_persistent_drawer$46template.MaterialPersistentDrawerDirectiveNgCd, () => ({
