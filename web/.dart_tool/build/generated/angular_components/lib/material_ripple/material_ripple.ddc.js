define(['dart_sdk', 'packages/angular_components/utils/browser/feature_detector/feature_detector', 'packages/angular_components/utils/browser/events/events', 'packages/angular/src/core/change_detection/change_detection'], function(dart_sdk, feature_detector, events, change_detection) {
  ...
  const material_ripple__material_ripple = Object.create(dart.library);
  ...
  let DivElementToNull = () => (DivElementToNull = dart.constFn(dart.fnType(core.Null, [html.DivElement])))();
  ...
  const _element = dart.privateName(material_ripple__material_ripple, "_element");
  const _onMouseDown = dart.privateName(material_ripple__material_ripple, "_onMouseDown");
  const _onKeyDown = dart.privateName(material_ripple__material_ripple, "_onKeyDown");
  material_ripple__material_ripple.MaterialRippleComponent = class MaterialRippleComponent extends core.Object {
    ...
    ngOnDestroy() {
      ...
      material_ripple__material_ripple._ripplePool[$forEach](dart.fn(ripple => {
        if (dart.equals(ripple == null ? null : ripple[$parent], this[_element])) {
          ripple[$remove]();
        }
      }, DivElementToNull()));
    }
  ...
  dart.setLibraryUri(material_ripple__material_ripple.MaterialRippleComponent, "package:angular_components/material_ripple/material_ripple.dart");
