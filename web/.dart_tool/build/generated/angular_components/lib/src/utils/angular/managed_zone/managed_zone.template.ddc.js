define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer.template'], function(dart_sdk, disposer) {
  ...
  const src__utils__angular__managed_zone__managed_zone$46template = Object.create(dart.library);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["managed_zone.template.dart"],"names":[],"mappings":";;;;;;;;MAQI,mEAAQ;YAAG;;;;;AAEb,kBAAI,mEAAQ,GAAE;AACZ;;AAEF,0EAAW;AAEX,IAAM,kDAAa;EACrB","file":"managed_zone.template.ddc.js"}');
  // Exports:
  return {
