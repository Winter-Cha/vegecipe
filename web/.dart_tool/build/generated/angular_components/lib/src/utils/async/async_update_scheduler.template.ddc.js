define(['dart_sdk', 'packages/angular_components/utils/rate_limit_utils/rate_limit_utils.template', 'packages/angular_components/utils/disposer/disposer.template'], function(dart_sdk, rate_limit_utils, disposer) {
  ...
  const src__utils__async__async_update_scheduler$46template = Object.create(dart.library);
  const src__utils__async__async_where$46template = Object.create(dart.library);
  const src__utils__async__rate_limit$46template = Object.create(dart.library);
  const src__utils__async__debounce_stream$46template = Object.create(dart.library);
  const src__utils__async__disposable_future$46template = Object.create(dart.library);
  const src__utils__async__lazy_stream_controller$46template = Object.create(dart.library);
  const src__utils__async__priority_stream_iterator$46template = Object.create(dart.library);
  const src__utils__async__simple_stream$46template = Object.create(dart.library);
  const src__utils__async__throttle_stream$46template = Object.create(dart.library);
  const src__utils__async__zoned_async$46template = Object.create(dart.library);
