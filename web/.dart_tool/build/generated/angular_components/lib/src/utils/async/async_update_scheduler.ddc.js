define(['dart_sdk', 'packages/angular_components/utils/rate_limit_utils/rate_limit_utils', 'packages/angular_components/utils/disposer/disposer', 'packages/collection/src/priority_queue'], function(dart_sdk, rate_limit_utils, disposer, priority_queue) {
  ...
  const src__utils__async__async_update_scheduler = Object.create(dart.library);
  const src__utils__async__async_where = Object.create(dart.library);
  const src__utils__async__rate_limit = Object.create(dart.library);
  const src__utils__async__debounce_stream = Object.create(dart.library);
  const src__utils__async__disposable_future = Object.create(dart.library);
  const src__utils__async__lazy_stream_controller = Object.create(dart.library);
  const src__utils__async__priority_stream_iterator = Object.create(dart.library);
  const src__utils__async__simple_stream = Object.create(dart.library);
  const src__utils__async__throttle_stream = Object.create(dart.library);
  const src__utils__async__zoned_async = Object.create(dart.library);
  ...
  let SimpleStreamSubscriptionOfNull = () => (SimpleStreamSubscriptionOfNull = dart.constFn(src__utils__async__simple_stream.SimpleStreamSubscription$(core.Null)))();
  ...
  const _updateCallback = dart.privateName(src__utils__async__async_update_scheduler, "_updateCallback");
  const _isUpdateScheduled = dart.privateName(src__utils__async__async_update_scheduler, "_isUpdateScheduled");
  const _onUpdateStreamController = dart.privateName(src__utils__async__async_update_scheduler, "_onUpdateStreamController");
  ...
  dart.setLibraryUri(src__utils__async__async_update_scheduler.AsyncUpdateScheduler, "package:angular_components/src/utils/async/async_update_scheduler.dart");
  ...
  const _outputSink = dart.privateName(src__utils__async__rate_limit, "_outputSink");
  const _duration = dart.privateName(src__utils__async__rate_limit, "_duration");
  const _rateLimitStrategy = dart.privateName(src__utils__async__rate_limit, "_rateLimitStrategy");
  const _addEvent = dart.privateName(src__utils__async__rate_limit, "_addEvent");
  ...
  dart.setLibraryUri(src__utils__async__rate_limit._RateLimitSink, "package:angular_components/src/utils/async/rate_limit.dart");
  ...
  src__utils__async__rate_limit.RateLimitTransformer$ = dart.generic((S, T) => {
    ...
    dart.setLibraryUri(RateLimitTransformer, "package:angular_components/src/utils/async/rate_limit.dart");
  ...
  const _delegateFuture = dart.privateName(src__utils__async__disposable_future, "_delegateFuture");
  const _disposeFn = dart.privateName(src__utils__async__disposable_future, "_disposeFn");
  const _wasDisposed = dart.privateName(src__utils__async__disposable_future, "_wasDisposed");
  ...
  src__utils__async__disposable_future.DisposableFuture$ = dart.generic(T => {
    ...
    dart.setLibraryUri(DisposableFuture, "package:angular_components/src/utils/async/disposable_future.dart");
  ...
  const _streamControllerFactory = dart.privateName(src__utils__async__lazy_stream_controller, "_streamControllerFactory");
  const _streamController = dart.privateName(src__utils__async__lazy_stream_controller, "_streamController");
  const _initializeLazy = dart.privateName(src__utils__async__lazy_stream_controller, "_initializeLazy");
  ...
  src__utils__async__lazy_stream_controller.LazyStreamController$ = dart.generic(T => {
    ...
    dart.setLibraryUri(LazyStreamController, "package:angular_components/src/utils/async/lazy_stream_controller.dart");
  ...
  const _iterator = dart.privateName(src__utils__async__priority_stream_iterator, "_iterator");
  const _queue = dart.privateName(src__utils__async__priority_stream_iterator, "_queue");
  const _current = dart.privateName(src__utils__async__priority_stream_iterator, "_current");
  const _next = dart.privateName(src__utils__async__priority_stream_iterator, "_next");
  const _accumulateValues = dart.privateName(src__utils__async__priority_stream_iterator, "_accumulateValues");
  const _clear = dart.privateName(src__utils__async__priority_stream_iterator, "_clear");
  const _getNextValue = dart.privateName(src__utils__async__priority_stream_iterator, "_getNextValue");
  ...
  src__utils__async__priority_stream_iterator.PriorityStreamIterator$ = dart.generic(T => {
    ...
    dart.setLibraryUri(PriorityStreamIterator, "package:angular_components/src/utils/async/priority_stream_iterator.dart");
  ...
  src__utils__async__priority_stream_iterator._StablePriorityQueue$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_StablePriorityQueue, "package:angular_components/src/utils/async/priority_stream_iterator.dart");
  ...
  const _comparison = dart.privateName(src__utils__async__priority_stream_iterator, "_comparison");
  const _ordinalByElement = dart.privateName(src__utils__async__priority_stream_iterator, "_ordinalByElement");
  const _nextOrdinal = dart.privateName(src__utils__async__priority_stream_iterator, "_nextOrdinal");
  const _renumerate = dart.privateName(src__utils__async__priority_stream_iterator, "_renumerate");
  const _compareOrder = dart.privateName(src__utils__async__priority_stream_iterator, "_compareOrder");
  ...
  src__utils__async__priority_stream_iterator._OrderedComparator$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_OrderedComparator, "package:angular_components/src/utils/async/priority_stream_iterator.dart");
  ...
  const _isSync = dart.privateName(src__utils__async__simple_stream, "_isSync");
  const _runInZone = dart.privateName(src__utils__async__simple_stream, "_runInZone");
  const _onListen = dart.privateName(src__utils__async__simple_stream, "_onListen");
  const _onCancel = dart.privateName(src__utils__async__simple_stream, "_onCancel");
  const _subscriptions = dart.privateName(src__utils__async__simple_stream, "_subscriptions");
  let const$;
  const _itemsToSend = dart.privateName(src__utils__async__simple_stream, "_itemsToSend");
  const _subscriptionRemoved = dart.privateName(src__utils__async__simple_stream, "_subscriptionRemoved");
  let const$0;
  const _sendItem = dart.privateName(src__utils__async__simple_stream, "_sendItem");
  const _sendAsync = dart.privateName(src__utils__async__simple_stream, "_sendAsync");
  const _cleanUp = dart.privateName(src__utils__async__simple_stream, "_cleanUp");
  const _stream = dart.privateName(src__utils__async__simple_stream, "_stream");
  const _add = dart.privateName(src__utils__async__simple_stream, "_add");
  const _onError = dart.privateName(src__utils__async__simple_stream, "_onError");
  const _cancelOnError = dart.privateName(src__utils__async__simple_stream, "_cancelOnError");
  const _closeSubscription = dart.privateName(src__utils__async__simple_stream, "_closeSubscription");
  const _scheduleCleanup = dart.privateName(src__utils__async__simple_stream, "_scheduleCleanup");
  ...
  src__utils__async__simple_stream.SimpleStream$ = dart.generic(T => {
    ...
    class SimpleStream extends async.Stream$(T) {
      get isBroadcast() {
      ...
      [_cleanUp]() {
        if (dart.test(this.hasListener)) {
          ...
          for (let liveCount = 0; liveCount < dart.notNull(listeners[$length]); liveCount++) {
            ...
            for (let i = liveCount + 1; i < dart.notNull(listeners[$length]); i++) {
              let listener = listeners[$_get](i);
              if (listener[_stream] != null) {
                listeners[$_set](liveCount++, listener);
              }
            }
            listeners[$length] = liveCount;
            if (liveCount === 0 && this[_onCancel] != null) {
              this[_onCancel](firstRemovedListener);
            }
            break;
          }
        }
      ...
      listen(onData, opts) {
        ...
        let sub = new (SimpleStreamSubscriptionOfT()).new(this, onData, onDone, onError, cancelOnError, contextZone);
    ...
    (SimpleStream.new = function(opts) {
      ...
      this[_subscriptions] = const$ || (const$ = dart.constList([], SimpleStreamSubscriptionOfNull()));
      this[_itemsToSend] = null;
      this[_subscriptionRemoved] = false;
      this[_isSync] = isSync;
    ...
    (SimpleStream.broadcast = function(opts) {
      ...
      let onCancel = opts && 'onCancel' in opts ? opts.onCancel : null;
      this[isBroadcast] = true;
      this[_subscriptions] = const$0 || (const$0 = dart.constList([], SimpleStreamSubscriptionOfNull()));
      this[_itemsToSend] = null;
      this[_subscriptionRemoved] = false;
      this[_isSync] = isSync;
      this[_runInZone] = runInZone;
    ...
    dart.setLibraryUri(SimpleStream, "package:angular_components/src/utils/async/simple_stream.dart");
  ...
  const _lastItem = dart.privateName(src__utils__async__simple_stream, "_lastItem");
  ...
  src__utils__async__simple_stream.LastStateStream$ = dart.generic(T => {
    ...
    dart.setLibraryUri(LastStateStream, "package:angular_components/src/utils/async/simple_stream.dart");
  ...
  src__utils__async__simple_stream.EmptySimpleStream$ = dart.generic(T => {
    ...
    dart.setLibraryUri(EmptySimpleStream, "package:angular_components/src/utils/async/simple_stream.dart");
  ...
  const _callback = dart.privateName(src__utils__async__simple_stream, "_callback");
  const _doneCallback = dart.privateName(src__utils__async__simple_stream, "_doneCallback");
  const _contextZone = dart.privateName(src__utils__async__simple_stream, "_contextZone");
  ...
  src__utils__async__simple_stream.SimpleStreamSubscription$ = dart.generic(T => {
      ...
      [_add](data) {
        ...
        if (this[_callback] != null) {
          if (this[_contextZone] != null) {
            this[_contextZone].runUnary(dart.void, T, this[_callback], data);
          } else {
            this[_callback](data);
          }
        }
    ...
    (SimpleStreamSubscription.new = function(stream, callback, doneCallback, onError, cancelOnError, contextZone) {
      this[isPaused] = false;
      this[_stream] = stream;
    ...
    dart.setLibraryUri(SimpleStreamSubscription, "package:angular_components/src/utils/async/simple_stream.dart");
    dart.setFieldSignature(SimpleStreamSubscription, () => ({
      ...
      [_contextZone]: dart.fieldType(async.Zone),
  ...
  src__utils__async__simple_stream.SimpleEmitter$ = dart.generic(T => {
    ...
    dart.setLibraryUri(SimpleEmitter, "package:angular_components/src/utils/async/simple_stream.dart");
  ...
  const _runInZoneFn = dart.privateName(src__utils__async__zoned_async, "_runInZoneFn");
  const _runInZone$ = dart.privateName(src__utils__async__zoned_async, "_runInZone");
  ...
  dart.setLibraryUri(src__utils__async__zoned_async._ZoneRunner, "package:angular_components/src/utils/async/zoned_async.dart");
  const _innerFuture = dart.privateName(src__utils__async__zoned_async, "_innerFuture");
  ...
  src__utils__async__zoned_async.ZonedFuture$ = dart.generic(T => {
    ...
    dart.setLibraryUri(ZonedFuture, "package:angular_components/src/utils/async/zoned_async.dart");
  ...
  const _innerStream = dart.privateName(src__utils__async__zoned_async, "_innerStream");
  ...
  src__utils__async__zoned_async.ZonedStream$ = dart.generic(T => {
    ...
    dart.setLibraryUri(ZonedStream, "package:angular_components/src/utils/async/zoned_async.dart");
