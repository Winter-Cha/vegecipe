define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer'], function(dart_sdk, disposer) {
  ...
  const src__utils__angular__managed_zone__managed_zone = Object.create(dart.library);
  ...
  const _isRunning = dart.privateName(src__utils__angular__managed_zone__managed_zone, "_isRunning");
