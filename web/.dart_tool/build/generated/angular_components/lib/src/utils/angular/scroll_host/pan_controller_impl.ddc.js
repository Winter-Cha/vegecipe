define(['dart_sdk', 'packages/angular_components/src/utils/angular/scroll_host/scroll_host_interface', 'packages/angular_components/src/utils/async/async_update_scheduler', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/utils/browser/feature_detector/feature_detector', 'packages/angular_components/utils/browser/events/events', 'packages/quiver/core', 'packages/angular_components/utils/angular/scroll_host/interface', 'packages/logging/logging'], function(dart_sdk, scroll_host_interface, async_update_scheduler, change_detection, dom_service, disposer, feature_detector, events, core, $interface, logging) {
  ...
  const src__utils__angular__scroll_host__pan_controller_impl = Object.create(dart.library);
  const src__utils__angular__scroll_host__position_sticky_controller = Object.create(dart.library);
  const src__utils__angular__scroll_host__sticky_controller_impl = Object.create(dart.library);
  const src__utils__angular__scroll_host__scroll_host_base = Object.create(dart.library);
  ...
  const _controller = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_controller");
  const _stream = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_stream");
  const _onWheelSubscription = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_onWheelSubscription");
  const _onScrollSubscription = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_onScrollSubscription");
  const _panTop = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_panTop");
  const _panRight = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_panRight");
  const _panBottom = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_panBottom");
  const _panLeft = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_panLeft");
  const _wasPanning = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_wasPanning");
  const _wasScrolling = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_wasScrolling");
  const _endPan = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_endPan");
  const _lastEvent = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_lastEvent");
  const _eventCollectTimer = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_eventCollectTimer");
  const _notificationSender = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_notificationSender");
  const _scrollCooldownTimer = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_scrollCooldownTimer");
  const _deduplicationTimer = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_deduplicationTimer");
  const _onListen = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_onListen");
  const _onCancel = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_onCancel");
  const _scheduleNotification = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_scheduleNotification");
  const _scheduleScrollingCooldown = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_scheduleScrollingCooldown");
  const _hasPan = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_hasPan");
  const _hasNotification = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_hasNotification");
  const _resetPans = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_resetPans");
  const _scheduleDeduplication = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_scheduleDeduplication");
  const _cancelSubscriptions = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_cancelSubscriptions");
  const _cancelScrollingCooldown = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_cancelScrollingCooldown");
  const _cancelDeduplication = dart.privateName(src__utils__angular__scroll_host__pan_controller_impl, "_cancelDeduplication");
  ...
  dart.setLibraryUri(src__utils__angular__scroll_host__pan_controller_impl.NonTouchPanController, "package:angular_components/src/utils/angular/scroll_host/pan_controller_impl.dart");
  ...
  dart.setLibraryUri(src__utils__angular__scroll_host__pan_controller_impl.PanEventImpl, "package:angular_components/src/utils/angular/scroll_host/pan_controller_impl.dart");
  ...
  const _scrollHost = dart.privateName(src__utils__angular__scroll_host__position_sticky_controller, "_scrollHost");
  const _stickyElements = dart.privateName(src__utils__angular__scroll_host__position_sticky_controller, "_stickyElements");
  const _isUpdateScheduled = dart.privateName(src__utils__angular__scroll_host__position_sticky_controller, "_isUpdateScheduled");
  const _scheduleUpdate = dart.privateName(src__utils__angular__scroll_host__position_sticky_controller, "_scheduleUpdate");
  const _removeStickyStyle = dart.privateName(src__utils__angular__scroll_host__position_sticky_controller, "_removeStickyStyle");
  const _update = dart.privateName(src__utils__angular__scroll_host__position_sticky_controller, "_update");
  const _startIntersectionSubscription = dart.privateName(src__utils__angular__scroll_host__position_sticky_controller, "_startIntersectionSubscription");
  const _addStickyStyle = dart.privateName(src__utils__angular__scroll_host__position_sticky_controller, "_addStickyStyle");
  const _stopIntersectionSubscription = dart.privateName(src__utils__angular__scroll_host__position_sticky_controller, "_stopIntersectionSubscription");
  const _updateLayout = dart.privateName(src__utils__angular__scroll_host__position_sticky_controller, "_updateLayout");
  ...
  dart.setLibraryUri(src__utils__angular__scroll_host__position_sticky_controller.PositionStickyController, "package:angular_components/src/utils/angular/scroll_host/position_sticky_controller.dart");
  ...
  dart.setLibraryUri(src__utils__angular__scroll_host__position_sticky_controller._StickyElement, "package:angular_components/src/utils/angular/scroll_host/position_sticky_controller.dart");
  ...
  const _domService = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_domService");
  const _scrollHost$ = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_scrollHost");
  const _onUpdateController = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_onUpdateController");
  const _layoutSubscription = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_layoutSubscription");
  const _rowMap = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_rowMap");
  const _floatingElements = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_floatingElements");
  const _orderedRows = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_orderedRows");
  const _currentLayout = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_currentLayout");
  const _startEventListeners = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_startEventListeners");
  const _stopEventListeners = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_stopEventListeners");
  const _checkAndUpdateLayout = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_checkAndUpdateLayout");
  const _scheduleLayoutCheck = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_scheduleLayoutCheck");
  const _getAvailableArea = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_getAvailableArea");
  const _observeRowPositions = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_observeRowPositions");
  const _getLayout = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_getLayout");
  const _updateContainer = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_updateContainer");
  src__utils__angular__scroll_host__sticky_controller_impl.StickyControllerImpl = class StickyControllerImpl extends core$.Object {
    ...
    [_updateContainer](layout) {
      ...
      if (layout.bottomRows != null) {
        ...
        for (let i = 0; i < dart.notNull(layout.bottomRows[$length]); i++) {
  ...
  dart.setLibraryUri(src__utils__angular__scroll_host__sticky_controller_impl.StickyControllerImpl, "package:angular_components/src/utils/angular/scroll_host/sticky_controller_impl.dart");
  ...
  dart.setLibraryUri(src__utils__angular__scroll_host__sticky_controller_impl.StickyRowPosition, "package:angular_components/src/utils/angular/scroll_host/sticky_controller_impl.dart");
  const _stickyKey = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_stickyKey");
  const _currentPosition = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_currentPosition");
  const _currentTransform = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_currentTransform");
  const _currentZIndex = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_currentZIndex");
  const _translateY = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_translateY");
  ...
  dart.setLibraryUri(src__utils__angular__scroll_host__sticky_controller_impl._StickyRow, "package:angular_components/src/utils/angular/scroll_host/sticky_controller_impl.dart");
  ...
  src__utils__angular__scroll_host__sticky_controller_impl._RowData$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_RowData, "package:angular_components/src/utils/angular/scroll_host/sticky_controller_impl.dart");
  ...
  const _translateYs = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_translateYs");
  const _listEquals = dart.privateName(src__utils__angular__scroll_host__sticky_controller_impl, "_listEquals");
  ...
  src__utils__angular__scroll_host__sticky_controller_impl.StickyContainerLayout$ = dart.generic(T => {
    ...
    dart.setLibraryUri(StickyContainerLayout, "package:angular_components/src/utils/angular/scroll_host/sticky_controller_impl.dart");
  ...
  dart.setLibraryUri(src__utils__angular__scroll_host__sticky_controller_impl.StickyRowUtils, "package:angular_components/src/utils/angular/scroll_host/sticky_controller_impl.dart");
  ...
  const _domService$ = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_domService");
  const _ngZone = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_ngZone");
  const _panController = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_panController");
  const _stickyController = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_stickyController");
  const _gestureListener = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_gestureListener");
  const _intersectionStreams = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_intersectionStreams");
  const _intersectionObserver = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_intersectionObserver");
  const _nativeOnScrollController = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_nativeOnScrollController");
  const _elementListenersDisposer = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_elementListenersDisposer");
  const _nativeOnScrollSubscription = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_nativeOnScrollSubscription");
  const _onScrollController = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_onScrollController");
  const _onScrollStream = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_onScrollStream");
  const _scrollInProgress = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_scrollInProgress");
  const _scrollFrameScheduled = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_scrollFrameScheduled");
  const _scrollFrameDelta = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_scrollFrameDelta");
  const _isDirectionScrollable = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_isDirectionScrollable");
  const _onIntersection = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_onIntersection");
  const _stopNativeScrollListener = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_stopNativeScrollListener");
  const _onNativeScroll = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_onNativeScroll");
  const _startElementListeners = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_startElementListeners");
  const _stopElementListeners = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_stopElementListeners");
  src__utils__angular__scroll_host__scroll_host_base.ScrollHostBase = class ScrollHostBase extends core$.Object {
    ...
    [_startElementListeners]() {
      ...
      if (!dart.test(this.usePositionSticky)) {
        this[_elementListenersDisposer].addStreamSubscription(html.WheelEvent, this.anchorElement[$onWheel].listen(dart.fn(event => {
          if (!html.WheelEvent.is(event)) return;
          if ((() => {
  ...
  dart.setLibraryUri(src__utils__angular__scroll_host__scroll_host_base.ScrollHostBase, "package:angular_components/src/utils/angular/scroll_host/scroll_host_base.dart");
  ...
  const _window = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_window");
  ...
  dart.setMethodSignature(src__utils__angular__scroll_host__scroll_host_base.WindowScrollHostBase, () => ({
    ...
    stopEvent: dart.fnType(dart.void, [html.WheelEvent])
  }));
  ...
  dart.setLibraryUri(src__utils__angular__scroll_host__scroll_host_base.WindowScrollHostBase, "package:angular_components/src/utils/angular/scroll_host/scroll_host_base.dart");
  ...
  dart.setLibraryUri(src__utils__angular__scroll_host__scroll_host_base.ElementScrollHostBase, "package:angular_components/src/utils/angular/scroll_host/scroll_host_base.dart");
  ...
  const _scrollHost$0 = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_scrollHost");
  const _element = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_element");
  const _lastEvent$ = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_lastEvent");
  const _className = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_className");
  const _subscription = dart.privateName(src__utils__angular__scroll_host__scroll_host_base, "_subscription");
  ...
  dart.setLibraryUri(src__utils__angular__scroll_host__scroll_host_base.BasePanClassDirective, "package:angular_components/src/utils/angular/scroll_host/scroll_host_base.dart");
