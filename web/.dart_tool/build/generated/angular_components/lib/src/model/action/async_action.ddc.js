define(['dart_sdk'], function(dart_sdk) {
  ...
  const src__model__action__async_action = Object.create(dart.library);
  const src__model__action__async_action_controller = Object.create(dart.library);
  const src__model__action__delegating_async_action = Object.create(dart.library);
  const $add = dartx.add;
  ...
  const _onDone = dart.privateName(src__model__action__async_action, "_onDone");
  const _onDefer = dart.privateName(src__model__action__async_action, "_onDefer");
  const _futureCancellations = dart.privateName(src__model__action__async_action, "_futureCancellations");
  const _executionDeferrals = dart.privateName(src__model__action__async_action, "_executionDeferrals");
  const _lockedGetter = dart.privateName(src__model__action__async_action, "_lockedGetter");
  const _cancelledGetter = dart.privateName(src__model__action__async_action, "_cancelledGetter");
  const _doneGetter = dart.privateName(src__model__action__async_action, "_doneGetter");
  const _syncCancelled = dart.privateName(src__model__action__async_action, "_syncCancelled");
  const _waitingForDone = dart.privateName(src__model__action__async_action, "_waitingForDone");
  ...
  src__model__action__async_action.AsyncAction$ = dart.generic(V => {
    ...
    dart.setLibraryUri(AsyncAction, "package:angular_components/src/model/action/async_action.dart");
  ...
  const _executeCompleter = dart.privateName(src__model__action__async_action_controller, "_executeCompleter");
  const _deferCompleter = dart.privateName(src__model__action__async_action_controller, "_deferCompleter");
  const _executionDeferrals$ = dart.privateName(src__model__action__async_action_controller, "_executionDeferrals");
  const _futureCancellations$ = dart.privateName(src__model__action__async_action_controller, "_futureCancellations");
  const _locked = dart.privateName(src__model__action__async_action_controller, "_locked");
  const _cancelled = dart.privateName(src__model__action__async_action_controller, "_cancelled");
  const _done = dart.privateName(src__model__action__async_action_controller, "_done");
  const _action = dart.privateName(src__model__action__async_action_controller, "_action");
  const _executeAndAttach = dart.privateName(src__model__action__async_action_controller, "_executeAndAttach");
  const _maybeWait = dart.privateName(src__model__action__async_action_controller, "_maybeWait");
  const _attachFuture = dart.privateName(src__model__action__async_action_controller, "_attachFuture");
  const _shouldCancel = dart.privateName(src__model__action__async_action_controller, "_shouldCancel");
  ...
  src__model__action__async_action_controller.AsyncActionController$ = dart.generic(V => {
    ...
    dart.setLibraryUri(AsyncActionController, "package:angular_components/src/model/action/async_action_controller.dart");
  ...
  src__model__action__delegating_async_action.DelegatingAsyncAction$ = dart.generic(V => {
    ...
    dart.setLibraryUri(DelegatingAsyncAction, "package:angular_components/src/model/action/delegating_async_action.dart");
