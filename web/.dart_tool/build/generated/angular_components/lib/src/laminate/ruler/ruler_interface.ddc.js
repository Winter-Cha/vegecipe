define(['dart_sdk', 'packages/angular_components/laminate/enums/visibility', 'packages/angular_components/laminate/enums/position'], function(dart_sdk, visibility, position) {
  ...
  const src__laminate__ruler__ruler_interface = Object.create(dart.library);
  const $abs = dartx.abs;
  const $top = dartx.top;
  ...
  src__laminate__ruler__ruler_interface.Ruler$ = dart.generic(E => {
    ...
    dart.setLibraryUri(Ruler, "package:angular_components/src/laminate/ruler/ruler_interface.dart");
    return Ruler;
  });
  ...
  const _addedCssClasses = dart.privateName(src__laminate__ruler__ruler_interface, "_addedCssClasses");
  ...
  src__laminate__ruler__ruler_interface.RulerBase$ = dart.generic(E => {
    ...
    dart.setLibraryUri(RulerBase, "package:angular_components/src/laminate/ruler/ruler_interface.dart");
