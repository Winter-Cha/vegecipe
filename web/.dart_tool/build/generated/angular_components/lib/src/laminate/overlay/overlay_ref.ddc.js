define(['dart_sdk', 'packages/quiver/core', 'packages/angular_components/laminate/enums/visibility', 'packages/angular_components/laminate/enums/position', 'packages/angular_components/src/utils/async/async_update_scheduler', 'packages/angular_components/laminate/portal/portal', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/laminate/ruler/dom_ruler', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/utils/angular/imperative_view/imperative_view', 'packages/angular_components/laminate/overlay/zindexer', 'packages/logging/logging'], function(dart_sdk, core, visibility, position, async_update_scheduler, portal, change_detection, dom_ruler, dom_service, imperative_view, zindexer, logging) {
  ...
  const src__laminate__overlay__overlay_state = Object.create(dart.library);
  const src__laminate__overlay__overlay_ref = Object.create(dart.library);
  const src__laminate__overlay__render__overlay_style_config = Object.create(dart.library);
  const src__laminate__overlay__render__overlay_dom_render_service = Object.create(dart.library);
  const src__laminate__overlay__overlay_service = Object.create(dart.library);
  ...
  dart.setLibraryUri(src__laminate__overlay__overlay_state.OverlayState, "package:angular_components/src/laminate/overlay/overlay_state.dart");
  ...
  dart.setLibraryUri(src__laminate__overlay__overlay_state._ImmutableOverlayState, "package:angular_components/src/laminate/overlay/overlay_state.dart");
  ...
  const _asyncScheduler = dart.privateName(src__laminate__overlay__overlay_state, "_asyncScheduler");
  const _captureEvents = dart.privateName(src__laminate__overlay__overlay_state, "_captureEvents");
  const _left = dart.privateName(src__laminate__overlay__overlay_state, "_left");
  const _top = dart.privateName(src__laminate__overlay__overlay_state, "_top");
  const _right = dart.privateName(src__laminate__overlay__overlay_state, "_right");
  const _bottom = dart.privateName(src__laminate__overlay__overlay_state, "_bottom");
  const _width = dart.privateName(src__laminate__overlay__overlay_state, "_width");
  const _minWidth = dart.privateName(src__laminate__overlay__overlay_state, "_minWidth");
  const _height = dart.privateName(src__laminate__overlay__overlay_state, "_height");
  const _zIndex = dart.privateName(src__laminate__overlay__overlay_state, "_zIndex");
  const _visibility = dart.privateName(src__laminate__overlay__overlay_state, "_visibility");
  const _position = dart.privateName(src__laminate__overlay__overlay_state, "_position");
  ...
  dart.setLibraryUri(src__laminate__overlay__overlay_state.MutableOverlayState, "package:angular_components/src/laminate/overlay/overlay_state.dart");
  ...
  const _asyncApplyState = dart.privateName(src__laminate__overlay__overlay_ref, "_asyncApplyState");
  const _asyncMeasureSize = dart.privateName(src__laminate__overlay__overlay_ref, "_asyncMeasureSize");
  const _delegatePortalHost = dart.privateName(src__laminate__overlay__overlay_ref, "_delegatePortalHost");
  const _runOutsideAngular = dart.privateName(src__laminate__overlay__overlay_ref, "_runOutsideAngular");
  const _lastVisible = dart.privateName(src__laminate__overlay__overlay_ref, "_lastVisible");
  const _onVisibleController = dart.privateName(src__laminate__overlay__overlay_ref, "_onVisibleController");
  const _stateUpdateListener = dart.privateName(src__laminate__overlay__overlay_ref, "_stateUpdateListener");
  const _applyChanges = dart.privateName(src__laminate__overlay__overlay_ref, "_applyChanges");
  ...
  dart.setLibraryUri(src__laminate__overlay__overlay_ref.OverlayRef, "package:angular_components/src/laminate/overlay/overlay_ref.dart");
  ...
  const _styleHost = dart.privateName(src__laminate__overlay__render__overlay_style_config, "_styleHost");
  const _document = dart.privateName(src__laminate__overlay__render__overlay_style_config, "_document");
  const _stylesRegistered = dart.privateName(src__laminate__overlay__render__overlay_style_config, "_stylesRegistered");
  ...
  dart.setLibraryUri(src__laminate__overlay__render__overlay_style_config.OverlayStyleConfig, "package:angular_components/src/laminate/overlay/render/overlay_style_config.dart");
  ...
  dart.defineLazy(src__laminate__overlay__render__overlay_dom_render_service, {
    ...
    /*src__laminate__overlay__render__overlay_dom_render_service.overlayViewportBoundaries*/get overlayViewportBoundaries() {
      return dart.const(new src__core__di__opaque_token.OpaqueToken.new("overlayViewportBoundaries"));
    }
  });
  const _containerName = dart.privateName(src__laminate__overlay__render__overlay_dom_render_service, "_containerName");
  const _domRuler = dart.privateName(src__laminate__overlay__render__overlay_dom_render_service, "_domRuler");
  const _domService = dart.privateName(src__laminate__overlay__render__overlay_dom_render_service, "_domService");
  const _imperativeViewUtils = dart.privateName(src__laminate__overlay__render__overlay_dom_render_service, "_imperativeViewUtils");
  const _useDomSynchronously = dart.privateName(src__laminate__overlay__render__overlay_dom_render_service, "_useDomSynchronously");
  const _useRepositionLoop = dart.privateName(src__laminate__overlay__render__overlay_dom_render_service, "_useRepositionLoop");
  const _zIndexer = dart.privateName(src__laminate__overlay__render__overlay_dom_render_service, "_zIndexer");
  const _lastZIndex = dart.privateName(src__laminate__overlay__render__overlay_dom_render_service, "_lastZIndex");
  const _uniqueId = dart.privateName(src__laminate__overlay__render__overlay_dom_render_service, "_uniqueId");
  const _createUniqueId = dart.privateName(src__laminate__overlay__render__overlay_dom_render_service, "_createUniqueId");
  ...
  dart.setLibraryUri(src__laminate__overlay__render__overlay_dom_render_service.OverlayDomRenderService, "package:angular_components/src/laminate/overlay/render/overlay_dom_render_service.dart");
  ...
  const _ngZone = dart.privateName(src__laminate__overlay__overlay_service, "_ngZone");
  const _useDomSynchronously$ = dart.privateName(src__laminate__overlay__overlay_service, "_useDomSynchronously");
  const _renderService = dart.privateName(src__laminate__overlay__overlay_service, "_renderService");
  const _createRef = dart.privateName(src__laminate__overlay__overlay_service, "_createRef");
  const _measurePane = dart.privateName(src__laminate__overlay__overlay_service, "_measurePane");
  ...
  dart.setLibraryUri(src__laminate__overlay__overlay_service.OverlayService, "package:angular_components/src/laminate/overlay/overlay_service.dart");
