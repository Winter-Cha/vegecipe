define(['dart_sdk', 'packages/angular_components/laminate/portal/portal', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/src/laminate/overlay/overlay_ref'], function(dart_sdk, portal, change_detection, overlay_ref) {
  'use strict';
  ...
  const src__laminate__components__modal__modal_controller_directive = Object.create(dart.library);
