define(['dart_sdk', 'packages/angular_components/laminate/enums/position.template', 'packages/angular_components/laminate/enums/visibility.template', 'packages/angular_components/utils/async/async.template', 'packages/angular_components/laminate/portal/portal.template', 'packages/angular_components/src/laminate/overlay/overlay_ref', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/angular.template', 'packages/angular_components/laminate/ruler/dom_ruler', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/utils/angular/imperative_view/imperative_view', 'packages/angular_components/laminate/overlay/zindexer', 'packages/angular_components/laminate/overlay/zindexer.template', 'packages/angular_components/laminate/ruler/dom_ruler.template', 'packages/angular_components/utils/angular/imperative_view/imperative_view.template', 'packages/angular_components/utils/browser/dom_service/dom_service.template'], function(dart_sdk, position, visibility, async, portal, overlay_ref, change_detection, angular, dom_ruler, dom_service, imperative_view, zindexer, zindexer$, dom_ruler$, imperative_view$, dom_service$) {
  ...
  const src__laminate__overlay__overlay_state$46template = Object.create(dart.library);
  const src__laminate__overlay__overlay_ref$46template = Object.create(dart.library);
  const src__laminate__overlay__render__overlay_style_config$46template = Object.create(dart.library);
  const src__laminate__overlay__render__overlay_dom_render_service$46template = Object.create(dart.library);
  const src__laminate__overlay__overlay_service$46template = Object.create(dart.library);
