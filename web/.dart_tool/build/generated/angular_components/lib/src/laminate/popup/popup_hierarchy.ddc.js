define(['dart_sdk', 'packages/angular_components/utils/browser/events/events', 'packages/angular/src/bootstrap/modules', 'packages/observable/observable', 'packages/angular_components/src/laminate/popup/dom_popup_source', 'packages/quiver/core', 'packages/angular_components/laminate/enums/alignment', 'packages/angular_components/utils/angular/properties/properties', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/utils/angular/reference/reference', 'packages/angular_components/focus/focus_interface'], function(dart_sdk, events, modules, observable, dom_popup_source, core, alignment, properties, change_detection, reference, focus_interface) {
  ...
  const src__laminate__popup__popup_hierarchy = Object.create(dart.library);
  const src__laminate__popup__popup_state = Object.create(dart.library);
  const src__laminate__popup__popup_interface = Object.create(dart.library);
  const src__laminate__popup__popup_size_provider = Object.create(dart.library);
  const src__laminate__popup__popup_position_mixin = Object.create(dart.library);
  const src__laminate__popup__popup_ref = Object.create(dart.library);
  const src__laminate__popup__popup_size_provider_directive = Object.create(dart.library);
  const src__laminate__popup__popup_source_directive = Object.create(dart.library);
  ...
  const _visiblePopupStack = dart.privateName(src__laminate__popup__popup_hierarchy, "_visiblePopupStack");
  const _rootPane = dart.privateName(src__laminate__popup__popup_hierarchy, "_rootPane");
  const _triggerListener = dart.privateName(src__laminate__popup__popup_hierarchy, "_triggerListener");
  const _keyUpListener = dart.privateName(src__laminate__popup__popup_hierarchy, "_keyUpListener");
  const _lastTriggerEvent = dart.privateName(src__laminate__popup__popup_hierarchy, "_lastTriggerEvent");
  const _disposeListeners = dart.privateName(src__laminate__popup__popup_hierarchy, "_disposeListeners");
  const _onTrigger = dart.privateName(src__laminate__popup__popup_hierarchy, "_onTrigger");
  const _onKeyUp = dart.privateName(src__laminate__popup__popup_hierarchy, "_onKeyUp");
  const _attach = dart.privateName(src__laminate__popup__popup_hierarchy, "_attach");
  const _detach = dart.privateName(src__laminate__popup__popup_hierarchy, "_detach");
  const _isInHiddenModal = dart.privateName(src__laminate__popup__popup_hierarchy, "_isInHiddenModal");
  ...
  src__laminate__popup__popup_state.PopupState = class PopupState extends src__observable.Observable$(src__records.ChangeRecord) {
    static new(opts) {
      ...
      return new src__laminate__popup__popup_state.PopupState.__(ObservableMapOfSymbol$dynamic().from(new (LinkedMapOfSymbol$dynamic()).from([const$0 || (const$0 = dart.const(new _internal.Symbol.new('autoDismiss'))), autoDismiss, const$1 || (const$1 = dart.const(new _internal.Symbol.new('enforceSpaceConstraints'))), enforceSpaceConstraints, const$2 || (const$2 = dart.const(new _internal.Symbol.new('matchMinSourceWidth'))), matchMinSourceWidth, const$3 || (const$3 = dart.const(new _internal.Symbol.new('offsetX'))), offsetX, const$4 || (const$4 = dart.const(new _internal.Symbol.new('offsetY'))), offsetY, const$5 || (const$5 = dart.const(new _internal.Symbol.new('preferredPositions'))), preferredPositions, const$6 || (const$6 = dart.const(new _internal.Symbol.new('source'))), source, const$7 || (const$7 = dart.const(new _internal.Symbol.new('trackLayoutChanges'))), trackLayoutChanges, const$8 || (const$8 = dart.const(new _internal.Symbol.new('constrainToViewport'))), constrainToViewport])));
    }
    static from(other) {
    ...
    get autoDismiss() {
      return core$.bool._check(this[_backingMap]._get(const$9 || (const$9 = dart.const(new _internal.Symbol.new('autoDismiss')))));
    }
    set autoDismiss(autoDismiss) {
      this[_backingMap]._set(const$10 || (const$10 = dart.const(new _internal.Symbol.new('autoDismiss'))), autoDismiss);
    }
    get enforceSpaceConstraints() {
      return core$.bool._check(this[_backingMap]._get(const$11 || (const$11 = dart.const(new _internal.Symbol.new('enforceSpaceConstraints')))));
    }
    set enforceSpaceConstraints(enforceSpaceConstraints) {
      this[_backingMap]._set(const$12 || (const$12 = dart.const(new _internal.Symbol.new('enforceSpaceConstraints'))), enforceSpaceConstraints);
    }
    get matchMinSourceWidth() {
      return core$.bool._check(this[_backingMap]._get(const$13 || (const$13 = dart.const(new _internal.Symbol.new('matchMinSourceWidth')))));
    }
    set matchMinSourceWidth(matchMinSourceWidth) {
      this[_backingMap]._set(const$14 || (const$14 = dart.const(new _internal.Symbol.new('matchMinSourceWidth'))), matchMinSourceWidth);
    }
    get source() {
      return src__laminate__popup__popup_source.PopupSource._check(this[_backingMap]._get(const$15 || (const$15 = dart.const(new _internal.Symbol.new('source')))));
    }
    set source(source) {
      this[_backingMap]._set(const$16 || (const$16 = dart.const(new _internal.Symbol.new('source'))), source);
    }
    get offsetX() {
      return core$.int._check(this[_backingMap]._get(const$17 || (const$17 = dart.const(new _internal.Symbol.new('offsetX')))));
    }
    set offsetX(offsetX) {
      this[_backingMap]._set(const$18 || (const$18 = dart.const(new _internal.Symbol.new('offsetX'))), offsetX);
    }
    get offsetY() {
      return core$.int._check(this[_backingMap]._get(const$19 || (const$19 = dart.const(new _internal.Symbol.new('offsetY')))));
    }
    set offsetY(offsetY) {
      this[_backingMap]._set(const$20 || (const$20 = dart.const(new _internal.Symbol.new('offsetY'))), offsetY);
    }
    get preferredPositions() {
      return core$.Iterable._check(this[_backingMap]._get(const$21 || (const$21 = dart.const(new _internal.Symbol.new('preferredPositions')))));
    }
    set preferredPositions(preferredPositions) {
      this[_backingMap]._set(const$22 || (const$22 = dart.const(new _internal.Symbol.new('preferredPositions'))), preferredPositions);
    }
    get trackLayoutChanges() {
      return core$.bool._check(this[_backingMap]._get(const$23 || (const$23 = dart.const(new _internal.Symbol.new('trackLayoutChanges')))));
    }
    set trackLayoutChanges(trackLayoutChanges) {
      this[_backingMap]._set(const$24 || (const$24 = dart.const(new _internal.Symbol.new('trackLayoutChanges'))), trackLayoutChanges);
    }
    get constrainToViewport() {
      return core$.bool._check(this[_backingMap]._get(const$25 || (const$25 = dart.const(new _internal.Symbol.new('constrainToViewport')))));
    }
    set constrainToViewport(constrainToViewport) {
      this[_backingMap]._set(const$26 || (const$26 = dart.const(new _internal.Symbol.new('constrainToViewport'))), constrainToViewport);
    }
    _equals(o) {
  ...
  const _maxHeightPercentage = dart.privateName(src__laminate__popup__popup_size_provider, "_maxHeightPercentage");
  ...
  const _minWidth = dart.privateName(src__laminate__popup__popup_size_provider, "_minWidth");
  const _minHeight = dart.privateName(src__laminate__popup__popup_size_provider, "_minHeight");
  const _maxWidth = dart.privateName(src__laminate__popup__popup_size_provider, "_maxWidth");
  const _maxHeight = dart.privateName(src__laminate__popup__popup_size_provider, "_maxHeight");
  ...
  const _popupPosition = dart.privateName(src__laminate__popup__popup_position_mixin, "_popupPosition");
  const _popupPositions = dart.privateName(src__laminate__popup__popup_position_mixin, "_popupPositions");
  let const$27;
  let const$28;
  let const$29;
  ...
  const _maxHeight$ = dart.privateName(src__laminate__popup__popup_size_provider_directive, "_maxHeight");
  const _maxWidth$ = dart.privateName(src__laminate__popup__popup_size_provider_directive, "_maxWidth");
  ...
  const _size = dart.privateName(src__laminate__popup__popup_size_provider_directive, "_size");
  ...
  const _percent = dart.privateName(src__laminate__popup__popup_size_provider_directive, "_percent");
  ...
  const _focusable = dart.privateName(src__laminate__popup__popup_source_directive, "_focusable");
  const _initAriaAttributes = dart.privateName(src__laminate__popup__popup_source_directive, "_initAriaAttributes");
  const _alignOriginX = dart.privateName(src__laminate__popup__popup_source_directive, "_alignOriginX");
  const _alignOriginY = dart.privateName(src__laminate__popup__popup_source_directive, "_alignOriginY");
  const _popupSource = dart.privateName(src__laminate__popup__popup_source_directive, "_popupSource");
  const _popupId = dart.privateName(src__laminate__popup__popup_source_directive, "_popupId");
  const _updateSource = dart.privateName(src__laminate__popup__popup_source_directive, "_updateSource");
