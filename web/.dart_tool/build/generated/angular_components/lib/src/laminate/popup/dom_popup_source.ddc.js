define(['dart_sdk', 'packages/angular_components/laminate/enums/alignment', 'packages/angular_components/focus/focus_interface', 'packages/angular_components/laminate/ruler/dom_ruler', 'packages/angular_components/annotations/rtl_annotation'], function(dart_sdk, alignment, focus_interface, dom_ruler, rtl_annotation) {
  ...
  const src__laminate__popup__popup_source = Object.create(dart.library);
  const src__laminate__popup__dom_popup_source = Object.create(dart.library);
  ...
  const _domRuler = dart.privateName(src__laminate__popup__dom_popup_source, "_domRuler");
  const _asyncMeasureSize = dart.privateName(src__laminate__popup__dom_popup_source, "_asyncMeasureSize");
  ...
  let const$;
  const _initAriaAttributes = dart.privateName(src__laminate__popup__dom_popup_source, "_initAriaAttributes");
  const _alignOriginX = dart.privateName(src__laminate__popup__dom_popup_source, "_alignOriginX");
  const _alignOriginY = dart.privateName(src__laminate__popup__dom_popup_source, "_alignOriginY");
  const _id = dart.privateName(src__laminate__popup__dom_popup_source, "_id");
