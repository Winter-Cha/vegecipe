define(['dart_sdk', 'packages/angular_components/material_datepicker/comparison_option', 'packages/angular_components/material_datepicker/comparison', 'packages/angular_components/material_datepicker/calendar', 'packages/angular_components/model/observable/observable', 'packages/angular_components/model/date/date', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/material_datepicker/range', 'packages/angular_components/src/material_datepicker/sequential', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/src/utils/angular/scroll_host/scroll_host_interface', 'packages/intl/intl'], function(dart_sdk, comparison_option, comparison, calendar, observable, date, disposer, range, sequential, change_detection, scroll_host_interface, intl) {
  'use strict';
  ...
  const src__material_datepicker__date_range_editor_model = Object.create(dart.library);
  const src__material_datepicker__comparison_range_editor = Object.create(dart.library);
  ...
  dart.setLibraryUri(src__material_datepicker__date_range_editor_model.Action, "package:angular_components/src/material_datepicker/date_range_editor_model.dart");
  ...
  dart.setLibraryUri(src__material_datepicker__date_range_editor_model.HasComparisonRange, "package:angular_components/src/material_datepicker/date_range_editor_model.dart");
  ...
  dart.setLibraryUri(src__material_datepicker__date_range_editor_model.DateRangeChange, "package:angular_components/src/material_datepicker/date_range_editor_model.dart");
  ...
  dart.setLibraryUri(src__material_datepicker__date_range_editor_model.ModelState, "package:angular_components/src/material_datepicker/date_range_editor_model.dart");
  ...
  const _ref = dart.privateName(src__material_datepicker__date_range_editor_model, "_ref");
  const _changes = dart.privateName(src__material_datepicker__date_range_editor_model, "_changes");
  const _disposer = dart.privateName(src__material_datepicker__date_range_editor_model, "_disposer");
  const _comparisonEnabled = dart.privateName(src__material_datepicker__date_range_editor_model, "_comparisonEnabled");
  const _comparisonOption = dart.privateName(src__material_datepicker__date_range_editor_model, "_comparisonOption");
  const _supportedComparisonOptions = dart.privateName(src__material_datepicker__date_range_editor_model, "_supportedComparisonOptions");
  const _customComparisonRange = dart.privateName(src__material_datepicker__date_range_editor_model, "_customComparisonRange");
  const _comparisonTitle = dart.privateName(src__material_datepicker__date_range_editor_model, "_comparisonTitle");
  const _lastCause = dart.privateName(src__material_datepicker__date_range_editor_model, "_lastCause");
  const _validComparisonOptions = dart.privateName(src__material_datepicker__date_range_editor_model, "_validComparisonOptions");
  const _updateHasNextPrev = dart.privateName(src__material_datepicker__date_range_editor_model, "_updateHasNextPrev");
  const _updateValidComparisonOptions = dart.privateName(src__material_datepicker__date_range_editor_model, "_updateValidComparisonOptions");
  const _setEverything = dart.privateName(src__material_datepicker__date_range_editor_model, "_setEverything");
  const _setPrimaryRange = dart.privateName(src__material_datepicker__date_range_editor_model, "_setPrimaryRange");
  const _setComparisonRange = dart.privateName(src__material_datepicker__date_range_editor_model, "_setComparisonRange");
  const _onCalendarChange = dart.privateName(src__material_datepicker__date_range_editor_model, "_onCalendarChange");
  const _withComparison = dart.privateName(src__material_datepicker__date_range_editor_model, "_withComparison");
  const _changeValue = dart.privateName(src__material_datepicker__date_range_editor_model, "_changeValue");
  const _setComparisonOption = dart.privateName(src__material_datepicker__date_range_editor_model, "_setComparisonOption");
  const _selectionDifferent = dart.privateName(src__material_datepicker__date_range_editor_model, "_selectionDifferent");
  const _buildComparison = dart.privateName(src__material_datepicker__date_range_editor_model, "_buildComparison");
  const _selectionAction = dart.privateName(src__material_datepicker__date_range_editor_model, "_selectionAction");
  const _getValidComparisonOptions = dart.privateName(src__material_datepicker__date_range_editor_model, "_getValidComparisonOptions");
  ...
  dart.setLibraryUri(src__material_datepicker__date_range_editor_model.DateRangeEditorModel, "package:angular_components/src/material_datepicker/date_range_editor_model.dart");
  ...
  const _ngZone = dart.privateName(src__material_datepicker__comparison_range_editor, "_ngZone");
  const _scrollHost = dart.privateName(src__material_datepicker__comparison_range_editor, "_scrollHost");
  const _optionMsgCache = dart.privateName(src__material_datepicker__comparison_range_editor, "_optionMsgCache");
  const _primaryDateRange = dart.privateName(src__material_datepicker__comparison_range_editor, "_primaryDateRange");
  const _updateOptionMsg = dart.privateName(src__material_datepicker__comparison_range_editor, "_updateOptionMsg");
  ...
  dart.setLibraryUri(src__material_datepicker__comparison_range_editor.ComparisonRangeEditorComponent, "package:angular_components/src/material_datepicker/comparison_range_editor.dart");
