define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/model/date/date', 'packages/angular_components/material_datepicker/calendar', 'packages/angular_components/model/observable/observable'], function(dart_sdk, disposer, date, calendar, observable) {
  ...
  const src__material_datepicker__calendar_listener = Object.create(dart.library);
  const src__material_datepicker__enum_parsing = Object.create(dart.library);
  ...
  src__material_datepicker__calendar_listener.CalendarListener = class CalendarListener extends core.Object {
    ...
    static dateRange(model, opts) {
      return new src__material_datepicker__calendar_listener._RangeListener.new(model, opts);
    }
  };
  ...
  dart.setLibraryUri(src__material_datepicker__calendar_listener.CalendarListener, "package:angular_components/src/material_datepicker/calendar_listener.dart");
  ...
  dart.setLibraryUri(src__material_datepicker__calendar_listener._DateListener, "package:angular_components/src/material_datepicker/calendar_listener.dart");
  ...
  dart.setLibraryUri(src__material_datepicker__calendar_listener._DragState, "package:angular_components/src/material_datepicker/calendar_listener.dart");
  ...
  const _disposer = dart.privateName(src__material_datepicker__calendar_listener, "_disposer");
  const _consecutiveClicks = dart.privateName(src__material_datepicker__calendar_listener, "_consecutiveClicks");
  const _initSelectionPreview = dart.privateName(src__material_datepicker__calendar_listener, "_initSelectionPreview");
  const _datesEqual = dart.privateName(src__material_datepicker__calendar_listener, "_datesEqual");
  const _grabExistingRange = dart.privateName(src__material_datepicker__calendar_listener, "_grabExistingRange");
  ...
  (src__material_datepicker__calendar_listener._RangeListener.new = function(model, opts) {
  ...
  dart.setLibraryUri(src__material_datepicker__calendar_listener._RangeListener, "package:angular_components/src/material_datepicker/calendar_listener.dart");
