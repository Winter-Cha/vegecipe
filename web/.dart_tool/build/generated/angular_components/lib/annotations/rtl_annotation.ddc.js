define(['dart_sdk', 'packages/angular/src/core/change_detection/change_detection'], function(dart_sdk, change_detection) {
  ...
  const annotations__rtl_annotation = Object.create(dart.library);
  ...
  dart.defineLazy(annotations__rtl_annotation, {
    ...
    /*annotations__rtl_annotation.rtlProvider*/get rtlProvider() {
      return dart.const(src__di__providers.FactoryProvider.forToken(annotations__rtl_annotation.rtlToken, dart.fn(annotations__rtl_annotation.determineRtl, DocumentTobool()), {deps: dart.constList([dart.wrapType(html.Document)], core.Object)}));
    }
  });
