define(['dart_sdk', 'packages/angular_components/material_select/material_dropdown_select', 'packages/angular_components/model/selection/selection_model', 'packages/angular_forms/src/directives', 'packages/angular/src/core/change_detection/change_detection'], function(dart_sdk, material_dropdown_select, selection_model, directives, change_detection) {
  ...
  const material_select__material_dropdown_select_accessor = Object.create(dart.library);
  const $isEmpty = dartx.isEmpty;
  const $first = dartx.first;
  const $toList = dartx.toList;
  let boolToNull = () => (boolToNull = dart.constFn(dart.fnType(core.Null, [core.bool])))();
  const _selectionChangesSub = dart.privateName(material_select__material_dropdown_select_accessor, "_selectionChangesSub");
  const _select = dart.privateName(material_select__material_dropdown_select_accessor, "_select");
  const _visibileSub = dart.privateName(material_select__material_dropdown_select_accessor, "_visibileSub");
