define(['dart_sdk', 'packages/angular_components/utils/browser/events/events', 'packages/angular_components/mixins/focusable_mixin', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/model/selection/select', 'packages/angular_components/material_input/material_input', 'packages/angular_components/src/utils/async/async_update_scheduler'], function(dart_sdk, events, focusable_mixin, change_detection, select, material_input, async_update_scheduler) {
  ...
  const material_select__material_select_searchbox = Object.create(dart.library);
  const _filterable = dart.privateName(material_select__material_select_searchbox, "_filterable");
  const _inputText = dart.privateName(material_select__material_select_searchbox, "_inputText");
  const _lastFilterFuture = dart.privateName(material_select__material_select_searchbox, "_lastFilterFuture");
  const _filter = dart.privateName(material_select__material_select_searchbox, "_filter");
