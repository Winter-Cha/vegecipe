define(['dart_sdk', 'packages/angular_components/utils/id_generator/id_generator', 'packages/angular_components/mixins/focusable_mixin', 'packages/angular_components/mixins/button_wrapper', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/button_decorator/button_decorator'], function(dart_sdk, id_generator, focusable_mixin, button_wrapper, change_detection, button_decorator) {
  ...
  const material_select__dropdown_button = Object.create(dart.library);
  let StreamControllerOfFocusEvent = () => (StreamControllerOfFocusEvent = dart.constFn(async.StreamController$(html.FocusEvent)))();
  const _role = dart.privateName(material_select__dropdown_button, "_role");
  const _ariaRole = dart.privateName(material_select__dropdown_button, "_ariaRole");
  const _button = dart.privateName(material_select__dropdown_button, "_button");
  const _ariaLabelledBy = dart.privateName(material_select__dropdown_button, "_ariaLabelledBy");
  const _showButtonBorder = dart.privateName(material_select__dropdown_button, "_showButtonBorder");
  const _blur = dart.privateName(material_select__dropdown_button, "_blur");
  ...
  const ariaDescribedBy = Symbol("DropdownButtonComponent.ariaDescribedBy");
