define(['dart_sdk'], function(dart_sdk) {
  ...
  const material_select__activation_handler = Object.create(dart.library);
  ...
  material_select__activation_handler.ActivationHandler$ = dart.generic(T => {
    ...
    dart.setLibraryUri(ActivationHandler, "package:angular_components/material_select/activation_handler.dart");
