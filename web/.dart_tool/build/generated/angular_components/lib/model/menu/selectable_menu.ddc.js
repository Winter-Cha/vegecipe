define(['dart_sdk', 'packages/angular_components/model/selection/selection_model', 'packages/angular_components/src/model/selection/interfaces/selectable', 'packages/angular_components/model/ui/has_renderer', 'packages/quiver/core', 'packages/angular_components/model/menu/menu_item_affix', 'packages/observable/observable', 'packages/built_collection/built_collection', 'packages/quiver/strings', 'packages/angular_components/model/menu/menu', 'packages/angular_components/model/ui/icon'], function(dart_sdk, selection_model, selectable, has_renderer, core, menu_item_affix, observable, built_collection, strings, menu, icon) {
  ...
  const model__menu__selectable_menu = Object.create(dart.library);
  ...
  const _action = dart.privateName(model__menu__selectable_menu, "_action");
  const _selectableState = dart.privateName(model__menu__selectable_menu, "_selectableState");
  let const$;
  let const$0;
  let const$1;
  ...
  model__menu__selectable_menu.SelectableMenuItem$ = dart.generic(ItemType => {
    ...
    class SelectableMenuItem extends src__change_notifier.PropertyChangeNotifier {
      ...
      set action(value) {
        ...
        this[_action] = value;
        this.notifyPropertyChange(core$.Function, const$0 || (const$0 = dart.const(new _internal.Symbol.new('action'))), this[_action], value);
      }
      ...
      set selectableState(value) {
        ...
        this.notifyPropertyChange(src__model__selection__interfaces__selectable.SelectableOption, const$1 || (const$1 = dart.const(new _internal.Symbol.new('selectableState'))), this[_selectableState], value);
      }
    }
    ...
    const ariaChecked = Symbol("SelectableMenuItem.ariaChecked");
    ...
    dart.setFieldSignature(SelectableMenuItem, () => ({
      ...
      ariaChecked: dart.fieldType(core$.String),
  ...
  model__menu__selectable_menu.MenuItemGroupWithSelection$ = dart.generic(SelectionItemType => {
    ...
    (MenuItemGroupWithSelection.new = function(opts) {
      ...
      this[itemsRole] = (() => {
        let t = selectionModel;
        let l = t == null ? null : t.isSingleSelect;
    ...
    const itemsRole = Symbol("MenuItemGroupWithSelection.itemsRole");
