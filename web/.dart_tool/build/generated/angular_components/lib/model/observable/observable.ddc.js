define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer'], function(dart_sdk, disposer) {
  ...
  const model__observable__observable = Object.create(dart.library);
  ...
  const _coalesce = dart.privateName(model__observable__observable, "_coalesce");
  const _coalesceScheduled = dart.privateName(model__observable__observable, "_coalesceScheduled");
  const _streamController = dart.privateName(model__observable__observable, "_streamController");
  const _changeController = dart.privateName(model__observable__observable, "_changeController");
  const _previous = dart.privateName(model__observable__observable, "_previous");
  const _next = dart.privateName(model__observable__observable, "_next");
  const _isInactive = dart.privateName(model__observable__observable, "_isInactive");
  const _hasStreamListener = dart.privateName(model__observable__observable, "_hasStreamListener");
  const _hasChangeListener = dart.privateName(model__observable__observable, "_hasChangeListener");
  const _doCoalesce = dart.privateName(model__observable__observable, "_doCoalesce");
  const _doNotifyChange = dart.privateName(model__observable__observable, "_doNotifyChange");
  const _isActive = dart.privateName(model__observable__observable, "_isActive");
  ...
  model__observable__observable.ObservableViewMixin$ = dart.generic(T => {
    ...
    let StreamOfChangeOfT = () => (StreamOfChangeOfT = dart.constFn(async.Stream$(ChangeOfT())))();
    ...
    class ObservableViewMixin extends core.Object {
      get changes() {
        let last = this.value;
        return StreamOfChangeOfT()._check(this.stream.map(ChangeOfT(), dart.fn(v => {
  ...
  const _delegate = dart.privateName(model__observable__observable, "_delegate");
  const _mapper = dart.privateName(model__observable__observable, "_mapper");
  ...
  const _value = dart.privateName(model__observable__observable, "_value");
  const _equalsFn = dart.privateName(model__observable__observable, "_equalsFn");
  const _listenSub = dart.privateName(model__observable__observable, "_listenSub");
  ...
  const _withStackTrace = dart.privateName(model__observable__observable, "_withStackTrace");
  const _subscriptions = dart.privateName(model__observable__observable, "_subscriptions");
  const _disposer = dart.privateName(model__observable__observable, "_disposer");
