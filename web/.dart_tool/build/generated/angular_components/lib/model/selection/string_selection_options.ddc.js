define(['dart_sdk', 'packages/angular_components/model/ui/has_renderer', 'packages/angular_components/model/selection/selection_options', 'packages/angular_components/src/utils/async/async_update_scheduler', 'packages/angular_components/model/selection/select'], function(dart_sdk, has_renderer, selection_options, async_update_scheduler, select) {
  'use strict';
  ...
  const model__selection__string_selection_options = Object.create(dart.library);
  ...
  const _toFilterableString = dart.privateName(model__selection__string_selection_options, "_toFilterableString");
  const _shouldSort = dart.privateName(model__selection__string_selection_options, "_shouldSort");
  const _shouldFilterEmpty = dart.privateName(model__selection__string_selection_options, "_shouldFilterEmpty");
  const _sanitizeString = dart.privateName(model__selection__string_selection_options, "_sanitizeString");
  const _currentQuery = dart.privateName(model__selection__string_selection_options, "_currentQuery");
  const _currentLimit = dart.privateName(model__selection__string_selection_options, "_currentLimit");
  const _optionGroups = dart.privateName(model__selection__string_selection_options, "_optionGroups");
  const _suggestionFilter = dart.privateName(model__selection__string_selection_options, "_suggestionFilter");
  const _sortFn = dart.privateName(model__selection__string_selection_options, "_sortFn");
  ...
  model__selection__string_selection_options.StringSelectionOptions$ = dart.generic(T => {
    ...
    (StringSelectionOptions.new = function(options, opts) {
      ...
      let sanitizeString = opts && 'sanitizeString' in opts ? opts.sanitizeString : dart.fn(model__selection__string_selection_options._stringFormatSuggestion, StringToString());
      ...
      StringSelectionOptions.withOptionGroups.call(this, JSArrayOfOptionGroupOfT().of([new (OptionGroupOfT()).new(options)]), {toFilterableString: toFilterableString, suggestionFilter: suggestionFilter, sanitizeString: sanitizeString, shouldSort: shouldSort, shouldFilterEmpty: shouldFilterEmpty});
    ...
    dart.setGetterSignature(StringSelectionOptions, () => ({
      ...
      filterApplied: core.bool,
      currentQuery: core.Object,
      currentLimit: core.int,
      unfilteredOptionGroups: core.List$(model__selection__selection_options.OptionGroup$(T))
    }));
    dart.setLibraryUri(StringSelectionOptions, "package:angular_components/model/selection/string_selection_options.dart");
    dart.setFieldSignature(StringSelectionOptions, () => ({
      ...
      [_shouldFilterEmpty]: dart.finalFieldType(core.bool)
    }));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["string_selection_options.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;gFAW+B,KAAY;UACvC,MAAK,aAAW,CAAC,KAAK,iBAAe;EAAE;4EAEP,cAAmC;UACnE,+CAAsB,IAAI,QAAC,KAAO,IAAK,cAAc,eAAC,KAAK;EAAa;;;;;;;;;;;;;;;;;;;;;aAmG5C,KAAY;YAAO,+CAAQ,CAAC;AACxD,2BAAa,GAAG,AAAM,aAAN,KAAK,IAAG,IAAI,gBAAS,GAAG,KAAK;AAC7C,2BAAa,kBAAG,KAAK;AACrB,qBAAQ;AACR,cAAO,mCAA0B,CAAC;MACpC;;cAG0B,kBAAY,IAAI;MAAI;;AAI5C,YAAqB,WAAW;AAChC,YAAI,QAAQ;AACZ,YAAO,cACH,mBAAa,IAAI,OAAO,KAAK,qBAAe,CAAC,mBAAa;AAC9D,iBAAS,QAAS,oBAAa,EAAE;AAC/B,cAAI,AAAM,KAAD,iBAAI,i