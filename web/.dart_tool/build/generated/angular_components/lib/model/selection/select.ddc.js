define(['dart_sdk', 'packages/angular_components/src/utils/async/async_update_scheduler'], function(dart_sdk, async_update_scheduler) {
  'use strict';
  const core = dart_sdk.core;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const src__utils__async__disposable_future = async_update_scheduler.src__utils__async__disposable_future;
  const model__selection__select = Object.create(dart.library);
