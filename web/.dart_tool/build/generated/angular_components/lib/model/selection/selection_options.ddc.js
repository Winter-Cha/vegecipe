define(['dart_sdk', 'packages/angular_components/model/collection/labeled_list', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/model/observable/observable'], function(dart_sdk, labeled_list, disposer, observable) {
  ...
  const src__model__selection__delegating_selection_options = Object.create(dart.library);
  const model__selection__selection_options = Object.create(dart.library);
  const $toList = dartx.toList;
  const $expand = dartx.expand;
  const $any = dartx.any;
  let VoidToString = () => (VoidToString = dart.constFn(dart.fnType(core.String, [])))();
  const _options = dart.privateName(src__model__selection__delegating_selection_options, "_options");
  ...
  const _emptyLabelFcn = dart.privateName(model__selection__selection_options, "_emptyLabelFcn");
  ...
  const _controller = dart.privateName(model__selection__selection_options, "_controller");
  const _flattenedList = dart.privateName(model__selection__selection_options, "_flattenedList");
  const _optionGroups = dart.privateName(model__selection__selection_options, "_optionGroups");
  const _setOptions = dart.privateName(model__selection__selection_options, "_setOptions");
    ...
    class SelectionOptions extends model__selection__selection_options.GroupedOptions$(T) {
      ...
      set optionGroups(value) {
        ...
        if (!dart.equals(oldValue, value)) {
          ...
          this[_flattenedList] = this[_optionGroups] != null ? IterableOfT()._check(this[_optionGroups][$expand](T, dart.fn(i => i, OptionGroupOfTToOptionGroupOfT())))[$toList]() : JSArrayOfT().of([]);
  ...
  const _streamSub = dart.privateName(model__selection__selection_options, "_streamSub");
