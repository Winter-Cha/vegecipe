define(['dart_sdk', 'packages/quiver/time', 'packages/angular_components/utils/comparators/comparators', 'packages/intl/intl', 'packages/quiver/core', 'packages/angular_components/model/observable/observable'], function(dart_sdk, time, comparators, intl, core, observable) {
  ...
  const model__date__date = Object.create(dart.library);
  ...
  const _time = dart.privateName(model__date__date, "_time");
  let const$;
  ...
  dart.setLibraryUri(model__date__date.Date, "package:angular_components/model/date/date.dart");
  ...
  dart.setLibraryUri(model__date__date.DateRange, "package:angular_components/model/date/date.dart");
  ...
  dart.setLibraryUri(model__date__date.DateRangeComparison, "package:angular_components/model/date/date.dart");
  ...
  const _ref = dart.privateName(model__date__date, "_ref");
  ...
  dart.setLibraryUri(model__date__date.DatepickerSelection, "package:angular_components/model/date/date.dart");
