define(['dart_sdk', 'packages/logging/logging', 'packages/angular/src/core/change_detection/change_detection', 'packages/quiver/time'], function(dart_sdk, logging, change_detection, time) {
  ...
  const model__date__time_zone_aware_clock = Object.create(dart.library);
  ...
  dart.defineLazy(model__date__time_zone_aware_clock, {
    ...
    /*model__date__time_zone_aware_clock.timeZoneAwareClockProviders*/get timeZoneAwareClockProviders() {
      return dart.constList([dart.const(src__di__providers.FactoryProvider.new(dart.wrapType(model__date__time_zone_aware_clock.SettableTimeZone), dart.fn(model__date__time_zone_aware_clock.settableTimeZoneFactory, VoidToSettableTimeZone()))), dart.const(src__di__providers.ClassProvider.new(dart.wrapType(model__date__time_zone_aware_clock.TimeZoneAwareClock))), dart.const(src__di__providers.ExistingProvider.forToken(model__date__time_zone_aware_clock.timeZoneAwareClock, dart.wrapType(model__date__time_zone_aware_clock.TimeZoneAwareClock)))], src__di__providers.Provider);
    },
    /*model__date__time_zone_aware_clock.timeZoneAwareClockModule*/get timeZoneAwareClockModule() {
      return dart.const(src__di__module.Module.new({provide: model__date__time_zone_aware_clock.timeZoneAwareClockProviders}));
    }
  });
  const _now = dart.privateName(model__date__time_zone_aware_clock, "_now");
  ...
  const _time = dart.privateName(model__date__time_zone_aware_clock, "_time");
  const _throwIfNotInitialized = dart.privateName(model__date__time_zone_aware_clock, "_throwIfNotInitialized");
  const _initialized = dart.privateName(model__date__time_zone_aware_clock, "_initialized");
  const _offsetFromUtc = dart.privateName(model__date__time_zone_aware_clock, "_offsetFromUtc");
