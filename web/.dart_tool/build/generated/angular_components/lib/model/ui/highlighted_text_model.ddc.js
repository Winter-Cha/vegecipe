define(['dart_sdk', 'packages/quiver/core'], function(dart_sdk, core) {
  ...
  const model__ui__highlighted_text_model = Object.create(dart.library);
  ...
  dart.setLibraryUri(model__ui__highlighted_text_model.HighlightedTextSegment, "package:angular_components/model/ui/highlighted_text_model.dart");
  ...
  const _applyMarkers = dart.privateName(model__ui__highlighted_text_model, "_applyMarkers");
  ...
  dart.setLibraryUri(model__ui__highlighted_text_model.TextHighlighter, "package:angular_components/model/ui/highlighted_text_model.dart");
