define(['dart_sdk'], function(dart_sdk) {
  ...
  const model__action__delayed_action = Object.create(dart.library);
  ...
  const _duration = dart.privateName(model__action__delayed_action, "_duration");
  const _callback = dart.privateName(model__action__delayed_action, "_callback");
  const _timer = dart.privateName(model__action__delayed_action, "_timer");
  const _completer = dart.privateName(model__action__delayed_action, "_completer");
  const _reset = dart.privateName(model__action__delayed_action, "_reset");
  const _wrappedCallback = dart.privateName(model__action__delayed_action, "_wrappedCallback");
