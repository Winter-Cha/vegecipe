define(['dart_sdk', 'packages/angular_components/src/model/action/async_action.template'], function(dart_sdk, async_action) {
  ...
  const src__model__action__async_action_controller$46template = async_action.src__model__action__async_action_controller$46template;
  const src__model__action__delegating_async_action$46template = async_action.src__model__action__delegating_async_action$46template;
  const model__action__async_action$46template = Object.create(dart.library);
