define(['dart_sdk', 'packages/collection/src/canonicalized_map', 'packages/angular_components/model/ui/display_name'], function(dart_sdk, canonicalized_map, display_name) {
  'use strict';
  ...
  const model__collection__labeled_list = Object.create(dart.library);
  let VoidToString = () => (VoidToString = dart.constFn(dart.fnType(core.String, [])))();
  const _labelFcn = dart.privateName(model__collection__labeled_list, "_labelFcn");
