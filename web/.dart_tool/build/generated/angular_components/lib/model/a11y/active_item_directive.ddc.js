define(['dart_sdk', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/laminate/components/modal/modal', 'packages/angular_components/src/laminate/popup/popup_hierarchy'], function(dart_sdk, change_detection, dom_service, modal, popup_hierarchy) {
  ...
  const model__a11y__active_item_directive = Object.create(dart.library);
  const $scrollIntoView = dartx.scrollIntoView;
  let boolToNull = () => (boolToNull = dart.constFn(dart.fnType(core.Null, [core.bool])))();
  let VoidToNull = () => (VoidToNull = dart.constFn(dart.fnType(core.Null, [])))();
  const _element = dart.privateName(model__a11y__active_item_directive, "_element");
  const _domService = dart.privateName(model__a11y__active_item_directive, "_domService");
  const _modal = dart.privateName(model__a11y__active_item_directive, "_modal");
  const _popupRef = dart.privateName(model__a11y__active_item_directive, "_popupRef");
  const _active = dart.privateName(model__a11y__active_item_directive, "_active");
  const _initialized = dart.privateName(model__a11y__active_item_directive, "_initialized");
  const _visibilitySubscription = dart.privateName(model__a11y__active_item_directive, "_visibilitySubscription");
  const _hasHover = dart.privateName(model__a11y__active_item_directive, "_hasHover");
  const _scrollIntoViewIfNecessary = dart.privateName(model__a11y__active_item_directive, "_scrollIntoViewIfNecessary");
  const _shouldScrollIntoView = dart.privateName(model__a11y__active_item_directive, "_shouldScrollIntoView");
  const _scrollIntoView = dart.privateName(model__a11y__active_item_directive, "_scrollIntoView");
