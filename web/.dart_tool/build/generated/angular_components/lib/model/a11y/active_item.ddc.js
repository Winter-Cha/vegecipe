define(['dart_sdk', 'packages/angular_components/utils/id_generator/id_generator', 'packages/collection/src/comparators'], function(dart_sdk, id_generator, comparators) {
  ...
  const model__a11y__active_item = Object.create(dart.library);
  ...
  let const$;
  const _idGenerator = dart.privateName(model__a11y__active_item, "_idGenerator");
  const _modelChanged = dart.privateName(model__a11y__active_item, "_modelChanged");
  const _ids = dart.privateName(model__a11y__active_item, "_ids");
  const _items = dart.privateName(model__a11y__active_item, "_items");
  const _loop = dart.privateName(model__a11y__active_item, "_loop");
  const _activeIndex = dart.privateName(model__a11y__active_item, "_activeIndex");
  let const$0;
  ...
  model__a11y__active_item.ActiveItemModel$ = dart.generic(T => {
    ...
    class ActiveItemModel extends core.Object {
      ...
      set items(itemList) {
        ...
        if (dart.test((const$0 || (const$0 = dart.const(new src__equality.ListEquality.new()))).equals(itemList, this[_items]))) return;
        this[_ids][$clear]();
    ...
    (ActiveItemModel.new = function(idGenerator, opts) {
      ...
      let items = opts && 'items' in opts ? opts.items : const$ || (const$ = dart.constList([], core.Null));
    ...
    const activateFirstItemByDefault$ = Symbol("ActiveItemModel.activateFirstItemByDefault");
    ...
    dart.setLibraryUri(ActiveItemModel, "package:angular_components/model/a11y/active_item.dart");
    dart.setFieldSignature(ActiveItemModel, () => ({
      ...
      activateFirstItemByDefault: dart.fieldType(core.bool),
  ...
  }, '{"version":3,"sourceRoot":"","sources":["active_item.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;cAuD6B,oBAAa,OAAO;;;cAIxB,QAAE,CAAC,eAAU;MAAC;eAGvB,IAAM;iBAAJ;2BAAS,eAAU,EAAI,IAAI;;gBAOjC,QAAgB;yBAAR;AAChB,uBAAI,qCAAM,8BAAY,YAAS,CAAC,QAAQ,EAAE,YAAM,IAAG;AAEnD,kBAAI,QAAM;AACV,YAAI,cAAc,eAAU;AAE5B,oBAAM,GAAG,sBAAiB,CAAC,QAAQ;AACnC,YAAI,WAAW,IAAI,MAAM;AACvB,cAAI,OAAO,YAAM,UAAQ,CAAC,WAAW;AACrC,cAAI,IAAI,KAAI,CAAC,GAAG;AACd,8BAAY,GAAG,IAAI;AACnB;;;AAGJ,0BAAY,aAAG,+BAA0B,IAAG,IAAI,CAAC;AACjD,2BAAa,IAAI,CAAC;MACpB;;yBAII,YAAM,UAAQ,KAAI,kBAAY,KAAI,CAAC,IAAI,OAAO,YAAM,QAAC,kBAAY;MAAC;;AAKpE,sBAAI,YAAM,UAAQ,GAAE;AAClB,4BAAY,GAAG,CAAC;cACX,KAAiB,a