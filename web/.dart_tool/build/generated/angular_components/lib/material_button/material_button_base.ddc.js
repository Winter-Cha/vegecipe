define(['dart_sdk', 'packages/angular_components/button_decorator/button_decorator'], function(dart_sdk, button_decorator) {
  ...
  const material_button__material_button_base = Object.create(dart.library);
  let VoidToNull = () => (VoidToNull = dart.constFn(dart.fnType(core.Null, [])))();
  const _focused = dart.privateName(material_button__material_button_base, "_focused");
  const _clickFocused = dart.privateName(material_button__material_button_base, "_clickFocused");
  const _isMouseDown = dart.privateName(material_button__material_button_base, "_isMouseDown");
  const _setFocused = dart.privateName(material_button__material_button_base, "_setFocused");
  ...
  (material_button__material_button_base.MaterialButtonBase.new = function(element, role, opts) {
    let handleSpacePresses = opts && 'handleSpacePresses' in opts ? opts.handleSpacePresses : true;
    this[_focused] = false;
    this[_clickFocused] = false;
    this[_isMouseDown] = false;
    this[raised] = false;
    material_button__material_button_base.MaterialButtonBase.__proto__.new.call(this, element, role, {handleSpacePresses: handleSpacePresses});
