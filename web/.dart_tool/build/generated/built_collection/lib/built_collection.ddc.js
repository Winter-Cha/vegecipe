define(['dart_sdk', 'packages/quiver/core', 'packages/collection/src/canonicalized_map', 'packages/quiver/collection'], function(dart_sdk, core, canonicalized_map, collection) {
  ...
  const src__internal__copy_on_write_set = Object.create(dart.library);
  const src__internal__copy_on_write_list = Object.create(dart.library);
  const src__internal__iterables = Object.create(dart.library);
  const src__set = Object.create(dart.library);
  const src__iterable = Object.create(dart.library);
  const src__list = Object.create(dart.library);
  const src__internal__copy_on_write_map = Object.create(dart.library);
  const src__list_multimap = Object.create(dart.library);
  const src__map = Object.create(dart.library);
  const src__set_multimap = Object.create(dart.library);
  const $any = dartx.any;
  ...
  const _set = dart.privateName(src__internal__copy_on_write_set, "_set");
  const _setFactory = dart.privateName(src__internal__copy_on_write_set, "_setFactory");
  const _copyBeforeWrite = dart.privateName(src__internal__copy_on_write_set, "_copyBeforeWrite");
  const _maybeCopyBeforeWrite = dart.privateName(src__internal__copy_on_write_set, "_maybeCopyBeforeWrite");
  ...
  const _list = dart.privateName(src__internal__copy_on_write_list, "_list");
  const _growable = dart.privateName(src__internal__copy_on_write_list, "_growable");
  const _copyBeforeWrite$ = dart.privateName(src__internal__copy_on_write_list, "_copyBeforeWrite");
  const _maybeCopyBeforeWrite$ = dart.privateName(src__internal__copy_on_write_list, "_maybeCopyBeforeWrite");
  ...
  const _overridenHashCode = dart.privateName(src__set, "_overridenHashCode");
  const _set$ = dart.privateName(src__set, "_set");
  const _setFactory$ = dart.privateName(src__set, "_setFactory");
  const _hashCode = dart.privateName(src__set, "_hashCode");
  let const$;
  ...
  const _setOwner = dart.privateName(src__set, "_setOwner");
  const _checkGenericTypeParameter = dart.privateName(src__set, "_checkGenericTypeParameter");
  let const$0;
  const _withOwner = dart.privateName(src__set, "_withOwner");
  const _createSet = dart.privateName(src__set, "_createSet");
  const _setSafeSet = dart.privateName(src__set, "_setSafeSet");
  const _checkElement = dart.privateName(src__set, "_checkElement");
  const _safeSet = dart.privateName(src__set, "_safeSet");
  const _checkElements = dart.privateName(src__set, "_checkElements");
  ...
  const _overridenHashCode$ = dart.privateName(src__list, "_overridenHashCode");
  let const$1;
  const _list$ = dart.privateName(src__list, "_list");
  const _hashCode$ = dart.privateName(src__list, "_hashCode");
  let const$2;
  ...
  const _listOwner = dart.privateName(src__list, "_listOwner");
  const _checkGenericTypeParameter$ = dart.privateName(src__list, "_checkGenericTypeParameter");
  let const$3;
  const _setOwner$ = dart.privateName(src__list, "_setOwner");
  const _setSafeList = dart.privateName(src__list, "_setSafeList");
  const _checkElement$ = dart.privateName(src__list, "_checkElement");
  const _safeList = dart.privateName(src__list, "_safeList");
  const _checkElements$ = dart.privateName(src__list, "_checkElements");
  ...
  const _map = dart.privateName(src__internal__copy_on_write_map, "_map");
  const _mapFactory = dart.privateName(src__internal__copy_on_write_map, "_mapFactory");
  const _copyBeforeWrite$0 = dart.privateName(src__internal__copy_on_write_map, "_copyBeforeWrite");
  const _maybeCopyBeforeWrite$0 = dart.privateName(src__internal__copy_on_write_map, "_maybeCopyBeforeWrite");
  ...
  const _overridenHashCode$0 = dart.privateName(src__list_multimap, "_overridenHashCode");
  const _map$ = dart.privateName(src__list_multimap, "_map");
  const _emptyList = dart.privateName(src__list_multimap, "_emptyList");
  const _hashCode$0 = dart.privateName(src__list_multimap, "_hashCode");
  const _keys = dart.privateName(src__list_multimap, "_keys");
  const _values = dart.privateName(src__list_multimap, "_values");
  let const$4;
  ...
  const _builtMap = dart.privateName(src__list_multimap, "_builtMap");
  const _builtMapOwner = dart.privateName(src__list_multimap, "_builtMapOwner");
  const _builderMap = dart.privateName(src__list_multimap, "_builderMap");
  const _checkGenericTypeParameter$0 = dart.privateName(src__list_multimap, "_checkGenericTypeParameter");
  let const$5;
  const _setOwner$0 = dart.privateName(src__list_multimap, "_setOwner");
  const _setWithCopyAndCheck = dart.privateName(src__list_multimap, "_setWithCopyAndCheck");
  const _makeWriteableCopy = dart.privateName(src__list_multimap, "_makeWriteableCopy");
  const _checkKey = dart.privateName(src__list_multimap, "_checkKey");
  const _checkValue = dart.privateName(src__list_multimap, "_checkValue");
  const _getValuesBuilder = dart.privateName(src__list_multimap, "_getValuesBuilder");
  ...
  const _overrridenHashCode = dart.privateName(src__map, "_overrridenHashCode");
  const _map$0 = dart.privateName(src__map, "_map");
  const _mapFactory$ = dart.privateName(src__map, "_mapFactory");
  const _hashCode$1 = dart.privateName(src__map, "_hashCode");
  const _keys$ = dart.privateName(src__map, "_keys");
  const _values$ = dart.privateName(src__map, "_values");
  let const$6;
  ...
  const _mapOwner = dart.privateName(src__map, "_mapOwner");
  const _checkGenericTypeParameter$1 = dart.privateName(src__map, "_checkGenericTypeParameter");
  let const$7;
  const _setOwner$1 = dart.privateName(src__map, "_setOwner");
  const _createMap = dart.privateName(src__map, "_createMap");
  const _setSafeMap = dart.privateName(src__map, "_setSafeMap");
  const _checkKey$ = dart.privateName(src__map, "_checkKey");
  const _checkValue$ = dart.privateName(src__map, "_checkValue");
  const _safeMap = dart.privateName(src__map, "_safeMap");
  const _checkKeys = dart.privateName(src__map, "_checkKeys");
  const _checkValues = dart.privateName(src__map, "_checkValues");
  ...
  const _overridenHashCode$1 = dart.privateName(src__set_multimap, "_overridenHashCode");
  const _map$1 = dart.privateName(src__set_multimap, "_map");
  const _emptySet = dart.privateName(src__set_multimap, "_emptySet");
  const _hashCode$2 = dart.privateName(src__set_multimap, "_hashCode");
  const _keys$0 = dart.privateName(src__set_multimap, "_keys");
  const _values$0 = dart.privateName(src__set_multimap, "_values");
  let const$8;
  ...
  const _builtMap$ = dart.privateName(src__set_multimap, "_builtMap");
  const _builtMapOwner$ = dart.privateName(src__set_multimap, "_builtMapOwner");
  const _builderMap$ = dart.privateName(src__set_multimap, "_builderMap");
  const _checkGenericTypeParameter$2 = dart.privateName(src__set_multimap, "_checkGenericTypeParameter");
  let const$9;
  const _setOwner$2 = dart.privateName(src__set_multimap, "_setOwner");
  const _setWithCopyAndCheck$ = dart.privateName(src__set_multimap, "_setWithCopyAndCheck");
  const _makeWriteableCopy$ = dart.privateName(src__set_multimap, "_makeWriteableCopy");
  const _checkKey$0 = dart.privateName(src__set_multimap, "_checkKey");
  const _checkValue$0 = dart.privateName(src__set_multimap, "_checkValue");
  const _getValuesBuilder$ = dart.privateName(src__set_multimap, "_getValuesBuilder");
