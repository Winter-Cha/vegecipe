...
class MediumEditorInterop {
  ...
  external void subscribe(name, listener);
}
...
class Toolbar {
  ...
  external factory Toolbar({List buttons});
}
...
class MediumEditorOptions {
  ...
  external Toolbar get toolbar;

  external factory MediumEditorOptions({PlaceHolderOptions placeholder,Toolbar toolbar});
}
