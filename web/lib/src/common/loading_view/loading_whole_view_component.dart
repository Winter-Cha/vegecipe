...
@Component(
  selector: 'loading-whole-view',
  templateUrl: 'loading_whole_view_component.html',
  styleUrls: ['loading_whole_view_component.css'],
  directives: [
    SpinnerComponent,
    NgIf,
  ],
)
class LoadingWholeViewComponent implements OnDestroy {
  LoadingWholeViewComponent(this.messages);
  ...
  bool get containerVisible => _status != LoadingStatus.idle;
  bool get containerPresent =>
      containerVisible || !_clearOutInvisibleContent;
