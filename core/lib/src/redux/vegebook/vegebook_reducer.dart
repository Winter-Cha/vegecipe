...
VegeBookState vegeBookReducer(VegeBookState state, dynamic action) {
  if(action is RefreshVegeBookAction){
    return _refreshVegeBook(state);
      }else if (action is RequestingVegeBookAction) {
...
VegeBookState _refreshVegeBook(VegeBookState state) {
